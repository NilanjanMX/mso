...
class AnalyticsReadymadeController extends Controller
{
    ...
    public function download_by_category(Request $request){
        ...
        $data['reports'] = DB::table("history_readymades")->select(['history_readymades.*','readymade_portfolio_categories.name as user_name',DB::raw('COUNT(readymade_portfolio_categories.name) as total_count')])->leftJoin('readymade_portfolio', 'history_readymades.page_id', '=', 'readymade_portfolio.id')->leftJoin('readymade_portfolio_categories', 'history_readymades.category_id', '=', 'readymade_portfolio_categories.id');
        ...
        if($data['ustart_date'] && $data['uend_date']){
            ...
            $data['reports'] = $data['reports']->whereBetween('history_readymades.created_at', [$ustart_date , $uend_date]);
        }
        ...
        $data['reports'] = $data['reports']->where('value','=','PDF')->groupBy(['readymade_portfolio_categories.id'])->get();
