...
class SuggestedAssetAllocationController extends Controller
{
    ...
    {
        $data['periods'] = Investment_period::latest()->get();
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'age_min' => 'required',
            'age_max' => 'required',
            'investment_periods_id' => 'required'
        ]);
        ...
        $saveData = [
            ...
            'investment_periods_id' => $input['investment_periods_id']
        ];
