...
class PremiumController extends Controller
{
    ...
    public function portfolio_projection()
    {
    ...
    public function portfolio_projection_output(Request $request)
    {
        ...
        UserHistory::create([
            ...
            'page_type' => "Premium Calculator",
            'page_name' => "Recover Your EMI's through SIPs",
        ]);
        ...
        if ($request->isMethod('get')) {
            if (Session::has('projection_portfolio')) {
                ...
                UserHistory::create([
                    ...
                    'main_page' => "Calculator",
                    'page_type' => "Premium",
                    'page_name' => "Portfolio Projection Report",
                ]);
            } else {
