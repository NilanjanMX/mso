...
class FutureValueOfStpController extends Controller
{
    ...
    public function futureValueOfSTP(Request $request){
        
        if($request->action == "back"){
            if (session()->has('future_value_of_stp_form_id')){
                session()->forget('future_value_of_stp_form_id');
            }
            // dd(Session::get('future_value_of_stp_form_data'));
            if (Session::has('future_value_of_stp_form_data')) {
                $saveCalculatorsData = Session::get('future_value_of_stp_form_data');
                ...
                $data['form_data']['equity_fund'] = $saveCalculatorsData['equity_fund'];
                $data['form_data']['monthly_transfer_mode'] = $saveCalculatorsData['monthly_transfer_mode'];
                if($data['form_data']['monthly_transfer_mode']=='FT'){
                ...
                $data['calculater_heading'] = CalculatorHeading::where('key_name','=','future_value_of_stp')->first();
                // dd($data);

                $data['details'] = DB::table("calculators")->where("url","calculators/stp-calculator/future-value-of-stp")->first();
                // dd($data);
                return view('frontend.calculators.futurevalueofstp.edit',$data);
                
            }else{
                return redirect()->route('frontend.futureValueOfSTP');
            }
        }else{
            ...
            if (session()->has('future_value_of_stp_form_data')){
                session()->forget('future_value_of_stp_form_data');
            }
            if (session()->has('future_value_of_stp_form_id')){
                session()->forget('future_value_of_stp_form_id');
            }
            ...
            $data['details'] = DB::table("calculators")->where('url','calculators/stp-calculator/future-value-of-stp')->first();
            // dd($data);
            return view('frontend.calculators.futurevalueofstp.index',$data);
        }
    }

    public function futureValueOfSTPOutput(Request $request){
        if ($request->isMethod('get')) {
            if (Session::has('future_value_of_stp_form_data')) {
                $input = Session::get('future_value_of_stp_form_data');
                // dd($input);
                ...
                $data['equity_fund'] = $input['equity_fund'];
        ...
        if ($request->isMethod('post')) {
            ...
            Session::put('future_value_of_stp_form_data', $data);
        }
        ...
        $category_detail = Calculator::where("url","calculators/stp-calculator/future-value-of-stp")->first();
        ...
        $edit_id = session()->get('future_value_of_stp_form_id');
        if(!empty($edit_id)){
            $calc = SaveCalculators::where('user_id',Auth::user()->id)->where('id',$edit_id)->first();
            $data['cal_name'] = $calc->title;
        }
        
        $calculators = DB::table("calculators")->where("id",13)->first();
        if($calculators){
        ...
        $data['edit_id'] = session()->get('future_value_of_stp_form_id');
        // dd(session()->get('future_value_of_stp_form_id'));
        return view('frontend.calculators.futurevalueofstp.output',$data);
    }

    public function futureValueOfSTPOutputSave(Request $request){
        ...
        if ($request->isMethod('get')) {
            if (Session::has('future_value_of_stp_form_data')) {
                ...
                $view = (string)View::make('frontend.calculators.futurevalueofstp.output_pdf',$data);
    ...
    public function futureValueOfSTPOutputDownloadPDF(Request $request){
        if ($request->isMethod('get')) {
            if (Session::has('future_value_of_stp_form_data')) {
                $input = Session::get('future_value_of_stp_form_data');
                $data['initial_investment'] = $input['initial_investment'];
                ...
                $data['title'] = "Future Value of STP";
                ...
                if($data['pdf_title_line1']){
                    ...
                    $pdf = PDF::loadView('frontend.calculators.futurevalueofstp.output_pdf', $data);
    ...
    public function edit(Request $request){
        ...
        Session::put('future_value_of_stp_form_id', $request->id);
    ...
    public function view(Request $request){
        ...
        $data['details'] = DB::table("calculators")->where('url','calculators/stp-calculator/future-value-of-stp')->first();
        // dd($data);
        return view('frontend.calculators.futurevalueofstp.view',$data);
    }
