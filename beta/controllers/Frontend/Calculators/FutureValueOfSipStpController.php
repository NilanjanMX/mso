...
class FutureValueOfSipStpController extends Controller
{
    ...
    public function index(Request $request){
        ...
        if($request->action == "back"){
            if (session()->has('futureValueOfSipStp_form_id')){
                session()->forget('futureValueOfSipStp_form_id');
            }
            // dd(Session::get('futureValueOfSipStp_form_data'));
            if (Session::has('futureValueOfSipStp_form_data')) {
                $saveCalculatorsData = Session::get('futureValueOfSipStp_form_data');
                ...
                $data['calculater_heading'] = CalculatorHeading::where('key_name','=','future_value of_sip_+_stp')->first();
                // dd($data);

                $data['details'] = DB::table("calculators")->where("url","calculators/combination/future-value-of-sip-stp")->first();
                // dd($data);
                return view('frontend.calculators.future_value_of_sip_stp.edit',$data);
                
            }else{
                return redirect()->route('frontend.futureValueOfSipStp');
            }
        }else{
            ...
            if (session()->has('futureValueOfSipStp_form_data')){
                session()->forget('futureValueOfSipStp_form_data');
            }
            if (session()->has('futureValueOfSipStp_form_id')){
                session()->forget('futureValueOfSipStp_form_id');
            }
            ...
            $data['details'] = DB::table("calculators")->where("url","calculators/combination/future-value-of-sip-stp")->first();
            // dd($data);
            return view('frontend.calculators.future_value_of_sip_stp.index',$data);
        }
    }
    ...
    public function output(Request $request){
        if ($request->isMethod('get')) {
            if (Session::has('futureValueOfSipStp_form_data')) {
                $input = Session::get('futureValueOfSipStp_form_data');
                // dd($input);
                $data = $input;
        ...
        if ($request->isMethod('post')) {
            ...
            Session::put('futureValueOfSipStp_form_data', $data);
        }
        ...
        $category_detail = Calculator::where("url","calculators/combination/future-value-of-sip-stp")->first();
        ...
        $edit_id = session()->get('futureValueOfSipStp_form_id');
        if(!empty($edit_id)){
            $calc = SaveCalculators::where('user_id',Auth::user()->id)->where('id',$edit_id)->first();
            $data['cal_name'] = $calc->title;
        }
        
        $calculators = DB::table("calculators")->where("id",25)->first();
        if($calculators){
        ...
        $data['edit_id'] = session()->get('futureValueOfSipStp_form_id');
        // dd(session()->get('calculator_duration'));
        return view('frontend.calculators.future_value_of_sip_stp.output',$data);
    }
    ...
    public function save(Request $request){
        ...
        if ($request->isMethod('get')) {
            if (Session::has('futureValueOfSipStp_form_data')) {
                ...
                $view = (string)View::make('frontend.calculators.future_value_of_sip_stp.pdf',$data);
    ...
    public function pdf(Request $request){
        if ($request->isMethod('get')) {
            if (Session::has('futureValueOfSipStp_form_data')) {
                ...
                $data['title'] = "Future Value Of SIP + STP";
                ...
                if(isset($data['pdf_title_line1']) && $data['pdf_title_line1']){
                    ...
                    $pdf = PDF::loadView('frontend.calculators.future_value_of_sip_stp.pdf', $data);
    ...
    public function edit(Request $request){
        ...
        Session::put('futureValueOfSipStp_form_id', $request->id);
    ...
    public function view(Request $request){
        ...
        $data['details'] = DB::table("calculators")->where("url","calculators/combination/future-value-of-sip-stp")->first();
        return view('frontend.calculators.future_value_of_sip_stp.view',$data);
    }
