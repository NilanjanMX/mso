...
class FutureValueStepUpSipRequiredTargetController extends Controller
{
    ...
    public function futureValueOfStepUpSIPRequiredTarget(Request $request){
        
        if($request->action == "back"){
            if (session()->has('future_value_of_stepup_sip_target_form_id')){
                session()->forget('future_value_of_stepup_sip_target_form_id');
            }
            // dd(Session::get('future_value_of_stepup_sip_target_form_data'));
            if (Session::has('future_value_of_stepup_sip_target_form_data')) {
                $saveCalculatorsData = Session::get('future_value_of_stepup_sip_target_form_data');
                ...
                $data['form_data']['annual_increment'] = isset($saveCalculatorsData['annual_increment'])?$saveCalculatorsData['annual_increment']:'';
                ...
                $data['calculater_heading'] = CalculatorHeading::where('key_name','=','step_up_sip_required_for_target_future_value')->first();
                // dd($data);

                $data['details'] = DB::table("calculators")->where("url","calculators/sip-calculator/future-value-of-stepup-sip-required-target")->first();
                // dd($data);
                return view('frontend.calculators.futurevalueofstepupsiprequiredtarget.edit',$data);
                
            }else{
                return redirect()->route('frontend.futureValueOfStepUpSIPRequiredTarget');
            }
        }else{
            ...
            if (session()->has('future_value_of_stepup_sip_target_form_data')){
                session()->forget('future_value_of_stepup_sip_target_form_data');
            }
            if (session()->has('future_value_of_stepup_sip_target_form_id')){
                session()->forget('future_value_of_stepup_sip_target_form_id');
            }
            ...
            $data['details'] = DB::table("calculators")->where('url','calculators/sip-calculator/future-value-of-stepup-sip-required-target')->first();
            // dd($data);
            return view('frontend.calculators.futurevalueofstepupsiprequiredtarget.index',$data);
        }
    }

    public function futureValueOfStepUpSIPRequiredTargetOutput(Request $request){
        if ($request->isMethod('get')) {
            if (Session::has('future_value_of_stepup_sip_target_form_data')) {
                $input = Session::get('future_value_of_stepup_sip_target_form_data');
                // dd($input);
                ...
                if (isset($input['annual_increment']) && $input['annual_increment'] != '') {
                    $data['annual_increment'] = $input['annual_increment'];
                }
        ...
        if ($request->isMethod('post')) {
            $request->validate([
                ...
                'annual_increment' => 'required|numeric|between:1,25',
            ...
            Session::put('future_value_of_stepup_sip_target_form_data', $data);
        }
        ...
        $category_detail = Calculator::where("url","calculators/sip-calculator/future-value-of-stepup-sip-required-target")->first();
        ...
        $edit_id = session()->get('future_value_of_stepup_sip_target_form_id');
        if(!empty($edit_id)){
            $calc = SaveCalculators::where('user_id',Auth::user()->id)->where('id',$edit_id)->first();
            $data['cal_name'] = $calc->title;
        }
        
        $calculators = DB::table("calculators")->where("id",10)->first();
        if($calculators){
        ...
        $data['edit_id'] = session()->get('future_value_of_stepup_sip_target_form_id');
        // dd(session()->get('future_value_of_stepup_sip_target_form_id'));
        return view('frontend.calculators.futurevalueofstepupsiprequiredtarget.output',$data);
    }

    public function futureValueOfStepUpSIPRequiredTargetOutputSave(Request $request){
        ...
        if ($request->isMethod('get')) {
            if (Session::has('future_value_of_stepup_sip_target_form_data')) {
                ...
                $view = (string)View::make('frontend.calculators.futurevalueofstepupsiprequiredtarget.output_pdf',$data);
    ...
    public function futureValueOfStepUpSIPRequiredTargetOutputPdfDownload(Request $request){
        if ($request->isMethod('get')) {
            if (Session::has('future_value_of_stepup_sip_target_form_data')) {
                $input = Session::get('future_value_of_stepup_sip_target_form_data');
                $data['amount'] = $input['amount'];
                ...
                $data['title'] = "Step-Up SIP Required For Target Future Value";
                ...
                if($data['pdf_title_line1']){
                    ...
                    $pdf = PDF::loadView('frontend.calculators.futurevalueofstepupsiprequiredtarget.output_pdf', $data);
    ...
    public function edit(Request $request){
        ...
        Session::put('future_value_of_stepup_sip_target_form_id', $request->id);
    ...
    public function view(Request $request){
        ...
        $data['details'] = DB::table("calculators")->where('url','calculators/sip-calculator/future-value-of-stepup-sip-required-target')->first();
        // dd($data);
        return view('frontend.calculators.futurevalueofstepupsiprequiredtarget.view',$data);
    }
