...
class FutureValueOfStepUpSipController extends Controller
{
    ...
    public function futureValueOfStepUpSIP(Request $request){
        
        if($request->action == "back"){
            if (session()->has('future_value_of_stepup_sip_form_id')){
                session()->forget('future_value_of_stepup_sip_form_id');
            }
            // dd(Session::get('future_value_of_stepup_sip_form_data'));
            if (Session::has('future_value_of_stepup_sip_form_data')) {
                $saveCalculatorsData = Session::get('future_value_of_stepup_sip_form_data');
                ...
                $data['calculater_heading'] = CalculatorHeading::where('key_name','=','future_value_of_step_up_sip')->first();
                // dd($data);

                $data['details'] = DB::table("calculators")->where("url","calculators/sip-calculator/future-value-of-stepup-sip")->first();
                // dd($data);
                return view('frontend.calculators.futurevalueofstepupsip.edit',$data);
                
            }else{
                return redirect()->route('frontend.futureValueOfStepUpSIP');
            }
        }else{
            ...
            if (session()->has('future_value_of_stepup_sip_form_data')){
                session()->forget('future_value_of_stepup_sip_form_data');
            }
            if (session()->has('future_value_of_stepup_sip_form_id')){
                session()->forget('future_value_of_stepup_sip_form_id');
            }
            ...
            $data['details'] = DB::table("calculators")->where('url','calculators/sip-calculator/future-value-of-stepup-sip')->first();
            // dd($data);
            return view('frontend.calculators.futurevalueofstepupsip.index',$data);
        }
    }

    public function futureValueOfStepUpSIPOutput(Request $request){
        if ($request->isMethod('get')) {
            if (Session::has('future_value_of_stepup_sip_form_data')) {
                $input = Session::get('future_value_of_stepup_sip_form_data');
                // dd($input);
        ...
        if ($request->isMethod('post')) {
            ...
            Session::put('future_value_of_stepup_sip_form_data', $data);
        }
        ...
        $category_detail = Calculator::where("url","calculators/sip-calculator/future-value-of-stepup-sip")->first();
        ...
        $edit_id = session()->get('future_value_of_stepup_sip_form_id');
        if(!empty($edit_id)){
            $calc = SaveCalculators::where('user_id',Auth::user()->id)->where('id',$edit_id)->first();
            $data['cal_name'] = $calc->title;
        }
        
        $calculators = DB::table("calculators")->where("id",9)->first();
        if($calculators){
        ...
        $data['edit_id'] = session()->get('future_value_of_stepup_sip_form_id');
        // dd(session()->get('future_value_of_stepup_sip_form_id'));
        return view('frontend.calculators.futurevalueofstepupsip.output',$data);
    }

    public function futureValueOfStepUpSIPOutputSave(Request $request){
        ...
        if ($request->isMethod('get')) {
            if (Session::has('future_value_of_stepup_sip_form_data')) {
                ...
                $view = (string)View::make('frontend.calculators.futurevalueofstepupsip.output_pdf',$data);
    ...
    public function futureValueOfStepUpSIPOutputPdfDownload(Request $request){
        if ($request->isMethod('get')) {
            if (Session::has('future_value_of_stepup_sip_form_data')) {
                $input = Session::get('future_value_of_stepup_sip_form_data');
                $data['amount'] = $input['amount'];
                ...
                $data['title'] = "Future Value of Step-Up SIP";
                ...
                if($data['pdf_title_line1']){
                    ...
                    $pdf = PDF::loadView('frontend.calculators.futurevalueofstepupsip.output_pdf', $data);
    ...
    public function edit(Request $request){
        ...
        Session::put('future_value_of_stepup_sip_form_id', $request->id);
    ...
    public function view(Request $request){
        ...
        $data['details'] = DB::table("calculators")->where('url','calculators/sip-calculator/future-value-of-stepup-sip')->first();
        // dd($data);
        return view('frontend.calculators.futurevalueofstepupsip.view',$data);
    }
