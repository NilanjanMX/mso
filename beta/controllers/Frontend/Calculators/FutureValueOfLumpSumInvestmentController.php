...
class FutureValueOfLumpSumInvestmentController extends Controller
{
    ...
    public function index(Request $request)
    {
        if($request->action == "back"){
            if (session()->has('future_value_of_lump_sum_investment_form_id')){
                session()->forget('future_value_of_lump_sum_investment_form_id');
            }
            // dd(Session::get('future_value_of_lump_sum_investment_form_data'));
            if (Session::has('future_value_of_lump_sum_investment_form_data')) {
                $saveCalculatorsData = Session::get('future_value_of_lump_sum_investment_form_data');
                
                // dd($saveCalculatorsData);
                
                // if (session()->has('future_value_of_lump_sum_investment_form_data')){
                //     session()->forget('future_value_of_lump_sum_investment_form_data');
                // }
                ...
                $data['calculater_heading'] = CalculatorHeading::where('key_name','=','future_value_of_lump_sum_investment')->first();
                // dd($data);

                $data['details'] = DB::table("calculators")->where("url","calculators/onetime-investment/future-value-of-one-time-investment")->first();
                // dd($data);
                return view('frontend.calculators.future_value_of_lump_sum_investment.edit',$data);
                
            }else{
                return redirect()->route('frontend.futureValueOfLumpsumInvestment');
            }
        }else{
            ...
            $data = [];
            $data['calculater_heading'] = CalculatorHeading::where('key_name','=','future_value_of_lump_sum_investment')->first();
            return view('frontend.calculators.future_value_of_lump_sum_investment.index',$data); 
    ...
    public function output(Request $request)
    {
        if ($request->isMethod('get')) {
            if (Session::has('future_value_of_lump_sum_investment_form_data')) {
                $input = Session::get('future_value_of_lump_sum_investment_form_data');
        ...
        if ($request->isMethod('post')) {
            ...
            Session::put('future_value_of_lump_sum_investment_form_data', $data);
        }
        ...
        $edit_id = session()->get('future_value_of_lump_sum_investment_form_id');
        if(!empty($edit_id)){
        ...
        $data['edit_id'] = session()->get('future_value_of_lump_sum_investment_form_id');

        return view('frontend.calculators.future_value_of_lump_sum_investment.output',$data);
    }

    public function pdf(Request $request){
        if ($request->isMethod('get')) {
            if (Session::has('future_value_of_lump_sum_investment_form_data')) {
                $data = Session::get('future_value_of_lump_sum_investment_form_data');
                ...
                if($data['pdf_title_line1']){
                    ...
                    $pdf = PDF::loadView('frontend.calculators.future_value_of_lump_sum_investment.pdf', $data);
    ...
    public function save(Request $request){
        ...
        if ($request->isMethod('get')) {
            if (Session::has('future_value_of_lump_sum_investment_form_data')) {
                ...
                $view = (string)View::make('frontend.calculators.future_value_of_lump_sum_investment.pdf',$data);
                $edit_id = session()->get('future_value_of_lump_sum_investment_form_id');
    ...
    public function edit(Request $request){
        ...
        Session::put('future_value_of_lump_sum_investment_form_id', $request->id);
    ...
    public function view(Request $request){
        ...
        $data['details'] = DB::table("calculators")->where('url','calculators/onetime-investment/future-value-of-one-time-investment')->first();
        return view('frontend.calculators.future_value_of_lump_sum_investment.view',$data);
    }
