...
class TermInsuranceSIPgoalBaseCalcController extends Controller
{
    ...
    public function index(Request $request){
        ...
        if($request->action == "back"){
            if (session()->has('term_insurance_+_sip_goal_based_form_id')){
                session()->forget('term_insurance_+_sip_goal_based_form_id');
            }
            // dd(Session::get('term_insurance_+_sip_goal_based_form_data'));
            if (Session::has('term_insurance_+_sip_goal_based_form_data')) {
                $saveCalculatorsData = Session::get('term_insurance_+_sip_goal_based_form_data');
                ...
                $data['calculater_heading'] = CalculatorHeading::where('key_name','=','term_insurance_+_sip_goal_based')->first();
                // dd($data);

                $data['details'] = DB::table("calculators")->where("url","calculators/mf-vs-insurance/term-insurance-sip-goal-base")->first();
                // dd($data);
                return view('frontend.calculators.term_insurance_sip_goal_based.edit',$data);
                
            }else{
                return redirect()->route('frontend.termInsuranceSIPgoalBase');
            }
        }else{
            ...
            if (session()->has('term_insurance_+_sip_goal_based_form_data')){
                session()->forget('term_insurance_+_sip_goal_based_form_data');
            }
            if (session()->has('term_insurance_+_sip_goal_based_form_id')){
                session()->forget('term_insurance_+_sip_goal_based_form_id');
            }
            ...
            $data['details'] = DB::table("calculators")->where("url","calculators/mf-vs-insurance/term-insurance-sip-goal-base")->first();
            // dd($data);
            return view('frontend.calculators.term_insurance_sip_goal_based.index',$data);
        }
    }
    ...
    public function output(Request $request){
        if ($request->isMethod('get')) {
            if (Session::has('term_insurance_+_sip_goal_based_form_data')) {
                $input = Session::get('term_insurance_+_sip_goal_based_form_data');
                // dd($input);
                $data = $input;
        ...
        if ($request->isMethod('post')) {
            ...
            $request->validate([
                'current_age' => 'required|numeric|between:1,99',
                'goal_amount' => 'required|numeric|between:100,9999999999',
                'term_insurance_period' => 'required|numeric|between:1,99',
                'term_insurance_annual_premium' => 'required|numeric|between:100,9999999999',
                'rate_of_return' => 'required|numeric|between:0.1,18',
            ...
            Session::put('term_insurance_+_sip_goal_based_form_data', $data);
        }
        ...
        $category_detail = Calculator::where("url","calculators/mf-vs-insurance/term-insurance-sip-goal-base")->first();
        ...
        $edit_id = session()->get('term_insurance_+_sip_goal_based_form_id');
        if(!empty($edit_id)){
            $calc = SaveCalculators::where('user_id',Auth::user()->id)->where('id',$edit_id)->first();
            $data['cal_name'] = $calc->title;
        }
        
        $calculators = DB::table("calculators")->where("id",30)->first();
        if($calculators){
        ...
        $data['edit_id'] = session()->get('term_insurance_+_sip_goal_based_form_id');
        // dd(session()->get('calculator_duration'));
        return view('frontend.calculators.term_insurance_sip_goal_based.output',$data);
    }
    ...
    public function save(Request $request){
        ...
        if ($request->isMethod('get')) {
            if (Session::has('term_insurance_+_sip_goal_based_form_data')) {
                ...
                $view = (string)View::make('frontend.calculators.term_insurance_sip_goal_based.pdf',$data);
    ...
    public function pdf(Request $request){
        if ($request->isMethod('get')) {
            if (Session::has('term_insurance_+_sip_goal_based_form_data')) {
                ...
                $data['title'] = "Term Insurance + SIP (Goal Based)";
                ...
                if($data['pdf_title_line1']){
                    ...
                    $pdf = PDF::loadView('frontend.calculators.term_insurance_sip_goal_based.pdf', $data);
    ...
    public function edit(Request $request){
        ...
        Session::put('term_insurance_+_sip_goal_based_form_id', $request->id);
    ...
    public function view(Request $request){
        ...
        $data['details'] = DB::table("calculators")->where("url","calculators/mf-vs-insurance/term-insurance-sip-goal-base")->first();
        return view('frontend.calculators.term_insurance_sip_goal_based.view',$data);
    }
    ...
    public function merge_download(Request $request){
        ...
        $data['title'] = "Term Insurance + SIP (Goal Based) Calculation";
