...
class OneTimeInvestmentGoalPlanningReadyReckonerController extends Controller
{
    ...
    public function one_time_investment_ready_reckoner(Request $request){
        
        if($request->action == "back"){
            if (session()->has('one_time_investmant_ready_reckoner_form_id')){
                session()->forget('one_time_investmant_ready_reckoner_form_id');
            }
            // dd(Session::get('one_time_investment_ready_reckoner_form_data'));
            if (Session::has('one_time_investment_ready_reckoner_form_data')) {
                $saveCalculatorsData = Session::get('one_time_investment_ready_reckoner_form_data');
                
                // dd($saveCalculatorsData);
                
                // if (session()->has('one_time_investment_ready_reckoner_form_data')){
                //     session()->forget('one_time_investment_ready_reckoner_form_data');
                // }
                ...
                $data['details'] = DB::table("calculators")->where("url","calculators/onetime-investment/one-time-investment-ready-reckoner")->first();
                // dd($data);
                return view('frontend.calculators.one_time_investment_goal_planning_ready_reckoner.edit',$data);
                
            }else{
                return redirect()->route('frontend.oneTimeInvestmentReadyReckoner');
            }
        }else{
            ...
            $data = [];
            $data['calculater_heading'] = CalculatorHeading::where('key_name','=','one_time_investment_ready_reckoner')->first();
            
            $data['details'] = DB::table("calculators")->where('url','calculators/onetime-investment/one-time-investment-ready-reckoner')->first();
            // dd($data);
            return view('frontend.calculators.one_time_investment_goal_planning_ready_reckoner.index',$data);
        }
    }

    public function one_time_investment_ready_reckoner_output(Request $request){
        if ($request->isMethod('get')) {
            if (Session::has('one_time_investment_ready_reckoner_form_data')) {
                $input = Session::get('one_time_investment_ready_reckoner_form_data');
                // dd($input);
        ...
        if ($request->isMethod('post')) {
            ...
            Session::put('one_time_investment_ready_reckoner_form_data', $data);
        }
        ...
        $category_detail = Calculator::where("url","calculators/onetime-investment/one-time-investment-ready-reckoner")->first();
        ...
        $edit_id = session()->get('one_time_investmant_ready_reckoner_form_id');
        if(!empty($edit_id)){
            $calc = SaveCalculators::where('user_id',Auth::user()->id)->where('id',$edit_id)->first();
            $data['cal_name'] = $calc->title;
        }
        
        $calculators = DB::table("calculators")->where("id",3)->first();
        if($calculators){
        ...
        $data['edit_id'] = session()->get('one_time_investmant_ready_reckoner_form_id');
        // dd(session()->get('calculator_duration'));
        return view('frontend.calculators.one_time_investment_goal_planning_ready_reckoner.output',$data);
    }

    public function one_time_investment_ready_reckoner_output_save(Request $request){
        ...
        if ($request->isMethod('get')) {
            if (Session::has('one_time_investment_ready_reckoner_form_data')) {
                ...
                $view = (string)View::make('frontend.calculators.one_time_investment_goal_planning_ready_reckoner.pdf',$data);
    ...
    public function one_time_investment_ready_reckoner_output_pdf_download(Request $request){
        if ($request->isMethod('get')) {
            if (Session::has('one_time_investment_ready_reckoner_form_data')) {
                $input = Session::get('one_time_investment_ready_reckoner_form_data');
                $data['investment'] = $input['investment'];
                ...
                $data['title'] = "Lumpsum Investment Ready Reckoner";
                ...
                if($data['pdf_title_line1']){
                    ...
                    $pdf = PDF::loadView('frontend.calculators.one_time_investment_goal_planning_ready_reckoner.pdf', $data);
                    ...
                    // dd($data);
                    $pdf = PDF::loadView('frontend.calculators.one_time_investment_goal_planning_ready_reckoner.output_pdf', $data);
    ...
    public function one_time_investment_ready_reckoner_edit(Request $request){
        ...
        Session::put('one_time_investmant_ready_reckoner_form_id', $request->id);
        
        $data['calculater_heading'] = CalculatorHeading::where('key_name','=','lumpsum_investment_goal_planning_ready_reckoner')->first();
        // dd($data);
        return view('frontend.calculators.one_time_investment_goal_planning_ready_reckoner.edit',$data);
    }
    ...
    public function view(Request $request){
        ...
        $data['details'] = DB::table("calculators")->where('url','calculators/onetime-investment/one-time-investment-ready-reckoner')->first();
        return view('frontend.calculators.one_time_investment_goal_planning_ready_reckoner.view',$data);
    }
