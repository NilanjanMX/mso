...
class StpRequiredForTargetFutureValueController extends Controller
{
    ...
    public function index(Request $request){
        ...
        if($request->action == "back"){
            if (session()->has('stp_required_for_target_future_value_form_id')){
                session()->forget('stp_required_for_target_future_value_form_id');
            }
            // dd(Session::get('stp_required_for_target_future_value_form_data'));
            if (Session::has('stp_required_for_target_future_value_form_data')) {
                $saveCalculatorsData = Session::get('stp_required_for_target_future_value_form_data');
                ...
                $data['calculater_heading'] = CalculatorHeading::where('key_name','=','stp_required_for_target_future_value')->first();
                // dd($data);

                $data['details'] = DB::table("calculators")->where("url","calculators/stp-calculator/stp-required-for-target-future-value")->first();
                // dd($data);
                return view('frontend.calculators.stp_required_for_target_future_value.edit',$data);
                
            }else{
                return redirect()->route('frontend.stpRequiredForTargetFutureValue');
            }
        }else{
            ...
            if (session()->has('stp_required_for_target_future_value_form_data')){
                session()->forget('stp_required_for_target_future_value_form_data');
            }
            if (session()->has('stp_required_for_target_future_value_form_id')){
                session()->forget('stp_required_for_target_future_value_form_id');
            }
            ...
            $data['details'] = DB::table("calculators")->where("url","calculators/stp-calculator/stp-required-for-target-future-value")->first();
            // dd($data);
            return view('frontend.calculators.stp_required_for_target_future_value.index',$data);
        }
    }
    ...
    public function output(Request $request){
        if ($request->isMethod('get')) {
            if (Session::has('stp_required_for_target_future_value_form_data')) {
                $input = Session::get('stp_required_for_target_future_value_form_data');
                // dd($input);
                $data = $input;
        ...
        if ($request->isMethod('post')) {
            ...
            if ($request->target_amount>100) {
                $target_amount = round($request->target_amount*2/100);
            }
            $request->validate([
                'target_amount' => 'required|numeric|between:100,9999999999',
                ...
                'fixed_amount' => "sometimes|nullable|numeric|between:100,$target_amount,",
            ]);
            ...
            Session::put('stp_required_for_target_future_value_form_data', $data);
        }
        ...
        $category_detail = Calculator::where("url","calculators/stp-calculator/stp-required-for-target-future-value")->first();
        ...
        $edit_id = session()->get('stp_required_for_target_future_value_form_id');
        if(!empty($edit_id)){
            $calc = SaveCalculators::where('user_id',Auth::user()->id)->where('id',$edit_id)->first();
            $data['cal_name'] = $calc->title;
        }
        
        $calculators = DB::table("calculators")->where("id",14)->first();
        if($calculators){
        ...
        $data['edit_id'] = session()->get('stp_required_for_target_future_value_form_id');
        // dd(session()->get('calculator_duration'));
        return view('frontend.calculators.stp_required_for_target_future_value.output',$data);
    }
    ...
    public function save(Request $request){
        ...
        if ($request->isMethod('get')) {
            if (Session::has('stp_required_for_target_future_value_form_data')) {
                ...
                $view = (string)View::make('frontend.calculators.stp_required_for_target_future_value.pdf',$data);
    ...
    public function pdf(Request $request){
        if ($request->isMethod('get')) {
            if (Session::has('stp_required_for_target_future_value_form_data')) {
                ...
                $data['title'] = "STP Required For Target Future Value";
                ...
                if($data['pdf_title_line1']){
                    ...
                    $pdf = PDF::loadView('frontend.calculators.stp_required_for_target_future_value.pdf', $data);
    ...
    public function edit(Request $request){
        ...
        Session::put('stp_required_for_target_future_value_form_id', $request->id);
    ...
    public function view(Request $request){
        ...
        $data['details'] = DB::table("calculators")->where("url","calculators/stp-calculator/stp-required-for-target-future-value")->first();
        return view('frontend.calculators.stp_required_for_target_future_value.view',$data);
    }
    ...
    public function merge_download(Request $request){
        ...
        $data['title'] = "STP Required For Target Future Value Calculation";
