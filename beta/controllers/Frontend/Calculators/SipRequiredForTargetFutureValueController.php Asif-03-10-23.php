...
class SipRequiredForTargetFutureValueController extends Controller
{
    ...
    public function index(Request $request)
    {
        if($request->action == "back"){
            ...
            if (Session::has('sip_required_for_target_future_value_form_data')) {
                ...
                $data['details'] = DB::table("calculators")->where("url","calculators/onetime-investment/future-value-of-one-time-investment")->first();
                // dd($data);
    ...
    public function output(Request $request)
    {
        ...
        $category_detail = Calculator::where("url","calculators/onetime-investment/future-value-of-one-time-investment")->first();
