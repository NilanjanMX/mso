...
class SwpCalculatorMonthlyAnnuityForSipController extends Controller
{
    ...
    public function monthlyAnnuityForSIP(Request $request){
        ...
        if($request->action == "back"){
            ...
            if (Session::has('monthly_annuity_for_sip_form_data')) {
                ...
                $data['calculater_heading'] = CalculatorHeading::where('key_name','=','monthly_swp_for_sip')->first();
                // dd($data);

                $data['details'] = DB::table("calculators")->where("url","calculators/swp-calculator/monthly-annuity-for-sip")->first();
                // dd($data);
                return view('frontend.calculators.swpcalculatormonthlyannuityforsip.edit',$data);
                
            }else{
                return redirect()->route('frontend.monthlyAnnuityForSIP');
            }
        }else{
            ...
            $data['details'] = DB::table("calculators")->where('url','calculators/swp-calculator/monthly-annuity-for-sip')->first();
            // dd($data);
            return view('frontend.calculators.swpcalculatormonthlyannuityforsip.monthly_annuity_for_sip',$data);
        }
    }
    ...
    public function monthlyAnnuityForSIPOutput(Request $request){
        ...
        $category_detail = Calculator::where("url","calculators/swp-calculator/monthly-annuity-for-sip")->first();
        ...
        $calculators = DB::table("calculators")->where("id",21)->first();
        if($calculators){
        ...
        return view('frontend.calculators.swpcalculatormonthlyannuityforsip.monthly_annuity_for_sip_output',$data);
    }
    ...
    public function monthlyAnnuityForSIPOutputSave(Request $request){
        ...
        if ($request->isMethod('get')) {
            if (Session::has('monthly_annuity_for_sip_form_data')) {
                ...
                $view = (string)View::make('frontend.calculators.swpcalculatormonthlyannuityforsip.monthly_annuity_for_sip_output_pdf',$data);
                $edit_id = session()->get('monthly_annuity_for_sip_form_id');
                if($edit_id){
        ...
        if ($request->isMethod('get')) {
            if (Session::has('monthly_annuity_for_sip_form_data')) {
                ...
                if($data['pdf_title_line1']){
                    ...
                    $pdf = PDF::loadView('frontend.calculators.swpcalculatormonthlyannuityforsip.monthly_annuity_for_sip_output_pdf', $data);
    ...
    public function view(Request $request){
        ...
        $data['details'] = DB::table("calculators")->where('url','calculators/swp-calculator/monthly-annuity-for-sip')->first();
        return view('frontend.calculators.swpcalculatormonthlyannuityforsip.view',$data);
    }
