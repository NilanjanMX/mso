...
class OneTimeInvestmentNeedBasedReadyReckonerController extends Controller
{
    ...
    public function index(Request $request){
        ...
        if($request->action == "back"){
            if (session()->has('lumpsum_investment_goal_planning_ready_form_id')){
                session()->forget('lumpsum_investment_goal_planning_ready_form_id');
            }
            // dd(Session::get('lumpsum_investment_goal_planning_ready_form_data'));
            if (Session::has('lumpsum_investment_goal_planning_ready_form_data')) {
                $saveCalculatorsData = Session::get('lumpsum_investment_goal_planning_ready_form_data');
                ...
                $data['calculater_heading'] = CalculatorHeading::where('key_name','=','lumpsum_investment_goal_planning_ready _reckoner')->first();
                // dd($data);

                $data['details'] = DB::table("calculators")->where("url","calculators/onetime-investment/one-time-investment-need-based-ready-reckoner")->first();
                // dd($data);
                return view('frontend.calculators.lumpsum_investment_goal_planning_ready.edit',$data);
                
            }else{
                return redirect()->route('frontend.oneTimeInvestmentGoalPlanningReadyReckoner');
            }
        }else{
            ...
            if (session()->has('lumpsum_investment_goal_planning_ready_form_data')){
                session()->forget('lumpsum_investment_goal_planning_ready_form_data');
            }
            if (session()->has('lumpsum_investment_goal_planning_ready_form_id')){
                session()->forget('lumpsum_investment_goal_planning_ready_form_id');
            }
            ...
            $data['details'] = DB::table("calculators")->where("url","calculators/onetime-investment/one-time-investment-need-based-ready-reckoner")->first();
            // dd($data);
            return view('frontend.calculators.lumpsum_investment_goal_planning_ready.index',$data);
        }
    }
    ...
    public function output(Request $request){
        if ($request->isMethod('get')) {
            if (Session::has('lumpsum_investment_goal_planning_ready_form_data')) {
                $input = Session::get('lumpsum_investment_goal_planning_ready_form_data');
                // dd($input);
                $data = $input;
        ...
        if ($request->isMethod('post')) {
            ...
            $request->validate([
                ...
                'clientname' => 'sometimes|nullable|max:50',
            ]);
            ...
            Session::put('lumpsum_investment_goal_planning_ready_form_data', $data);
        }
        ...
        $category_detail = Calculator::where("url","calculators/onetime-investment/one-time-investment-need-based-ready-reckoner")->first();
        ...
        $edit_id = session()->get('lumpsum_investment_goal_planning_ready_form_id');
        if(!empty($edit_id)){
            $calc = SaveCalculators::where('user_id',Auth::user()->id)->where('id',$edit_id)->first();
            $data['cal_name'] = $calc->title;
        }
        
        $calculators = DB::table("calculators")->where("id",4)->first();
        if($calculators){
        ...
        $data['edit_id'] = session()->get('lumpsum_investment_goal_planning_ready_form_id');
        // dd(session()->get('calculator_duration'));
        return view('frontend.calculators.lumpsum_investment_goal_planning_ready.output',$data);
    }
    ...
    public function save(Request $request){
        ...
        if ($request->isMethod('get')) {
            if (Session::has('lumpsum_investment_goal_planning_ready_form_data')) {
                ...
                $view = (string)View::make('frontend.calculators.lumpsum_investment_goal_planning_ready.pdf',$data);
    ...
    public function pdf(Request $request){
        if ($request->isMethod('get')) {
            if (Session::has('lumpsum_investment_goal_planning_ready_form_data')) {
                ...
                $data['title'] = "Lumpsum Investment Goal Planning Ready Reckoner";
                ...
                if($data['pdf_title_line1']){
                    ...
                    $pdf = PDF::loadView('frontend.calculators.lumpsum_investment_goal_planning_ready.pdf', $data);
    ...
    public function edit(Request $request){
        ...
        Session::put('lumpsum_investment_goal_planning_ready_form_id', $request->id);
    ...
    public function view(Request $request){
        ...
        $data['details'] = DB::table("calculators")->where("url","calculators/onetime-investment/one-time-investment-need-based-ready-reckoner")->first();
        return view('frontend.calculators.lumpsum_investment_goal_planning_ready.view',$data);
    }
    ...
    public function merge_download(Request $request){
        ...
        $data['title'] = "Lumpsum Investment Goal Planning Ready Reckoner Calculation";
