...
class SipStpRquiredForTargetFutureController extends Controller
{
    ...
    public function index(Request $request){
        ...
        if($request->action == "back"){
            if (session()->has('sipStpRequiredForTargetFutureValue_form_id')){
                session()->forget('sipStpRequiredForTargetFutureValue_form_id');
            }
            // dd(Session::get('sipStpRequiredForTargetFutureValue_form_data'));
            if (Session::has('sipStpRequiredForTargetFutureValue_form_data')) {
                $saveCalculatorsData = Session::get('sipStpRequiredForTargetFutureValue_form_data');
                ...
                $data['calculater_heading'] = CalculatorHeading::where('key_name','=','sip_stp_required_for_target_future_value')->first();
                // dd($data);

                $data['details'] = DB::table("calculators")->where("url","calculators/combination/sip-or-stp-required-for-target-future-value")->first();
                // dd($data);
                return view('frontend.calculators.sip_or_stp_required_for_target_future_value.edit',$data);
                
            }else{
                return redirect()->route('frontend.sipStpRequiredForTargetFutureValue');
            }
        }else{
            ...
            if (session()->has('sipStpRequiredForTargetFutureValue_form_data')){
                session()->forget('sipStpRequiredForTargetFutureValue_form_data');
            }
            if (session()->has('sipStpRequiredForTargetFutureValue_form_id')){
                session()->forget('sipStpRequiredForTargetFutureValue_form_id');
            }
            ...
            $data['details'] = DB::table("calculators")->where("url","calculators/combination/sip-or-stp-required-for-target-future-value")->first();
            // dd($data);
            return view('frontend.calculators.sip_or_stp_required_for_target_future_value.index',$data);
        }
    }
    ...
    public function output(Request $request){
        if ($request->isMethod('get')) {
            if (Session::has('sipStpRequiredForTargetFutureValue_form_data')) {
                $input = Session::get('sipStpRequiredForTargetFutureValue_form_data');
                // dd($input);
                $data = $input;
        ...
        if ($request->isMethod('post')) {
            ...
            Session::put('sipStpRequiredForTargetFutureValue_form_data', $data);
        }
        ...
        $category_detail = Calculator::where("url","calculators/combination/sip-or-stp-required-for-target-future-value")->first();
        ...
        $edit_id = session()->get('sipStpRequiredForTargetFutureValue_form_id');
        if(!empty($edit_id)){
            $calc = SaveCalculators::where('user_id',Auth::user()->id)->where('id',$edit_id)->first();
            $data['cal_name'] = $calc->title;
        }
        
        $calculators = DB::table("calculators")->where("id",26)->first();
        if($calculators){
        ...
        $data['edit_id'] = session()->get('sipStpRequiredForTargetFutureValue_form_id');
        // dd(session()->get('calculator_duration'));
        return view('frontend.calculators.sip_or_stp_required_for_target_future_value.output',$data);
    }
    ...
    public function save(Request $request){
        ...
        if ($request->isMethod('get')) {
            if (Session::has('sipStpRequiredForTargetFutureValue_form_data')) {
                ...
                $view = (string)View::make('frontend.calculators.sip_or_stp_required_for_target_future_value.pdf',$data);
        ...
        if ($request->isMethod('get')) {
            if (Session::has('sipStpRequiredForTargetFutureValue_form_data')) {
                ...
                if(isset($data['pdf_title_line1']) && $data['pdf_title_line1']){
                    ...
                    $pdf = PDF::loadView('frontend.calculators.sip_or_stp_required_for_target_future_value.pdf', $data);
    ...
    public function edit(Request $request){
        ...
        Session::put('sipStpRequiredForTargetFutureValue_form_id', $request->id);
    ...
    public function view(Request $request){
        ...
        $data['details'] = DB::table("calculators")->where("url","calculators/combination/sip-or-stp-required-for-target-future-value")->first();
        return view('frontend.calculators.sip_or_stp_required_for_target_future_value.view',$data);
    }
