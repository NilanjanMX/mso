...
class SipNeedBasedReadyReckonerController extends Controller
{
    ...
    public function sip_need_based_ready_reckoner(Request $request){
        
        if($request->action == "back"){
            if (session()->has('sip_need_based_ready_reckoner_form_id')){
                session()->forget('sip_need_based_ready_reckoner_form_id');
            }
            // dd(Session::get('sip_need_based_ready_reckoner_form_data'));
            if (Session::has('sip_need_based_ready_reckoner_form_data')) {
                $saveCalculatorsData = Session::get('sip_need_based_ready_reckoner_form_data');
                
                // dd($saveCalculatorsData);
                
                // if (session()->has('sip_need_based_ready_reckoner_form_data')){
                //     session()->forget('sip_need_based_ready_reckoner_form_data');
                // }
                ...
                $data['calculater_heading'] = CalculatorHeading::where('key_name','=','sip_need_based_ready_recokner')->first();
                // dd($data);

                $data['details'] = DB::table("calculators")->where("url","calculators/sip-calculator/sip-need-based-ready-reckoner")->first();
                // dd($data);
                return view('frontend.calculators.sipneedbasedreadyreckoner.edit',$data);
                
            }else{
                return redirect()->route('frontend.sipNeedBasedReadyReckoner');
            }
        }else{
            ...
            $data['details'] = DB::table("calculators")->where('url','calculators/sip-calculator/sip-need-based-ready-reckoner')->first();
            // dd($data);
            return view('frontend.calculators.sipneedbasedreadyreckoner.index',$data);
        }
    }

    public function sip_need_based_ready_reckoner_output(Request $request){
        if ($request->isMethod('get')) {
            if (Session::has('sip_need_based_ready_reckoner_form_data')) {
                $input = Session::get('sip_need_based_ready_reckoner_form_data');
                // dd($input);
        ...
        if ($request->isMethod('post')) {
            ...
            Session::put('sip_need_based_ready_reckoner_form_data', $data);
        }
        ...
        $category_detail = Calculator::where("url","calculators/sip-calculator/sip-need-based-ready-reckoner")->first();
        ...
        $edit_id = session()->get('sip_need_based_ready_reckoner_form_id');
        if(!empty($edit_id)){
            $calc = SaveCalculators::where('user_id',Auth::user()->id)->where('id',$edit_id)->first();
            $data['cal_name'] = $calc->title;
        }
        
        $calculators = DB::table("calculators")->where("id",12)->first();
        if($calculators){
        ...
        $data['edit_id'] = session()->get('sip_need_based_ready_reckoner_form_id');
        // dd(session()->get('sip_need_based_ready_reckoner_form_id'));
        return view('frontend.calculators.sipneedbasedreadyreckoner.output',$data);
    }

    public function sip_need_based_ready_reckoner_output_save(Request $request){
        ...
        if ($request->isMethod('get')) {
            if (Session::has('sip_need_based_ready_reckoner_form_data')) {
                ...
                $view = (string)View::make('frontend.calculators.sipneedbasedreadyreckoner.output_pdf',$data);
    ...
    public function sip_need_based_ready_reckoner_output_pdf_download(Request $request){
        if ($request->isMethod('get')) {
            if (Session::has('sip_need_based_ready_reckoner_form_data')) {
                $input = Session::get('sip_need_based_ready_reckoner_form_data');
                $data['investment'] = $input['investment'];
                ...
                $data['title'] = "SIP Need Based Ready Recokner";
                ...
                if($data['pdf_title_line1']){
                    ...
                    $pdf = PDF::loadView('frontend.calculators.sipneedbasedreadyreckoner.output_pdf', $data);
    ...
    public function sip_need_based_ready_reckoner_edit(Request $request){
        ...
        Session::put('sip_need_based_ready_reckoner_form_id', $request->id);
    ...
    public function view(Request $request){
        ...
        $data['details'] = DB::table("calculators")->where('url','calculators/sip-calculator/sip-need-based-ready-reckoner')->first();
        return view('frontend.calculators.sipneedbasedreadyreckoner.view',$data);
    }
