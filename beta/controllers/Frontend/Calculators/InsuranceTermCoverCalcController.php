...
class InsuranceTermCoverCalcController extends Controller
{
    ...
    public function index(Request $request){
        ...
        if($request->action == "back"){
            if (session()->has('insurance_vs_term_cover_with_annual_sip_form_id')){
                session()->forget('insurance_vs_term_cover_with_annual_sip_form_id');
            }
            // dd(Session::get('insurance_vs_term_cover_with_annual_sip_form_data'));
            if (Session::has('insurance_vs_term_cover_with_annual_sip_form_data')) {
                $saveCalculatorsData = Session::get('insurance_vs_term_cover_with_annual_sip_form_data');
                ...
                $data['calculater_heading'] = CalculatorHeading::where('key_name','=','insurance_vs_term_cover_with_annual_sip')->first();
                // dd($data);

                $data['details'] = DB::table("calculators")->where("url","calculators/mf-vs-insurance/insurance-term-cover")->first();
                // dd($data);
                return view('frontend.calculators.insurance_vs_term_cover_with_annual_sip.edit',$data);
                
            }else{
                return redirect()->route('frontend.insuranceTermCover');
            }
        }else{
            ...
            if (session()->has('insurance_vs_term_cover_with_annual_sip_form_data')){
                session()->forget('insurance_vs_term_cover_with_annual_sip_form_data');
            }
            if (session()->has('insurance_vs_term_cover_with_annual_sip_form_id')){
                session()->forget('insurance_vs_term_cover_with_annual_sip_form_id');
            }
            ...
            $data['details'] = DB::table("calculators")->where("url","calculators/mf-vs-insurance/insurance-term-cover")->first();
            // dd($data);
            return view('frontend.calculators.insurance_vs_term_cover_with_annual_sip.index',$data);
        }
    }
    ...
    public function output(Request $request){
        if ($request->isMethod('get')) {
            if (Session::has('insurance_vs_term_cover_with_annual_sip_form_data')) {
                $input = Session::get('insurance_vs_term_cover_with_annual_sip_form_data');
                // dd($input);
                $data = $input;
        ...
        if ($request->isMethod('post')) {
            ...
            $request->validate([
                'insurance_policy_annual_premium' => 'required|numeric|between:100,9999999999',
                'sum_assured' => 'required|numeric|between:10000,9999999999',
                'policy_term' => 'required|numeric|between:1,99',
                'equivalent_insurance_term_policy_premium' => 'required|numeric|between:100,99999999',
                'rate_of_return_investments' => 'required|numeric|between:0.1,18',
                'rate_of_return_insurance' => 'required|numeric|between:0.1,18',
                'clientname' => 'sometimes|nullable|max:31',
            ]);
            ...
            Session::put('insurance_vs_term_cover_with_annual_sip_form_data', $data);
        }
        ...
        $category_detail = Calculator::where("url","calculators/mf-vs-insurance/insurance-term-cover")->first();
        ...
        $edit_id = session()->get('insurance_vs_term_cover_with_annual_sip_form_id');
        if(!empty($edit_id)){
            $calc = SaveCalculators::where('user_id',Auth::user()->id)->where('id',$edit_id)->first();
            $data['cal_name'] = $calc->title;
        }
        
        $calculators = DB::table("calculators")->where("id",31)->first();
        if($calculators){
        ...
        $data['edit_id'] = session()->get('insurance_vs_term_cover_with_annual_sip_form_id');
        // dd(session()->get('calculator_duration'));
        return view('frontend.calculators.insurance_vs_term_cover_with_annual_sip.output',$data);
    }
    ...
    public function save(Request $request){
        ...
        if ($request->isMethod('get')) {
            if (Session::has('insurance_vs_term_cover_with_annual_sip_form_data')) {
                ...
                $view = (string)View::make('frontend.calculators.insurance_vs_term_cover_with_annual_sip.pdf',$data);
    ...
    public function pdf(Request $request){
        if ($request->isMethod('get')) {
            if (Session::has('insurance_vs_term_cover_with_annual_sip_form_data')) {
                ...
                $data['title'] = "Insurance vs. Term Cover With Annual SIP";
                ...
                if($data['pdf_title_line1']){
                    ...
                    $pdf = PDF::loadView('frontend.calculators.insurance_vs_term_cover_with_annual_sip.pdf', $data);
    ...
    public function edit(Request $request){
        ...
        Session::put('insurance_vs_term_cover_with_annual_sip_form_id', $request->id);
    ...
    public function view(Request $request){
        ...
        $data['details'] = DB::table("calculators")->where("url","calculators/mf-vs-insurance/insurance-term-cover")->first();
        return view('frontend.calculators.insurance_vs_term_cover_with_annual_sip.view',$data);
    }
    ...
    public function merge_download(Request $request){
        ...
        $data['title'] = "Insurance vs. Term Cover With Annual SIP Calculation";
