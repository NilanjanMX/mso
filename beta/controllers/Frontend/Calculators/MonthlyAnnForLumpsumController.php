...
class MonthlyAnnForLumpsumController extends Controller
{
    ...
    public function index(Request $request){
        ...
        if($request->action == "back"){
            if (session()->has('monthlyAnnuityForLumpsumInvestment_form_id')){
                session()->forget('monthlyAnnuityForLumpsumInvestment_form_id');
            }
            // dd(Session::get('monthlyAnnuityForLumpsumInvestment_form_data'));
            if (Session::has('monthlyAnnuityForLumpsumInvestment_form_data')) {
                $saveCalculatorsData = Session::get('monthlyAnnuityForLumpsumInvestment_form_data');
                ...
                $data['calculater_heading'] = CalculatorHeading::where('key_name','=','monthly_swp_for_lumpsum_investment')->first();
                // dd($data);

                $data['details'] = DB::table("calculators")->where("url","calculators/swp-calculator/monthly-annuity-for-lumpsum-investment")->first();
                // dd($data);
                return view('frontend.calculators.monthly_annuity_for_lumpsum_investment.edit',$data);
            ...
            if (session()->has('monthlyAnnuityForLumpsumInvestment_form_data')){
                session()->forget('monthlyAnnuityForLumpsumInvestment_form_data');
            }
            if (session()->has('monthlyAnnuityForLumpsumInvestment_form_id')){
                session()->forget('monthlyAnnuityForLumpsumInvestment_form_id');
            }
            ...
            $data['details'] = DB::table("calculators")->where("url","calculators/swp-calculator/monthly-annuity-for-lumpsum-investment")->first();
            // dd($data);
            return view('frontend.calculators.monthly_annuity_for_lumpsum_investment.index',$data);
        }
    }
    ...
    public function output(Request $request){
        if ($request->isMethod('get')) {
            if (Session::has('monthlyAnnuityForLumpsumInvestment_form_data')) {
                $input = Session::get('monthlyAnnuityForLumpsumInvestment_form_data');
                // dd($input);
                $data = $input;
        ...
        if ($request->isMethod('post')) {
            ...
            Session::put('monthlyAnnuityForLumpsumInvestment_form_data', $data);
        }
        ...
        $category_detail = Calculator::where("url","calculators/swp-calculator/monthly-annuity-for-lumpsum-investment")->first();
        ...
        $edit_id = session()->get('monthlyAnnuityForLumpsumInvestment_form_id');
        if(!empty($edit_id)){
            $calc = SaveCalculators::where('user_id',Auth::user()->id)->where('id',$edit_id)->first();
            $data['cal_name'] = $calc->title;
        }
        
        $calculators = DB::table("calculators")->where("id",19)->first();
        if($calculators){
        ...
        $data['edit_id'] = session()->get('monthlyAnnuityForLumpsumInvestment_form_id');
        // dd(session()->get('calculator_duration'));
        return view('frontend.calculators.monthly_annuity_for_lumpsum_investment.output',$data);
    }
    ...
    public function save(Request $request){
        ...
        if ($request->isMethod('get')) {
            if (Session::has('monthlyAnnuityForLumpsumInvestment_form_data')) {
                ...
                $view = (string)View::make('frontend.calculators.monthly_annuity_for_lumpsum_investment.pdf',$data);
    ...
    public function pdf(Request $request){
        if ($request->isMethod('get')) {
            if (Session::has('monthlyAnnuityForLumpsumInvestment_form_data')) {
                ...
                $data['title'] = "Monthly SWP For Lumpsum Investment";
                ...
                if(isset($data['pdf_title_line1']) && $data['pdf_title_line1']){
                    ...
                    $pdf = PDF::loadView('frontend.calculators.monthly_annuity_for_lumpsum_investment.pdf', $data);
    ...
    public function edit(Request $request){
        ...
        Session::put('monthlyAnnuityForLumpsumInvestment_form_id', $request->id);
    ...
    public function view(Request $request){
        ...
        $data['details'] = DB::table("calculators")->where("url","calculators/swp-calculator/monthly-annuity-for-lumpsum-investment")->first();
        return view('frontend.calculators.monthly_annuity_for_lumpsum_investment.view',$data);
    }
