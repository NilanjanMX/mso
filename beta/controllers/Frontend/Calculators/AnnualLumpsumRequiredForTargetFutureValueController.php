...
class AnnualLumpsumRequiredForTargetFutureValueController extends Controller
{
    ...
    public function index(Request $request){
        ...
        if (session()->has('annual_lumpsum_investment_target_future_value_form_id')){
            session()->forget('annual_lumpsum_investment_target_future_value_form_id');
        }
        if($request->action == "back"){
            
            if (Session::has('annual_lumpsum_investment_target_future_value_form_data')) {
                $saveCalculatorsData = Session::get('annual_lumpsum_investment_target_future_value_form_data');
                ...
                $data['form_data']['payment_period'] = $saveCalculatorsData['payment_period'];
                ...
                $data['calculater_heading'] = CalculatorHeading::where('key_name','=','annual_lumpsum_required_for_target_future_value')->first();
                // dd($data);

                $data['details'] = DB::table("calculators")->where("url","calculators/annual-lumpsum-calculator/annual-lumpsum-required-for-target-future-value")->first();
                return view('frontend.calculators.annualLumpsumInvestmentRequiredForTargetFutureValue.edit',$data);
                
            }else{
                return redirect()->route('frontend.annualLumpsumRequiredForTargetFutureValue');
            }
        }else{
            ...
            if (session()->has('annual_lumpsum_investment_target_future_value_form_data')){
                session()->forget('annual_lumpsum_investment_target_future_value_form_data');
            }
            ...
            $data['details'] = DB::table("calculators")->where('url','calculators/annual-lumpsum-calculator/annual-lumpsum-required-for-target-future-value')->first();
            // dd($data);
            return view('frontend.calculators.annualLumpsumInvestmentRequiredForTargetFutureValue.index',$data);
        }
    ...
    public function output(Request $request){
        if ($request->isMethod('get')) {
            if (Session::has('annual_lumpsum_investment_target_future_value_form_data')) {
                $input = Session::get('annual_lumpsum_investment_target_future_value_form_data');
        ...
        if ($request->isMethod('post')) {
            ...
            Session::put('annual_lumpsum_investment_target_future_value_form_data', $data);
        }
        ...
        $calculators = DB::table("calculators")->where("id",50)->first();
        if($calculators){
        ...
        $data['edit_id'] = session()->get('annual_lumpsum_investment_target_future_value_form_id');
        // dd($data);
        return view('frontend.calculators.annualLumpsumInvestmentRequiredForTargetFutureValue.output',$data);
    }
    ...
    public function save(Request $request){
        ...
        if ($request->isMethod('get')) {
            if (Session::has('annual_lumpsum_investment_target_future_value_form_data')) {
                ...
                $view = (string)View::make('frontend.calculators.annualLumpsumInvestmentRequiredForTargetFutureValue.pdf',$data);

                $edit_id = session()->get('annual_lumpsum_investment_target_future_value_form_id');
        ...
        if ($request->isMethod('get')) {
            if (Session::has('annual_lumpsum_investment_target_future_value_form_data')) {
                ...
                if($data['pdf_title_line1']){
                    ...
                    $pdf = PDF::loadView('frontend.calculators.annualLumpsumInvestmentRequiredForTargetFutureValue.pdf', $data);
    ...
    public function edit(Request $request){
        ...
        Session::put('annual_lumpsum_investment_target_future_value_form_id', $request->id);
    ...
    public function view(Request $request){
        ...
        $data['details'] = DB::table("calculators")->where('url','calculators/annual-lumpsum-calculator/annual-lumpsum-required-for-target-future-value')->first();
        return view('frontend.calculators.annualLumpsumInvestmentRequiredForTargetFutureValue.view',$data);
    }
