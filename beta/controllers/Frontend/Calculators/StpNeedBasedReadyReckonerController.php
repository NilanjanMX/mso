...
class StpNeedBasedReadyReckonerController extends Controller
{
    ...
    public function stpFutureValueReadyRecokner(Request $request){
        ...
        if($request->action == "back"){
            if (session()->has('stp_need_based_ready_recokner_form_id')){
                session()->forget('stp_need_based_ready_recokner_form_id');
            }
            // dd(Session::get('stp_need_based_ready_recokner_form_data'));
            if (Session::has('stp_need_based_ready_recokner_form_data')) {
                $saveCalculatorsData = Session::get('stp_need_based_ready_recokner_form_data');
                
                // dd($saveCalculatorsData);
                
                // if (session()->has('stp_need_based_ready_recokner_form_data')){
                //     session()->forget('stp_need_based_ready_recokner_form_data');
                // }
                ...
                $data['calculater_heading'] = CalculatorHeading::where('key_name','=','stp_goal_planning_value_ready_recokner')->first();
                // dd($data);

                $data['details'] = DB::table("calculators")->where("url","calculators/stp-calculator/stp-need-based-ready-reckoner")->first();
                // dd($data);
                return view('frontend.calculators.stpneedbasedreadyreckoner.edit',$data);
                
            }else{
                return redirect()->route('frontend.stpGoalPlanningValueReadyRecokner');
            }
        }else{
            ...
            $data['details'] = DB::table("calculators")->where('url','calculators/stp-calculator/stp-need-based-ready-reckoner')->first();
            // dd($data);
            return view('frontend.calculators.stpneedbasedreadyreckoner.index',$data);
        }
    }
    ...
    public function stpFutureValueReadyRecoknerOutput(Request $request){
        if ($request->isMethod('get')) {
            if (Session::has('stp_need_based_ready_recokner_form_data')) {
                $input = Session::get('stp_need_based_ready_recokner_form_data');
                // dd($input);
        ...
        if ($request->isMethod('post')) {
            ...
            Session::put('stp_need_based_ready_recokner_form_data', $data);
        }
        ...
        $category_detail = Calculator::where("url","calculators/stp-calculator/stp-need-based-ready-reckoner")->first();
        ...
        $edit_id = session()->get('stp_need_based_ready_recokner_form_id');
        if(!empty($edit_id)){
            $calc = SaveCalculators::where('user_id',Auth::user()->id)->where('id',$edit_id)->first();
            $data['cal_name'] = $calc->title;
        }
        
        $calculators = DB::table("calculators")->where("id",16)->first();
        if($calculators){
        ...
        $data['edit_id'] = session()->get('stp_need_based_ready_recokner_form_id');
        // dd(session()->get('stp_need_based_ready_recokner_form_id'));
        return view('frontend.calculators.stpneedbasedreadyreckoner.output',$data);
    }
    ...
    public function stpFutureValueReadyRecoknerOutputSave(Request $request){
        ...
        if ($request->isMethod('get')) {
            if (Session::has('stp_need_based_ready_recokner_form_data')) {
                ...
                $view = (string)View::make('frontend.calculators.stpneedbasedreadyreckoner.output_pdf',$data);
        ...
        if ($request->isMethod('get')) {
            if (Session::has('stp_need_based_ready_recokner_form_data')) {
                ...
                if($data['pdf_title_line1']){
                    ...
                    $pdf = PDF::loadView('frontend.calculators.stpneedbasedreadyreckoner.output_pdf', $data);
    ...
    public function edit(Request $request){
        ...
        Session::put('stp_need_based_ready_recokner_form_id', $request->id);
    ...
    public function view(Request $request){
        ...
        $data['details'] = DB::table("calculators")->where('url','calculators/stp-calculator/stp-need-based-ready-reckoner')->first();
        return view('frontend.calculators.stpneedbasedreadyreckoner.view',$data);
    }
