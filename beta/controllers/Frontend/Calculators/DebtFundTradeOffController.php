...
class DebtFundTradeOffController extends Controller
{
    ...
    public function index(Request $request){
        ...
        if($request->action == "back"){
            if (session()->has('debt_fund_trade_off_form_id')){
                session()->forget('debt_fund_trade_off_form_id');
            }
            // dd(Session::get('debt_fund_trade_off_form_data'));
            if (Session::has('debt_fund_trade_off_form_data')) {
                $saveCalculatorsData = Session::get('debt_fund_trade_off_form_data');
                ...
                $data['details'] = DB::table("calculators")->where("url","premium-calculator/debt_fund_trade_off")->first();
                // dd($data);
                return view('frontend.calculators.debt_fund_trade_off.edit',$data);
                
            }else{
                return redirect()->route('frontend.debt_fund_trade_off');
            }
        }else{
            ...
            if (session()->has('debt_fund_trade_off_form_data')){
                session()->forget('debt_fund_trade_off_form_data');
            }
            if (session()->has('debt_fund_trade_off_form_id')){
                session()->forget('debt_fund_trade_off_form_id');
            }
            ...
            $data['details'] = DB::table("calculators")->where("url","premium-calculator/debt_fund_trade_off")->first();
            // dd($data);
            return view('frontend.calculators.debt_fund_trade_off.index',$data);
        }
    }
    ...
    public function output(Request $request){
        if ($request->isMethod('get')) {
            if (Session::has('debt_fund_trade_off_form_data')) {
                $input = Session::get('debt_fund_trade_off_form_data');
                // dd($input);
                $data = $input;
        ...
        if ($request->isMethod('post')) {
            ...
            Session::put('debt_fund_trade_off_form_data', $data);
        }
        ...
        $category_detail = Calculator::where("url","premium-calculator/debt_fund_trade_off")->first();
        ...
        $edit_id = session()->get('debt_fund_trade_off_form_id');
        if(!empty($edit_id)){
            $calc = SaveCalculators::where('user_id',Auth::user()->id)->where('id',$edit_id)->first();
            $data['cal_name'] = $calc->title;
        }
        
        $calculators = DB::table("calculators")->where("id",41)->first();
        if($calculators){
        ...
        $data['edit_id'] = session()->get('debt_fund_trade_off_form_id');
        // dd(session()->get('calculator_duration'));
        return view('frontend.calculators.debt_fund_trade_off.output',$data);
    }
    ...
    public function save(Request $request){
        ...
        if ($request->isMethod('get')) {
            if (Session::has('debt_fund_trade_off_form_data')) {
                ...
                $view = (string)View::make('frontend.calculators.debt_fund_trade_off.pdf',$data);
        ...
        if ($request->isMethod('get')) {
            if (Session::has('debt_fund_trade_off_form_data')) {
                ...
                if($data['pdf_title_line1']){
                    ...
                    $pdf = PDF::loadView('frontend.calculators.debt_fund_trade_off.pdf', $data);
    ...
    public function edit(Request $request){
        ...
        Session::put('debt_fund_trade_off_form_id', $request->id);
    ...
    public function view(Request $request){
        ...
        $data['details'] = DB::table("calculators")->where("url","premium-calculator/debt_fund_trade_off")->first();
        return view('frontend.calculators.debt_fund_trade_off.view',$data);
    }
