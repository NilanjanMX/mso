...
class TermInsuranceSIPController extends Controller
{
    ...
    public function index(Request $request){
        ...
        if($request->action == "back"){
            if (session()->has('termInsuranceSIP_form_id')){
                session()->forget('termInsuranceSIP_form_id');
            }
            // dd(Session::get('termInsuranceSIP_form_data'));
            if (Session::has('termInsuranceSIP_form_data')) {
                $saveCalculatorsData = Session::get('termInsuranceSIP_form_data');
                ...
                $data['calculater_heading'] = CalculatorHeading::where('key_name','=','term_insurance_+_sip')->first();
                // dd($data);

                $data['details'] = DB::table("calculators")->where("url","calculators/mf-vs-insurance/term-insurance-sip")->first();
                // dd($data);
                return view('frontend.calculators.term_insurance_sip.edit',$data);
                
            }else{
                return redirect()->route('frontend.termInsuranceSIP');
            }
        }else{
            ...
            if (session()->has('termInsuranceSIP_form_data')){
                session()->forget('termInsuranceSIP_form_data');
            }
            if (session()->has('termInsuranceSIP_form_id')){
                session()->forget('termInsuranceSIP_form_id');
            }
            ...
            $data['details'] = DB::table("calculators")->where("url","calculators/mf-vs-insurance/term-insurance-sip")->first();
            // dd($data);
            return view('frontend.calculators.term_insurance_sip.index',$data);
        }
    }
    ...
    public function output(Request $request){
        if ($request->isMethod('get')) {
            if (Session::has('termInsuranceSIP_form_data')) {
                $input = Session::get('termInsuranceSIP_form_data');
                // dd($input);
                $data = $input;
        ...
        if ($request->isMethod('post')) {
            ...
            Session::put('termInsuranceSIP_form_data', $data);
        }
        ...
        $category_detail = Calculator::where("url","calculators/mf-vs-insurance/term-insurance-sip")->first();
        ...
        $edit_id = session()->get('termInsuranceSIP_form_id');
        if(!empty($edit_id)){
            $calc = SaveCalculators::where('user_id',Auth::user()->id)->where('id',$edit_id)->first();
            $data['cal_name'] = $calc->title;
        }
        
        $calculators = DB::table("calculators")->where("id",29)->first();
        if($calculators){
        ...
        $data['edit_id'] = session()->get('termInsuranceSIP_form_id');
        // dd(session()->get('calculator_duration'));
        return view('frontend.calculators.term_insurance_sip.output',$data);
    }
    ...
    public function save(Request $request){
        ...
        if ($request->isMethod('get')) {
            if (Session::has('termInsuranceSIP_form_data')) {
                ...
                $view = (string)View::make('frontend.calculators.term_insurance_sip.pdf',$data);
        ...
        if ($request->isMethod('get')) {
            if (Session::has('termInsuranceSIP_form_data')) {
                ...
                if(isset($data['pdf_title_line1']) && $data['pdf_title_line1']){
                    ...
                    $pdf = PDF::loadView('frontend.calculators.term_insurance_sip.pdf', $data);
    ...
    public function edit(Request $request){
        ...
        Session::put('termInsuranceSIP_form_id', $request->id);
    ...
    public function view(Request $request){
        ...
        $data['details'] = DB::table("calculators")->where("url","calculators/mf-vs-insurance/term-insurance-sip")->first();
        return view('frontend.calculators.term_insurance_sip.view',$data);
    }
