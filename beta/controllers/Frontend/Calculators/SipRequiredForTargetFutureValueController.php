...
class SipRequiredForTargetFutureValueController extends Controller
{
    ...
    public function index(Request $request)
    {
        if($request->action == "back"){
            if (session()->has('sip_required_for_target_future_value_form_id')){
                session()->forget('sip_required_for_target_future_value_form_id');
            }
            // dd(Session::get('sip_required_for_target_future_value_form_data'));
            if (Session::has('sip_required_for_target_future_value_form_data')) {
                $saveCalculatorsData = Session::get('sip_required_for_target_future_value_form_data');
                
                // dd($saveCalculatorsData);
                
                // if (session()->has('sip_required_for_target_future_value_form_data')){
                //     session()->forget('sip_required_for_target_future_value_form_data');
                // }
                ...
                $data['calculater_heading'] = CalculatorHeading::where('key_name','=','sip_required_for_target_future_value')->first();
                // dd($data);

                $data['details'] = DB::table("calculators")->where("url","calculators/sip-calculator/sip-required-for-target-future-value")->first();
                // dd($data);
                return view('frontend.calculators.sip_required_for_target_future_value.edit',$data);
                
            }else{
                return redirect()->route('frontend.sipRequiredForTargetFutureValue');
            }
        }else{
            ...
            $data = [];
            $data['calculater_heading'] = CalculatorHeading::where('key_name','=','sip_required_for_target_future_value')->first();
            return view('frontend.calculators.sip_required_for_target_future_value.index',$data); 
    ...
    public function output(Request $request)
    {
        if ($request->isMethod('get')) {
            if (Session::has('sip_required_for_target_future_value_form_data')) {
                $input = Session::get('sip_required_for_target_future_value_form_data');
        ...
        if ($request->isMethod('post')) {
            ...
            Session::put('sip_required_for_target_future_value_form_data', $data);
        }
        ...
        $category_detail = Calculator::where("url","calculators/sip-calculator/sip-required-for-target-future-value")->first();
        ...
        $edit_id = session()->get('sip_required_for_target_future_value_form_id');
        if(!empty($edit_id)){
            $calc = SaveCalculators::where('user_id',Auth::user()->id)->where('id',$edit_id)->first();
            $data['cal_name'] = $calc->title;
        }
        
        $calculators = DB::table("calculators")->where("id",6)->first();
        if($calculators){
        ...
        $data['edit_id'] = session()->get('sip_required_for_target_future_value_form_id');

        return view('frontend.calculators.sip_required_for_target_future_value.output',$data);
    }
    ...
    public function pdf(Request $request){
        ...
        if ($request->isMethod('get')) {
            if (Session::has('sip_required_for_target_future_value_form_data')) {
                $data = Session::get('sip_required_for_target_future_value_form_data');
                // dd($data);
                ...
                $data['title'] = "SIP Required For Target Future Value";
                ...
                if($data['pdf_title_line1']){
                    ...
                    $pdf = PDF::loadView('frontend.calculators.sip_required_for_target_future_value.pdf', $data);
    ...
    public function save(Request $request){
        ...
        if ($request->isMethod('get')) {
            if (Session::has('sip_required_for_target_future_value_form_data')) {
                ...
                $view = (string)View::make('frontend.calculators.sip_required_for_target_future_value.pdf',$data);
                $edit_id = session()->get('sip_required_for_target_future_value_form_id');
    ...
    public function edit(Request $request){
        ...
        Session::put('sip_required_for_target_future_value_form_id', $request->id);
    ...
    public function view(Request $request){
        ...
        Session::put('sip_required_for_target_future_value_form_data', $data);
        Session::put('pie_chart1', isset($data['pie_chart1']));
        Session::put('pie_chart2', isset($data['pie_chart2']));
        $data['edit_id'] = 0;
        $data['id'] = $request->id;
        $calculators = DB::table("calculators")->where("id",6)->first();
        if($calculators){
        ...
        $data['details'] = DB::table("calculators")->where('url','calculators/sip-calculator/sip-required-for-target-future-value')->first();
        return view('frontend.calculators.sip_required_for_target_future_value.view',$data);
    }
