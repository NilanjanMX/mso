...
class LumpsumInvestmentRequiredForTargetMonthlyAnnuityController extends Controller
{
    ...
    public function lumpsumInvestmentRequiredForTargetMonthlyAnnuity(Request $request){
        
        if($request->action == "back"){
            if (session()->has('lumpsum_investment_required_for_form_id')){
                session()->forget('lumpsum_investment_required_for_form_id');
            }
            // dd(Session::get('lumpsum_investment_required_for_form_data'));
            if (Session::has('lumpsum_investment_required_for_form_data')) {
                $saveCalculatorsData = Session::get('lumpsum_investment_required_for_form_data');
                ...
                $data['form_data']['deferment'] = $saveCalculatorsData['deferment'];
                ...
                if (isset($saveCalculatorsData['interest1']) && $saveCalculatorsData['interest1'] != '') {
                    $data['form_data']['interest1'] = $saveCalculatorsData['interest1'];
                }
                if (isset($saveCalculatorsData['interest2']) && $saveCalculatorsData['interest2'] != '') {
                    $data['form_data']['interest2'] = $saveCalculatorsData['interest2'];
                }
        
                if (isset($saveCalculatorsData['accumulation_phase_interest_rate_1']) && $saveCalculatorsData['accumulation_phase_interest_rate_1'] != '') {
                    $data['form_data']['accumulation_phase_interest_rate_1'] = $saveCalculatorsData['accumulation_phase_interest_rate_1'];
                }
                if (isset($saveCalculatorsData['distribution_phase_interest_rate_1']) && $saveCalculatorsData['distribution_phase_interest_rate_1'] != '') {
                    $data['form_data']['distribution_phase_interest_rate_1'] = $saveCalculatorsData['distribution_phase_interest_rate_1'];
                }
        
                if (isset($saveCalculatorsData['accumulation_phase_interest_rate_2']) && $saveCalculatorsData['accumulation_phase_interest_rate_2'] != '') {
                    $data['form_data']['accumulation_phase_interest_rate_2'] = $saveCalculatorsData['accumulation_phase_interest_rate_2'];
                }
                if (isset($saveCalculatorsData['distribution_phase_interest_rate_2']) && $saveCalculatorsData['distribution_phase_interest_rate_2'] != '') {
                    $data['form_data']['distribution_phase_interest_rate_2'] = $saveCalculatorsData['distribution_phase_interest_rate_2'];
                }
        
                $data['form_data']['balance_required'] = $saveCalculatorsData['balance_required'];
        
                $data['form_data']['include_inflation'] = $saveCalculatorsData['include_inflation'];
        
                if (isset($saveCalculatorsData['expected_inflation_rate']) && $saveCalculatorsData['expected_inflation_rate'] != '') {
                    $data['form_data']['expected_inflation_rate'] = $saveCalculatorsData['expected_inflation_rate'];
                }
        
                $data['form_data']['include_taxation'] = $saveCalculatorsData['include_taxation'];
        
                if (isset($saveCalculatorsData['assumed_inflation_rate_for_indexation']) && $saveCalculatorsData['assumed_inflation_rate_for_indexation'] != '') {
                    $data['form_data']['assumed_inflation_rate_for_indexation'] = $saveCalculatorsData['assumed_inflation_rate_for_indexation'];
                }
        
                if (isset($saveCalculatorsData['applicable_short_term_tax_rate']) && $saveCalculatorsData['applicable_short_term_tax_rate'] != '') {
                    $data['form_data']['applicable_short_term_tax_rate'] = $saveCalculatorsData['applicable_short_term_tax_rate'];
                }
        
                if (isset($saveCalculatorsData['for_period_upto']) && $saveCalculatorsData['for_period_upto'] != '') {
                    $data['form_data']['for_period_upto'] = $saveCalculatorsData['for_period_upto'];
                }
                if (isset($saveCalculatorsData['applicable_long_term_tax_rate']) && $saveCalculatorsData['applicable_long_term_tax_rate'] != '') {
                    $data['form_data']['applicable_long_term_tax_rate'] = $saveCalculatorsData['applicable_long_term_tax_rate'];
                }
                if (isset($saveCalculatorsData['from_the_year']) && $saveCalculatorsData['from_the_year'] != '') {
                    $data['form_data']['from_the_year'] = $saveCalculatorsData['from_the_year'];
                }
                ...
                $data['calculater_heading'] = CalculatorHeading::where('key_name','=','lumpsum_investment_required_for_target_monthly_annuity')->first();
                // dd($data);

                $data['details'] = DB::table("calculators")->where("url","calculators/swp-calculator/lumpsum-investment-required-for-target-monthly-annuity")->first();
                // dd($data);
                return view('frontend.calculators.lumpsuminvestmentrequiredfortargetmonthlyannuity.edit',$data);
                
            }else{
                return redirect()->route('frontend.lumpsumInvestmentRequiredForTargetMonthlyAnnuity');
            }
        }else{
            ...
            if (session()->has('lumpsum_investment_required_for_form_data')){
                session()->forget('lumpsum_investment_required_for_form_data');
            }
            if (session()->has('lumpsum_investment_required_for_form_id')){
                session()->forget('lumpsum_investment_required_for_form_id');
            }
            ...
            $data['details'] = DB::table("calculators")->where('url','calculators/swp-calculator/lumpsum-investment-required-for-target-monthly-annuity')->first();
            // dd($data);
            return view('frontend.calculators.lumpsuminvestmentrequiredfortargetmonthlyannuity.index',$data);
        }
    }

    public function lumpsumInvestmentRequiredForTargetMonthlyAnnuityOutput(Request $request){
        if ($request->isMethod('get')) {
            if (Session::has('lumpsum_investment_required_for_form_data')) {
                $input = Session::get('lumpsum_investment_required_for_form_data');
                $data['required_monthly_annuity'] = $input['required_monthly_annuity'];
        ...
        if ($request->isMethod('post')) {
            $request->validate([
                ...
                'interest1' => 'sometimes|nullable|numeric|between:0.1,18',
            ...
            if (isset($input['interest1']) && $input['interest1'] != '') {
                $data['interest1'] = $input['interest1'];
            }
            if (isset($input['interest2']) && $input['interest2'] != '') {
                $data['interest2'] = $input['interest2'];
            ...
            if (isset($input['accumulation_phase_interest_rate_1']) && $input['accumulation_phase_interest_rate_1'] != '') {
                $data['accumulation_phase_interest_rate_1'] = $input['accumulation_phase_interest_rate_1'];
            }
            if (isset($input['distribution_phase_interest_rate_1']) && $input['distribution_phase_interest_rate_1'] != '') {
                $data['distribution_phase_interest_rate_1'] = $input['distribution_phase_interest_rate_1'];
            }

            if (isset($input['accumulation_phase_interest_rate_2']) && $input['accumulation_phase_interest_rate_2'] != '') {
                $data['accumulation_phase_interest_rate_2'] = $input['accumulation_phase_interest_rate_2'];
            }
            if (isset($input['distribution_phase_interest_rate_2']) && $input['distribution_phase_interest_rate_2'] != '') {
            ...
            Session::put('lumpsum_investment_required_for_form_data', $data);
        }
        ...
        $category_detail = Calculator::where("url","calculators/swp-calculator/lumpsum-investment-required-for-target-monthly-annuity")->first();
        ...
        $edit_id = session()->get('lumpsum_investment_required_for_form_id');
        if(!empty($edit_id)){
            $calc = SaveCalculators::where('user_id',Auth::user()->id)->where('id',$edit_id)->first();
            $data['cal_name'] = $calc->title;
        }
        
        $calculators = DB::table("calculators")->where("id",20)->first();
        if($calculators){
        ...
        $data['edit_id'] = session()->get('lumpsum_investment_required_for_form_id');
        // dd(session()->get('lumpsum_investment_required_for_form_id'));
        return view('frontend.calculators.lumpsuminvestmentrequiredfortargetmonthlyannuity.output',$data);
    }

    public function lumpsumInvestmentRequiredForTargetMonthlyAnnuityOutputSave(Request $request){
        ...
        if ($request->isMethod('get')) {
            if (Session::has('lumpsum_investment_required_for_form_data')) {
                ...
                $view = (string)View::make('frontend.calculators.lumpsuminvestmentrequiredfortargetmonthlyannuity.output_pdf',$data);
    ...
    public function lumpsumInvestmentRequiredForTargetMonthlyAnnuityOutputDownloadPdf(Request $request){
        if ($request->isMethod('get')) {
            if (Session::has('lumpsum_investment_required_for_form_data')) {
                $input = Session::get('lumpsum_investment_required_for_form_data');
                if (isset($input['current_age']) && $input['current_age'] != '') {
                ...
                $data['title'] = "Lumpsum Investment Required For Target Monthly Annuity";
                ...
                if($data['pdf_title_line1']){
                    ...
                    $pdf = PDF::loadView('frontend.calculators.lumpsuminvestmentrequiredfortargetmonthlyannuity.output_pdf', $data);
    ...
    public function edit(Request $request){
        ...
        Session::put('lumpsum_investment_required_for_form_id', $request->id);
    ...
    public function view(Request $request){
        ...
        $data['details'] = DB::table("calculators")->where('url','calculators/swp-calculator/lumpsum-investment-required-for-target-monthly-annuity')->first();
        // dd($data);
        return view('frontend.calculators.lumpsuminvestmentrequiredfortargetmonthlyannuity.view',$data);
    }
