    ...
    <script>
        ...
        function setDefaultFun(index){
            ...
            $('#swp_start_date_'+index).datepicker({
                ...
                console.log($(this).val());
                $('#swp_end_date_'+index).datepicker('setStartDate', new Date($(this).val()));
            });
        ...
        function renderRow(all_data,global_result,index){
            ...
            table_html = table_html+"<td id='total_withdrawal_"+index+"'>"+all_data.total_withdrawal+"</td>";
            table_html = table_html+"</tr>";
            table_html = table_html+"<tr>";
            ...
            if($("#stock_table_"+index)){
                $("#stock_table_"+index).dataTable().fnDestroy();
            }else{
            ...
            document.getElementById('total_withdrawal_'+index).innerHTML = total_withdrawal;
                        ...
                        <div id="swp_live_form" style="">
                            <div id="swp_live_form_list_0">
                                <div class="input-group row" style="margin-bottom: 10px;">
                                    <label for="" class="col-sm-3 col-form-label">Lumpsum Investment Amount</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="lumpsum_investment_amount[0]" id="lumpsum_investment_amount_0" class="form-control" value=""  message="text" datatype="0">
                                ...
                                <div class="input-group row" style="margin-bottom: 10px;">
                                    <label for="data_frequency" class="col-sm-3 col-form-label">SWP Frequency</label>
                                    <div class="col-sm-9">
                                        <select class="form-control ui-autocomplete-input" name="data_frequency[0]" id="data_frequency_0">
                                            <option value="">Select Data Frequency</option>
                                            @foreach($data_frequency as $dropdown)
                                                <option value="{{$dropdown['id']}}">{{$dropdown['name']}}</option>
                                            @endforeach
                                ...
                                <div class="input-group row" style="margin-bottom: 10px;">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="swp_amount[0]" id="swp_amount_0" class="form-control" value="">
