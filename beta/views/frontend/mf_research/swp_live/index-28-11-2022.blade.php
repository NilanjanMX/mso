        ...
        function callAPI(all_data){
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    data1.xirr = globla_xirr_value;

                    console.log(data1);
                    $.ajax({
                        url: "{{ url('/mf-swp-historical-save-xirr') }}",
                        method: 'post',
                        data: data1,
                        success: function (result) {
                ...
                <div class="col-12 col-sm-10 col-md-8 col-lg-8 col-xl-8" >
                    <form action="" method="get" id="comp_sch" >
                        ...
                        <div class="input-group-append text-center" style="display: flex; justify-content: center; padding-top: 16px;">
                            ...
                            <a href="{{route('frontend.mf_swp_historical_action')}}" class="btn btn-primary add_button" id="download_button" style="display: none;margin-left: 20px;">Download</a>
                        </div> 
                    </form>
                </div>
            </div>
