...
@section('js_after')
    ...
    <script>
        ...
        function renderRow(all_data,global_result,index){
            ...
            var table_html = table_html+`<table class="table text-center stock_table mfliketbl">`;
            ...
            table_html = table_html+"<td id='total_withdrawal_"+index+"'>"+global_result.total_withdrawal+"</td>";
            table_html = table_html+"</tr>";
            table_html = table_html+"<tr>";
            ...
            document.getElementById('total_withdrawal_'+index).innerHTML = parseFloat(total_withdrawal).toFixed(2);
        ...
        function addButton(){
            ...
            if(form_list.length < 3){
                ...
                var iHtml = `<div id="swp_live_form_list_`+globla_index+`">
                                    <div class="input-group row" style="margin-bottom: 10px;">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="lumpsum_investment_amount[`+globla_index+`]" id="lumpsum_investment_amount_`+globla_index+`" class="form-control" value="500000"  message="text" datatype="`+globla_index+`">
                                    ...
                                    <div class="input-group row" style="margin-bottom: 10px;">
                                        ...
                                        <div class="col-sm-9">
                                            <div  class="form-control" id="incept_date_`+globla_index+`"></div> 
                                        </div> 
                                    </div>
                                    ...
                                    <div class="input-group row" style="margin-bottom: 10px;">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="investment_date[`+globla_index+`]" id="investment_date_`+globla_index+`" value="">
                                    ...
                                    <div class="input-group row" style="margin-bottom: 10px;">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control ui-autocomplete-input" name="data_frequency[`+globla_index+`]" id="data_frequency_`+globla_index+`">
                                    ...
                                    <div class="input-group row" style="margin-bottom: 10px;">
                                        <input type="hidden" name="swp_type[`+globla_index+`]" id="swp_type_`+globla_index+`">
                                    ...
                                    <div class="input-group row" style="margin-bottom: 10px;">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="swp_amount[`+globla_index+`]" id="swp_amount_`+globla_index+`" class="form-control" value="0.50">
        ...
        <div class="container">
            ...
            <div class="row Search_Here" style="margin-top: 20px;">
                <div class="col-12 col-sm-10 col-md-8 col-lg-8 col-xl-8" >
                    <form action="" method="get" id="comp_sch" >
                        @csrf
                        <div id="swp_live_form" style="">
                            <div id="swp_live_form_list_0">
                                ...
                                <div class="input-group row" style="margin-bottom: 20px;">
                                    <label for="" class="col-sm-3 col-form-label">Incept Date</label>
                                    <div class="col-sm-9">
                                        <div  class="form-control" id="incept_date_0"></div> 
                                    </div> 
                                </div>
                                ...
                                <div class="input-group row" style="margin-bottom: 20px;">
                                    <label for="" class="col-sm-3 col-form-label">Lumpsum Investment Amount</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="lumpsum_investment_amount[0]" id="lumpsum_investment_amount_0" class="form-control" value="1000000"  message="text" datatype="0"  onkeyup="formValidation(1,0);">
                                ...
                                <div class="input-group row" style="margin-bottom: 20px;">
                                    <label for="" class="col-sm-3 col-form-label">Investment Date</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="investment_date[0]" id="investment_date_0" value="06/01/2021"  onkeyup="formValidation(2,0);">
                                ...
                                <div class="input-group row" style="margin-bottom: 20px;">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="swp_amount[0]" id="swp_amount_0" class="form-control" value="10000" onkeyup="formValidation(4,0);">
                                ...
                                <div class="input-group row" style="margin-bottom: 20px;">
                                    <label for="" class="col-sm-3 col-form-label">SWP Start Date</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="swp_start_date[0]" id="swp_start_date_0" class="form-control" value="02/04/2021">
                                ...
                                <div class="input-group row" style="margin-bottom: 20px;">
                                    <label for="" class="col-sm-3 col-form-label">SWP End Date</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="swp_end_date[0]" id="swp_end_date_0" class="form-control" value="30/06/2022">
                        ...
                        <div class="input-group-append text-center" style="display: flex; justify-content: center; padding-top: 16px;">
                            ...
                            <a href="{{route('frontend.mf_swp_live_action')}}" class="btn btn-primary add_button" id="download_button" style="display: none;margin-left: 20px;">Download</a>
                        </div> 
                    </form>
                </div>
            </div>
