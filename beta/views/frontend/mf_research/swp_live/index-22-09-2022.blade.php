...
@section('js_after')
    ...
    <script>
        ...
        $('#investment_date').datepicker({
            ...
            $('#swp_start_date').datepicker('setStartDate', new Date($(this).val()));
        }); 
        $('#swp_start_date').datepicker({
            autoclose: true
        }).on('changeDate', function(){
            console.log($(this).val());
            $('#swp_end_date').datepicker('setStartDate', new Date($(this).val()));
        });
        ...
        function renderRow(all_data){
            ...
            table_html = table_html+"<td id='total_withdrawal'>"+all_data.total_withdrawal+"</td>";
            table_html = table_html+"</tr>";
            table_html = table_html+"<tr>";
            ...
            document.getElementById('total_withdrawal').innerHTML = total_withdrawal;
        ...
        function changeSWP(type){
            ...
            document.getElementById("swp_label").innerHTML = swp_label;

            document.getElementById("swp_amount").value = "";
        }
    </script>
@endsection
@section('content')
                        ...
                        <div id="categorywise_type" style="">
                            <div>
                                ...
                                <div class="input-group row" style="margin-bottom: 10px;">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="investment_date" id="investment_date" value="">
                                ...
                                <div class="input-group row" style="margin-bottom: 10px;">
                                    <label for="compare_category" class="col-sm-3 col-form-label">SWP</label>
                                    <div class="col-sm-9 dequitis" style="display: flex; align-items: center;">
                                        <input type="radio" id="amount_type_amt" name="amount_type" value="1" checked="" onchange="changeSWP(1);" >
                                        <label>Amount</label>
                                        <input type="radio" id="amount_type_per" name="amount_type" value="2"  onchange="changeSWP(2);">
                                        <label>%</label><br>
                                    </div> 
                                </div> 

                                <div class="input-group row" style="margin-bottom: 10px;">
                                    <label for="" class="col-sm-3 col-form-label" id="swp_label">SWP Amount</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="input-group row" style="margin-bottom: 10px;">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="swp_start_date" id="swp_start_date" class="form-control" value="">
                                ...
                                <div class="input-group row" style="margin-bottom: 10px;">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="swp_end_date" id="swp_end_date" class="form-control" value="">
