...
<main style="width: 760px; margin-left: 20px;">
    ...
    <div style="padding: 0 5%;">
        <h1 style="color: #000;font-size:15px;margin-bottom:10px !important;text-align:center;">Debt held by Mutual Funds </h1>
    </div>
    ...
    <table class="table text-center mfliketbl">
        <tbody>
            <tr>
                ...
                <th>
                    <strong>Total Market Value (In <span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> Cr)</strong>
                </th>
            </tr>
            <tr>
    ...
    @if($type == "Stock")
        <table class="table text-center mfliketbl" style="margin-top:10px;">
            <tbody>
                <tr>
                    <th rowspan="1" style="width: 250px;"><strong>Scheme Name</strong></th>
                    <th rowspan="1" style="width: 100px;"><strong>Fund Manager</strong></th>
                    <th><strong>AUM (in <span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> Cr)</strong></th>
                    <th><strong>% of AUM</strong></th>
                    <th colspan="1"><strong>Market Value (In <span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> Cr)</strong></th>
                </tr>
                <?php foreach($list as $key=>$value){ 
                    ...
                    <tr>
                        ...
                        <td style="text-align:right;padding-right:10px;">{{custome_money_format($value['aum']/100)}}</td>
                        <td style="text-align:right;padding-right:10px;">{{number_format((float)($value['mktval']*100/$value['aum']), 4, '.', '')}}</td>
                        <td style="text-align:right;padding-right:10px;">{{number_format((float)($value['mktval']/100), 2, '.', '')}}</td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
            ...
            <tbody>
                ...
                <?php foreach($list as $key=>$value){ 
                    ...
                    <tr>
                        ...
                        <td style="text-align:right;padding-right:10px;">{{custome_money_format($value['totalaum']/100)}}</td>
                        <td style="text-align:right;padding-right:10px;">{{number_format((float)($value['mktval']*100/$value['totalaum']), 4, '.', '')}}</td>
                        <td style="text-align:right;padding-right:10px;">{{number_format((float)($value['mktval']/100), 2, '.', '')}}</td>
                    </tr>
                <?php } ?>
            </tbody>
