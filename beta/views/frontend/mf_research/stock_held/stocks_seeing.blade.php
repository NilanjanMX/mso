...
@section('js_after')
    ...
    <script>
        ...
        var stock_table = $('#stock_table').dataTable({
            "bPaginate": true,
            "searching": false, 
            "lengthMenu": [[10,20,30,-1], ["Top 10","Top 20","Top 30", "All"]],
        ...
        function clickSubmitButton(){
            ...
            var sortedDir = $('#stock_table').dataTable().fnSettings().aaSorting[0][1];
            document.getElementById('shorting_id').value = sortedCol+"_"+sortedDir;
            document.getElementById('page_type').value = "SUBMIT";
        }
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="page-title" style="margin-top: 16px; padding-bottom: 3px;">Stocks Seeing Selling Pressure</h2>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row" style="padding-bottom: 10px; font-size: 12px;">
                ...
                <div class="col-md-12 text-center pt-2">
                    <form action="" method="get" id="save_form_data">
                      ...
                      <div class="input-group row" style="margin-bottom: 10px;">
                        <label for="compare_category" class="col-sm-2 col-form-label text-left" style="font-size: 16px;">Category</label>
                        <div class="col-sm-6 dequitis" style="display: flex; align-items: center;font-size: 16px;">
                            <input type="radio" id="gst_zone" name="gst_zone" value="Domestic" checked="" @if(isset($gst_zone) && $gst_zone=='Domestic') checked @endif>
                            <label>Domestic Equities</label>
                            <input type="radio" name="gst_zone" value="Overseas" @if(isset($gst_zone) && $gst_zone=='Overseas') checked @endif>
                            <label>Overseas Equities</label><br>
                        </div>
                        <div class="col-sm-4 text-right">
                            <button type="submit" onclick="clickSubmitButton();" class="btn btn-primary campairButton">
                                Submit
                            </button>
                            @if (Auth::check())
                            ...
                            <?php if(count($list)){ ?>
                                <?php foreach ($list as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td align="right">{{custome_money_format($value->p_noshares - $value->c_noshares)}}</td>
