...
<head>
    <meta charset="utf-8">
    <title>Stocks Completely Exited By Funds</title>
...
<main style="width: 760px; margin-left: 20px;">
    ...
    <div style="padding: 0 15%;">
        <h1 style="color: #000;font-size:16px;margin-bottom:20px !important;text-align:center;">Stocks Completely Exited By Funds</h1>
    </div>
    ...
    <table class="table text-center mfliketbl">
        <tbody>
            <tr>
                ...
                <th>
                    <strong>Net Qty Bought</strong>
                </th>
                <th>
                    <strong>Buy Value (In Rs Cr)</strong>
                </th>
            </tr>
            <?php foreach($list as $key=>$value){ 
                ...
                <tr>
                    ...
                    <td style="text-align:right;">{{$value->Industry}}</td>
                    <td style="text-align:right;">{{$value->mode}}</td>
                    <td style="text-align:right;">{{$value->noshares}}</td>
                    <td style="text-align:right;">{{custome_money_format((int)$value->mktval)}}</td>
                </tr>
            <?php } ?>
        </tbody>
    </table>
    ...
    <div style="margin-top:10px;">
        @php
            $note_data1 = \App\Models\Mfresearch_note::where('type',"mf-stocks-completely-exited")->first();
            if(!empty($note_data1)){
            @endphp
