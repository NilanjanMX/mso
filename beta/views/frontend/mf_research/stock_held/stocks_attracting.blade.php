        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="page-title" style="margin-top: 16px; padding-bottom: 3px;">
        ...
        <div class="container">
            ...
            <div class="row" style="padding-bottom: 10px; font-size: 12px;">
                ...
                <div class="col-md-12 text-center pt-2">
                    <form action="{{route('frontend.stocks_attracting_fund_managers')}}" method="get" id="save_form_data">
                            ...
                            <?php if(count($list)){ ?>
                                <?php foreach ($list as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td align="right">{{custome_money_format($value->difference)}}</td>
