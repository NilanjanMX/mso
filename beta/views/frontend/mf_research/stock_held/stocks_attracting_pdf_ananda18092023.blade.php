...
<main style="width: 760px; margin-left: 20px;">
    ...
    <div style="padding: 0 15%;">
        <h1 style="color: #000;font-size:16px;margin-bottom:20px !important;text-align:center;">Stocks Attracting Fund Managers</h1>
    </div>
    ...
    <table class="table text-center mfliketbl">
        <tbody>
            <tr>
                ...
                <th>
                    <strong>Approx. Buy Value (In <span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> Cr)</strong>
                </th>
            </tr>
            <?php foreach($list as $key=>$value){ 
                ...
                <tr>
                    ...
                    <td style="text-align:right;">{{custome_money_format($value->difference)}}</td>
    ...
    <div style="margin-top:10px;">
        @php
            $note_data1 = \App\Models\Mfresearch_note::where('type',"mf-stocks-attracting")->first();
            if(!empty($note_data1)){
            @endphp
