        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="page-title" style="margin-top: 16px; padding-bottom: 3px;">Stocks Completely Exited</h2>
                </div>
            </div>
        </div>
            ...
            <div class="row" style="padding-bottom: 10px; font-size: 12px;">
                ...
                <div class="col-md-12 text-center pt-2">
                    <form action="{{route('frontend.stocks_held_action')}}" method="get" id="save_form_data">
                      ...
                      <input type="hidden" name="page_name" id="page_name" value="SEEING">
