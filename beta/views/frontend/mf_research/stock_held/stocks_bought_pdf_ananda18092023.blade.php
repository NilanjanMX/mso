...
<head>
    <meta charset="utf-8">
    <title>New Stocks Bought By Funds</title>
...
<main style="width: 760px; margin-left: 20px;">
    ...
    <div style="padding: 0 15%;">
        <h1 style="color: #000;font-size:16px;margin-bottom:20px !important;text-align:center;">New Stocks Bought By Funds</h1>
    </div>
    ...
    <div style="margin-top:10px;">
        @php
            $note_data1 = \App\Models\Mfresearch_note::where('type',"stocks_bought")->first();
            if(!empty($note_data1)){
            @endphp
