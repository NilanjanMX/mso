...
@section('js_after')
    ...
    <script>
        ...
        var global_retuen_list = [
            {"id":"1","name":"1 Years","is_checked":0,"key_name":"1_year"},
            {"id":"2","name":"2 Years","is_checked":0,"key_name":"2_year"},
            {"id":"3","name":"3 Years","is_checked":0,"key_name":"3_year"},
            {"id":"4","name":"4 Years","is_checked":0,"key_name":"4_year"},
            {"id":"5","name":"5 Years","is_checked":0,"key_name":"5_year"},
            {"id":"6","name":"6 Years","is_checked":1,"key_name":"6_year"},
            {"id":"7","name":"7 Years","is_checked":0,"key_name":"7_year"},
            {"id":"8","name":"8 Years","is_checked":1,"key_name":"8_year"},
            {"id":"9","name":"9 Years","is_checked":1,"key_name":"9_year"},
            {"id":"10","name":"10 Years","is_checked":0,"key_name":"10_year"}
          ];
        ...
        function renderRow(all_data){
            ...
            table_html = table_html+'<td rowspan="2">Scheme</td>';
            table_html = table_html+'<td rowspan="2">Category</td>';
            global_retuen_list.forEach(function(val){
                if(all_data.period1_id == val.key_name || all_data.period2_id == val.key_name || all_data.period3_id == val.key_name){
                    table_html = table_html+'<td colspan="2">'+val.name+'</td>';
                }
            });
            table_html = table_html+"</tr>";
            ...
            if(all_data.period1_id){
                table_html = table_html+'<td>Current Value</td>';
                table_html = table_html+'<td>XIRR</td>';
            }
        ...
        function renderSchemeRow(all_data,result){
            ...
            if(is_first_time){
                ...
                table_html = table_html+'<td rowspan="2">Category</td>';
                global_retuen_list.forEach(function(val){
                    if(all_data.period1_id == val.id || all_data.period2_id == val.id || all_data.period3_id == val.id){
                        table_html = table_html+'<td colspan="2">'+val.name+'</td>';
                    }
                });
                table_html = table_html+"</tr>";
            ...
            if(result.s_name){
                table_html = table_html+"<tr>";
                table_html = table_html+'<td>'+result.s_name+'</td>';
                table_html = table_html+'<td>'+result.category+'</td>';
                var current_value = 0;
                var xirr_value = 0;
                if(all_data.period1_id){
                    current_value = result[all_data.period1_id+"_c"];
                    xirr_value = result[all_data.period1_id+"_x"];
                    table_html = table_html+'<td>'+parseFloat(current_value).toFixed(4)+'</td>';
                    table_html = table_html+'<td>'+parseFloat(xirr_value).toFixed(4)+'</td>';
                }
                if(all_data.period2_id){
                    current_value = result[all_data.period2_id+"_c"];
                    xirr_value = result[all_data.period2_id+"_x"];
                    table_html = table_html+'<td>'+parseFloat(current_value).toFixed(4)+'</td>';
                    table_html = table_html+'<td>'+parseFloat(xirr_value).toFixed(4)+'</td>';
                }
                if(all_data.period3_id){
                    current_value = result[all_data.period3_id+"_c"];
                    xirr_value = result[all_data.period3_id+"_x"];
                    table_html = table_html+'<td>'+parseFloat(current_value).toFixed(4)+'</td>';
                    table_html = table_html+'<td>'+parseFloat(xirr_value).toFixed(4)+'</td>';
                }
                table_html = table_html+"</tr>";
            ...
            $.ajax({
                ...
                success: function (result) {
                    if(all_data.type == 1){
                        ...
                        renderSchemeRow(all_data,result);
                    }
                }
            });
        }
        ...
        function searchData(){
            ...
            data.sip_amount = document.getElementById("sip_amount").value;
        ...
        function addData(){
            ...
            data.sip_amount = document.getElementById("s_sip_amount").value;
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="page-title" style="margin-top: 16px; padding-bottom: 3px;">SIP RETURN</h2>
                </div>
            </div>
        </div>
                    ...
                    <form method="get" id="comp_sch" >
                        ...
                        <div id="categorywise_type" style="">
                            <div>
                                ...
                                <div class="input-group row" style="margin-bottom: 10px;">
                                    <label for="sip_amount" class="col-sm-3 col-form-label">SIP Amount</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="sip_amount" id="sip_amount" autocomplete="off" placeholder="SIP Amount">
                                    </div> 
                                  </div>
                                  <div class="input-group row" style="margin-bottom: 10px;">
                        ...
                        <div id="schemewise_type" style="display: none;">
                            <div>
                                ...
                                <div class="input-group row" style="margin-bottom: 10px;">
                                    <label for="s_sip_amount" class="col-sm-3 col-form-label">SIP Amount</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="s_sip_amount" id="s_sip_amount" autocomplete="off" placeholder="SIP Amount">
                                    </div> 
                                  </div>
                                  <div class="input-group row" style="margin-bottom: 10px;">
