    ...
    <script>
        ...
        function renderRow(all_data){
            ...
            if(all_data.period1_id){
                table_html = table_html+'<th colspan="3" style="text-align:center;">'+getPeriodName(all_data.period1_id)+' Year</th>';
            }
            if(all_data.period2_id){
                table_html = table_html+'<th colspan="3" style="text-align:center;">'+getPeriodName(all_data.period2_id)+' Year</th>';
            }
            if(all_data.period3_id){
                table_html = table_html+'<th colspan="3" style="text-align:center;">'+getPeriodName(all_data.period3_id)+' Year</th>';
            }
