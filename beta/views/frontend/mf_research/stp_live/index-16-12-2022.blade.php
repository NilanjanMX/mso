        ...
        function renderRow(all_data,global_result,index){
            ...
            global_result.returnDataFrom.forEach(function(val){
                if(i == 0){
                    ...
                    first_date = new Date(val.navdate);

                    iHtml1 = iHtml1+"<tr>";
                    iHtml1 = iHtml1+"<td>"+val.navdate+"</td>";
            ...
            global_result.returnDataTo.forEach(function(val){
                if(i == 0){
                    ...
                    // iHtml2 = iHtml2+"<tr>";
                    // iHtml2 = iHtml2+"<td>"+val.navdate+"</td>";
                    // iHtml2 = iHtml2+"<td>"+val.navrs+"</td>";
                    // iHtml2 = iHtml2+"<td>"+global_result.lumpsum_investment_amount+"</td>";
                    // iHtml2 = iHtml2+"<td>"+balance_units+"</td>";
                    // iHtml2 = iHtml2+"<td>"+balance_units+"</td>";
                    // iHtml2 = iHtml2+"<td>"+net_amount+"</td>";
                    // iHtml2 = iHtml2+"<td>"+global_result.lumpsum_investment_amount+"</td>";
                    // iHtml2 = iHtml2+"</tr>";
                }else{
                    units = parseFloat(-(-global_result.cash_flow / val.navrs)).toFixed(2);
                    ...
                    var date2 = new Date(val.navdate);
                    var diffTime = Math.abs(date2 - first_date);
                    ...
                    iHtml2 = iHtml2+"<td>"+units+"</td>";
                    iHtml2 = iHtml2+"<td>"+balance_units+"</td>";
                    iHtml2 = iHtml2+"<td>"+net_amount+"</td>";
                    iHtml2 = iHtml2+"<td>"+parseFloat(balance_units * val.navrs).toFixed(2)+"</td>";
                    iHtml2 = iHtml2+"</tr>";
                }
                total_withdrawal2 = parseFloat(total_withdrawal2) + parseFloat(balance_units);
                i = i+1;
            });
            ...
            table_html = table_html+"<td>"+global_result.stp_amount+"</td>";
            table_html = table_html+"</tr>";
            table_html = table_html+"<tr>";
            ...
            table_html = table_html+"<td>"+global_result.returnDataTo.length * global_result.cash_flow+"</td>";
            table_html = table_html+"</tr>";
            table_html = table_html+"<tr>";
            ...
            table_html = table_html+"<td id='to_market_value_as_on_"+index+"'>"+parseFloat(total_withdrawal1).toFixed(2)+"</td>";
            table_html = table_html+"</tr>";
            ...
            table_html = table_html+"<tr>";
            table_html = table_html+"<td>Market Value as on "+global_result.stp_end_date+"</td>";
            table_html = table_html+"<td id='from_market_value_as_on_"+index+"'>"+parseFloat(total_withdrawal2).toFixed(2)+"</td>";
            table_html = table_html+"</tr>";
            table_html = table_html+"</table>";

            var total_withdrawal = total_withdrawal1+total_withdrawal2;
            ...
            table_html = table_html+"<tr>";
            table_html = table_html+"<td>Market Value as on "+global_result.stp_end_date+"</td>";
            table_html = table_html+"<td id='market_value_as_on_"+index+"'>"+total_withdrawal+"</td>";
            table_html = table_html+"</tr>";
            table_html = table_html+"<tr>";
            table_html = table_html+"<td>Total Profit</td>";
            table_html = table_html+"<td>"+(total_withdrawal-global_result.lumpsum_investment_amount)+"</td>";
            table_html = table_html+"</tr>";
            table_html = table_html+"<tr>";
            table_html = table_html+"<td>CAGR Returns</td>";
            table_html = table_html+"<td>"+cagr_returns+"</td>";
            table_html = table_html+"</tr>";
            table_html = table_html+"</table>";
