                            ...
                            <div id="stp_form">
                                <div id="stp_form_0" style="padding: 10px;border: 1px solid;margin-top: 10px;">
                                    ...
                                    <div class="input-group row" style="margin-bottom: 10px;">
                                        <label for="initial_investment_amount" class="col-sm-3 col-form-label">Initial Investment</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="initial_investment_amount[0]" id="initial_investment_amount_0" class="form-control" value="" onkeypress="return isNumeric(event)" onkeyup="changeValidation(0,'initial_investment_amount');">
                                    ...
                                    <div class="input-group row" style="margin-bottom: 10px;">
                                        <label for="" class="col-sm-3 col-form-label">Investment Date</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="investment_date[0]" id="investment_date_0" value="">
                                    ...
                                    <div class="input-group row" style="margin-bottom: 10px;">
                                        <label for="each_transfer_amount" class="col-sm-3 col-form-label">Each Transfer Amount</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="each_transfer_amount[0]" id="each_transfer_amount_0" class="form-control" value="" onkeypress="return isNumeric(event)" onkeyup="changeValidation(0,'each_transfer_amount');">
                                    ...
                                    <div class="input-group row" style="margin-bottom: 10px;">
                                        <label for="stp_start_date" class="col-sm-3 col-form-label">STP Start Date</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="stp_start_date[0]" id="stp_start_date_0" class="form-control" value="">
                                    ...
                                    <div class="input-group row" style="margin-bottom: 10px;">
                                        <label for="stp_end_date" class="col-sm-3 col-form-label">STP End Date</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="stp_end_date[0]" id="stp_end_date_0" class="form-control" value="">
                                    ...
                                    <div class="input-group row" style="margin-bottom: 10px;">
                                        <label for="" class="col-sm-3 col-form-label">Valuation Date</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="valuation_date[0]" id="valuation_date_0" class="form-control" value="">
