...
@section('js_after')
    ...
    <script>
        ...
        function renderRow(global_result,index){
            var table_html = ``;
            table_html = table_html+`<table class="table text-center stock_table mfliketbl">`;
            table_html = table_html+"<h4>STP Transferor Scheme: "+global_result.from_scheme_details.s_name;
            ...
            table_html = table_html+"<h4>STP Transferee Scheme: "+global_result.to_scheme_details.s_name;
            table_html = table_html+"<tr>";
            table_html = table_html+"<td>"+global_result.data_frequency+" STP Amount</td>";
            table_html = table_html+"<td>"+global_result.lumpsum_investment_amount+"</td>";
            table_html = table_html+"</tr>";
            ...
            table_html = table_html+"<h4>STP Total Returns: ";
            table_html = table_html+"<tr>";
            ...
            global_result.returnDataTo.forEach(function(val){
                if(i == 0){
                    ...
                    table_html = table_html+"<td>"+all_data.data_frequency+"</td>";
        ...
        function addButton(){
            ...
            if(form_list.length < 3){
                var iHtml = `<div id="stp_form_`+global_index+`">
                            ...
                            <div id="stp_form">
                                <div id="stp_form_0">
                                    <div class="input-group row" style="margin-bottom: 10px;">
                                        <label for="" class="col-sm-3 col-form-label">AMC Name</label>
                                        <div class="col-sm-9">
                                            <select class="form-control ui-autocomplete-input amc_name" name="amc_name[0]" message="text" datatype="0" id="amc_name_0" onchange="changeAMCName(0);">
                                                <option value="">Select AMC Name</option>
                                                @foreach($fund_house_list as $key => $value)
                                                    <option value="{{$value->amc_code}}">{{$value->fund}}</option>
                                                @endforeach
                                    ...
                                    <div class="input-group row" style="margin-bottom: 10px;">
                                        <label for="from_scheme" class="col-sm-3 col-form-label">From Scheme</label>
                                        <div class="col-sm-9">
                                            <select class="form-control ui-autocomplete-input schemecode_id" name="from_scheme[0]" id="from_scheme_0">
                                                <option value="">Select From Scheme</option>
                                            </select>
                                    ...
                                    <div class="input-group row" style="margin-bottom: 10px;">
                                        <label for="to_scheme" class="col-sm-3 col-form-label">To Scheme</label>
                                        <div class="col-sm-9">
                                            <select class="form-control ui-autocomplete-input schemecode_id" name="to_scheme[0]" id="to_scheme_0">
                                                <option value="">Select To Scheme</option>
                                            </select>
                                    ...
                                    <div class="input-group row" style="margin-bottom: 10px;">
                                        <label for="initial_investment_amount" class="col-sm-3 col-form-label">Initial Investment</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="initial_investment_amount[0]" id="initial_investment_amount_0" class="form-control" value="500000">
                                    ...
                                    <div class="input-group row" style="margin-bottom: 10px;">
                                        <label for="each_transfer_amount" class="col-sm-3 col-form-label">Each Transfer Amount</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="each_transfer_amount[0]" id="each_transfer_amount_0" class="form-control" value="500000">
