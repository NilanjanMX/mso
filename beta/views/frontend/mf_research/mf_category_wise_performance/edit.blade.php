...
@section('js_after')
    ...
    <script type="text/javascript">
        ...
        var global_point_to_point = <?php echo json_encode($point_to_point);?>;
        var schemecode_id = "<?php echo $schemecode_id;?>";
        var global_view_nav_graph = "<?php echo $nav_graph;?>";

        var nav_flag = true;

        schemecode_id = schemecode_id.split(",");
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <h2 class="page-title" style="margin-top: 16px; padding-bottom: 3px;">MF Category-wise Scheme Performance</h2>
            </div>
        </div>
    </div>
                ...
                <div class="rt-pnl" style="box-shadow: none;">
                    <div class="VideoNav" style="border: 0">
                                        ...
                                        @foreach ($equity_list as $key=>$result)
                                            <div class="form-check">
                                              <label class="form-check-label" for="equity_fund_{{$result->classcode}}">
                                                <input type="radio" data="{{$result->classname}}" class="form-check-input" id="equity_fund_{{$result->classcode}}" name="category_id" value="{{$result->classcode}}" onchange="renderView();" @if($result->is_checked) checked @endif>
                                        ...
                                        @foreach ($debt_list as $key=>$result)
                                            <div class="form-check">
                                              <label class="form-check-label" for="debt_fund_{{$result->classcode}}">
                                                <input type="radio" data="{{$result->classname}}" class="form-check-input" id="debt_fund_{{$result->classcode}}" name="category_id" value="{{$result->classcode}}" onchange="renderView();" @if($result->is_checked) checked @endif>
                                                <?php echo ($result->class_name)?$result->class_name:$result->classname;?>
                                              </label>
                                            </div>
                                        @endforeach
                                        ...
                                        @foreach ($hybrid_list as $key=>$result)
                                            <div class="form-check">
                                              <label class="form-check-label" for="hybrid_fund_{{$result->classcode}}">
                                                <input type="radio" data="{{$result->classname}}" class="form-check-input" id="hybrid_fund_{{$result->classcode}}" name="category_id" value="{{$result->classcode}}" onchange="renderView();" @if($result->is_checked) checked @endif>
                                                <?php echo ($result->class_name)?$result->class_name:$result->classname;?>
                                              </label>
                                            </div>
                                        @endforeach
                                        ...
                                        @foreach ($other_list as $key=>$result)
                                            <div class="form-check">
                                              <label class="form-check-label" for="commodity_other_{{$result->classcode}}">
                                                <input type="radio" data="{{$result->classname}}" class="form-check-input" id="commodity_other_{{$result->classcode}}" name="category_id" value="{{$result->classcode}}" onchange="renderView();" @if($result->is_checked) checked @endif>
                                                <?php echo ($result->class_name)?$result->class_name:$result->classname;?>
                                              </label>
                                            </div>
                                        @endforeach
                                            ...
                                            <div class="form-check">
                                              <label class="form-check-label" for="plan_{{$result->plan_code}}">
                                                <input type="checkbox" data="{{$result->plan}}" class="form-check-input" id="plan_{{$result->plan_code}}" name="plan[]" value="{{$result->plan_code}}" onchange="renderView();" 
                                                 @if($result->is_checked) checked @endif>
                            ...
                            <div class="row mt-1" id="choose_columns_view">
                              <div class="col-md-12">
                                ...
                                <div class="mf-scanner-filter-box" id="calender_return" style="display: flex;height: auto;margin-bottom: 15px;">
                                    @foreach ($calender_list as $key=>$result)
                                        <div class="form-check">
                                          <label class="form-check-label" for="calender_return_{{$result['year']}}">
                                            <input type="checkbox" class="form-check-input" id="calender_return_{{$result['year']}}" name="calender_return[]" value="{{$result['year']}}" onchange="renderView('calender_return_{{$result['year']}}');" @if($result['is_checked']) checked @endif>{{$result['year']}}
                                          </label>
                                        </div>
                                    @endforeach
                                </div>
                            ...
                            <div class="row mt-1" id="choose_columns_view">
                              <div class="col-md-12">
                                ...
                                <div class="mf-scanner-filter-box" id="point_to_point_view" style="display: flex;height: auto;margin-bottom: 15px;">
                                    ...
                                    @foreach($point_to_point as $result)
                                        <span class="category-view-span">
                                            {{$result['start_date']}}-{{$result['end_date']}} 
                                            <span class="icon-cancel asset_child equities1" style="font-size:18px;" onclick="removeFilterView('{{$result['start_date']}}-{{$result['end_date']}}');">
                                            </span>
                                        </span>
                                    @endforeach
                                </div>
                        ...
                        <div class="row mx-0" style="padding-bottom: 10px; font-size: 12px;">
                          ...
                          <div class="col-md-12 text-center pt-2 mx-0" style="border-top: 1px solid #ccc; margin-top: 3px;">
                        ...
                        <div class="row mx-0" style="padding-bottom: 10px; font-size: 12px;">
                          ...
                          <div class="col-md-12 text-center pt-2 mx-0" style="border-top: 1px solid #ccc; margin-top: 3px;">
                            <form action="{{route('frontend.mf_category_wise_performance_save')}}" method="get" id="save_form_data">
                                ...
                                <input type="hidden" name="schemecode_id" id="schemecode_id" value="{{$schemecode_id}}">
                                ...
                                <input type="hidden" name="f_graph" id="f_graph" value="{{$is_graph}}">
                                @if (Auth::check())
                                ...
                                <button type="button" class="btn btn-success btn-sm downloadButton" onclick="openViewNAVGraph();" id="view_nav_graph" style="display:none;">
                                    View NAV Graph
                                </button>
                    ...
                    <div class="row mt-1 mx-0" id="line_chart_div" style="display: <?php echo (count($schemecode_ids)>1 && $schemecode_ids <= 5)?'block':'none';?>;">
                        <div class="form-group row mt-2 mx-0" style="align-items: flex-start;">
                            <div class="col-sm-12 d-flex px-0">
                                <label class="sqarecontainer">View Detailed Graph
                                    <input id="is_graph" type="checkbox" name="is_graph" value="1" <?php echo ($is_graph)?'checked':'';?>> 
                                    <span class="checkmark"></span>
                                </label>
                            </div>
                            <div class="col-md-12 text-center" id="curve_chart" style="width: 100%; height: 500px;display: <?php echo ($is_graph)?'block':'none';?>;">
