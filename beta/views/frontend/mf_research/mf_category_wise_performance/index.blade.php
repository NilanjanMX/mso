...
@section('js_after')
    ...
    <script type="text/javascript">
        ...
        function withCoverPagec(){
            $('#errorAfterLoginModal').modal('hide');
            $('#downloadModal').modal('show');
        }

        function withoutCoverPagec(){
            checkDownload();
    ...
    function openModalc(){
        ...
        document.getElementById("client_name").value = "";
        $('#errorAfterLoginModalc').modal('show');
    }
...
<style>
    #errorAfterLoginModalc .modal-content {
        border-radius: 15px !important;
    }
    #errorAfterLoginModalc .successHead {
        background: #16a1dc;
        text-align: center;
        padding: 20px 0 10px 0;
        border-radius: .7rem .7rem 0 0;
    }
    #errorAfterLoginModalc .successHead h3 {
        margin: 0;
        padding: 0;
        color: #fff;
    }
    #errorAfterLoginModalc .successHead button.close {
        position: absolute;
        right: 10px;
        top: 10px;
    }
    #errorAfterLoginModalc #success_model_body {
        color: #444444;
        font-size: 12px;
        text-align: center;
        margin-top: 0.7rem;
    ...
    #errorAfterLoginModalc #successModal .modal-footer {
        justify-content: center;
    }
    #errorAfterLoginModalc .btnblue {
        padding: .5rem 2rem;
...
<section class="main-sec">
                              ...
                              @if (Auth::check())
                                @if($permission['is_download'])
                                    @if($permission['is_cover'])
                                        <button type="button"  class="btn btn-success btn-sm downloadButton" onclick="return openModalc();">
                                            Download
                                        </button>
                                    @else
    ...
    <div class="modal fade" id="errorAfterLoginModalc" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
              ...
              <div class="modal-footer text-center" style="justify-content: center;">
                  <a href="javascript:void(0);" class="btn btn-secondary btnblue" id="with_cover_page" onclick="withCoverPagec();" >With Cover Page</a>
                  <a href="javascript:void(0);" class="btn btn-secondary btnblue" id="without_cover_page" onclick="withoutCoverPagec();" >Without Cover Page</a>
              </div>
          </div>
        </div>
      </div>
