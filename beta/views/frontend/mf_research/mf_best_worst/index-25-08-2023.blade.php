...
@section('js_after')
    ...
    <script type="text/javascript">
        ...
        function checkDownload(){
            console.log(document.querySelector('input[name="category_id"]:checked').value);
    ...
    <script type="text/javascript">
        ...
        $("#is_comments").click( function(){
            if( $(this).is(':checked') ){
                $('textarea[name="comments"]').prop("readonly", false);
            }else {
                $('textarea[name="comments"]').prop("readonly", true);
                                ...
                                <div class="row mt-2">
                                  ...
                                  <div class="col-md-6">
                                    ...
                                    <select class="form-control" id="query_period" name="query_period" onchange="renderRow(1);">
                                        <option value="1dayret">1 Day</option>
                                        <option value="1weekret">1 Week</option>
                                        <option value="1monthret">1 Month</option>
                                        <option value="3monthret">3 Month</option>
                                        <option value="6monthret">6 Month</option>
                                        <option value="1yrret" selected>1 Year</option>
                                        <option value="2yearret">2 Year</option>
                                        <option value="3yearret">3 Year</option>
                                        <option value="5yearret">5 Year</option>
                                        <option value="10yearret">10 Year</option>
                                    </select>
                                  </div>
                                </div>
                            </div>
                                    ...
                                    <div class="mf-scanner-filter-box" style="display: flex;height: auto;margin-bottom: 15px;">
                                        <div class="form-check" style="margin-right: 7px;">
                                          <label class="form-check-label" for="cc_return">
                                            <input type="radio" class="form-check-input" name="criteria" value="1" onchange="renderRow(0);">Best
                                          </label>
                                        </div>
                                        <div class="form-check" style="margin-right: 7px;">
                                          <label class="form-check-label" for="cc_return">
                                            <input type="radio" class="form-check-input" name="criteria" value="2" onchange="renderRow(0);">Worst
                                          </label>
                                        </div>
                                        <div class="form-check">
                                          <label class="form-check-label" for="cc_return">
                                            <input type="radio" class="form-check-input" name="criteria" value="3" onchange="renderRow(0);" checked="checked">Both
                                          </label>
                                        </div>
                                    </div>
                                  </div>
