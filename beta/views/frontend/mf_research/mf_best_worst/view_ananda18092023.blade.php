                        ...
                        <div class="rt-btn-prt">
                            ...
                            @if($permission['is_download'])
                                @if($permission['is_cover'])
                                    <a href="javascript:void(0);"  class="btn btn-success btn-sm downloadButton" onclick="return openModal('{{$details->url}}','{{$mf_scanner_saved_id}}');">
                                        Download
                                    </a>
                                @else
                                    <a href="{{$details->url}}-download?id={{$mf_scanner_saved_id}}"  class="btn btn-success btn-sm downloadButton">
                                        Download
                                    </a>
                                @endif
                            @else
