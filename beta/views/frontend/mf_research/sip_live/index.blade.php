...
@section('js_after')
    ...
    <script>
        ...
        // function inputDays()
        // {
        //     var frequency = $('#select_frequency').
        // }
        ...
        function getFrequency(index){
            ...
            */
            ...
            if(frequency != '')
            {
                if(frequency == 'Weekly')
                {
                    frequency_html = frequency_html+"<div class='input-group row' style='margin-bottom: 10px;'><label for='day_one' class='col-sm-2 col-form-label'>First Day</label><div class='col-sm-4'><input type='text' name='day_one' id='day_one' class='form-control' value='' onkeypress='return isNumeric(event)'><em id='day_one_error' class='error'></em> </div></div>";

                    frequency_html = frequency_html+"<div class='input-group row' style='margin-bottom: 10px;'><label for='day_two' class='col-sm-2 col-form-label'>Second Day</label><div class='col-sm-4'><input type='text' name='day_two' id='day_two' class='form-control' value='' onkeypress='return isNumeric(event)'><em id='day_two_error' class='error'></em> </div></div>";

                    frequency_html = frequency_html+"<div class='input-group row' style='margin-bottom: 10px;'><label for='day_three' class='col-sm-2 col-form-label'>Third Day</label><div class='col-sm-4'><input type='text' name='day_three' id='day_three' class='form-control' value='' onkeypress='return isNumeric(event)'><em id='day_three_error' class='error'></em> </div></div>";

                    frequency_html = frequency_html+"<div class='input-group row' style='margin-bottom: 10px;'><label for='day_four' class='col-sm-2 col-form-label'>Fourth Day</label><div class='col-sm-4'><input type='text' name='day_four' id='day_four' class='form-control' value='' onkeypress='return isNumeric(event)'><em id='day_four_error' class='error'></em> </div></div>";
                }
                ...
                {
                    frequency_html = frequency_html+"<div class='input-group row' style='margin-bottom: 10px;'><label for='day_one' class='col-sm-2 col-form-label'>First Day</label><div class='col-sm-4'><input type='text' name='day_one' id='day_one' class='form-control' value='' onkeypress='return isNumeric(event)'></div><div class='col-sm-6'><select class='form-control ui-autocomplete-input month_one' name='month_one' id='month_one'><option value=''>Select Monthly</option><option value='January'>January</option><option value='February'>February</option><option value='March'>March</option><option value='April'>April</option><option value='May'>May</option><option value='June'>June</option><option value='July'>July</option><option value='August'>August</option><option value='September'>September</option><option value='October'>October</option><option value='November'>November</option><option value='December'>December</option></select></div><em id='day_one_error' class='error'></em> </div></div>";

                    frequency_html = frequency_html+"<div class='input-group row' style='margin-bottom: 10px;'><label for='day_two' class='col-sm-2 col-form-label'>Second Day</label><div class='col-sm-4'><input type='text' name='day_two' id='day_two' class='form-control' value='' onkeypress='return isNumeric(event)'></div><div class='col-sm-6'><select class='form-control ui-autocomplete-input month_two' name='month_two' id='month_two'><option value=''>Select Monthly</option><option value='January'>January</option><option value='February'>February</option><option value='March'>March</option><option value='April'>April</option><option value='May'>May</option><option value='June'>June</option><option value='July'>July</option><option value='August'>August</option><option value='September'>September</option><option value='October'>October</option><option value='November'>November</option><option value='December'>December</option></select></div><em id='day_two_error' class='error'></em> </div></div>";

                    frequency_html = frequency_html+"<div class='input-group row' style='margin-bottom: 10px;'><label for='day_three' class='col-sm-2 col-form-label'>Third Day</label><div class='col-sm-4'><input type='text' name='day_three' id='day_three' class='form-control' value='' onkeypress='return isNumeric(event)'></div><div class='col-sm-6'><select class='form-control ui-autocomplete-input month_three' name='month_tree' id='month_three'><option value=''>Select Monthly</option><option value='January'>January</option><option value='February'>February</option><option value='March'>March</option><option value='April'>April</option><option value='May'>May</option><option value='June'>June</option><option value='July'>July</option><option value='August'>August</option><option value='September'>September</option><option value='October'>October</option><option value='November'>November</option><option value='December'>December</option></select></div><em id='day_three_error' class='error'></em> </div></div>";

                    frequency_html = frequency_html+"<div class='input-group row' style='margin-bottom: 10px;'><label for='day_four' class='col-sm-2 col-form-label'>Fourth Day</label><div class='col-sm-4'><input type='text' name='day_four' id='day_four' class='form-control' value='' onkeypress='return isNumeric(event)'></div><div class='col-sm-6'><select class='form-control ui-autocomplete-input month_four' name='month_four' id='month_four'><option value=''>Select Monthly</option><option value='January'>January</option><option value='February'>February</option><option value='March'>March</option><option value='April'>April</option><option value='May'>May</option><option value='June'>June</option><option value='July'>July</option><option value='August'>August</option><option value='September'>September</option><option value='October'>October</option><option value='November'>November</option><option value='December'>December</option></select></div><em id='day_four_error' class='error'></em> </div></div>";
                }
                ...
                $('#choose-friquency-form').html('');
                $('#choose-friquency-form').html(frequency_html);
                $('#choose-friquency').show();
            }
            else
            {
                $('#choose-friquency-form').html('');
                $('#choose-friquency').hide();
            }
        }
        ...
        function setDefaultFun(index){
            $('#investment_date_'+index).datepicker({
                ...
                var x_date = $(this).val();
                var x_dates = x_date.split("/");
                var x_date = x_dates[1]+"/"+x_dates[0]+"/"+x_dates[2];
                
                var index_d = $(this).attr('id');
                index_d = index_d.split("_");
                index_d = index_d[index_d.length-1];
                
                console.log(index_d);
                
                var y_date = document.getElementById("to_incept_date_"+index_d).innerHTML;
                if(y_date){
                    var y_dates = y_date.split("/");
                    var y_date = y_dates[1]+"/"+y_dates[0]+"/"+y_dates[2];
                    
                    x_date = new Date(x_date);
                    console.log(x_date);
                    y_date = new Date(y_date);
                    console.log(y_date);
                    
                    if(x_date > y_date){
                        console.log("to_incept_date");
                        $('#stp_start_date_'+index).datepicker('setStartDate', new Date(x_date));
                    }else{
                        console.log("investment_date");
                        $('#stp_start_date_'+index).datepicker('setStartDate', new Date(y_date));
                    }
                }else{
                    $('#stp_start_date_'+index).datepicker('setStartDate', new Date(x_date));
                }
        ...
        function getIncept(index)
        {
            var scheme_code = document.getElementById("to_scheme_"+index).value;
            $.ajax({
                url: "{{ url('/get-scheme-this') }}/"+scheme_code,
                method: 'get',
                success: function (result) {
                    ...
                    var incept_dates = global_scheme_list.incept_date;
                    incept_dates = incept_dates.split(" ");
                    console.log(incept_dates);
                    incept_dates = incept_dates[index];
                    console.log(incept_dates);
                    ...
                    var to_incept_date = document.getElementById("to_incept_date_"+index).innerHTML;
                    // var investment_date = document.getElementById("investment_date_"+index).value;
                    
                    console.log(to_incept_date);
                    // console.log(investment_date);
                    
                    // if(to_incept_date && investment_date){
                    if(to_incept_date){
                        
                        var x_date = to_incept_date;
                        var x_dates = x_date.split("/");
                        var x_date = x_dates[1]+"/"+x_dates[0]+"/"+x_dates[2];
                        
                        // var y_date = investment_date;
                        // var y_dates = y_date.split("/");
                        // var y_date = y_dates[1]+"/"+y_dates[0]+"/"+y_dates[2];
        ...
        function renderRow(all_data,global_result,index){
            ...
            pre_nav = parseFloat(global_result.investment_data.navrs);
            first_date = new Date(global_result.investment_data.navdate);

            iHtml1 = iHtml1+"<tr>";
            iHtml1 = iHtml1+"<td>"+global_result.investment_data.date+"</td>";
            iHtml1 = iHtml1+"<td>"+global_result.investment_data.navrs+"</td>";
            iHtml1 = iHtml1+"<td>₹ "+parseInt(global_result.lumpsum_investment_amount).toLocaleString('en-IN')+"</td>";
            iHtml1 = iHtml1+"<td>"+balance_units+"</td>";
            iHtml1 = iHtml1+"<td>"+balance_units+"</td>";
            iHtml1 = iHtml1+"<td>₹ "+parseInt(net_amount).toLocaleString('en-IN')+"</td>";
            ...
            global_result.returnDataFrom.forEach(function(val){
                ...
                iHtml1 = iHtml1+"<td>₹ -"+parseInt(global_result.cash_flow).toLocaleString('en-IN')+"</td>";
                ...
                iHtml1 = iHtml1+"<td>₹ "+parseInt(balance_units * val.navrs).toLocaleString('en-IN')+"</td>";
                iHtml1 = iHtml1+"</tr>";
            ...
            global_result.returnDataTo.forEach(function(val){
                ...
                iHtml2 = iHtml2+"<td>₹ "+parseInt(global_result.cash_flow).toLocaleString('en-IN')+"</td>";
                iHtml2 = iHtml2+"<td>"+parseFloat(val.units).toFixed(2)+"</td>";
                iHtml2 = iHtml2+"<td>"+parseFloat(val.balance_units).toFixed(2)+"</td>";
                iHtml2 = iHtml2+"<td>₹ "+parseInt(val.amount_invested).toLocaleString('en-IN')+"</td>";
                iHtml2 = iHtml2+"<td>₹ "+parseInt(val.market_value).toLocaleString('en-IN')+"</td>";
                iHtml2 = iHtml2+"</tr>";
                i = i+1;
            });
            ...
            table_html = table_html+"<td>"+global_result.stp_start_date+" - "+global_result.stp_end_date1+"</td>";
            table_html = table_html+"</tr>";
            table_html = table_html+"<tr>";
            ...
            table_html = table_html+"<td>"+parseFloat(global_result.from_unit).toFixed(2)+"</td>";
            table_html = table_html+"</tr>";
            table_html = table_html+"<tr>";
            table_html = table_html+"<td>Market Value as on "+global_result.stp_end_date+"</td>";
            table_html = table_html+"<td>₹ "+parseInt(global_result.from_market_value).toLocaleString('en-IN')+"</td>";
            table_html = table_html+"</tr>";
            ...
            table_html = table_html+"<tr>";
            table_html = table_html+"<td>No. of Units Remaining</td>";
            table_html = table_html+"<td>"+parseFloat(global_result.to_unit).toFixed(2)+"</td>";
            table_html = table_html+"</tr>";
            table_html = table_html+"<tr>";
            table_html = table_html+"<td>Market Value as on "+global_result.stp_end_date+"</td>";
            table_html = table_html+"<td>₹ "+parseInt(global_result.to_market_value).toLocaleString('en-IN')+"</td>";
            table_html = table_html+"</tr>";
            table_html = table_html+"</table>";
            ...
            var abc = parseFloat(total_withdrawal)/parseFloat(global_result.lumpsum_investment_amount);
            var abd = 1/number_of_days;

            console.log("number_of_days:"+number_of_days);
            console.log("total_withdrawal:"+total_withdrawal);
            console.log("lumpsum_investment_amount:"+global_result.lumpsum_investment_amount);

            var daily_return = Math.pow(abc,abd)-1;

            console.log("daily_return:"+daily_return);

            var cagr_returns = Math.pow((1+parseFloat(daily_return)),(365))-1;
            
            
            console.log("daily_return:"+cagr_returns);
            ...
            table_html = table_html+"<tr>";
            table_html = table_html+"<td>Market Value as on "+global_result.stp_end_date+"</td>";
            table_html = table_html+"<td>₹ "+parseInt(total_withdrawal).toLocaleString('en-IN')+"</td>";
            table_html = table_html+"</tr>";
            table_html = table_html+"<tr>";
            ...
            table_html = table_html+"<td>"+parseFloat(cagr_returns*100).toFixed(2)+" %</td>";
            table_html = table_html+"</tr>";
            table_html = table_html+"</table>";
            ...
            table_html = table_html+"<tr>";
            table_html = table_html+"<th style='width:11%;'>NAV Date</th>";
            table_html = table_html+"<th style='width:9%;'>NAV</th>";
            table_html = table_html+"<th style='width:9%;'>Cash Flow</th>";
            table_html = table_html+"<th style='width:11%;'>Units</th>";
            table_html = table_html+"<th style='width:12%;'>Balance Units</th>";
            table_html = table_html+"<th style='width:12%;'>Net Amount</th>";
            table_html = table_html+"<th style='width:11%;'>Capital Gain/Loss</th>";
            table_html = table_html+"<th style='width:11%;'>No. of Days (Investment)</th>";
            table_html = table_html+"<th style='width:14%;'>Market Value</th>";
            table_html = table_html+"</tr>";
            table_html = table_html+"</thead>";
        ...
        function callAPI(all_data){
            // console.log('go: '+"{{ url('/mf-stp-historical-list') }}");
            // return false;
            ...
            // document.getElementById('result_view').innerHTML = "hello all";
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    // document.getElementById('result_view').innerHTML = result;
        ...
        function searchData(){
            var scheme_code = '';
            var each_transfer_amount = '';
            var select_frequency = '';
            var stp_start_date = '';
            var stp_end_date = '';
            var valuation_date = '';

            scheme_code = document.getElementById("to_scheme_0").value;
            each_transfer_amount = document.getElementById("each_transfer_amount_0").value;
            select_frequency = document.getElementById("select_frequency").value;
            stp_start_date = document.getElementById("stp_start_date_0").value;
            stp_end_date = document.getElementById("stp_end_date_0").value;
            valuation_date = document.getElementById("valuation_date_0").value;
            ...
            if(form_list.length < 3){
                var iHtml = `<div id="stp_form_`+global_index+`" style="padding: 10px;border: 1px solid;margin-top: 10px;">
                                    ...
                                    <div class="input-group row" style="margin-bottom: 10px;">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="initial_investment_amount[`+global_index+`]" id="initial_investment_amount_`+global_index+`" class="form-control" value="500000" onkeypress="return isNumeric(event)" onkeyup="changeValidation(`+global_index+`,'initial_investment_amount');">
        ...
        function changeValidation(index,id){
            ...
            //         // var x_date = new Date(incept_date);
            //         // console.log(x_date);
            //         // var y_date = "";
            //         // var y_date_array = "";

            //         // var schemeHtml = ``;
            //         // global_scheme_list.forEach(function(val){
            //         //     y_date_array = val.incept_date.split(" ");
                        
            //         //     var y_date = new Date(y_date_array[0]);
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="page-title" style="margin-top: 16px; padding-bottom: 3px;">SIP</h2>
                </div>
            </div>
        </div>
            ...
            <div class="row Search_Here" style="margin-top: 20px;">
                <div class="col-12 col-sm-10 col-md-8 col-lg-8 col-xl-8" >
                    <form action="{{route('frontend.mf_stp_historical_action')}}" method="post" id="comp_sch" >
                        ...
                        <input type="hidden" name="rownumber" value="{{$index}}" id="rownumber">

                        <div id="rowexist"><input type="hidden" name="row_{{$index}}" id="row_{{$index}}" value="yes"></div>
                        <div style="">
                            <div id="stp_form">
                                <div id="stp_form_0" style="padding: 10px;border: 1px solid;margin-top: 10px;">
                                    
                                    <div class="input-group row" style="margin-bottom: 10px;">
                                        <label for="to_scheme" class="col-sm-3 col-form-label">Scheme</label>
                                        <div class="col-sm-9">
                                            <select class="form-control ui-autocomplete-input schemecode_id" name="to_scheme[{{$index}}]" id="to_scheme_{{$index}}" onchange="getIncept({{$index}});">
                                                <option value="">Select To Scheme</option>
                                                @if(count($schemes) > 0)
                                                    @foreach($schemes as $scheme)
                                                        <option value="{{$scheme->schemecode}}">{{$scheme->s_name}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                            <em id="to_scheme_{{$index}}_error" class="error"></em>  
                                        </div> 
                                    </div>
                                    ...
                                    <div class="input-group row" style="margin-bottom: 20px;">
                                        <label for="" class="col-sm-3 col-form-label" >Incept Date</label>
                                        <div class="col-sm-9">
                                            <div  class="form-control" id="to_incept_date_{{$index}}" style="padding-top: 9px;"></div> 
                                        </div> 
                                    </div>


                                    <div class="input-group row" style="margin-bottom: 10px;">
                                        <label for="each_transfer_amount" class="col-sm-3 col-form-label">SIP Amount</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="each_transfer_amount[{{$index}}]" id="each_transfer_amount_{{$index}}" class="form-control" value="" onkeypress="return isNumeric(event)">
                                            <em id="each_transfer_amount_{{$index}}_error" class="error"></em>  
                                        </div> 
                                    </div>
                                    ...
                                    <div class="input-group row" style="margin-bottom: 10px;">
                                        <label for="select_frequency" class="col-sm-3 col-form-label">Select Frequency</label>
                                        <div class="col-sm-9">
                                            <select class="form-control ui-autocomplete-input" name="select_frequency[{{$index}}]" id="select_frequency_{{$index}}" onchange="getFrequency({{$index}});">
                                                <option value="">Select Frequency</option>
                                                @foreach($data_frequency as $dropdown)
                                                    <option value="{{$dropdown['id']}}">{{$dropdown['name']}}</option>
                                                @endforeach
                                            </select>
                                            <em id="select_frequency_{{$index}}_error" class="error"></em>  
                                        </div> 
                                    </div>

                                    <div class="input-group row" id="choose-friquency-{{$index}}" style="margin-bottom: 10px; display: none;">
                                        <label for="" class="col-sm-3 col-form-label">Choose Frequency</label>
                                        <div class="col-sm-9" id="choose-friquency-form">
                                    ...
                                    <div class="input-group row" style="margin-bottom: 10px;">
                                        <label for="stp_start_date" class="col-sm-3 col-form-label">SIP Start Date</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="stp_start_date[{{$index}}]" id="stp_start_date_{{$index}}" class="form-control" value="">
                                            <em id="stp_start_date_{{$index}}_error" class="error"></em>  
                                        </div> 
                                    </div>

                                    <div class="input-group row" style="margin-bottom: 10px;">
                                        <label for="stp_end_date" class="col-sm-3 col-form-label">SIP End Date</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="stp_end_date[{{$index}}]" id="stp_end_date_{{$index}}" class="form-control" value="">
                                            <em id="stp_end_date_{{$index}}_error" class="error"></em>  
                                        </div> 
                                    </div>
                                    ...
                                    <div class="input-group row" style="margin-bottom: 10px;">
                                        <label for="" class="col-sm-3 col-form-label">Valuation Date</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="valuation_date[{{$index}}]" id="valuation_date_{{$index}}" class="form-control" value="">
                                            <em id="valuation_date_{{$index}}_error" class="error"></em>  
                                        </div> 
                                    </div>
                                </div>
                            </div>
