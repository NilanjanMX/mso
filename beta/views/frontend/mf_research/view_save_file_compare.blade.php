    ...
    foreach($result as $key=>$value){
        ...
        $iHtml2 .= '<div class="mob_mf_com col-3 col-md-3 col_0" style="display: block;"  id="row_view2_'.$key.'">
            ...
            if(in_array("inception_date", $basic_detail_checkbox) || count($basic_detail_checkbox) == 0){
                $iHtml2 .=  '<li class="list-group-item" id="basic_launch_date_0">'.date('d-m-Y', strtotime($value->Incept_date)).'</li>';
            }
            if(in_array("fund_type", $basic_detail_checkbox) || count($basic_detail_checkbox) == 0){
                $iHtml2 .= '<li class="list-group-item" id="basic_launch_date_0">'.$value->classname.'</li>';
            }
            if(in_array("fund_manager", $basic_detail_checkbox) || count($basic_detail_checkbox) == 0){
                $iHtml2 .= '<li class="list-group-item" id="basic_launch_date_0">'.$value->fund_mgr1.'</li>';
            }
            if(in_array("aum", $basic_detail_checkbox) || count($basic_detail_checkbox) == 0){
                $iHtml2 .= '<li class="list-group-item" id="basic_launch_date_0"><div class="dataHintHold">'.custome_money_format((int)($value->total/100)).'<span>'.date('d-m-Y', strtotime($value->total_date)).'</span></div></li>';
            }
            if(in_array("benchmark_index", $basic_detail_checkbox) || count($basic_detail_checkbox) == 0){
                $iHtml2 .= '<li class="list-group-item"><div class="comp_holding" id="basic_bench_index_0">'.$value->IndexName.'</div></li>';
            }
            if(in_array("expense_ratio", $basic_detail_checkbox) || count($basic_detail_checkbox) == 0){
                $iHtml2 .= '<li class="list-group-item" id="basic_expense_ratio_0">'.$value->expratio.'</li>';
            }
            if(in_array("exit_load", $basic_detail_checkbox) || count($basic_detail_checkbox) == 0){
                $iHtml2 .= '<li class="list-group-item" id="basic_exit_load_0"><div class="dataHintHold">'.$EXITLOAD.'<span>'.$value->REMARKS.'</span></div></li>';
            }
            if(in_array("latest_nav", $basic_detail_checkbox) || count($basic_detail_checkbox) == 0){
                $iHtml2 .= '<li class="list-group-item" id="basic_lock_in_period_0">'.$value->navrs.'</li>';
            }
        $iHtml2 .= '</ul></div>';
        ...
        $iHtml3 .= '<div class="mob_mf_com col-3 col-md-3 col_0" style="display: block;" id="row_view3_'.$key.'">
            ...
            if(in_array("1_month", $return_checkbox) || count($return_checkbox) == 0){
                $iHtml3 .= '<li class="list-group-item" id="return_6m_0">'.$onemonthret.'</li>';
            }     
            if(in_array("3_month", $return_checkbox) || count($return_checkbox) == 0){
                $iHtml3 .= '<li class="list-group-item" id="return_6m_0">'.$threemonthret.'</li>';
            }     
            if(in_array("6_month", $return_checkbox) || count($return_checkbox) == 0){
                $iHtml3 .= '<li class="list-group-item" id="return_6m_0">'.$sixmonthret.'</li>';
            }     
            if(in_array("1_year", $return_checkbox) || count($return_checkbox) == 0){
                $iHtml3 .= '<li class="list-group-item" id="return_6m_0">'.$oneyrret.'</li>';
            }     
            if(in_array("2_year", $return_checkbox) || count($return_checkbox) == 0){
                $iHtml3 .= '<li class="list-group-item" id="return_6m_0">'.$twoyearret.'</li>';
            }     
            if(in_array("3_year", $return_checkbox) || count($return_checkbox) == 0){
                $iHtml3 .= '<li class="list-group-item" id="return_6m_0">'.$threeyearret.'</li>';
            }     
            if(in_array("5_year", $return_checkbox) || count($return_checkbox) == 0){
                $iHtml3 .= '<li class="list-group-item" id="return_6m_0">'.$fiveyearret.'</li>';
            }     
            if(in_array("10_year", $return_checkbox) || count($return_checkbox) == 0){
                $iHtml3 .= '<li class="list-group-item" id="return_6m_0">'.$tenyret.'</li>';
            }     
            if(in_array("since_inception", $return_checkbox) || count($return_checkbox) == 0){
                $iHtml3 .= '<li class="list-group-item" id="return_6m_0">'.$incret.'</li>';
            }
           $iHtml3 .= '</ul>  </div>';
        ...
        $iHtml4 .= '<div class="mob_mf_com col-3 col-md-3 col_0" style="display: block;" id="row_view4_'.$key.'">
            ...
            if(in_array("alpha_ratio", $mf_ratios_checkbox) || count($mf_ratios_checkbox) == 0){
                $iHtml4 .= '<li class="list-group-item" id="performance_alpha_0">'.$alpha.'</li>';
            }     
            if(in_array("sharpe_ratio", $mf_ratios_checkbox) || count($mf_ratios_checkbox) == 0){
                $iHtml4 .= '<li class="list-group-item" id="performance_sharpe_0">'.$sharpe.'</li>';
            }     
            if(in_array("sortino", $mf_ratios_checkbox) || count($mf_ratios_checkbox) == 0){
                $iHtml4 .= '<li class="list-group-item" id="performance_sortino_0">'.$sortino.'</li>';
            } 
            if(in_array("beta", $mf_ratios_checkbox) || count($mf_ratios_checkbox) == 0){
                $iHtml4 .= '<li class="list-group-item" id="performance_beta_0">'.$beta.'</li>';
            }
            if(in_array("standard_deviation", $mf_ratios_checkbox) || count($mf_ratios_checkbox) == 0){
                $iHtml4 .= '<li class="list-group-item" id="performance_stand_dev_0">'.$sd.'</li>';
            }
        ...
        <div class="container">
            ...
            <div class="row Search_Here" style="margin-top: 20px;">
                  <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" >
                    <form method="get" action="" id="comp_sch" onsubmit="return formValidation();">
                      <div class="input-group row">
                        <div class="col-sm-8 text-center" style="padding-right: 0px;">
                            <h3>{{$name}}</h3>
                        </div>
                        <div class="col-sm-4 text-right" style="padding-left: 0px;">
                            <?php if(count($result) > 1) { ?>
                                <a href="{{route('frontend.mf_download_saved_file',['id'=>$mf_scanner_saved_id])}}" class="btn btn-success btn-sm downloadButton">
                                    Download
                                </a>
                                <a href="javascript:history.back()" class="btn btn-success btn-sm savedButton">
                                    Back
                                </a> 
                            <?php } ?>
                        </div> 
        ...
        <div id="show_page" class="d_none" style="display: block;">
            <div class="area_wrap_mob">
                ...
                <div class="row" id="comparison_basic" style="padding-top: 1.5rem;">
                  ...
                  <div class="col-2 col-md-2 comparison_bodyP1">
                    <ul class="list-group">
                      <li class="list-group-item">Inception Date</li>
                      <li class="list-group-item">Fund Type</li>
                      <li class="list-group-item">Fund Manager</li>
                      <li class="list-group-item">AUM (in Rs. Cr)</li>
                      <li class="list-group-item">Benchmark Index</li>
                      <li class="list-group-item">Expense Ratio (%)</li>
                      <li class="list-group-item">Exit Load (%)</li>
                      <li class="list-group-item">Latest NAV</li>
                    </ul>                       
                  </div>
                ...
                <div class="row" id="comparison_return">
                  ...
                  <div class="col-2 col-md-2 comparison_bodyP1">
                      <ul class="list-group">
                        ...
                        <li class="list-group-item">3 Month</li>
                        <li class="list-group-item">6 Month</li>
                        <li class="list-group-item">1 Year</li>
                        <li class="list-group-item">2 Year</li>
                        <li class="list-group-item">3 Year</li>
                        <li class="list-group-item">5 Year</li>
                        <li class="list-group-item">10 Year</li>
                        <li class="list-group-item">Since Inception</li>
                      </ul>                       
                  </div>
                  <div class="col-10 col-md-10 comparison_bodyP2">
                    <div class="row">
                ...
                <div class="row" id="comparison_performance_measures">
                  ...
                  <div class="col-2 col-md-2 comparison_bodyP1">
                    <ul class="list-group">
                      <li class="list-group-item">Alpha Ratio</li>
                      <li class="list-group-item">Sharpe Ratio</li>
                      <li class="list-group-item">Sortino</li>
                      <li class="list-group-item">Beta</li>
                      <li class="list-group-item">Standard Deviation</li>
                    </ul>                       
                  </div>
                  <div class="col-10 col-md-10 comparison_bodyP2">
                    <div class="row">
                ...
                <div class="row" id="comparison_portfolio_attributes">
                  ...
                  <div class="col-2 col-md-2 comparison_bodyP1">
                    <ul class="list-group">
                      <li class="list-group-item">Portfolio P/B Ratio</li>
                      <li class="list-group-item">Portfolio P/E Ratio</li>
                      <li class="list-group-item">Dividend Yield</li>
                      <li class="list-group-item">Turnover Ratio (%)</li>
                      <li class="list-group-item">No. of Stocks</li>
                      <li class="list-group-item">Avg Mkt Cap (Rs Cr)</li>
                      <li class="list-group-item">Large Cap (%)</li>
                      <li class="list-group-item">Mid Cap (%)</li>
                      <li class="list-group-item">Small Cap (%)</li> 
                      <li class="list-group-item">Average Maturity</li> 
                      <li class="list-group-item">Modified Duration</li> 
                      <li class="list-group-item">YTM (%)</li> 
                      <li class="list-group-item">Sovereign Rating</li> 
                      <li class="list-group-item">AAA Rated</li> 
                      <li class="list-group-item">AA Rated</li> 
                      <li class="list-group-item">A Rated</li> 
                ...
                <div class="row" id="comparison_portfolio_market" style="display:none;">
                    ...
                    <div class="col-2 col-md-2 comparison_bodyP1">
                        <ul class="list-group">
                          <li class="list-group-item avgMkCap">Sector 1</li>                               
                          <li class="list-group-item avgMkCap">Sector 2</li>                               
                          <li class="list-group-item avgMkCap">Sector 3</li>                               
                        </ul>                       
                    </div>
                    <div class="col-10 col-md-10 comparison_bodyP2">
                        <div class="row">
                ...
                <div class="row" id="comparison_top_10_holdings">
                    ...
                    <div class="col-2 col-md-2 comparison_bodyP1">
                        <ul class="list-group">
                          <li class="list-group-item">Holding 1</li>
                          <li class="list-group-item">Holding 2</li>
                          <li class="list-group-item">Holding 3</li>
                          <li class="list-group-item">Holding 4</li> 
                          <li class="list-group-item">Holding 5</li>  
                          <li class="list-group-item">Holding 6</li>  
                          <li class="list-group-item">Holding 7</li>  
                          <li class="list-group-item">Holding 8</li>  
                          <li class="list-group-item">Holding 9</li>  
                          <li class="list-group-item">Holding 10</li>                                 
                        </ul>                       
                    </div>
                    <div class="col-10 col-md-10 comparison_bodyP2">
                        <div class="row">
