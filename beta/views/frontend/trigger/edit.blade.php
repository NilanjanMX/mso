...
@section('js_after')
    ...
    <script type="text/javascript">
        ...
        if(detail){
            if(detail.trigger_type == "nav-trigger"){
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        scheme_list.forEach(function(val){
                            selected = "";
                            if(val.schemecode == detail.scheme){
                                selected = "selected";
                            }
                            iHtml = iHtml+`<option value="`+val.schemecode+`" `+selected+`>`+val.s_name+`</option>`;
                        });
            ...
            }else if(detail.trigger_type == "index-trigger"){
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        index_list.forEach(function(val){
                            selected = "";
                            if(val.index_code == detail.select_index){
                                selected = "selected";
                            }
                            iHtml = iHtml+`<option value="`+val.index_code+`" `+selected+`>`+val.index_name+`</option>`;
                        });
            ...
            }else if(detail.trigger_type == "aum-trigger"){
                ...
                if(detail.specific_aum == "Scheme AUM"){
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            ...
                            fund_house_list.forEach(function(val){
                                selected = "";
                                if(val.amc_code == detail.select_amc){
                                    selected = "selected";
                                }
                                iHtml = iHtml+`<option value="`+val.amc_code+`" `+selected+`>`+val.fund+`</option>`;
                            });
            ...
            }else if(detail.trigger_type == "category-performance-trigger"){
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        category_list.forEach(function(val){
                            ...
                            selected = "";
                            if(val.classcode == detail.category_id){
                                selected = "selected";
                            }
                            iHtml = iHtml+`<option value="`+val.classcode+`" `+selected+`>`+category_name+`</option>`;
                        });
                ...
                plan_list.forEach(function(val){
                    ...
                    selected = "";
                    if(val.plan_code == detail.plan_id){
                        selected = "selected";
                    }
                    iHtml = iHtml+`<option value="`+val.plan_code+`" `+selected+`>`+val.planname+`</option>`;
                });
                document.getElementById("plan_id").innerHTML = iHtml;
                ...
                return_list.forEach(function(val){
                    selected = "";
                    if(val.key_name == detail.period_id){
                        selected = "selected";
                    }
                    iHtml = iHtml+`<option value="`+val.key_name+`" `+selected+`>`+val.name+`</option>`;
                });
            ...
            }else if(detail.trigger_type == "scheme-performance-trigger"){
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        ...
                        mf_scheme_list.forEach(function(val){
                            selected = "";
                            if(val.schemecode == detail.mf_scheme){
                                selected = "selected";
                            }
                            iHtml = iHtml+`<option value="`+val.schemecode+`" `+selected+`>`+val.s_name+`</option>`;
                        });
            ...
            }else if(detail.trigger_type == "quants-trigger"){
                ...
                quant_list.forEach(function(val){
                    selected = "";
                    if(val.key_name == detail.select_quant){
                        selected = "selected";
                    }
                    iHtml = iHtml+`<option value="`+val.key_name+`" `+selected+`>`+val.name+`</option>`;
                });
            ...
            }else if(detail.trigger_type == "scheme-performance-advance-trigger"){
                $.ajax({
                    url: "{{ url('/trigger/get-data') }}",
                    method: 'get',
                    data: {"type":5},
        ...
        changeTriggerValue('{{$detail->trigger_value}}');
...
<section class="main-sec bodyResponsive">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <form action="{{route('frontend.trigger_update')}}" method="post" onsubmit="return formValidation();">
                        @csrf
                        ...
                        <div class="triggerSetting newTrigger newTriggerFormSetup">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="trigger_name" placeholder="Trigger Name" name="trigger_name" value="{{$detail->trigger_name}}" maxlength="40">
                                      ...
                                      <div class="tiggerListDrop">
                                        <select class="form-control" id="trigger_type" name="trigger_type" onchange="changeTriggerType()">
                                            @foreach($trigger_list as $key=>$value)
                                                <option value="{{$value->type}}" @if($detail->trigger_type == $value->type) selected="selected" @endif>{{$value->name}}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="tiggerListDrop">
                                            <select class="form-control" id="specific_aum" name="specific_aum" onchange="changeSpecificAMC()">
                                                <option value="Scheme AUM" @if($detail->specific_aum == "Scheme AUM") selected="selected" @endif>Scheme AUM</option>
                                                <option value="AMC AUM" @if($detail->specific_aum == "AMC AUM") selected="selected" @endif>AMC AUM</option>
                                            </select>
                            ...
                            <div class="row"  id="scheme_id_div" style="display: none;">
                                <div class="col-md-12">
                                    <div class="form-group">
                            ...
                            <div class="row" id="period_id_div" style="display: none;">
                                <div class="col-md-12">
                                    <div class="form-group">
                                      ...
                                      <div class="tiggerListDrop">
                                        <select class="form-control schemecode_id" id="period_id" name="period_id" onchange="changeValue('period_id');">
                                            <option value="">Select</option>
                            ...
                            <div class="row" id="investment_date_div" style="display: none;">
                                <div class="col-md-12">
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" id="investment_date" placeholder="" name="investment_date" value="{{$detail->specific_aum}}">
                            ...
                            <div class="row" id="current_nav_div">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="current_nav" placeholder="Value" name="current_nav" value="{{$detail->current_nav}}" readonly>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="formCheeck triggerValueOption">
                                                                <label class="displaySettionRadio">
                                                                    <input type="radio" name="trigger_value" id="trigger_value_amount" value="2" onchange="changeTriggerValue(2);" @if($detail->trigger_value =="2") checked="checked" @endif >
                                                ...
                                                <div class="formCheeckAll">
                                                    <div class="formCheeck">
                                                        <div class="form-group">
                                                            <div class="formCheeck triggerValueOption">
                                                                <label class="displaySettionRadio">
                                                                    <input type="radio" name="trigger_value" id="trigger_value_percentage" value="1" onchange="changeTriggerValue(1);" @if($detail->trigger_value =="1") checked="checked" @endif>
                                                                    <span class="checkmark"></span>
                                                                </label>
                                ...
                                <div class="col-md-6">
                                    <div id="trigger_value_amount_div">
                                        <div class="form-group">
                                            ...
                                            <div class="tiggerListDrop">
                                                <select class="form-control" id="trigger_condition" name="trigger_condition" onchange="changeValue('trigger_condition');">
                                                    <option value="">Select</option>
                                                    <option value="1" @if($detail->trigger_condition =="1") selected="selected" @endif>Greater Than Equal To</option>
                                                    <option value="2" @if($detail->trigger_condition =="2") selected="selected" @endif>Less Than Equal To</option>
                                                </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="amount" placeholder="Value" name="amount" onkeyup="changeValue('amount');" value="{{$detail->amount}}">
                                            <em id="amount_em"></em>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div id="trigger_value_percentage_div">
                                        <div class="form-group">
                                          <label for="text" class="radioTitle">Enter Purchase/Base <span id="base_nav_span">NAV</span></label>
                                          <input type="text" class="form-control" id="base_nav" placeholder="Value" name="base_nav" onkeyup="changeValue('base_nav');" value="{{($detail->base_nav)?$detail->base_nav:$detail->current_nav}}">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <div class="formCheeckAll inDecForm">
                                                    <div class="formCheeck">
                                                        <div class="form-group">
                                                            <div class="formCheeck triggerValueOption">
                                                                <label class="displaySettionRadio">
                                                                    <input type="radio" name="increase_decrease" id="increase_decrease_i" value="1" checked="checked" onchange="changeValue('increase_decrease');" @if($detail->increase_decrease =="1") checked="checked" @endif>
                                                                    <span class="checkmark"></span>
                                                                </label>
                                                    ...
                                                    <div class="formCheeck">
                                                        <div class="form-group">
                                                            <div class="formCheeck triggerValueOption">
                                                                <label class="displaySettionRadio">
                                                                    <input type="radio" name="increase_decrease" id="increase_decrease_d" value="2" onchange="changeValue('increase_decrease');" @if($detail->increase_decrease =="2") checked="checked" @endif>
                                                                    <span class="checkmark"></span>
                                                                </label>
                                            ...
                                            <input type="text" class="form-control" id="appreciation" placeholder="Percentage Value" name="appreciation"  onkeyup="changeValue('appreciation');" value="{{$detail->appreciation}}" onkeypress="return isOnlyNumber(event)">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control h-auto" rows="3" id="remarks" name="remarks" placeholder="" maxlength="200" style="margin-bottom: 0px;" onkeyup="changeRemarks();">{{$detail->remarks}}</textarea>
                                        <div style="text-align: right;margin-bottom: 25px;font-weight: bold;" id="remarks_count_div">{{strlen($detail->remarks)}}/200</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="triggerSetting newTrigger">
                            <div class="uploadedLogoBtn triggerSettingBtn triggerBtnInline">
                                <a href="{{url('/trigger/list')}}" class="btn banner-btn whitebg">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cancel&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
                                <button type="submit" class="btn banner-btn">Update Trigger</button>
                            </div>
                        </div>
                    </form>
                </div>
