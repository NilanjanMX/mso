                            ...
                            <div class="card planCard cartCard oldCart pl-0">
                                <table class="cartTable cartTableProduct">
                                  ...
                                  <tr>
                                    ...
                                    <!--</td>-->
                                    <td>
                                        <div class="productTotalPrice">₹{{number_format((float)$total_price_per_user_with_discount, 2, '.', '')}}</div>
                                    </td>
                                  </tr>
                                  <tr>
                                    <td colspan="2">
                                ...
                                <table class="cartTable cartTableCoupon">
                                  ...
                                  <tr style="border: 1px solid #ddd;">
                                    ...
                                    <td>
                                        <form action="{{route('frontend.membership_renewal_payment')}}" method="post" style="height: 100%;">
                                            @csrf()
                                            <input type="hidden" name="package_id" value="{{$package_id}}">
                                            <input type="hidden" name="total_user" value="{{$user->number_user}}">
                                            <input type="hidden" name="total_amount" value="{{number_format((float)($total_price_per_user_with_discount - $coupon_price)*1.18, 2, '.', '')}}" id="total_amount">
...
<script type="text/javascript">
    ...
    var g_total_amount = "{{$total_price_per_user_with_discount - $coupon_price}}";
    ...
    function change_wallet_amount(){
        ...
        if(wallet_amount){
            ...
            document.getElementById('total_gst_price_id').innerHTML = "₹"+total_gst_amount.toFixedNoRounding(2);
