...
<section class="main-sec styleNew">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                <h3 class="smalllineHeading">Future Value of Lump sum Investment</h3>
                
                    @include('frontend.calculators.common_bio')
                    <br>
                    <form class="js-validate-form" action="{{route('frontend.futureValueOfLumpsumInvestment_output')}}" method="post">
                        <div class="card sip-calculator singleLineHolder calculatorFormShape">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control maxtwodigit {{ $errors->has('period') ? ' is-invalid' : '' }}" name="period" value="{{old('period', $data['period'])}}"  >
                                    <div class="cal-icon">
                                        Yrs
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="offset-1 col-sm-10">
                                        <div class="calcBelowBtn">
                                            ...
                                            @if(session()->get('future_value_of_lump_sum_investment_form_id'))
                                                <button type="button" onclick="location.reload();" class="btn banner-btn whitebg mx-3"> Reset</button>
                                            @else
                                                <a href="{{route('frontend.futureValueOfLumpsumInvestment')}}" class="btn banner-btn whitebg mx-3"> Reset</a>
                                            @endif
                                                <button class="btn banner-btn mx-3">Calculate</button>
                                        </div>
                                    </div>
