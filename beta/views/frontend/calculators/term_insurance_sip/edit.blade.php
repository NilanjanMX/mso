...
<section class="main-sec styleNew">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                <h3 class="smalllineHeading">Term Insurance + SIP</h3>
                
                    @include('frontend.calculators.common_bio')
                    <br>
                    <form class="js-validate-form" action="{{route('frontend.termInsuranceSIP_output')}}" method="post">
                        <div class="card sip-calculator singleLineHolder calculatorFormShape">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control {{ $errors->has('annual_investment') ? ' is-invalid' : '' }}" name="annual_investment" value="{{old('annual_investment', isset($data['annual_investment'])?$data['annual_investment']:'')}}" maxlength="10"  required>
                                    <div class="cal-icon">
                                        ₹
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control {{ $errors->has('term_insurance_sum_assured') ? ' is-invalid' : '' }}" name="term_insurance_sum_assured" value="{{old('term_insurance_sum_assured', isset($data['term_insurance_sum_assured'])?$data['term_insurance_sum_assured']:'')}}" maxlength="10"  required>
                                    <div class="cal-icon">
                                        ₹
                                    </div>
                        ...
                        <div class="card sip-calculator singleLineHolder calculatorFormShape">
                            <div class="form-group row">
                                ...
                                <label class="sqarecontainer" style="margin: 8px 0 0 0;">
                                    <input id="is_client" type="checkbox" name="client" value="1" @if(isset($form_data['client']) && $form_data['client']=='1') checked  @endif> 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="offset-1 col-sm-10">
                                    <div class="calcBelowBtn">
                                            ...
                                            @if(session()->get('termInsuranceSIP_form_id'))
                                                <button type="button" onclick="location.reload();" class="btn banner-btn whitebg mx-3"> Reset</button>
                                            @else
                                                <a href="{{route('frontend.termInsuranceSIP')}}" class="btn banner-btn whitebg mx-3"> Reset</a>
                                            @endif
                                            <button class="btn banner-btn mx-3">Calculate</button>
                                    </div>
                                </div>
