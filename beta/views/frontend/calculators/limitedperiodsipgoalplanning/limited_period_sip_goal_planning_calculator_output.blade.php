                ...
                var data = google.visualization.arrayToDataTable([
                    ...
                    @for($i=1;$i<=$sip_period+$deferment_period;$i++)
                        @php
                            ...
                            if($i<=$sip_period){
                                $investment1 = $investment1 + $senario1_monthly_sip_amount*12;
                                $investment2 = $investment2 + $senario2_monthly_sip_amount*12;
                            }
    
                            $vaiue1 = round($previous_amount_int1);
                            $vaiue2 = round($previous_amount_int2);
                            $investment1 = round($investment1);
                            $investment2 = round($investment2);
                        @endphp
                        ['<?php echo $i;?>',<?php echo $investment1;?>,<?php echo $vaiue1;?>,<?php echo $investment2;?>,<?php echo $vaiue2;?>],
                    @endfor
                ]);
                ...
                var data = google.visualization.arrayToDataTable([
                    ...
                    @for($i=1;$i<=$sip_period+$deferment_period;$i++)
                        @php
                            ...
                            $investment1 = round($investment1);
                        @endphp
                        ['<?php echo $i;?>',<?php echo $investment1;?>,<?php echo $vaiue1;?>],
                    @endfor
                ]);
