...
<main class="mainPdf">
    ...
    <div style="padding: 0 0%;">
        <h1 class="pdfTitie">Limited Period
            SIP @if(isset($clientname)) Proposal <br> For {{$clientname?$clientname:''}} @else Need Based Calculator @endif</h1>
        ...
        <table class="table text-center">
            ...
            @if(isset($interest2))
                ...
                <tr>
                    <td>
                        <strong><span
                                    class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($senario1_monthly_sip_amount)}}
                        </strong>
                    </td>
                    <td>
                        <strong><span
                                    class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($senario2_monthly_sip_amount)}}
                        </strong>
                    </td>
                </tr>
            @else
                <tr>
                    <td >
                        <strong>
                            <span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($senario1_monthly_sip_amount)}}
                        </strong>
                    </td>
                </tr>
            @endif
    ...
    @endif
    @if(!isset($interest2))
        <div style="padding: 0 00%;">
    @endif
    <h1 class="pdfTitie">Total
        Investment</h1>
    <div class="roundBorderHolder">
        <table class="table text-center">
            <tbody>
            @if(isset($interest2))
                ...
                <tr>
                    <td>
                        <strong><span
                                    class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($senario1_totalinvestment)}}
                        </strong>
                    </td>
                    <td>
                        <strong><span
                                    class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($senario2_totalinvestment)}}
                        </strong>
                    </td>
                </tr>
            @else
                <tr>
                    <td>
                        <strong>
                        <span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($senario1_totalinvestment)}}
                        </strong>
                    </td>
                </tr>
            @endif
            ...
            <table>
                ...
                @if(isset($interest2))
                                ...
                                @for($i=1;$i<=$sip_period+$deferment_period;$i++)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($i<=$sip_period)
                                                <span class="pdfRupeeIcon">&#8377;</span> {{$senario1_monthly_sip_amount?custome_money_format($senario1_monthly_sip_amount*12):0}}
                                            @else
                                                --
                                            @endif
                                        </td>
                                        <td>
                                            <span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($previous_amount_int1)}}
                                        </td>
                                        <td>
                                            @if($i<=$sip_period)
                                                <span class="pdfRupeeIcon">&#8377;</span> {{$senario2_monthly_sip_amount?custome_money_format($senario2_monthly_sip_amount*12):0}}
                                            @else
                                                --
                                            @endif
                                        </td>
                                        <td>
                                            <span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($previous_amount_int2)}}
                                        </td>
                                    </tr>
                ...
                @else
                    <tr>
                        ...
                        <th style="background:{{$address_color_background}}">Annual Investment</th>
                        <th style="background:{{$address_color_background}}">Year End Value @ {{$interest1?number_format($interest1, 2, '.', ''):0}} %</th>
                    </tr>
                    @php
                        $previous_amount_int1 = $amount;
                    @endphp
