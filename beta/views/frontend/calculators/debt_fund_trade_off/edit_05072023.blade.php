                    ...
                    <div class="card sip-calculator singleLineHolder calculatorFormShape">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input fixed_deposit_chk" type="radio" name="selectType" onchange="TurnOnSip('sipInv')"  checked value="1">
                        ...
                        <div id="sip">
                            <div>        
                                    ...
                                    <input class="form-check-input fixed_deposit_chk" type="radio" name="enter_loan_details" value="2"  onchange="TurnOnOption('one')" checked>
                                </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <input id="inv1" type="text" name="units" class="form-control" value="{{isset($data['units'])?$data['units']:''}}" readonly>
                                            </div>
                                            <div class="cal-icon">
                                                Unit
                                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="d-flex align-items-center">
                                            <input id="market1" type="text" name="nav" class="form-control" value="{{isset($data['nav'])?$data['nav']:''}}" readonly>
                                        </div>
                                        <div class="cal-icon">
                                            ₹
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="d-flex align-items-center">
                                            <input id="redeem1" type="text" name="redeem1" class="form-control" value="{{isset($data['redeem1'])?$data['redeem1']:''}}" onChange="checkTotalDiffNew()" autocomplete="off" readonly>
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="d-flex align-items-center">
                                            <input id="cnav" type="text" name="currentnav" class="form-control" value="{{isset($data['currentnav'])?$data['currentnav']:''}}" readonly>
                                        </div>
                                        <div class="cal-icon">
                                            ₹
                                        </div>
