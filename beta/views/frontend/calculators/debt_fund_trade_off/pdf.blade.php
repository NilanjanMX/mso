...
<main class="mainPdf">
    <div style="padding: 0 0%;">
        <h1 class="pdfTitie">Debt Fund (Hold/Sell) Benefit Calculation @if(isset($clientname) && !empty($clientname)) <br> For {{$clientname?$clientname:''}}  @else  @endif</h1>
            ...
            @if($formType == 1)
                ...
                @if($taxation != "Long Term")
                    <h1 class="pdfTitie">If investment is redeemed TODAY</h1>
                @endif
                ...
                <h1 class="pdfTitie">If investment is redeemed on {{$mainThreeYears}}<br/>
                i.e., after  {{$remainingDays}} days, it will qualify as LTCG giving you benefit of Long Term Taxation</h1>
                ...
                <h1 class="pdfTitie">If the redemption is made on {{$mainThreeYears}} <br/> 
                i.e., after  {{$remainingDays}} days, the effective post-tax yield for the remaining period of investment will be {{sprintf('%0.2f', $irr)}} %.</h1>
                @endif
                @else
                @php
                ...
                <h1 class="pdfTitie">If the investment horizon is increased from {{$invyear}} Year {{$invmonth}} Mnths to {{$after}} Years<br>
                effective post-tax yield for the additional {{$bd38-$bd39}} month's period of investment will be {{sprintf('%0.2f', $irrBal)}} %.</h1>
    ...
    @php
        $note_data1 = \App\Models\Calculator_note::where('category','cashflow')->where('calculator','debt_fund')->first();
    @endphp
    @if(!empty($note_data1))
