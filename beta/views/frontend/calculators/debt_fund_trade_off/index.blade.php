                        ...
                        <div class="card sip-calculator singleLineHolder calculatorFormShape">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-check form-check-inline">
                                        <label class="checkLinecontainer mb-0" for="TurnOnSip_sipInv">Existing Investment
                                            <input class="form-check-input fixed_deposit_chk sipInvcheck" id="TurnOnSip_sipInv" type="radio" name="selectType" onchange="TurnOnSip('sipInv')"  checked value="1">
                                            <span class="checkmark"></span>
                                        </label> 
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <label class="checkLinecontainer mb-0" for="TurnOnSip_emiInv">New Investment
                                            <input class="form-check-input fixed_deposit_chk" type="radio" id="TurnOnSip_emiInv" name="selectType" value="2"  onchange="TurnOnSip('emiInv')" >
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div id="sip">
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <div class="form-check form-check-inline">
                                                <label class="checkLinecontainer mb-0" for="TurnOnOption_one">Option 1
                                                    <input class="form-check-input fixed_deposit_chk" type="radio" id="TurnOnOption_one" name="enter_loan_details" value="2"  onchange="TurnOnOption('one')" checked>
                                                    <span class="checkmark"></span>
                                                </label> 
                                            </div>
                                    ...
                                    <div id="option1">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-5 col-form-label" id="monthly_emi">Purchase Date</label>
                                            <div class="col-sm-7">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-5 col-form-label">Investment Amount</label>
                                            <div class="col-sm-7">
                                                <div class="d-flex align-items-center">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-5 col-form-label">Redemption Date</label>
                                            <div class="col-sm-7">
                                                <div class="d-flex align-items-center">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-5 col-form-label">Current Market Value</label>
                                            <div class="col-sm-7">
                                                <div class="d-flex align-items-center">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12">
                                                <div class="form-check form-check-inline">
                                                    <label class="checkLinecontainer mb-0" for="TurnOnOption_two">Option 2
                                                        <input class="form-check-input fixed_deposit_chk" type="radio" id="TurnOnOption_two" name="enter_loan_details" value="2"  onchange="TurnOnOption('two')" >
                                                        <span class="checkmark"></span>
                                                    </label> 
                                                </div>
                                            </div>
                                    ...
                                    <div id="option2">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="d-flex align-items-center">
                                                    <input type="text" id="pdate1" name="purchase1" class="form-control" value="" onChange="checkTotalDiffNew()" autocomplete="off" disabled="disabled">
                                                    </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-5 col-form-label">No. of Units</label>
                                            <div class="col-sm-7">
                                                <div class="d-flex align-items-center">
                                                    
                                                    <input id="inv1" type="text" name="units" class="form-control" value="">
                                                </div>
                                                <div class="cal-icon">
                                                    Unit
                                                </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-5 col-form-label">Purchase NAV</label>
                                            <div class="col-sm-7">
                                                <div class="d-flex align-items-center">
                                                    <input id="market1" type="text" name="nav" class="form-control" value="">
                                                </div>
                                                <div class="cal-icon">
                                                    ₹
                                                </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <div class="d-flex align-items-center">
                                                    <input id="redeem1" type="text" name="redeem1" class="form-control" value="" onChange="checkTotalDiffNew()" autocomplete="off">
                                                </div>
                                                
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-5 col-form-label">Current Nav</label>
                                            <div class="col-sm-7">
                                                <div class="d-flex align-items-center">
                                                    <input id="cnav" type="text" name="currentnav" class="form-control" value="">
                                                </div>
                                                <div class="cal-icon">
                                                    ₹
                                                </div>
                                    ...
                                    <br/>
                                    <div class="form-group row">
                                        <label class="col-sm-5 col-form-label">LTCG Applicable After</label>
                                        <div class="col-sm-7">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-5 col-form-label">Applicable Taxation</label>
                                        <div class="col-sm-7">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-5 col-form-label">Assumed Indexation Rate</label>
                                        <div class="col-sm-7">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-5 col-form-label">Expected Return For Remaining Period</label>
                                        <div class="col-sm-7">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-5 col-form-label">Applicable Short Term Tax Rate</label>
                                        <div class="col-sm-7">
                                            <div class="d-flex align-items-center">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-5 col-form-label">Applicable Long Term Tax Rate</label>
                                        <div class="col-sm-7">
                                            <div class="d-flex align-items-center">
                            ...
                            <div id="emi">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-5 col-form-label" id="monthly_emi">Initial Investment</label>
                                    <div class="col-sm-7">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-5 col-form-label">Applicable Long Term Tax Rate
                                    </label>
                                    <div class="col-sm-7">
                                        <div class="row">
                                                <div class="col-sm-6">
                                            ...
                                            %
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <lable class="col-form-label mr-3">After</lable>&nbsp;
                                        ...
                                        <div class="col-sm-7">
                                            ...
                                            Yrs
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="cal-icon" style="width: 82px;">
                                                Months
                                            </div>
                                                </div>
                                            </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-5 col-form-label"><span>Assumed Inflation Rate for Indexation</span></label>
                                    <div class="col-sm-7">
                                        <div class="d-flex align-items-center">
