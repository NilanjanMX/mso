            ...
            <div class="row">
                <div class="col-md-12 offset-md-0 text-center">
                    ...
                    <div class="outputTableHolder">
                        <h1 class="midheading">Debt Fund (Hold/Sell) Benefit Calculation @if(isset($clientname) && !empty($clientname)) <br> For {{$clientname?$clientname:''}}  @else  @endif</h1>
                            ...
                            @if($formType == 1)
                                ...
                                @if($taxation != "Long Term")
                                    <h1 class="midheading">If investment is redeemed TODAY</h1>
                                @endif
                                ...
                                <h1 class="midheading">If investment is redeemed on {{$mainThreeYears}}<br>
                            ...
                            <h1 class="midheading">@if($formType != 1)  
                            If the investment horizon is increased from {{$invyear}}Year {{$invmonth}} Mnths to {{$after}} Years<br>
                            effective post-tax yield for the additional {{$bd38-$bd39}} month's period of investment will be {{sprintf('%0.2f', $irrBal)}} %. 
                            @else
                            @if($taxation != "Long Term")
                            If the redemption is made on {{$mainThreeYears}} <br> i.e., after  {{$remainingDays}} days, the effective post-tax yield for the remaining period of investment will be {{sprintf('%0.2f', $irr)}} % @endif 
                            @endif</h1>
