        ...
        <div id="content" class="container">
            <div class="row">
                <div class="col-md-12 offset-md-0 text-center">
                    <a href="{{route('frontend.review_of_existing_investment')}}?action=back" class="btn btn-primary btn-round"><i class="fa fa-angle-left"></i> Back</a>
                    ...
                    <div class="outputTableHolder">
                        <h1 class="midheading">Review of Investments @if(isset($client_name) && !empty($clientname) && !empty($clientname)) <br> For {{$client_name}} @endif</h1>
