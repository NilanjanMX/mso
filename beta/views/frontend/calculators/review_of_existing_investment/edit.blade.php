...
@section('js_after')
    ...
    <script>
        ...
        var mutual_fund_index = <?php echo count($mutual_fund_list);?>;
        if(mutual_fund_index){
            mutual_fund_index = mutual_fund_index-1;
        }

        var non_mutual_fund_index = <?php echo count($non_mutual_fund_list);?>;
        if(non_mutual_fund_index){
            non_mutual_fund_index = non_mutual_fund_index-1;
        }

        var insurance_index = <?php echo count($insurance_list);?>;
        if(insurance_index){
            ...
            var iHtml = `<tr id="mutual_fund_tr1`+mutual_fund_index+`">
                            ...
                            <th>
                                <label class="checkcontainer">
                                        <input type="checkbox" name="day1[`+mutual_fund_index+`]" onchange="changeReturnCheckbox('`+mutual_fund_index+`','oneday');" id="oneday`+mutual_fund_index+`">
                                        <span class="checkmark"></span>
                                    </label>
                            </th>
                            <th>
                                <label class="checkcontainer">
                                        <input type="checkbox" name="day7[`+mutual_fund_index+`]" onchange="changeReturnCheckbox('`+mutual_fund_index+`','oneweek');" id="oneweek`+mutual_fund_index+`">
                                        <span class="checkmark"></span>
                                    </label>
                            </th>
                            <th>
                        ...
                        <tr id="mutual_fund_tr2`+mutual_fund_index+`">
                            ...
                            <th colspan="9" class="text-center">Performance</th>
                        ...
                        <tr id="mutual_fund_tr4`+mutual_fund_index+`">
                            ...
                            <td class="text-center" id="day1_`+mutual_fund_index+`"></td>
                            <td class="text-center" id="day7_`+mutual_fund_index+`"></td>
                        ...
                        <tr id="mutual_fund_tr5`+mutual_fund_index+`">
                            ...
                            <td class="text-center" id="category_day1_`+mutual_fund_index+`"></td>
                            <td class="text-center" id="category_day7_`+mutual_fund_index+`"></td>
                    ...
                    <form action="{{route('frontend.review_of_existing_investment_output')}}" method="post" onsubmit="return onsubmitFunction();">
                        <div class="card sip-calculator singleLineHolder calculatorFormShape">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" id="client_name" placeholder="" name="client_name" value="{{$client_name}}">
                                </div>
                            </div>
                            @if(count($mutual_fund_list))
                                <div class="row">
                                    <label class="col-sm-12 col-form-label checkcontainer2">
                                        <input type="checkbox" name="mutual_fund" id="mutual_fund" onchange="changeHeaderCheckBox();" <?php echo (count($mutual_fund_list))?'checked':'';?>> Mutual Fund
                                        <span class="checkmark"></span>
                                    </label>
                                        ...
                                        <div class="table-responsive pt-2">
                                            <div class="roundTable">
                                                <table id="mfTable" class="table table-bordered" cellspacing="0">
                                                    @foreach($mutual_fund_list as $key=>$ress)
                                                        <tbody id="mutual_fund_div" class="spaceless">
                                                            <tr id="mutual_fund_tr10">
                                                                ...
                                                                <th>
                                                                    <label class="checkcontainer">
                                                                        <input type="checkbox" name="day1[{{$key}}]" onchange="changeReturnCheckbox('{{$key}}','oneday');" id="oneday{{$key}}" <?php echo ($ress['day1'] == 1)?'checked':'';?>>
                                                                        <span class="checkmark"></span>
                                                                    </label>
                                                                </th>
                                                                <th>
                                                                    <label class="checkcontainer">
                                                                        <input type="checkbox" name="day7[{{$key}}]" onchange="changeReturnCheckbox('{{$key}}','oneweek');" id="oneweek{{$key}}" <?php echo ($ress['day7'] == 1)?'checked':'';?>>
                                                                        <span class="checkmark"></span>
                                                                    </label>
                                                                </th>
                                                                <th>
                                                                    <label class="checkcontainer">
                                                                        <input type="checkbox" name="month1[{{$key}}]" onchange="changeReturnCheckbox('{{$key}},'onemonth');" id="onemonth{{$key}}" <?php echo ($ress['month1'] == 1)?'checked':'';?>>
                                                                        <span class="checkmark"></span>
                                                                    </label>
                                                                </th>
                                                                <th>
                                                                    <label class="checkcontainer">
                                                                        <input type="checkbox" name="month3[{{$key}}]" onchange="changeReturnCheckbox('{{$key}}','threemonth');" id="threemonth{{$key}}" <?php echo ($ress['month3'] == 1)?'checked':'';?>>
                                                                        <span class="checkmark"></span>
                                                                    </label>
                                                                </th>
                                                                <th>
                                                                    <label class="checkcontainer">
                                                                        <input type="checkbox" name="month6[{{$key}}]" onchange="changeReturnCheckbox('{{$key}}','sixmonth');" id="sixmonth{{$key}}" <?php echo ($ress['month6'] == 1)?'checked':'';?>>
                                                                        <span class="checkmark"></span>
                                                                    </label>
                                                                </th>
                                                                <th>
                                                                    <label class="checkcontainer">
                                                                        <input type="checkbox" name="year1[{{$key}}]" onchange="changeReturnCheckbox('{{$key}}','oneyear');" id="oneyear{{$key}}" <?php echo ($ress['year1'] == 1)?'checked':'';?>>
                                                                        <span class="checkmark"></span>
                                                                    </label>
                                                                </th>
                                                                <th>
                                                                    <label class="checkcontainer">
                                                                        <input type="checkbox" name="year3[{{$key}}]" onchange="changeReturnCheckbox('{{$key}}','threeyear');" id="threeyear{{$key}}" <?php echo ($ress['year3'] == 1)?'checked':'';?>>
                                                                        <span class="checkmark"></span>
                                                                    </label>
                                                                </th>
                                                                <th>
                                                                    <label class="checkcontainer">
                                                                        <input type="checkbox" name="year5[{{$key}}]" onchange="changeReturnCheckbox('{{$key}}','fiveyear');" id="fiveyear{{$key}}" <?php echo ($ress['year5'] == 1)?'checked':'';?>>
                                                                        <span class="checkmark"></span>
                                                                    </label>
                                                                </th>
                                                                <th>
                                                                    <label class="checkcontainer">
                                                                        <input type="checkbox" name="year10[{{$key}}]" onchange="changeReturnCheckbox('{{$key}}','tenyear');" id="tenyear{{$key}}" <?php echo ($ress['year10'] == 1)?'checked':'';?>>
                                                                        <span class="checkmark"></span>
                                                                    </label>
                                                                </th>
                                                                <th>
                                                            ...
                                                            <tr id="mutual_fund_tr40">
                                                                <td>
                                                                    <div class="allocationSegment mfTableCheck">
                                                                        <div class="form-group mb-0">
                                                                            <select class="form-control" id="asset_class{{$key}}" name="asset_class[]" onchange="changeAssetClass(0);">
                                                                                <option value="0">Custom</option>
                                                                                <?php foreach ($assets_list as $key1 => $value) { ?>
                                                                                    <option value="<?php echo $value;?>" <?php echo ($value == $ress['asset_type'])?'selected':'';?>><?php echo $value;?></option>
                                                                                <?php }?>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <td>
                                                                    <div class="form-group mb-0" style="padding:0px;">
                                                                        <select class="form-control ui-autocomplete-input" id="category_id{{$key}}" name="category_id[]" onchange="changeCategory(0);">
                                                                            <option value="0">Custom</option>
                                                                            <?php foreach ($category_list as $key1 => $value) { ?>
                                                                                <option value="<?php echo $value->classcode;?>"  <?php echo ($value->classcode == $ress['classcode'])?'selected':'';?>><?php echo ($value->class_name)?$value->class_name:$value->classname;?></option>
                                                                            <?php }?>
                                                                        </select>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-group mb-0" style="padding:0px;">
                                                                      <select class="form-control ui-autocomplete-input schemecode_id" name="schemecode_id[{{$key}}]" id="schemecode_id{{$key}}" onchange="changeScheme('{{$key}}')" message="MutualFund" datatype="{{$key}}">
                                                                        <option value="">Select</option>
                                                                        <?php foreach ($scheme_list as $key1 => $value) { ?>
                                                                            <option value="<?php echo $value->schemecode;?>" <?php echo ($value->schemecode == $ress['schemecode'])?'selected':'';?>><?php echo $value->s_name;?></option>
                                                                        <?php }?>
                                                                      </select>
                                                                    </div>
                                                                </td>
                                                                <td class="text-center" id="day1_{{$key}}">{{($ress["oneday"])?$ress["oneday"]:"-"}}</td>
                                                                <td class="text-center" id="day7_{{$key}}">{{($ress["oneweek"])?$ress["oneweek"]:"-"}}</td>
                                                                <td class="text-center" id="month1_{{$key}}">{{($ress["onemonth"])?$ress["onemonth"]:"-"}}</td>
                                                                <td class="text-center" id="month3_{{$key}}">{{($ress["threemonth"])?$ress["threemonth"]:"-"}}</td>
                                                                <td class="text-center" id="month6_{{$key}}">{{($ress["sixmonth"])?$ress["sixmonth"]:"-"}}</td>
                                                                <td class="text-center" id="year1_{{$key}}">{{($ress["oneyear"])?$ress["oneyear"]:"-"}}</td>
                                                                <td class="text-center" id="year3_{{$key}}">{{($ress["threeyear"])?$ress["threeyear"]:"-"}}</td>
                                                                <td class="text-center" id="year5_{{$key}}">{{($ress["fiveyear"])?$ress["fiveyear"]:"-"}}</td>
                                                                <td class="text-center" id="year10_{{$key}}">{{($ress["tenyear"])?$ress["tenyear"]:"-"}}</td>
                                                                <td rowspan="2" id="" style="color:red;text-align: center;" onclick="removeSchemecode('{{$key}}');">
                                                                    <i class="fa fa-trash" aria-hidden="true" style="font-size: 18px;"></i>
                                                                </td>
                                                            </tr>

                                                            <tr id="mutual_fund_tr5{{$key}}">
                                                                <td style="height:40px;">
                                                                    <label class="checkcontainer" style="margin-top: -12px;">
                                                                        <input type="checkbox" name="category_checkbox[{{$key}}]" id="category_checkbox{{$key}}" <?php echo ($ress['category_checkbox'] == 1)?'checked':'';?>>
                                                                        <span class="checkmark"></span>
                                                                    </label>
                                                                </td>
                                                                <td class="text-center" id="category_{{$key}}" colspan="2">{{$ress["classname"]}}</td>
                                                                <td class="text-center" id="category_day1_{{$key}}">{{($ress["category_oneday"])?$ress["category_oneday"]:"-"}}</td>
                                                                <td class="text-center" id="category_day7_{{$key}}">{{($ress["category_oneweek"])?$ress["category_oneweek"]:"-"}}</td>
                                                                <td class="text-center" id="category_month1_{{$key}}">{{($ress["category_onemonth"])?$ress["category_onemonth"]:"-"}}</td>
                                                                <td class="text-center" id="category_month3_{{$key}}">{{($ress["category_threemonth"])?$ress["category_threemonth"]:"-"}}</td>
                                                                <td class="text-center" id="category_month6_{{$key}}">{{($ress["category_sixmonth"])?$ress["category_sixmonth"]:"-"}}</td>
                                                                <td class="text-center" id="category_year1_{{$key}}">{{($ress["category_oneyear"])?$ress["category_oneyear"]:"-"}}</td>
                                                                <td class="text-center" id="category_year3_{{$key}}">{{($ress["category_threeyear"])?$ress["category_threeyear"]:"-"}}</td>
                                                                <td class="text-center" id="category_year5_{{$key}}">{{($ress["category_fiveyear"])?$ress["category_fiveyear"]:"-"}}</td>
                                                                <td class="text-center" id="category_year10_{{$key}}">{{($ress["category_tenyear"])?$ress["category_tenyear"]:"-"}}</td>
                                                            </tr>
                                                            <tr id="mutual_fund_tr6{{$key}}">
                                                                <td colspan="13"><textarea style="width: 100%; vertical-align: bottom;" maxlength="500" name="mutual_fund_comment[]" rows="2">{{$ress['comments']}}</textarea></td>
                                                            </tr>
                                                        </tbody>
                                                    @endforeach
                                                </table>
                                            </div>
                                            <div style="position: absolute;top: -5px;left: 0;right: 0;bottom: 0;background-color: black;opacity: 0%;display: none;" id="mutual_fund_over">
                            ...
                            @if(count($non_mutual_fund_list))
                                <div class="row mt-5">
                                    <label class="col-sm-12 col-form-label checkcontainer2">
                                        <input type="checkbox" name="non_mutual_fund" id="non_mutual_fund" onchange="changeHeaderCheckBox();" checked="checked"> Non Mutual Fund
                                        <span class="checkmark"></span>
                                    </label>
                                    ...
                                    <div class="col-md-12">
                                        <div class="table-responsive pt-2">
                                            <div class="roundTable">
                                                <table id="nonMfTable" class="table table-bordered">
                                                    ...
                                                    <tbody id="non_mutual_fund_div" class="">
                                                        @foreach($non_mutual_fund_list as $key => $ress)
                                                            <tr id="non_mutual_fund_tr_{{$key}}">
                                                                <td>
                                                                    <div class="allocationSegment mfTableCheck">
                                                                        <div class="form-group mb-0 mx-1" id="product_id_div0">
                                                                            <select class="form-control" id="product_id{{$key}}" name="product_id[]" onchange="changeProduct('{{$key}}');" message="NonMutualFund" datatype="0">
                                                                                <option value="">Select</option>
                                                                                <option value="0">Custom</option>
                                                                                <?php foreach ($product_list as $key1 => $value) { ?>
                                                                                    <option value="<?php echo $value->id;?>" <?php echo ($value->id == $ress['id'])?'selected':'';?>><?php echo $value->name;?></option>
                                                                                <?php } ?>
                                                                            </select>
                                                                        </div>
                                                                        <div class="form-group mb-0" id="product_name_div{{$key}}" style="display: none;">
                                                                            <textarea style="width: 100%;" id="product_name{{$key}}" maxlength="500" rows="3" name="product_name[]"></textarea>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td><textarea style="width: 100%;" maxlength="500" rows="3" name="non_mutual_fund_comment[]">{{$ress['comments']}}</textarea></td>
                                                                <td id="" style="color:red;text-align: center;" onclick="removeNonMutualFund('{{$key}}');">
                                                                     <i class="fa fa-trash" aria-hidden="true" style="font-size: 18px;"></i> 
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                            ...
                                            <div style="position: absolute;top: 0;left: 0;right: 0;bottom: 0;background-color: black;opacity: 0%;display: none;" id="non_mutual_fund_over">
                            ...
                            @if(count($insurance_list))
                                <div class="row mt-5">
                                    <label class="col-sm-12 col-form-label checkcontainer2">
                                        <input type="checkbox" name="insurance" id="insurance" onchange="changeHeaderCheckBox();" checked="checked"> Insurance
                                        <span class="checkmark"></span>
                                    </label>
                                    ...
                                    <div class="col-md-12">
                                        <div class="table-responsive pt-2">
                                            <div class="roundTable">
                                                <table id="insuranceTable" class="table table-bordered">
                                                    ...
                                                    <tbody id="insurance_view" class="">
                                                        @foreach($insurance_list as $key=>$ress)
                                                            <tr id="insurance_tr_{{$key}}">
                                                                <td>
                                                                    <div class="allocationSegment mfTableCheck">
                                                                        <div class="form-group mb-0 mx-1" id="product_type_id_div{{$key}}">
                                                                            <select class="form-control" id="product_type_id{{$key}}" name="product_type_id[]" onchange="changeProductType('{{$key}}');" message="Insurance" datatype="{{$key}}">
                                                                                 <option value="">Select</option> 
                                                                                <option value="0">Custom</option>
                                                                                <?php foreach ($product_type_list as $key1 => $value) { ?>
                                                                                    <option value="<?php echo $value->id;?>" <?php echo ($value->id == $ress['id'])?'selected':'';?>><?php echo $value->name;?></option>
                                                                                <?php } ?>
                                                                            </select>
                                                                            <!--<b class="schemeSelectNotch"></b>-->
                                                                        </div>
                                                                        <div class="form-group mb-0" id="product_type_name_div{{$key}}" style="display: none;">
                                                                            <textarea style="width: 100%;" id="product_type_name{{$key}}" maxlength="500" rows="3" name="product_type_name[]"></textarea>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td><textarea style="width: 100%;" maxlength="500" rows="3" name="insurance_user[]">{{$ress['user']}}</textarea></td>
                                                                <td><textarea style="width: 100%;" maxlength="500" rows="3" name="insurance_comment[]">{{$ress['comments']}}</textarea></td>
                                                                <td id="" style="color:red;text-align: center;" onclick="removeInsurance('{{$key}}');">
                                                                     <i class="fa fa-trash" aria-hidden="true" style="font-size: 18px;"></i> 
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                            ...
                                            <div style="position: absolute;top: 0;left: 0;right: 0;bottom: 0;background-color: black;opacity: 0%;display: none;" id="insurance_over">
                            ...
                            <div class="form-group row">
                                <div class="offset-1 col-sm-10">
                                    <div class="calcBelowBtn pt-4">
                                        ...
                                        @else
                                            <a href="{{route('frontend.review_of_existing_investment')}}" class="btn banner-btn whitebg mx-3"> Reset</a>
                                        @endif
