        ...
        <div id="content" class="container">
            <div class="row">
                <div class="col-md-8 offset-md-2 text-center">
                    <a href="{{route('frontend.swp_periodic_withdrawal')}}" class="btn btn-primary btn-round"><i class="fa fa-angle-left"></i> Back</a>
                    ...
                    <a href="{{route('frontend.swp_periodic_withdrawal_output_pdf')}}" target="_blank" id="cmd" class="btn btn-primary btn-round">Download / Print</a>
                    @else
