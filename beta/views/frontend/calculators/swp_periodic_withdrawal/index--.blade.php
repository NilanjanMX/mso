...
@section('js_after')
    ...
    var invType = 1;
        ...
        //         },
        //         messages: {
        //             initial : "Please enter a value between ₹100-₹9,99,99,999",
  ...
  e.value = (t.indexOf(".") >= 0) ? (t.substr(0, t.indexOf(".")) + t.substr(t.indexOf("."), 3)) : t;
        ...
        var csam = window.setInterval(function()
        {
           ...
           // var swptp = document.getElementById("swptype").value;
            var form = $("#emi");
            var url = "/premium-calculator/periodicCheck";
            $.ajax({
                type: "POST",
                crossDomain: true,
                url: url,
                ...
                <div class="col-md-12">
                    ...
                    <div class="card sip-calculator sip-calculator__modify">
                        ...
                        <div class="card-body">
                                ...
                                <!--            <input class="form-check-input fixed_deposit_chk" type="radio" name="enter_loan_details" onchange="TurnOnSip('sipInv')"  checked value="1">-->
                            ...
                            <form id="emi" style="display:block;" enctype="multipart/form-data" method="post" class="js-validate-form" action="{{route('frontend.swp_periodic_withdrawal_output')}}" name="recover_emis_through_sip_form">
                                @csrf
                                <input type="hidden" name="formType" value="2" />
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label">Custom Calculator Header
                                    </label>
                                    <div class="col-sm-8">
                                        <div class="row">
                                                <div class="col-sm-2">
                                            ...
                                            <select name="headertype" id="cus" class="form-control">
                                             ...
                                             <option value="2">Yes</option>
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        &nbsp;
                                                        <input type="text" class="form-control" id="aft" name="details" value="" maxlength=30>
                                                    </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label">Current Age (optional)
                                    </label>
                                    <div class="col-sm-8">
                                        <div class="row">
                                                <div class="col-sm-12">
                                                  <div class="d-flex align-items-center">
                                            <input type="text" class="form-control pr-2 mr-1 maxtwodigit " name="currentage" value="" maxlength="2">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="form-check">
                                            <input class="form-check-input fixed_deposit_chk" type="radio" name="investmentmode" onchange="invest(1)"  checked value=1>
                                            <label class="form-check-label" for="inlineRadio1">Lumpsum</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input fixed_deposit_chk" type="radio" name="investmentmode" value=2  onchange="invest(2)" >
                                            <label class="form-check-label" for="inlineRadio2">Annual Lumpsum</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input fixed_deposit_chk" type="radio" name="investmentmode" value=3  onchange="invest(3)" >
                                            <label class="form-check-label" for="inlineRadio2">SIP</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input fixed_deposit_chk" type="radio" name="investmentmode" value=4  onchange="invest(4)" >
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <div class="form-group row">
                                    <label class="col-sm-4 col-form-label">Monthly SIP Amount
                                    </label>
                                    <div class="col-sm-8">
                                        <div class="row">
                                                <div class="col-sm-12">
                               ...
                               <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-check form-check-inline">
                                            <input class="form-check-input fixed_deposit_chk" type="radio" name="def" onchange="activateMe(1)"  checked value=1>
                                            <label class="form-check-label" for="inlineRadio1">No</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input fixed_deposit_chk" type="radio" name="def" value=2  onchange="activateMe(2)" >
                                    ...
                                    <div id="defermentallot" style="display:none;">
                                        ...
                                        <div class="form-group row">
                                    <label class="col-sm-4 col-form-label" id="invtypeperiod">Assumed Return During Distribution Period
                                    </label>
                                    <div class="col-sm-8">
                                        <div class="row">
                                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group row">
                                    <label class="col-sm-4 col-form-label" id="defermentperiod">Deferment Period
                                    ...
                                    <div class="col-sm-8">
                                        <div class="row">
                                                <div class="col-sm-12">
                                                  <div class="d-flex align-items-center">
                                            <input  type="text" class="form-control pr-2 mr-1 maxtwodigit " id="swpdefer" name="deferment" value="" required="" maxlength="2">
                                    ...
                                    <div class="form-group row">
                                    <label class="col-sm-4 col-form-label" id="moneyback">Periodic Withdrawal Interval
                                    </label>
                                    <div class="col-sm-8">
                                        <div class="row">
                                                <div class="col-sm-12">
                                                  <div class="d-flex align-items-center">
                                            <input  type="text" class="form-control pr-2 mr-1 maxtwodigit " id="moneyback" name="moneyback" value="" required="" maxlength="2">
                                    ...
                                    <div class="form-group row">
                                    <label class="col-sm-4 col-form-label" id="install">No. of Instalment
                                    </label>
                                    <div class="col-sm-8">
                                        <div class="row">
                                                <div class="col-sm-12">
                                                  <div class="d-flex align-items-center">
                                            <input  type="text" class="form-control pr-2 mr-1 maxtwodigit " id="" name="installments" value="" required="" maxlength="2">
                                    ...
                                    <div class="form-group row">
                                    <label class="col-sm-4 col-form-label" id="each">Each Withdrawal Amount
                                    </label>
                                    <div class="col-sm-8">
                                        <div class="row">
                                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <div class="form-check form-check-inline">
                                            <input class="form-check-input fixed_deposit_chk" type="radio" name="swpmode" onchange="activateCustom(false)"  checked value=1>
                                            <label class="form-check-label" for="inlineRadio1">Fixed</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input fixed_deposit_chk" type="radio" name="swpmode" value=2  onchange="activateCustom(true)" >
                                    ...
                                    <div id="fixed">
                                        <div class="form-group row">
                                            <label id="withdrawalinterval" class="col-sm-4 col-form-label">Periodic Withdrawal Interval
                                    </label>
                                    <div class="col-sm-8">
                                        <div class="row">
                                                <div class="col-sm-12">
                                        ...
                                        <div class="form-group row">
                                            <label id="installments" class="col-sm-4 col-form-label">No. of Withdrawals
                                    </label>
                                    <div class="col-sm-8">
                                        <div class="row">
                                                <div class="col-sm-12">
                                        ...
                                        <div class="form-group row">
                                            <label id="eachwithdrawamt" class="col-sm-4 col-form-label">Each Withdrawal Amount
                                    </label>
                                    <div class="col-sm-8">
                                        <div class="row">
                                                <div class="col-sm-12">
                                    ...
                                    <div id="custom" style="display:none;">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="d-flex align-items-center"> Period (Yrs)
                                                            <input  type="text" class="form-control" id="p1" name="period1" value="" onChange="AddAnother(1)" style="width:70%;">
                                                        </div>
                                                        <div class="cal-icon" style="width:47px; right:20px; top: 4px;">Yrs</div>
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <div class="d-flex align-items-center"> Amount &nbsp;
                                                            <input  type="text" class="form-control" id="a1" name="amount1" style="width:70%;" value="" onfocus="showValidation('amount1')" onfocusout="document.getElementById('amount1').innerHTML = ''" readonly>
                                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <div class="d-flex align-items-center"> Period (Yrs)
                                                            <input  type="text" class="form-control" id="p2" name="period2" value="" onChange="AddAnother(2)" style="width:70%;">
                                                        </div>
                                                        <div class="cal-icon" style="width:47px; right:20px; top: 4px;">Yrs</div>
                                                </div>
                                                <div class="col-sm-8">
                                                  <div class="d-flex align-items-center"> Amount &nbsp
                                                  <input  type="text" class="form-control" id="a2" name="amount2" value="" style="width:70%;" onfocus="showValidation('amount2')" onfocusout="document.getElementById('amount2').innerHTML = ''" readonly>
                                                </div>
                                                <div class="cal-icon" style="width:47px; right:92px;"> ₹ </div>
                                                <p id="amount2"></p>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Withdrawal 3
                                    </label>
                                    <div class="col-sm-8">
                                        <div class="row">
                                                <div class="col-sm-4">
                                                  <div class="d-flex align-items-center"> Period (Yrs)
                                            <input  type="text" class="form-control" id="p3" name="period3" value="" onChange="AddAnother(3)"  style="width:70%;">
                                            
                                            
                                            </div>
                                            <div class="cal-icon" style="width:47px; right:20px; top: 4px;">
                                               Yrs
                                            </div>
                                                </div>
                                                <div class="col-sm-8">
                                                  <div class="d-flex align-items-center"> Amount &nbsp;
                                            <input  type="text" class="form-control" id="a3" name="amount3" value="" style="width:70%;" onfocus="showValidation('amount3')" onfocusout="document.getElementById('amount3').innerHTML = ''" readonly>
                                            
                                            
                                            </div>
                                            <div class="cal-icon" style="width:47px; right:92px;">
                                               ₹
                                            </div>
                                            <p id="amount3"></p>
                                                </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Withdrawal 4
                                    </label>
                                    <div class="col-sm-8">
                                        <div class="row">
                                                <div class="col-sm-4">
                                                  <div class="d-flex align-items-center"> Period (Yrs) &nbsp;
                                            <input  type="text" class="form-control" id="p4" name="period4" value="" onChange="AddAnother(4)" style="width:70%;">
                                            ...
                                            <div class="cal-icon" style="width:47px; right:20px; top: 4px;">
                                               Yrs
                                                ...
                                                <div class="col-sm-8">
                                                  <div class="d-flex align-items-center"> Amount &nbsp;
                                            <input  type="text" class="form-control" id="a4" name="amount4" value="" style="width:70%;" onfocus="showValidation('amount4')" onfocusout="document.getElementById('amount4').innerHTML = ''" readonly>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Withdrawal 5
                                    </label>
                                    <div class="col-sm-8">
                                        <div class="row">
                                                <div class="col-sm-4">
                                                  <div class="d-flex align-items-center"> Period (Yrs)&nbsp;
                                            <input  type="text" class="form-control" id="p5" name="period5" value="" onChange="AddAnother(5)" style="width:70%;">
                                            ...
                                            <div class="cal-icon" style="width:47px; right:20px; top: 4px;">
                                               Yrs
                                                ...
                                                <div class="col-sm-8">
                                                  <div class="d-flex align-items-center"> Amount &nbsp;
                                            <input  type="text" class="form-control" id="a5" name="amount5" value="" style="width:70%;" onfocus="showValidation('amount5')" onfocusout="document.getElementById('amount5').innerHTML = ''" readonly>
                                        ...
                                        <div class="col-sm-8">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                  <div class="d-flex align-items-center">
                                            <input type="text" id="accval" class="form-control" name="lastwithdraw" value="" required="" style="width: 89%;">
                                            
                                            
                                            </div>
                                            <div class="cal-icon" style="width: 52px; right: 93px;">
                                               Yrs
                                            </div>
                                                </div>
                                ...
                                <div class="form-group row">
                                        <label class="col-sm-4 col-form-label">Get Report</label>
                                        <div class="col-sm-8">
                                            <div class="row">
                                                &nbsp;&nbsp;&nbsp;&nbsp;
                                                    <div class="form-check form-check-inline">
                                            <input class="form-check-input fixed_deposit_chk" type="radio" name="reporttype" onchange="" value=1>
                                            <label class="form-check-label" for="inlineRadio1">Summary Report</label>
                                        </div>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input fixed_deposit_chk" type="radio" name="reporttype" value=2  onchange="" checked>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label">
                                        <input id="is_client2" type="checkbox" name="client" value="1" @if(old('client')=='1') checked  @endif> Add Client Name
                                    </label>
                                    <div class="col-sm-8">
                                        <input type="text" id="name2" class="form-control {{ $errors->has('clientname') ? ' is-invalid' : '' }}" name="clientname"   value="{{old('clientname')}}" maxlength="30">
                                        <div class="cal-icon" style="padding-top:11px; padding-bottom: 14px;">
                                ...
                                <div class="form-group row">
                                    <div class="offset-5 col-sm-7">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <a href="javascript:history.back()" class="btn btn-primary btn-round btn-block"><i class="fa fa-angle-left"></i> Back</a>
                                            </div>
                                            <div class="col-md-8">
                                                <input type="submit" class="btn btn-primary btn-round btn-block" value="Calculate" />
                                            </div>
                                        </div>
