    ...
    jQuery(document).ready(function(){
        jQuery('#save_cal_btn').click(function(e){
            ...
            if(title.trim()==''){
                ...
                jQuery.ajax({
                    url: "{{ route('frontend.swp_periodic_withdrawal_output_save') }}",
                    method: 'get',
                    data: {
                        title: title
                    },
...
@section('content')
    ...
    <div class="banner styleApril">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="page-title">SWP Periodic Withdrawal</h2>
                </div>
            </div>
        </div>
    </div>
        ...
        <div id="content" class="container">
            <div class="row">
                <div class="col-md-12 offset-md-0 text-center">
                    ...
                    <a href="{{route('frontend.swp_periodic_withdrawal_back')}}?action=back" class="btn btn-primary btn-round"><i class="fa fa-angle-left"></i> Back</a>
                    ...
                    @if($permission['is_download'])
                        ...
                        @else
                            <a href="{{route('frontend.swp_periodic_withdrawal_output_pdf')}}" target="_blank" id="cmd" class="btn btn-primary btn-round btn-solid">Download / Print</a>
                        @endif
                    @else
                    ...
                    <div class="outputTableHolder">
                        <h1 class="midheading">@if(isset($details)) {{$details}} @else SWP Calculation @endif @if(isset($clientname) && !empty($clientname)) <br> For {{$clientname?$clientname:''}}  @else  @endif</h1>
                        @php
                        $calcType = '';
                        $terminalBalance = 0;
                        $endValue = 0;
                    ...
                    @endphp
                            ...
                            <tbody>
                                ...
                                @endif
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                              ₹ {{custome_money_format($monthlysipamount)}}
                                        </td>
                                    </tr>
                                    @endif
                                    @if($invper > 0)
                        ...
                        <h1 class="midheading"> Periodic Withdrawal Details </h1>
                        <div class="roundBorderHolder">
                            <table class="table table-bordered">
                            <tbody>
                                <tr><td><strong>Year</strong></td><td><strong>Amount</strong></td></tr>
                                @if(isset($period1))
                                <tr><td>{{$period1}}</td><td>₹ {{custome_money_format($amount1)}}</td></tr>
                                @endif
                                 @if(isset($period2))
                                <tr><td>{{$period2}}</td><td>₹ {{custome_money_format($amount2)}}</td></tr>
                                @endif
                                 @if(isset($period3))
                                <tr><td>{{$period3}}</td><td>₹ {{custome_money_format($amount3)}}</td></tr>
                                @endif
                                 @if(isset($period4))
                                <tr><td>{{$period4}}</td><td>₹ {{custome_money_format($amount4)}}</td></tr>
                                @endif
                                 @if(isset($period5))
                                <tr><td>{{$period5}}</td><td>₹ {{custome_money_format($amount5)}}</td></tr>
                                @endif
                            </tbody>
                        </table>
                        </div>
                        ...
                        @if($report == "detailed")
                            ...
                            @php 
                                ...
                                if($calcType==1){
                                    $tableHtml .= '
                                        <h1 class="midheading">
                                            Projected Periodic Withdrawal & Fund Value
                                        </h1>
                                        <div class="roundBorderHolder">
                                            <table class="table table-bordered">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <th>Fund Value at End of Year</th>
                                                </tr>';
                                        ...
                                        while($year <= $withdrawal * $interval)
                                        {
                                            ...
                                            if($year == 1){
                                                $tableHtml .='<tr><td>'.$age.'</td><td>₹ '. custome_money_format($withDrawal).'</td><td>₹ '.custome_money_format($yearEndBal).'</td></tr>';
                                            }else{
                                                $tableHtml .='<tr><td>'.$age.'</td><td>₹ '. custome_money_format($withDrawal).'</td><td>₹ '.custome_money_format($yearEndBal).'</td></tr>';
                                            }
                                ...
                                if($calcType == 2){
                                    ...
                                    while($year <= $swpPeriod)
                                    {
                                        ...
                                        if($year == 1){
                                            $tableHtml .='<tr><td>'.$age.'</td><td>₹ '. custome_money_format($withdrawalAmountMain).'</td><td>₹ '.custome_money_format($yearEndValue).'</td></tr>';
                                        }else{
                                            $tableHtml .='<tr><td>'.$age.'</td><td>₹ '. custome_money_format($withdrawalAmountMain).'</td><td>₹ '.custome_money_format($yearEndValue).'</td></tr>';
                                        }
                                ...
                                if($calcType == 3){
                                    ...
                                    while($year <= $swpPeriod){
                                        ...
                                        if($year <= $accumulationPeriod)
                                            ...
                                            $tableHtml .='<tr><td>'.$age.'</td><td>₹ '. custome_money_format($withdrawalAmount).'</td><td>₹ '.custome_money_format($yearEndVal).'</td></tr>';
                                ...
                                if($calcType == 4){
                                    ...
                                    while($year <= $swpPeriod){
                                        ...
                                        if($year == 1){
                                            $tableHtml .='<tr><td>'.$age.'</td><td>₹ '. custome_money_format($annualLump).'</td><td>₹ '. custome_money_format($withdrawMade).'</td><td>₹ '.custome_money_format($yearEndVal).'</td></tr>';
                                        }else{
                                            $tableHtml .='<tr><td>'.$age.'</td><td>₹ '. custome_money_format($annualLump).'</td><td>₹ '. custome_money_format($withdrawMade).'</td><td>₹ '.custome_money_format($yearEndVal).'</td></tr>';
                                        }
                                ...
                                if($calcType == 5){
                                    ...
                                    while($year <= $swpPeriod){
                                        ...
                                        if($year == 1){
                                            $tableHtml .='<tr><td>'.$age.'</td><td>₹ '. custome_money_format($annualInv).'</td><td>₹ '. custome_money_format($withdrawalAmountMain).'</td><td>₹ '.custome_money_format($yearEndValue).'</td></tr>';
                                        }else{
                                            $tableHtml .='<tr><td>'.$age.'</td><td>₹ '. custome_money_format($annualInv).'</td><td>₹ '. custome_money_format($withdrawalAmountMain).'</td><td>₹ '.custome_money_format($yearEndValue).'</td></tr>';
                                        }
                                ...
                                if($calcType == 6){
                                    ...
                                    while($year <= $invper){
                                        ...
                                        //echo("<tr><td>".$agecount."</td><td>₹ ". custome_money_format($investmentMade)."</td><td>₹ ". custome_money_format($yearEndBal)."</td></tr>");
                                        $tableHtml .='<tr><td>'.$agecount.'</td><td>₹ '. custome_money_format($investmentMade).'</td><td>₹ '. custome_money_format($yearEndBal).'</td></tr>';
                                        $age++;
                                    ...
                                    $tableHtml .= '
                                        <h1 class="midheading">
                                            Distribution Phase <br/> Projected Periodic Withdrawal & Fund Value
                                        </h1>
                                        <div class="roundBorderHolder">
                                            <table class="table table-bordered">
                                            <tbody>
                                    ...
                                    while($year <= $swpPeriod){
                                        ...
                                        $tableHtml .='<tr><td>'.$agecount.'</td><td>₹ '. custome_money_format($withdrawMade).'</td><td>₹ '.custome_money_format($yearEndBal).'</td></tr>';
                                        $age++;
                                        $openingBal = $yearEndBal;
                                        $year++;
                                    }
                                ...
                                if($calcType == 7){
                                    ...
                                    while($year <= $swpPeriod)
                                    {
                                        ...
                                        if($year == 1){
                                            $tableHtml .='<tr><td>'.$age.'</td><td>₹ '. custome_money_format($annualLump*12).'</td><td>₹ '. custome_money_format($withdrawMade).'</td><td>₹ '.custome_money_format($yearEndVal).'</td></tr>';
                                        }else{
                                            $tableHtml .='<tr><td>'.$age.'</td><td>₹ '. custome_money_format($annualLump*12).'</td><td>₹ '. custome_money_format($withdrawMade).'</td><td>₹ '.custome_money_format($yearEndVal).'</td></tr>';
                                        }
                                ...
                                if($calcType == 8){
                                    ...
                                    while($year <= $swpPeriod)
                                    {
                                        ...
                                        if($year == 1){
                                            $tableHtml .='<tr><td>'.($year + $currentage).'</td><td>₹ '. custome_money_format(($sipDone*12)).'</td><td>₹ '. custome_money_format($withdrawalAmountMain).'</td><td>₹ '.custome_money_format($yearEndValue).'</td></tr>';
                                        }else{
                                            $tableHtml .='<tr><td>'.($year + $currentage).'</td><td>₹ '. custome_money_format($sipDone*12).'</td><td>₹ '. custome_money_format($withdrawalAmountMain).'</td><td>₹ '.custome_money_format($yearEndValue).'</td></tr>';
                                        }
                                ...
                                if($calcType == 9){
                                    ...
                                    while($year <= $invper){
                                        ...
                                        $tableHtml .='<tr><td>'.$age.'</td><td>₹ '. custome_money_format($sipDone*12).'</td><td>₹ '.custome_money_format($yearEndValue).'</td></tr>';
                                        $year++;
                                    ...
                                    while($year <= $swpPeriod){
                                        ...
                                        $tableHtml .='<tr><td>'.$age.'</td><td>₹ '. custome_money_format($withDraw).'</td><td>₹ '.custome_money_format($yearEndValue).'</td></tr>';
                                        $year++;
                                        $openingBal = $yearEndValue;
                                        $age++;
                                ...
                                if($calcType == 10){
                                    ...
                                    while($year <= $swpPeriod){
                                        ...
                                        if($year == 1){
                                            $tableHtml .='<tr><td>'.$age.'</td><td>₹ '. custome_money_format($initial+($sipDone * 12)).'</td><td>₹ '. custome_money_format($withdrawMade).'</td><td>₹ '.custome_money_format($yearEndVal).'</td></tr>';
                                        }else{
                                            $tableHtml .='<tr><td>'.$age.'</td><td>₹ '. custome_money_format(($sipDone * 12)).'</td><td>₹ '. custome_money_format($withdrawMade).'</td><td>₹ '.custome_money_format($yearEndVal).'</td></tr>';
                                        }
                                ...
                                if($calcType == 11){
                                    ...
                                    while($year <= $swpPeriod){
                                        ...
                                        if($year == 1){
                                            $tableHtml .='<tr><td>'.$age.'</td><td>₹ '. custome_money_format($initial+($sipDone * 12)).'</td><td>₹ '. custome_money_format($withdrawalAmountMain).'</td><td>₹ '.custome_money_format($yearEndValue).'</td></tr>';
                                        }else{
                                            $tableHtml .='<tr><td>'.$age.'</td><td>₹ '. custome_money_format(($sipDone * 12)).'</td><td>₹ '. custome_money_format($withdrawalAmountMain).'</td><td>₹ '.custome_money_format($yearEndValue).'</td></tr>';
                                        }
                                        $year++;
                                        $openingBal = $yearEndValue;
                                        $endValue = $yearEndValue;
                        ...
                        @if($calcType == 1)
                            <h1 class="midheading">Withdrawal Amount Every {{$interval}} @if($interval > 1) Years @else Year @endif</h1>
    
                            <h5 class="outputSingleBox">
                                    ₹ {{custome_money_format($withdrawamount)}}
                            </h5>
                            
                            <h1 class="midheading">Total Withdrawal Amount</h1>
    
                            <h5 class="outputSingleBox">
                                    ₹ {{custome_money_format($withdrawamount * $swpperiod)}}
                            </h5>
                            <h1 class="midheading">End Value</h1>
    
                            <h5 class="outputSingleBox">
                                    ₹ {{custome_money_format($terminalBalance)}}
                            </h5>
                        @endif
                        @if($calcType == 2 || $calcType == 5)
                            <h1 class="midheading">End value after {{$lastwithdraw}} @if($lastwithdraw > 1) Years @else Year @endif</h1>
                            <h5 class="outputSingleBox">
                                    ₹ {{custome_money_format($endValue)}}
                            </h5>
                        @endif
                        @if($calcType == 3 || $calcType == 6 || $calcType == 10 || $calcType == 7 || $calcType == 9)
                            @if($calcType != 7 && $calcType != 10)
                                <h1 class="midheading">Periodic Withdrawal Amount Every {{$moneyback}} @if($moneyback > 1) Years @else Year @endif</h1>
                            @else
                                <h1 class="midheading">Periodic Withdrawal Amount Every {{$interval}} @if($interval > 1) Years @else Year @endif</h1>
                            @endif
                            <h5 class="outputSingleBox">
                                    @if($calcType == 10 || $calcType == 7)
                                    ₹ {{custome_money_format($withdrawamount)}}
                                    @else
                                    ₹ {{custome_money_format($eachwithdraw)}}
                                    @endif
                            </h5>
                            <h1 class="midheading">Total Periodic Withdrawal Amount</h1>
                            <h5 class="outputSingleBox">
                                @if($calcType == 10 || $calcType == 7)
                                    ₹ {{custome_money_format($withdrawamount * $withdrawal)}}
                                    @else
                                    ₹ {{custome_money_format($eachwithdraw * $installments)}}
                                    @endif
                                    </h5>
                        ...
                        @if($calcType == 4)
                            ...
                            <h1 class="midheading">Total Periodic Withdrawal Amount</h1>
                            <h5 class="outputSingleBox">
                                    ₹ {{custome_money_format($withdrawal * $withdrawamount)}}
                            </h5>
                            <h1 class="midheading">End Value</h1>
                            <h5 class="outputSingleBox">
                                    ₹ {{custome_money_format($terminalBal)}}
                            </h5>
                        ...
                        {!!$tableHtml!!}
                                ...
                                <p class="text-left">*The above is for illustration purpose only. Report Date : {{date('d/m/Y')}}</p>
    ...
    <script type="text/javascript">
        var base_url = "{{route('frontend.swp_periodic_withdrawal_output_pdf')}}";
    </script>
