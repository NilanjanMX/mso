                ...
                <div class="col-md-12 offset-md-0 text-center">
                    ...
                    @endphp
                        ...
                        {!!$tableHtml!!}
                            ...
                            <p class="text-left">*The above is for illustration purpose only. Report Date : {{date('d/m/Y')}}<br></p>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form target="_blank" action="{{route('frontend.swp_periodic_withdrawal_merge_download')}}" method="get">
