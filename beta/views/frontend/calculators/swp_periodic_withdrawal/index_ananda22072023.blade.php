                        ...
                        <div class="card sip-calculator singleLineHolder">
                            ...
                            <div style="display:none;" id="acc">
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                  <div class="row">
                                    <div class="col-sm-3">
                                      <label class="col-form-label">Debt %</label> &nbsp; <input type="text" name="acdebt" id="acdebt" class="form-control" value="" onChange="SetAcTotal()">
                                    </div>
                                    <div class="col-sm-3">
                                      <label class="col-form-label">Hybrid %</label> &nbsp; <input type="text" name="achybrid" id="achybrid" class="form-control" value="" onChange="SetAcTotal()">
                                    </div>
                                    <div class="col-sm-3">
                                      <label class="col-form-label">Equity %</label> &nbsp; <input type="text" name="acequity" id="acequity" class="form-control" value="" onChange="SetAcTotal()">
                                    </div>
                                    <div class="col-sm-3">
                                      <label class="col-form-label">Total %</label> &nbsp; <input type="text" name="actotal" id="actotal" class="form-control" value="" readonly>
                                    </div>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                  <div class="row">
                                    <div class="col-sm-3">
                                      <label class="col-form-label">Debt %</label> &nbsp; <input type="text" name="acdebt1" id="acdebt1" class="form-control" value="" onChange="SetAcTotal()" oninput="validate(this)">
                                    </div>
                                    <div class="col-sm-3">
                                      <label class="col-form-label">Hybrid %</label> &nbsp; <input type="text" name="achybrid1" id="achybrid1" class="form-control" value="" onChange="SetAcTotal()" oninput="validate(this)">
                                    </div>
                                    <div class="col-sm-3">
                                      <label class="col-form-label">Equity %</label> &nbsp; <input type="text" name="acequity1" id="acequity1" class="form-control" value="" onChange="SetAcTotal()" oninput="validate(this)">
                                    </div>
                                    <div class="col-sm-3">
                                      <label class="col-form-label">Average %</label> &nbsp; <input type="text" name="actotal1" id="actotal1" class="form-control" value="" readonly>
                                    </div>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-8">
                                <div class="row">
                                  <div class="col-sm-3">
                                    <label class="col-form-label">Debt %</label> &nbsp; <input type="text" name="debt" id="debt" class="form-control" value="" onChange="SetTotal()">
                                  </div>
                                  <div class="col-sm-3">
                                    <label class="col-form-label">Hybrid %</label> &nbsp; <input type="text" name="hybrid" id="hybrid" class="form-control" value="" onChange="SetTotal()">
                                  </div>
                                  <div class="col-sm-3">
                                    <label class="col-form-label">Equity %</label> &nbsp; <input type="text" name="equity" id="equity" class="form-control" value="" onChange="SetTotal()">
                                  </div>
                                  <div class="col-sm-3">
                                    <label class="col-form-label">Total %</label> &nbsp; <input type="text" name="total" id="total" class="form-control" value="" readonly>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-8">
                                <div class="row">
                                  <div class="col-sm-3">
                                    <label class="col-form-label">Debt %</label> &nbsp; <input type="text" name="debt1" id="debt1" class="form-control" value="" onChange="SetTotal()" oninput="validate(this)">
                                  </div>
                                  <div class="col-sm-3">
                                    <label class="col-form-label">Hybrid %</label> &nbsp; <input type="text" name="hybrid1" id="hybrid1" class="form-control" value="" onChange="SetTotal()" oninput="validate(this)">
                                  </div>
                                  <div class="col-sm-3">
                                    <label class="col-form-label">Equity %</label> &nbsp; <input type="text" name="equity1" id="equity1" class="form-control" value="" onChange="SetTotal()" oninput="validate(this)">
                                  </div>
                                  <div class="col-sm-3">
                                    <label class="col-form-label">Average %</label> &nbsp; <input type="text" name="total1" id="total1" class="form-control" value="" readonly>
                                  </div>
                                </div>
                              </div>
                            </div>
                              ...
                              <div id="custom" style="display:none;">
                                <div class="form-group row">
                                  ...
                                  <div class="col-sm-8">
                                    <div class="row">
                                      <div class="col-sm-4">
                                        <div class="d-flex align-items-center"> Period (Yrs) <input type="text" class="form-control" id="p1" name="period1" value="" onChange="AddAnother(1)" style="width:70%;">
                                        </div>
                                        <div class="cal-icon" style="width:47px; right:20px; top: 4px;">Yrs</div>
                                      </div>
                                      <div class="col-sm-8">
                                        <div class="d-flex align-items-center"> Amount &nbsp; <input type="text" class="form-control" id="a1" name="amount1" style="width:70%;" value="" onfocus="showValidation('amount1')" onfocusout="document.getElementById('amount1').innerHTML = ''" readonly>
                                        </div>
                                ...
                                <div class="form-group row">
                                  ...
                                  <div class="col-sm-8">
                                    <div class="row">
                                      <div class="col-sm-4">
                                        <div class="d-flex align-items-center"> Period (Yrs) <input type="text" class="form-control" id="p2" name="period2" value="" onChange="AddAnother(2)" style="width:70%;">
                                        </div>
                                        <div class="cal-icon" style="width:47px; right:20px; top: 4px;">Yrs</div>
                                      </div>
                                      <div class="col-sm-8">
                                        <div class="d-flex align-items-center"> Amount &nbsp <input type="text" class="form-control" id="a2" name="amount2" value="" style="width:70%;" onfocus="showValidation('amount2')" onfocusout="document.getElementById('amount2').innerHTML = ''" readonly>
                                        </div>
                                        <div class="cal-icon" style="width:47px; right:92px;"> ₹ </div>
                                        <p id="amount2"></p>
                                      </div>
                                ...
                                <div class="form-group row">
                                  ...
                                  <div class="col-sm-8">
                                    <div class="row">
                                      <div class="col-sm-4">
                                        <div class="d-flex align-items-center"> Period (Yrs) <input type="text" class="form-control" id="p3" name="period3" value="" onChange="AddAnother(3)" style="width:70%;">
                                        </div>
                                        <div class="cal-icon" style="width:47px; right:20px; top: 4px;"> Yrs </div>
                                      </div>
                                      <div class="col-sm-8">
                                        <div class="d-flex align-items-center"> Amount &nbsp; <input type="text" class="form-control" id="a3" name="amount3" value="" style="width:70%;" onfocus="showValidation('amount3')" onfocusout="document.getElementById('amount3').innerHTML = ''" readonly>
                                        </div>
                                        <div class="cal-icon" style="width:47px; right:92px;"> ₹ </div>
                                        <p id="amount3"></p>
                                      </div>
                                ...
                                <div class="form-group row">
                                  ...
                                  <div class="col-sm-8">
                                    <div class="row">
                                      <div class="col-sm-4">
                                        <div class="d-flex align-items-center"> Period (Yrs) &nbsp; <input type="text" class="form-control" id="p4" name="period4" value="" onChange="AddAnother(4)" style="width:70%;">
                                        </div>
                                        <div class="cal-icon" style="width:47px; right:20px; top: 4px;"> Yrs </div>
                                      </div>
                                      <div class="col-sm-8">
                                        <div class="d-flex align-items-center"> Amount &nbsp; <input type="text" class="form-control" id="a4" name="amount4" value="" style="width:70%;" onfocus="showValidation('amount4')" onfocusout="document.getElementById('amount4').innerHTML = ''" readonly>
                                        </div>
                                        <div class="cal-icon" style="width:47px; right:92px;"> ₹ </div>
                                        <p id="amount4"></p>
                                      </div>
                                ...
                                <div class="form-group row">
                                  ...
                                  <div class="col-sm-8">
                                    <div class="row">
                                      <div class="col-sm-4">
                                        <div class="d-flex align-items-center"> Period (Yrs)&nbsp; <input type="text" class="form-control" id="p5" name="period5" value="" onChange="AddAnother(5)" style="width:70%;">
                                        </div>
                                        <div class="cal-icon" style="width:47px; right:20px; top: 4px;"> Yrs </div>
                                      </div>
                                      <div class="col-sm-8">
                                        <div class="d-flex align-items-center"> Amount &nbsp; <input type="text" class="form-control" id="a5" name="amount5" value="" style="width:70%;" onfocus="showValidation('amount5')" onfocusout="document.getElementById('amount5').innerHTML = ''" readonly>
                                        </div>
                                        <div class="cal-icon" style="width:47px; right:92px;"> ₹ </div>
                                        <p id="amount5"></p>
                                      </div>
