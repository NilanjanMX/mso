        ...
        <main class="mainPdf">
            <div style="padding: 0 0%;">
                <h1 class="pdfTitie">
                    ...
                    @if(isset($details)) {{$details}} @else Periodic Withdrawal Calculation @endif @if(isset($clientname) && !empty($clientname)) <br> For {{$clientname?$clientname:''}}  @else  @endif
                </h1>
            </div>
                            ...
                            <tbody>
                                ...
                                @endif
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                              <span class='pdfRupeeIcon'>&#8377;</span> {{custome_money_format($monthlysipamount)}}
                                        </td>
                                    </tr>
                                    @endif
                                    @if($invper > 0)
                    ...
                    @if($calcType == 2 || $calcType == 5 || $calcType == 8 || $calcType == 11)
                        <h1 class="pdfTitie">Periodic Withdrawal Details </h1>
                        <div class="roundBorderHolder">
                            <table>
                                <tbody>
                                    <tr><td><strong>Year</strong></td><td><strong>Amount</strong></td></tr>
                                    @if(isset($period1))
                                    <tr><td>{{$period1}}</td><td><span class='pdfRupeeIcon'>&#8377;</span> {{custome_money_format($amount1)}}</td></tr>
                                    @endif
                                     @if(isset($period2))
                                    <tr><td>{{$period2}}</td><td><span class='pdfRupeeIcon'>&#8377;</span> {{custome_money_format($amount2)}}</td></tr>
                                    @endif
                                     @if(isset($period3))
                                    <tr><td>{{$period3}}</td><td><span class='pdfRupeeIcon'>&#8377;</span> {{custome_money_format($amount3)}}</td></tr>
                                    @endif
                                     @if(isset($period4))
                                    <tr><td>{{$period4}}</td><td><span class='pdfRupeeIcon'>&#8377;</span> {{custome_money_format($amount4)}}</td></tr>
                                    @endif
                                     @if(isset($period5))
                                    <tr><td>{{$period5}}</td><td><span class='pdfRupeeIcon'>&#8377;</span> {{custome_money_format($amount5)}}</td></tr>
                                    @endif
                                </tbody>
                            </table>
                        </div>
                    ...
                    @if($calcType == 1)
                        <h1 class="pdfTitie">Withdrawal Amount Every {{$interval}} @if($interval > 1) Years @else Year @endif</h1>

                        <h5 class="pdfBlueCell">
                                <span class='pdfRupeeIcon'>&#8377;</span> {{custome_money_format($withdrawamount)}}
                        </h5>
                        
                        <h1 class="pdfTitie">Total Withdrawal Amount</h1>

                        <h5 class="pdfBlueCell">
                                <span class='pdfRupeeIcon'>&#8377;</span> {{custome_money_format($withdrawamount * $swpperiod)}}
                        </h5>
                        <h1 class="pdfTitie">End Value</h1>

                        <h5 class="pdfBlueCell">
                                <span class='pdfRupeeIcon'>&#8377;</span> {{custome_money_format($terminalBalance)}}
                        </h5>
                    @endif
                    @if($calcType == 2 || $calcType == 5)
                        <h1 class="pdfTitie">End value after {{$lastwithdraw}} @if($lastwithdraw > 1) Years @else Year @endif</h1>
                        <h5 class="pdfBlueCell">
                                <span class='pdfRupeeIcon'>&#8377;</span> {{custome_money_format($endValue)}}
                        </h5>
                    @endif
                    @if($calcType == 3 || $calcType == 6 || $calcType == 10 || $calcType == 7 || $calcType == 9)
                        @if($calcType != 7 && $calcType != 10)
                            <h1 class="pdfTitie">Periodic Withdrawal Amount Every {{$moneyback}} @if($moneyback > 1) Years @else Year @endif</h1>
                        @else
                            <h1 class="pdfTitie">Periodic Withdrawal Amount Every {{$interval}} @if($interval > 1) Years @else Year @endif</h1>
                        @endif
                        <h5 class="pdfBlueCell">
                                @if($calcType == 10 || $calcType == 7)
                                <span class='pdfRupeeIcon'>&#8377;</span> {{custome_money_format($withdrawamount)}}
                                @else
                                <span class='pdfRupeeIcon'>&#8377;</span> {{custome_money_format($eachwithdraw)}}
                                @endif
                        </h5>
                        <h1 class="pdfTitie">Total Periodic Withdrawal Amount</h1>
                        <h5 class="pdfBlueCell">
                            @if($calcType == 10 || $calcType == 7)
                                <span class='pdfRupeeIcon'>&#8377;</span> {{custome_money_format($withdrawamount * $withdrawal)}}
                                @else
                                <span class='pdfRupeeIcon'>&#8377;</span> {{custome_money_format($eachwithdraw * $installments)}}
                                @endif
                                </h5>
                    ...
                    @if($calcType == 4)
                        ...
                        <h1 class="pdfTitie">Total Periodic Withdrawal Amount</h1>
                        <h5 class="pdfBlueCell">
                                <span class='pdfRupeeIcon'>&#8377;</span> {{custome_money_format($withdrawal * $withdrawamount)}}
                        </h5>
                        <h1 class="pdfTitie">End Value</h1>
                        <h5 class="pdfBlueCell">
                                <span class='pdfRupeeIcon'>&#8377;</span> {{custome_money_format($terminalBal)}}
                        </h5>
                    ...
                    <main class="mainPdf">
                        ...
                        @if($calcType==1)
                                <h1 class="bluebar" style="background:{{$city_color}}">Projected Periodic Withdrawal & Fund Value</h1>
                                <div class="roundBorderHolder withBluebar">
                                    <table>
                                        <tbody>
                                         <tr >
                                            <th style="background:{{$address_color_background}}">@if(isset($currentage))Age @else Year @endif</th>
                                            <th style="background:{{$address_color_background}}">Withdrawal Amount</th>
                                            <th style="background:{{$address_color_background}}">Fund Value at End of Year</th>
                                        </tr>
                                    @php
                                        $year = 1;
                                        $maxMoneyBackPeriod = $interval;
                                        ...
                                        if($year == 1){
                                            echo("<tr><td>".$age."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ". custome_money_format($withDrawal)."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ".custome_money_format($yearEndBal)."</td></tr>");
                                        }else{
                                            echo("<tr><td>".$age."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ". custome_money_format($withDrawal)."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ".custome_money_format($yearEndBal)."</td></tr>");
                                        }
                                ...
                                <tbody>
                                    ...
                                    @php
                                        ...
                                        <main class="mainPdf"> 
                                            ...
                                            if($year == 1){
                                                echo("<tr><td>".$age."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ". custome_money_format($withdrawalAmountMain)."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ". custome_money_format($yearEndValue)."</td></tr>");
                                            }else{
                                                echo("<tr><td>".$age."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ". custome_money_format($withdrawalAmountMain)."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ". custome_money_format($yearEndValue)."</td></tr>");
                                            }
                                ...
                                <tbody>
                                    ...
                                    @php
                                        ...
                                        <main class="mainPdf"> 
                                                ...
                                                echo("<tr><td>".$age."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ".custome_money_format($withdrawalAmount)."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ".custome_money_format($yearEndVal)."</td></tr>");
                                                $year++;
                                                $openingBal = $yearEndVal;
                                                $age++;
                                                if($nowAllow)
                                ...
                                <tbody>
                                    ...
                                    @php
                                        ...
                                        <main class="mainPdf"> 
                                            ...
                                            if($year == 1){
                                                echo ("<tr><td>".$age."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ".custome_money_format($annualLump)."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ".custome_money_format($withdrawMade)."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ".custome_money_format($yearEndVal)."</td></tr>");
                                            }else{
                                                echo ("<tr><td>".$age."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ".custome_money_format($annualLump)."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ".custome_money_format($withdrawMade)."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ".custome_money_format($yearEndVal)."</td></tr>");
                                            }
                        ...
                        @if($calcType == 5)
                            ...
                            <table>
                                <tbody>
                                    <tr >
                                        <th style="background:{{$address_color_background}}">@if(isset($currentage))Age @else Years @endif</th>
                                        <th style="background:{{$address_color_background}}">Annual Investment</th>
                                        <th style="background:{{$address_color_background}}">Withdrawal Amount</th>
                                        <th style="background:{{$address_color_background}}">Fund Value at End of Year</th>
                                    </tr>
                                    ...
                                    @php
                                        ...
                                        <main class="mainPdf"> 
                                            ...
                                            if($year == 1){
                                                echo("<tr><td>".$age."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ". custome_money_format($annualInv)."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ". custome_money_format($withdrawalAmountMain)."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ". custome_money_format($yearEndValue)."</td></tr>");
                                            }else{
                                                echo("<tr><td>".$age."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ". custome_money_format($annualInv)."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ". custome_money_format($withdrawalAmountMain)."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ". custome_money_format($yearEndValue)."</td></tr>");
                                            }
                                ...
                                <tbody>
                                    ...
                                    @php
                                        ...
                                        <main class="mainPdf"> 
                                            ...
                                            echo("<tr><td>".$agecount."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ". custome_money_format($investmentMade)."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ". custome_money_format($yearEndBal)."</td></tr>");
                                            $age++;
                                            $openingBal = $yearEndBal;
                                            $year++;
                                    ...
                                    @endphp
                                            ...
                                            @include('frontend.calculators.common.header')
                                        <main class="mainPdf"> 
                                <h1 class="bluebar" style="background:{{$city_color}}">Distribution Phase <br/> Projected Periodic Withdrawal & Fund Value</h1>
                                <div class="roundBorderHolder withBluebar doubleLineTableTitle">
                                <table>
                                    <tbody>
                                        <tr >
                                        ...
                                        <main class="mainPdf"> 
                                                ...
                                                echo("<tr><td>".$agecount."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ". custome_money_format($withdrawMade)."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ". custome_money_format($yearEndBal)."</td></tr>");
                                ...
                                <tbody>
                                    ...
                                    @php
                                        ...
                                        <main class="mainPdf"> 
                                            ...
                                            if($year == 1){
                                                echo("<tr><td>".($year + $currentage)."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ".custome_money_format(($sipDone*12))."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ". custome_money_format($withdrawalAmountMain)."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ". custome_money_format($yearEndValue)."</td></tr>");
                                            }else{
                                                echo("<tr><td>".($year + $currentage)."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ".custome_money_format($sipDone*12)."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ". custome_money_format($withdrawalAmountMain)."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ". custome_money_format($yearEndValue)."</td></tr>");
                                            }
                                ...
                                <tbody>
                                    ...
                                    @php
                                        ...
                                        <main class="mainPdf"> 
                                            ...
                                            echo("<tr><td>".$age."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ". custome_money_format($sipDone*12)."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ". custome_money_format($yearEndValue)."</td></tr>");
                                            $year++;
                                ...
                                <tbody>
                                    ...
                                    @php
                                        ...
                                        <main class="mainPdf"> 
                                            ...
                                            echo("<tr><td>".$age."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ". custome_money_format($withDraw)."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ". custome_money_format($yearEndValue)."</td></tr>");
                                            $year++;
                                            $openingBal = $yearEndValue;
                                            $age++;
                        ...
                        @if($calcType == 10)
                            ...
                            <table>
                                <tbody>
                                    <tr >
                                        <th style="background:{{$address_color_background}}">@if(isset($currentage))Age @else Year @endif</td>
                                        <th style="background:{{$address_color_background}}">Annual Investment</td>
                                        <th style="background:{{$address_color_background}}">Withdrawal Amount</td>
                                        <th style="background:{{$address_color_background}}">Fund Value at End of Year</td>
                                    </tr>
                                    ...
                                    @php
                                        ...
                                        <main class="mainPdf"> 
                                            ...
                                            if($year == 1){
                                                echo("<tr><td>".$age."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ". custome_money_format($initial+($sipDone * 12))."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ". custome_money_format($withdrawMade)."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ". custome_money_format($yearEndVal)."</td></tr>");
                                            }else{
                                                echo("<tr><td>".$age."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ". custome_money_format(($sipDone * 12))."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ". custome_money_format($withdrawMade)."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ". custome_money_format($yearEndVal)."</td></tr>");
                                            }
                                ...
                                <tbody>
                                    ...
                                    @php
                                        ...
                                        <main class="mainPdf"> 
                                            ...
                                            if($year == 1){
                                                echo("<tr><td>".$age."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ".custome_money_format($initial+($sipDone * 12))."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ". custome_money_format($withdrawalAmountMain)."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ". custome_money_format($yearEndValue)."</td></tr>");
                                            }else{
                                                echo("<tr><td>".$age."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ".custome_money_format(($sipDone * 12))."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ". custome_money_format($withdrawalAmountMain)."</td><td><span class='pdfRupeeIcon'>&#8377;</span> ". custome_money_format($yearEndValue)."</td></tr>");
                                            }
