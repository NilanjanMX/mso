    ...
    <section class="main-sec">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    <h3 class="smalllineHeading">SWP Periodic Withdrawal</h3>
                    ...
                    <form class="js-validate-form" action="{{route('frontend.swp_periodic_withdrawal_output')}}" method="post" id="emi">
                        ...
                        <div class="card sip-calculator singleLineHolder calculatorFormShape">
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-7">
                                <div class="row">
                                  ...
                                  <div class="col-sm-9">
                                    <div class="d-flex align-items-center"> &nbsp; <input type="text" class="form-control" id="aft" name="details" value="" maxlength=30>
                                    </div>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-7">
                                <div class="row">
                                  <div class="col-sm-12">
                                    <div class="d-flex align-items-center">
                                      <input type="text" class="form-control pr-2 mr-0 maxtwodigit " name="currentage" value="" maxlength="2">
                                    </div>
                                    <div class="cal-icon"> Yrs </div>
                                  </div>
                                </div>
                              </div>
                            </div>
                            <div class="form-group row">
                              ...
                              <div class="col-sm-7">
                                <div class="form-check pl-0">
                                    <label class="checkLinecontainer" for="investmentmode1">Lumpsum
                                        <input class="form-check-input fixed_deposit_chk" id="investmentmode1" type="radio" name="investmentmode" onchange="invest(1)" checked value=1>
                                        <span class="checkmark"></span>
                                    </label> 
                                </div>
                                <div class="form-check pl-0">
                                    <label class="checkLinecontainer" for="investmentmode2">Annual Lumpsum
                                        <input class="form-check-input fixed_deposit_chk" id="investmentmode2" type="radio" name="investmentmode" value=2 onchange="invest(2)">
                                        <span class="checkmark"></span>
                                    </label> 
                                </div>
                                <div class="form-check pl-0">
                                    <label class="checkLinecontainer" for="investmentmode3">SIP
                                        <input class="form-check-input fixed_deposit_chk" id="investmentmode3" type="radio" name="investmentmode" value=3 onchange="invest(3)">
                                        <span class="checkmark"></span>
                                    </label> 
                                </div>
                                <div class="form-check pl-0">
                                    <label class="checkLinecontainer" for="investmentmode4">Lumpsum+SIP
                                        <input class="form-check-input fixed_deposit_chk" id="investmentmode4" type="radio" name="investmentmode" value=4 onchange="invest(4)">
                                        <span class="checkmark"></span>
                                    </label> 
                                </div>
                              </div>
                            ...
                            <div class="form-group row">
                              <label class="col-sm-5 col-form-label" id="invtypetext">Initial Investment</label>
                              <div class="col-sm-7">
                                <div class="row">
                                  <div class="col-sm-12">
                                    <div class="d-flex align-items-center">
                                      <input type="text" id="initial" class="form-control" name="initial" value="" required="">
                                    </div>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                  <div class="row">
                                    <div class="col-sm-12">
                                      <div class="d-flex align-items-center">
                                        <input type="text" class="form-control" id="sipamti" name="monthlysipamount" value="">
                                      </div>
                                      <div class="cal-icon"> ₹ </div>
                                    </div>
                                  </div>
                            ...
                            <div id="invper" style="display:none;">
                              <div class="form-group row">
                                <label class="col-sm-5 col-form-label" id="invlabel">Investment Period</label>
                                <div class="col-sm-7">
                                  <div class="row">
                                    <div class="col-sm-12">
                                      <div class="d-flex align-items-center">
                                        <input type="text" id="invperiod" class="form-control" name="invper" value="" required="">
                                      </div>
                                      <div class="cal-icon"> Yrs </div>
                                    </div>
                                  </div>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                  <div class="row">
                                    <div class="col-sm-3">
                                      <label class="col-form-label">Debt %</label>
                                      <input type="text" name="acdebt1" id="acdebt1" class="form-control" value="" onChange="SetAcTotal()" oninput="validate(this)">
                                    </div>
                                    <div class="col-sm-3">
                                      <label class="col-form-label">Hybrid %</label>
                                      <input type="text" name="achybrid1" id="achybrid1" class="form-control" value="" onChange="SetAcTotal()" oninput="validate(this)">
                                    </div>
                                    <div class="col-sm-3">
                                      <label class="col-form-label">Equity %</label>
                                      <input type="text" name="acequity1" id="acequity1" class="form-control" value="" onChange="SetAcTotal()" oninput="validate(this)">
                                    </div>
                                    <div class="col-sm-3">
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-7">
                                <div class="row">
                                  <div class="col-sm-3">
                                    <label class="col-form-label">Debt %</label>
                                    <input type="text" name="debt1" id="debt1" class="form-control" value="" onChange="SetTotal()" oninput="validate(this)">
                                  </div>
                                  <div class="col-sm-3">
                                    <label class="col-form-label">Hybrid %</label>
                                    <input type="text" name="hybrid1" id="hybrid1" class="form-control" value="" onChange="SetTotal()" oninput="validate(this)">
                                  </div>
                                  <div class="col-sm-3">
                                    <label class="col-form-label">Equity %</label>
                                    <input type="text" name="equity1" id="equity1" class="form-control" value="" onChange="SetTotal()" oninput="validate(this)">
                                  </div>
                                  <div class="col-sm-3">
                                    <label class="col-form-label">Average %</label>
                            ...
                            <div class="form-group row">
                              <label class="col-sm-5 col-form-label">Deferment Required</label>
                              <div class="col-sm-7">
                                <div class="row">
                                  <div class="col-sm-5">
                                    <div class="form-check form-check-inline">
                                        <label class="checkLinecontainer mb-0 mt-1" for="activateMe_1">No
                                            <input class="form-check-input fixed_deposit_chk" id="activateMe_1" type="radio" name="def" onchange="activateMe(1)" checked value=1>
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <label class="checkLinecontainer mb-0 mt-1" for="activateMe_2">Yes
                                            <input class="form-check-input fixed_deposit_chk" id="activateMe_2" type="radio" name="def" value=2 onchange="activateMe(2)">
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                  </div>
                            ...
                            <div id="defermentallot" style="display:none;">
                              <div id="expected" style="display:block;">
                                <div class="form-group row">
                                  <label class="col-sm-5 col-form-label" id="invtypeperiod">Assumed Return During Distribution Period </label>
                                  <div class="col-sm-7">
                                    <div class="row">
                                      <div class="col-sm-12">
                                        <div class="d-flex align-items-center">
                                          <input type="text" class="form-control" id="invperi" name="distribution" value="" required="">
                                        </div>
                                        <div class="cal-icon"> % </div>
                                      </div>
                                    </div>
                              ...
                              <div class="form-group row">
                                  <div class="col-sm-5 openEye">
                                    <label class="col-form-label" id="defermentperiod">Deferment Period  &nbsp; 
                                ...
                                <div class="col-sm-7">
                                  <div class="row">
                                    <div class="col-sm-12">
                                      <div class="d-flex align-items-center">
                                        <input type="text" class="form-control pr-2 mr-0 maxtwodigit " id="swpdefer" name="deferment" value="" required="" maxlength="2">
                                      </div>
                                      <div class="cal-icon"> Yrs </div>
                                    </div>
                                  </div>
                              ...
                              <div class="form-group row">
                                <label class="col-sm-5 col-form-label" id="moneyback">Periodic Withdrawal Interval </label>
                                <div class="col-sm-7">
                                  <div class="row">
                                    <div class="col-sm-12">
                                      <div class="d-flex align-items-center">
                                        <input type="text" class="form-control pr-2 mr-0 maxtwodigit " id="moneyback" name="moneyback" value="" required="" maxlength="2">
                                      </div>
                                      <div class="cal-icon"> Yrs </div>
                                    </div>
                                  </div>
                              ...
                              <div class="form-group row">
                                <label class="col-sm-5 col-form-label" id="install">No. of Instalment </label>
                                <div class="col-sm-7">
                                  <div class="row">
                                    <div class="col-sm-12">
                                      <div class="d-flex align-items-center">
                                        <input type="text" class="form-control pr-2 mr-0 maxtwodigit " id="" name="installments" value="" required="" maxlength="2">
                                      </div>
                                      <div class="cal-icon"> Yrs </div>
                                    </div>
                                  </div>
                              ...
                              <div class="form-group row">
                                <label class="col-sm-5 col-form-label" id="each">Each Withdrawal Amount </label>
                                <div class="col-sm-7">
                                  <div class="row">
                                    <div class="col-sm-12">
                                      <div class="d-flex align-items-center">
                                        <input type="text" class="form-control" id="eachwithdrawamm" name="eachwithdraw" onfocus="showValidation('each')" onfocusout="document.getElementById('withdrawtext').innerHTML = ''" value="" required="" readonly>
                                      </div>
                                      <div class="cal-icon"> ₹ </div>
                                    </div>
                                  </div>
                                  <em id="eachwithdrawtext" class="error maxClass" style="color: #343434;font-size: 12px;">  </em>
                                </div>
                              </div>
                            </div>
                            <div id="swpmode">
                              <div class="form-group row">
                                <label class="col-sm-5 col-form-label">Select SWP Mode</label>
                                <div class="col-sm-7">
                                  <div class="row">
                                    <div class="col-sm-5">
                                      <div class="form-check form-check-inline">
                                          <label class="checkLinecontainer mb-0 mt-1" for="activateCustom_false">Fixed
                                            <input class="form-check-input fixed_deposit_chk" id="activateCustom_false" type="radio" name="swpmode" onchange="activateCustom(false)" checked value=1>
                                            <span class="checkmark"></span>
                                          </label>
                                      </div>
                                      <div class="form-check form-check-inline">
                                          <label class="checkLinecontainer mb-0 mt-1" for="activateCustom_true">Custom
                                            <input class="form-check-input fixed_deposit_chk" id="activateCustom_true" type="radio" name="swpmode" value=2 onchange="activateCustom(true)">
                                            <span class="checkmark"></span>
                                          </label>
                                      </div>
                                    </div>
                              ...
                              <div id="fixed">
                                <div class="form-group row">
                                  <label id="withdrawalinterval" class="col-sm-5 col-form-label">Periodic Withdrawal Interval </label>
                                  <div class="col-sm-7">
                                    <div class="row">
                                      <div class="col-sm-12">
                                        <div class="d-flex align-items-center">
                                ...
                                <div class="form-group row">
                                  <label id="installments" class="col-sm-5 col-form-label">No. of Withdrawals </label>
                                  <div class="col-sm-7">
                                    <div class="row">
                                      <div class="col-sm-12">
                                        <div class="d-flex align-items-center">
                                          <input type="text" class="form-control" id="" name="withdrawal" value="">
                                        </div>
                                        <div class="cal-icon"> Nos </div>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                <div class="form-group row">
                                  <label id="eachwithdrawamt" class="col-sm-5 col-form-label">Each Withdrawal Amount </label>
                                  <div class="col-sm-7">
                                    <div class="row">
                                      <div class="col-sm-12">
                                        <div class="d-flex align-items-center">
                                          <input type="text" class="form-control" id="withdrawamount" name="withdrawamount" onfocus="showValidation('withdraw')" onfocusout="document.getElementById('withdrawtext').innerHTML = ''" value="" required="" readonly>
                                        </div>
                                        <div class="cal-icon"> ₹ </div>
                                        <em id="withdrawtext" class="error maxClass" style="color: #343434;font-size: 12px;">  </em>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div id="custom" style="display:none;">
                                <div class="form-group row">
                                  <label class="col-sm-5 col-form-label">Withdrawal 1 </label>
                                  <div class="col-sm-7">
                                    <div class="row">
                                      <div class="col-sm-5">
                                        <div class="d-flex align-items-center" style="white-space: nowrap;"> Period (Yrs) <input type="text" class="form-control ml-2" id="p1" name="period1" value="" onChange="AddAnother(1)" >
                                        </div>
                                        <div class="cal-icon" >Yrs</div>
                                      </div>
                                      <div class="col-sm-7">
                                        <div class="d-flex align-items-center" style="white-space: nowrap;"> Amount <input type="text" class="form-control ml-2" id="a1" name="amount1"  value="" onfocus="showValidation('amount1')" onfocusout="document.getElementById('amount1').innerHTML = ''" readonly>
                                        </div>
                                        <div class="cal-icon" >₹</div>
                                        <em id="amount1" class="error maxClass" style="color: #343434;font-size: 12px;">  </em>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                <div class="form-group row">
                                  <label class="col-sm-5 col-form-label">Withdrawal 2 </label>
                                  <div class="col-sm-7">
                                    <div class="row">
                                      <div class="col-sm-5">
                                        <div class="d-flex align-items-center" style="white-space: nowrap;"> Period (Yrs) <input type="text" class="form-control ml-2" id="p2" name="period2" value="" onChange="AddAnother(2)" >
                                        </div>
                                        <div class="cal-icon" >Yrs</div>
                                      </div>
                                      <div class="col-sm-7">
                                        <div class="d-flex align-items-center" style="white-space: nowrap;"> Amount <input type="text" class="form-control ml-2" id="a2" name="amount2" value=""  onfocus="showValidation('amount2')" onfocusout="document.getElementById('amount2').innerHTML = ''" readonly>
                                        </div>
                                        <div class="cal-icon" > ₹ </div>
                                        <em id="amount2" class="error maxClass" style="color: #343434;font-size: 12px;">  </em>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                <div class="form-group row">
                                  <label class="col-sm-5 col-form-label">Withdrawal 3 </label>
                                  <div class="col-sm-7">
                                    <div class="row">
                                      <div class="col-sm-5">
                                        <div class="d-flex align-items-center" style="white-space: nowrap;"> Period (Yrs) <input type="text" class="form-control ml-2" id="p3" name="period3" value="" onChange="AddAnother(3)" >
                                        </div>
                                        <div class="cal-icon" > Yrs </div>
                                      </div>
                                      <div class="col-sm-7">
                                        <div class="d-flex align-items-center" style="white-space: nowrap;"> Amount <input type="text" class="form-control ml-2" id="a3" name="amount3" value=""  onfocus="showValidation('amount3')" onfocusout="document.getElementById('amount3').innerHTML = ''" readonly>
                                        </div>
                                        <div class="cal-icon" > ₹ </div>
                                        <em id="amount3" class="error maxClass" style="color: #343434;font-size: 12px;">  </em>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                <div class="form-group row">
                                  <label class="col-sm-5 col-form-label">Withdrawal 4 </label>
                                  <div class="col-sm-7">
                                    <div class="row">
                                      <div class="col-sm-5">
                                        <div class="d-flex align-items-center" style="white-space: nowrap;"> Period (Yrs) <input type="text" class="form-control ml-2" id="p4" name="period4" value="" onChange="AddAnother(4)" >
                                        </div>
                                        <div class="cal-icon" > Yrs </div>
                                      </div>
                                      <div class="col-sm-7">
                                        <div class="d-flex align-items-center" style="white-space: nowrap;"> Amount <input type="text" class="form-control ml-2" id="a4" name="amount4" value=""  onfocus="showValidation('amount4')" onfocusout="document.getElementById('amount4').innerHTML = ''" readonly>
                                        </div>
                                        <div class="cal-icon" > ₹ </div>
                                        <em id="amount4" class="error maxClass" style="color: #343434;font-size: 12px;">  </em>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                <div class="form-group row">
                                  <label class="col-sm-5 col-form-label">Withdrawal 5 </label>
                                  <div class="col-sm-7">
                                    <div class="row">
                                      <div class="col-sm-5">
                                        <div class="d-flex align-items-center" style="white-space: nowrap;"> Period (Yrs) <input type="text" class="form-control ml-2" id="p5" name="period5" value="" onChange="AddAnother(5)" >
                                        </div>
                                        <div class="cal-icon" > Yrs </div>
                                      </div>
                                      <div class="col-sm-7">
                                        <div class="d-flex align-items-center" style="white-space: nowrap;"> Amount <input type="text" class="form-control ml-2" id="a5" name="amount5" value=""  onfocus="showValidation('amount5')" onfocusout="document.getElementById('amount5').innerHTML = ''" readonly>
                                        </div>
                                        <div class="cal-icon" > ₹ </div>
                                        <em id="amount5" class="error maxClass" style="color: #343434;font-size: 12px;">  </em>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                <div class="form-group row">
                                  <label class="col-sm-5 col-form-label">Report End Period</label>
                                  <div class="col-sm-7">
                                    <div class="row">
                                      <div class="col-sm-12">
                                        <div class="d-flex align-items-center">
                                          <input type="text" id="accval" class="form-control" name="lastwithdraw" value="" required="">
                                        </div>
                                        <div class="cal-icon"> Yrs </div>
                                      </div>
                                    </div>
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <label class="checkLinecontainer">Detailed Report
                                            <input class="form-check-input" type="radio" name="report" id="inlineRadio2" value="detailed" @if(old('report')=='detailed')  @else checked  @endif >
                                            <span class="checkmark"></span>
                                        </label> 
                                    </div>
                                </div>
