        ...
        <div id="content" class="container">
            <div class="row">
                ...
                @endphp
                    ...
                    <h5 style="color: #131f55;font-size:22px;margin-bottom:5px; text-align:center;"> Periodic Withdrawal Details </h5>
                    <table class="table table-bordered">
                        <tbody>
                    ...
                    @if($report == "detailed")
                        ...
                        @php 
                            ...
                            if($calcType==1){
                                $tableHtml .= '
                                    <h5 style="color: #131f55;font-size:22px;margin-bottom:5px; text-align:center;">
