                ...
                <div class="col-md-12">
                    ...
                    <form class="js-validate-form" action="{{route('frontend.swp_periodic_withdrawal_output')}}" method="post" id="emi">
                        ...
                        <div class="card sip-calculator singleLineHolder calculatorFormShape">
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-7">
                                <div class="row">
                                  <div class="col-sm-12">
                                    <div class="d-flex align-items-center">
                                      <input type="number" class="form-control pr-2 mr-0 maxtwodigit " name="currentage" value="{{$currentage}}" maxlength="2">
                                    </div>
                                ...
                                <div class="col-sm-7">
                                  <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                      ...
                                      <input type="text" name="actotal" id="actotal" class="form-control" value="{{$actotal}}" readonly>
                                    </div>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                  <div class="row">
                                    <div class="col-sm-3">
                                      <label class="col-form-label">Debt %</label>
                                      <input type="text" name="acdebt1" id="acdebt1" class="form-control" value="{{$acdebt1}}" onChange="SetAcTotal()" oninput="validate(this)">
                                    </div>
                                    <div class="col-sm-3">
                                      <label class="col-form-label">Hybrid %</label>
                                      <input type="text" name="achybrid1" id="achybrid1" class="form-control" value="{{$achybrid1}}" onChange="SetAcTotal()" oninput="validate(this)">
                                    </div>
                                    <div class="col-sm-3">
                                      <label class="col-form-label">Equity %</label>
                                      <input type="text" name="acequity1" id="acequity1" class="form-control" value="{{$acequity1}}" onChange="SetAcTotal()" oninput="validate(this)">
                                    </div>
                                    <div class="col-sm-3">
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-7">
                                <div class="row">
                                  <div class="col-sm-3">
                                    <label class="col-form-label">Debt %</label>
                                    <input type="text" name="debt1" id="debt1" class="form-control" value="{{$debt1}}" onChange="SetTotal()" oninput="validate(this)">
                                  </div>
                                  <div class="col-sm-3">
                                    <label class="col-form-label">Hybrid %</label>
                                    <input type="text" name="hybrid1" id="hybrid1" class="form-control" value="{{$hybrid1}}" onChange="SetTotal()" oninput="validate(this)">
                                  </div>
                                  <div class="col-sm-3">
                                    <label class="col-form-label">Equity %</label>
                                    <input type="text" name="equity1" id="equity1" class="form-control" value="{{$equity1}}" onChange="SetTotal()" oninput="validate(this)">
                                  </div>
                                  <div class="col-sm-3">
                                    <label class="col-form-label">Average %</label>
                                  ...
                                  <div class="col-sm-5">
                                    <div class="form-check form-check-inline">
                                        <label class="checkLinecontainer mb-0 mt-1" for="activateMe_1">No
                                            <input class="form-check-input fixed_deposit_chk" id="activateMe_1" type="radio" name="def" onchange="activateMe(1)"  @if($def==1) checked  @endif value=1>
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <label class="checkLinecontainer mb-0 mt-1" for="activateMe_2">Yes
                                            <input class="form-check-input fixed_deposit_chk" id="activateMe_2" type="radio" name="def" value=2 @if($def==2) checked  @endif onchange="activateMe(2)">
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                  </div>
                            ...
                            <div id="defermentallot" style="display:@if($def==2) block @else none  @endif;">
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                  <div class="row">
                                    <div class="col-sm-12">
                                      <div class="d-flex align-items-center">
                                        <input type="text" class="form-control pr-2 mr-0 maxtwodigit " id="swpdefer" name="deferment" value="{{$deferment}}" required="" maxlength="2">
                                      </div>
                                      <div class="cal-icon"> Yrs </div>
                                    </div>
                                  </div>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                  <div class="row">
                                    <div class="col-sm-12">
                                      <div class="d-flex align-items-center">
                                        <input type="text" class="form-control pr-2 mr-0 maxtwodigit " id="moneyback" name="moneyback" value="{{$moneyback}}" required="" maxlength="2">
                                      </div>
                                      <div class="cal-icon"> Yrs </div>
                                    </div>
                                  </div>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                  <div class="row">
                                    <div class="col-sm-12">
                                      <div class="d-flex align-items-center">
                                        <input type="text" class="form-control pr-2 mr-0 maxtwodigit " id="" name="installments" value="{{$installments}}" required="" maxlength="2">
                                      </div>
                                      <div class="cal-icon"> Yrs </div>
                                    </div>
                                  </div>
                            ...
                            <div id="swpmode" style="display:@if($def==1) block @else none  @endif;">
                              <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                      <div class="form-check form-check-inline">
                                          <label class="checkLinecontainer mb-0 mt-1" for="activateCustom_false">Fixed
                                            <input class="form-check-input fixed_deposit_chk" id="activateCustom_false" type="radio" name="swpmode" onchange="activateCustom(false)"  @if($swpmode==1) checked  @endif value=1>
                                            <span class="checkmark"></span>
                                          </label>
                                      </div>
                                      <div class="form-check form-check-inline">
                                          <label class="checkLinecontainer mb-0 mt-1" for="activateCustom_true">Custom
                                            <input class="form-check-input fixed_deposit_chk" id="activateCustom_true" @if($swpmode==2) checked  @endif type="radio" name="swpmode" value=2 onchange="activateCustom(true)">
                                            <span class="checkmark"></span>
                                          </label>
                                      </div>
                                    </div>
                              ...
                              <div id="fixed" style="display:@if($swpmode==1) block @else none  @endif;">
                                <div class="form-group row">
                              ...
                              <div id="custom" style="display:@if($swpmode==2) block @else none  @endif;">
                                <div class="form-group row">
                                  <label class="col-sm-5 col-form-label">Withdrawal 1 </label>
                                  <div class="col-sm-7">
                                    <div class="row">
                                      <div class="col-sm-5">
                                        <div class="d-flex align-items-center" style="white-space: nowrap;"> Period (Yrs) <input type="text" class="form-control ml-2" id="p1" name="period1" value="{{$period1}}" onChange="AddAnother(1)">
                                        </div>
                                        <div class="cal-icon">Yrs</div>
                                      </div>
                                      <div class="col-sm-7">
                                        <div class="d-flex align-items-center" style="white-space: nowrap;"> Amount <input type="text" class="form-control ml-2" id="a1" name="amount1" value="{{$amount1}}" onfocus="showValidation('amount1')" onfocusout="document.getElementById('amount1').innerHTML = ''" readonly>
                                        </div>
                                        <div class="cal-icon">₹</div>
                                ...
                                <div class="form-group row">
                                  ...
                                  <div class="col-sm-7">
                                    <div class="row">
                                      <div class="col-sm-5">
                                        <div class="d-flex align-items-center" style="white-space: nowrap;"> Period (Yrs) <input type="text" class="form-control ml-2" id="p2" name="period2" value="{{$period2}}" onChange="AddAnother(2)">
                                        </div>
                                        <div class="cal-icon">Yrs</div>
                                      </div>
                                      <div class="col-sm-7">
                                        <div class="d-flex align-items-center" style="white-space: nowrap;"> Amount <input type="text" class="form-control ml-2" id="a2" name="amount2" value="{{$amount2}}" onfocus="showValidation('amount2')" onfocusout="document.getElementById('amount2').innerHTML = ''" readonly>
                                        </div>
                                        <div class="cal-icon"> ₹ </div>
                                ...
                                <div class="form-group row">
                                  ...
                                  <div class="col-sm-7">
                                    <div class="row">
                                      <div class="col-sm-5">
                                        <div class="d-flex align-items-center" style="white-space: nowrap;"> Period (Yrs) <input type="text" class="form-control ml-2" id="p3" name="period3" value="{{$period3}}" onChange="AddAnother(3)">
                                        </div>
                                        <div class="cal-icon"> Yrs </div>
                                      </div>
                                      <div class="col-sm-7">
                                        <div class="d-flex align-items-center" style="white-space: nowrap;"> Amount <input type="text" class="form-control ml-2" id="a3" name="amount3" value="{{$amount3}}" onfocus="showValidation('amount3')" onfocusout="document.getElementById('amount3').innerHTML = ''" readonly>
                                        </div>
                                        <div class="cal-icon"> ₹ </div>
                                ...
                                <div class="form-group row">
                                  ...
                                  <div class="col-sm-7">
                                    <div class="row">
                                      <div class="col-sm-5">
                                        <div class="d-flex align-items-center" style="white-space: nowrap;"> Period (Yrs) &nbsp; <input type="text" class="form-control ml-2" id="p4" name="period4" value="{{$period4}}" onChange="AddAnother(4)">
                                        </div>
                                        <div class="cal-icon"> Yrs </div>
                                      </div>
                                      <div class="col-sm-7">
                                        <div class="d-flex align-items-center" style="white-space: nowrap;"> Amount <input type="text" class="form-control ml-2" id="a4" name="amount4" value="{{$amount4}}" onfocus="showValidation('amount4')" onfocusout="document.getElementById('amount4').innerHTML = ''" readonly>
                                        </div>
                                        <div class="cal-icon"> ₹ </div>
                                ...
                                <div class="form-group row">
                                  ...
                                  <div class="col-sm-7">
                                    <div class="row">
                                      <div class="col-sm-5">
                                        <div class="d-flex align-items-center" style="white-space: nowrap;"> Period (Yrs)&nbsp; <input type="text" class="form-control ml-2" id="p5" name="period5" value="{{$period5}}" onChange="AddAnother(5)">
                                        </div>
                                        <div class="cal-icon"> Yrs </div>
                                      </div>
                                      <div class="col-sm-7">
                                        <div class="d-flex align-items-center" style="white-space: nowrap;"> Amount <input type="text" class="form-control ml-2" id="a5" name="amount5" value="{{$amount5}}" onfocus="showValidation('amount5')" onfocusout="document.getElementById('amount5').innerHTML = ''" readonly>
                                        </div>
                                        <div class="cal-icon"> ₹ </div>
                                ...
                                <div class="form-group row">
                                  ...
                                  <div class="col-sm-7">
                                    <div class="row">
                                      <div class="col-sm-12">
                                        <div class="d-flex align-items-center">
                                          <input type="text" id="accval" class="form-control" name="lastwithdraw" value="{{$lastwithdraw}}" required="">
                                        </div>
                                        <div class="cal-icon"> Yrs </div>
                                      </div>
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="offset-1 col-sm-10">
                                    <div class=" calcBelowBtn">
                                        ...
                                        @else
                                            <a href="{{route('frontend.swp_periodic_withdrawal')}}" class="btn banner-btn whitebg mx-3"> Reset</a>
                                        @endif
