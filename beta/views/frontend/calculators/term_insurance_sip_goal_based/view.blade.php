            ...
            <div class="row">
                <div class="col-md-12 offset-md-0 text-center">
                    ...
                    <div class="outputTableHolder">
                        <h1 class="midheading">Term Insurance + SIP (Goal Based) Comparison @if(isset($clientname) && !empty($clientname)) <br> For {{$clientname?$clientname:''}} @else  @endif</h1>
                        ...
                        <div class="roundBorderHolder">
                            <table class="table table-bordered text-center">
                                ...
                                <tr>
                                    ...
                                    <th style="vertical-align: middle;">Annual Investment (Insurance Premium + SIP)</th>
                                    <th style="vertical-align: middle;">Year End SIP Value @ {{$rate_of_return?number_format($rate_of_return, 2, '.', ''):0}} %</th>
                                    <th style="vertical-align: middle;">In case of Death<br> (Life Cover + SIP Value)</th>
                                </tr>
