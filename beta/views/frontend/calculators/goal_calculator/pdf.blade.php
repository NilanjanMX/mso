            ...
            @foreach($list as $key => $value)
                ...
                <main class="mainPdf">
                    ...
                    <div style="padding: 0 0%;">
                        @if($key == 0)
                            <h1 class="pdfTitie">Goal Planning Calculation @if(isset($clientname) && !empty($clientname)) <br> For {{$clientname?$clientname:''}}  @else  @endif</h1>
                        @endif
                        <h1 class="pdfTitie">{{$value['purpose_of_investment']}} </h1>
                        ...
                        @if($value['cost_type'] == 1)
                            ...
                            <h1 class="pdfTitie">Assumed Rate of Return</h1>
                            <div class="roundBorderHolder">
                                <table>
                                    <tbody>
                                        <tr>
                            ...
                            <h1 class="pdfTitie">Investment Options</h1>
                            <div class="roundBorderHolder">
                                <table>
                                    <tbody>
                                        <tr>
