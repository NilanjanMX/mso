                                    ...
                                    <div style="padding-left: 20px;display: none;" id="lumpsum_monthly_sip_investment_mode_view_`+goal_calculator_index+`">
                                        <div class="form-group row">
                                            <label class="col-sm-12 checkLinecontainer mb-0 mt-2"> Lumpsum Amount
                                                <input id="lumpsum_monthly_sip_1_`+goal_calculator_index+`" type="radio" name="lumpsum_monthly_sip[`+goal_calculator_index+`]" value="1" checked="checked" onchange="changeLumpsumAmount(`+goal_calculator_index+`)">
                                                <span class="checkmark"></span>
                                            </label>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label class="col-sm-12 checkLinecontainer mb-0 mt-2"> Monthly SIP Amount
                                                <input id="lumpsum_monthly_sip_2_`+goal_calculator_index+`" type="radio" name="lumpsum_monthly_sip[`+goal_calculator_index+`]" value="2" onchange="changeMonthlySIPAmount(`+goal_calculator_index+`);">
                                                <span class="checkmark"></span>
                                            </label>
                                        </div>
                    ...
                    <form enctype="multipart/form-data" method="post" class="js-validate-form" action="{{route('frontend.goal_calculator_output')}}" name="goal_calculator_form" id="goal_calculator_form" onsubmit="return formSubmit();">
                        <div class="card sip-calculator singleLineHolder calculatorFormShape">
                                ...
                                <div id="goal_calculator_view">
                                    <div id="goal_calculator_view_0">
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group row">
                                                    <label class="col-sm-4 col-form-label">Purpose of Investment </label>
                                                    <div class="col-sm-8">
                                                        <input type="text" name="purpose_of_investment[0]" id="purpose_of_investment_0" class="form-control" value="" onkeyup="checkInput('purpose_of_investment',0,1);" message="text" datatype="0">
                                                        <em id="purpose_of_investment_error_0" class="error"></em>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <div class="d-flex align-items-center">
                                                            <input type="text" name="current_age[0]" id="current_age_0" class="form-control" value="" onkeyup="checkInput('current_age',0,2);">
                                                        </div>
                                                        <div class="cal-icon">
                                                            Yrs
                                                        </div>
                                                        <em id="current_age_error_0" class="error"></em>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12" style="display: flex;">
                                                <div class="form-check form-check-inline">
                                                    <label class="checkLinecontainer mb-0" for="cost_type_1_0">Future Cost
                                                        <input class="form-check-input fixed_deposit_chk" type="radio" name="cost_type[0]" id="cost_type_1_0" value="1" onchange="changeCostType(1,0)"  checked>
                                                        <span class="checkmark"></span>
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <label class="checkLinecontainer mb-0" for="cost_type_2_0">Current Cost
                                                        <input class="form-check-input fixed_deposit_chk" type="radio" name="cost_type[0]" id="cost_type_2_0" value="2"  onchange="changeCostType(2,0)" >
                                                        <span class="checkmark"></span>
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    <label class="col-sm-5 col-form-label" id="cost_type_amount_label_0">Future Cost</label>
                                                    <div class="col-sm-7">
                                                        <input type="text" name="amount[0]" id="amount_0" class="form-control" value="" onkeyup="checkInput('amount',0,3);">
                                                        <div class="cal-icon">
                                                            ₹
                                                        </div>
                                                        <em id="amount_error_0" class="error"></em>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4" id="inflation_view_0" style="display: none;">
                                                <div class="form-group row"> 
                                                    <label class="col-sm-5 col-form-label">Inflation</label>
                                                    <div class="col-sm-7">
                                                        <input type="text" name="inflation[0]" id="inflation_0" class="form-control" value="" onkeyup="checkInput('inflation',0,4);">
                                                        <div class="cal-icon">
                                                            %
                                                        </div>
                                                        <em id="inflation_error_0" class="error"></em>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group row">
                                                    <label class="col-sm-5 col-form-label">Period</label>
                                                    <div class="col-sm-7">
                                                        <input type="text" name="period[0]" id="period_0" class="form-control" value="" onkeyup="checkInput('period',0,5);">
                                                        <div class="cal-icon">
                                                            Yrs
                                                        </div>
                                                        <em id="period_error_0" class="error"></em>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row" style="padding-left: 20px;">
                                            <label class="col-sm-1 col-form-label">Debt</label>
                                            <div class="col-sm-3">
                                                <input type="text" name="aror_debt[0]" id="aror_debt_0" class="form-control" value="" onkeyup="checkInput('aror_debt',0,6);">
                                                <div class="cal-icon">
                                                    %
                                                </div>
                                                <em id="aror_debt_error_0" class="error"></em>
                                            </div>
                                            <label class="col-sm-1 col-form-label">Hybrid</label>
                                            <div class="col-sm-3">
                                                <input type="text" name="aror_hybrid[0]" id="aror_hybrid_0" class="form-control" value="" onkeyup="checkInput('aror_hybrid',0,7);">
                                                <div class="cal-icon">
                                                    %
                                                </div>
                                                <em id="aror_hybrid_error_0" class="error"></em>
                                            </div>
                                            <label class="col-sm-1 col-form-label">Equity</label>
                                            <div class="col-sm-3">
                                                <input type="text" name="aror_equity[0]" id="aror_equity_0" class="form-control" value="" onkeyup="checkInput('aror_equity',0,8);">
                                                <div class="cal-icon">
                                                    %
                                                </div>
                                                <em id="aror_equity_error_0" class="error"></em>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="row">
                                                <label class="col-sm-12 col-form-label checkcontainer2">
                                                    <input type="hidden" name="lumpsum_investment[0]" id="lumpsum_investment_0" value="1">
                                                    <input id="lumpsum_investment_mode_0" type="checkbox" name="lumpsum_investment_mode[]" value="1" checked="checked" onchange="changeLumpsumInvestmentMode(0);"> Lumpsum
                                                    <span class="checkmark"></span>
                                                </label>
                                            </div>
                                            <div class="form-group row" id="lumpsum_investment_mode_view_0"  style="padding-left: 20px;">
                                                <label class="col-sm-1 col-form-label">Debt</label>
                                                <div class="col-sm-2">
                                                    <input type="text" name="lumpsum_debt[0]" id="lumpsum_debt_0" class="form-control" value="" onkeyup="changeLumpsum(0);" readonly="readonly">
                                                    <div class="cal-icon">
                                                        %
                                                    </div>
                                                    <em id="lumpsum_debt_error_0" class="error"></em>
                                                </div>
                                                <label class="col-sm-1 col-form-label">Hybrid</label>
                                                <div class="col-sm-2">
                                                    <input type="text" name="lumpsum_hybrid[0]" id="lumpsum_hybrid_0" class="form-control" value="" onkeyup="changeLumpsum(0);" readonly="readonly">
                                                    <div class="cal-icon">
                                                        %
                                                    </div>
                                                    <em id="lumpsum_hybrid_error_0" class="error"></em>
                                                </div>
                                                <label class="col-sm-1 col-form-label">Equity</label>
                                                <div class="col-sm-2">
                                                    <input type="text" name="lumpsum_equity[0]" id="lumpsum_equity_0" class="form-control" value="" onkeyup="changeLumpsum(0);" readonly="readonly">
                                                    <div class="cal-icon">
                                                        %
                                                    </div>
                                                    <em id="lumpsum_equity_error_0" class="error"></em>
                                                </div>
                                                <label class="col-sm-1 col-form-label">Total</label>
                                                <div class="col-sm-2">
                                                    <input type="text" name="lumpsum_total[0]" id="lumpsum_total_0" class="form-control" value="" readonly="readonly" onkeyup="changeLumpsum(0);">
                                                    <div class="cal-icon">
                                                        %
                                                    </div>
                                                    <em id="lumpsum_total_error_0" class="error"></em>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            <div class="row">
                                                <label class="col-sm-12 col-form-label checkcontainer2">
                                                    <input type="hidden" name="monthly_sip_investment[0]" id="monthly_sip_investment_0" value="0">
                                                    <input id="monthly_sip_investment_mode_0" type="checkbox" name="monthly_sip_investment_mode[0]" value="2" onchange="changeMonthlySIPInvestmentMode(0);"> Monthly SIP
                                                    <span class="checkmark"></span>
                                                </label>
                                            </div>
                                            <div class="form-group row"style="padding-left: 20px;display: none;" id="monthly_sip_investment_mode_view_0">
                                                <label class="col-sm-1 col-form-label">Debt</label>
                                                <div class="col-sm-2">
                                                    <input type="text" name="monthly_sip_debt[0]" id="monthly_sip_debt_0" class="form-control" value="" onkeyup="changeMonthlySIP(0);" readonly="readonly">
                                                    <div class="cal-icon">
                                                        %
                                                    </div>
                                                    <em id="monthly_sip_debt_error_0" class="error"></em>
                                                </div>
                                                <label class="col-sm-1 col-form-label">Hybrid</label>
                                                <div class="col-sm-2">
                                                    <input type="text" name="monthly_sip_hybrid[0]" id="monthly_sip_hybrid_0" class="form-control" value="" onkeyup="changeMonthlySIP(0);" readonly="readonly">
                                                    <div class="cal-icon">
                                                        %
                                                    </div>
                                                    <em id="monthly_sip_hybrid_error_0" class="error"></em>
                                                </div>
                                                <label class="col-sm-1 col-form-label">Equity</label>
                                                <div class="col-sm-2">
                                                    <input type="text" name="monthly_sip_equity[0]" id="monthly_sip_equity_0" class="form-control" value="" onkeyup="changeMonthlySIP(0);" readonly="readonly">
                                                    <div class="cal-icon">
                                                        %
                                                    </div>
                                                    <em id="monthly_sip_equity_error_0" class="error"></em>
                                                </div>
                                                <label class="col-sm-1 col-form-label">Total</label>
                                                <div class="col-sm-2">
                                                    <input type="text" name="monthly_sip_total[0]" id="monthly_sip_total_0" class="form-control" value="" readonly="readonly">
                                                    <div class="cal-icon">
                                                        %
                                                    </div>
                                                    <em id="monthly_sip_total_error_0" class="error"></em>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            <div class="row">
                                                <label class="col-sm-12 col-form-label checkcontainer2">
                                                    <input type="hidden" name="limited_period_monthly_investment[0]" id="limited_period_monthly_investment_0" value="0">
                                                    <input id="limited_period_monthly_investment_mode_0" type="checkbox" name="limited_period_monthly_investment_mode[0]" value="3" onchange="changeLimitedPeriodMonthlySIPInvestmentMode(0);"> Limited Period Monthly SIP
                                                    <span class="checkmark"></span>
                                                </label>
                                            </div>
                                            <div class="form-group row" style="padding-left: 20px;display: none;" id="limited_period_monthly_investment_mode_period_view_0">
                                                <label class="col-sm-2 col-form-label">1. SIP Period</label>
                                                <div class="col-sm-2">
                                                    <input type="text" name="limited_period_monthly_sip_period_1[0]" id="limited_period_monthly_sip_period_1_0" class="form-control" value="">
                                                    <div class="cal-icon">
                                                        Yr
                                                    </div>
                                                    <em id="limited_period_monthly_sip_period_1_error_0" class="error"></em>
                                                </div>
                                                <label class="col-sm-2 col-form-label">2. SIP Period</label>
                                                <div class="col-sm-2">
                                                    <input type="text" name="limited_period_monthly_sip_period_2[0]" id="limited_period_monthly_sip_period_2_0" class="form-control" value="">
                                                    <div class="cal-icon">
                                                       Yr
                                                    </div>
                                                    <em id="limited_period_monthly_sip_period_2_error_0" class="error"></em>
                                                </div>
                                                <label class="col-sm-2 col-form-label">3. SIP Period</label>
                                                <div class="col-sm-2">
                                                    <input type="text" name="limited_period_monthly_sip_period_3[0]" id="limited_period_monthly_sip_period_3_0" class="form-control" value="">
                                                    <div class="cal-icon">
                                                        Yr
                                                    </div>
                                                    <em id="limited_period_monthly_sip_period_3_error_0" class="error"></em>
                                                </div>
                                            </div>
                                            <div class="form-group row" style="padding-left: 20px;display: none;" id="limited_period_monthly_investment_mode_view_0">
                                                <label class="col-sm-1 col-form-label">Debt</label>
                                                <div class="col-sm-2">
                                                    <input type="text" name="limited_period_monthly_sip_debt[0]" id="limited_period_monthly_sip_debt_0" class="form-control" value="" onkeyup="changeLimitedPeriodMonthlySIP(0);" readonly="readonly">
                                                    <div class="cal-icon">
                                                        %
                                                    </div>
                                                    <em id="limited_period_monthly_sip_debt_error_0" class="error"></em>
                                                </div>
                                                <label class="col-sm-1 col-form-label">Hybrid</label>
                                                <div class="col-sm-2">
                                                    <input type="text" name="limited_period_monthly_sip_hybrid[0]" id="limited_period_monthly_sip_hybrid_0" class="form-control" value="" onkeyup="changeLimitedPeriodMonthlySIP(0);" readonly="readonly">
                                                    <div class="cal-icon">
                                                        %
                                                    </div>
                                                    <em id="limited_period_monthly_sip_hybrid_error_0" class="error"></em>
                                                </div>
                                                <label class="col-sm-1 col-form-label">Equity</label>
                                                <div class="col-sm-2">
                                                    <input type="text" name="limited_period_monthly_sip_equity[0]" id="limited_period_monthly_sip_equity_0" class="form-control" value="" onkeyup="changeLimitedPeriodMonthlySIP(0);" readonly="readonly">
                                                    <div class="cal-icon">
                                                        %
                                                    </div>
                                                    <em id="limited_period_monthly_sip_equity_error_0" class="error"></em>
                                                </div>
                                                <label class="col-sm-1 col-form-label">Total</label>
                                                <div class="col-sm-2">
                                                    <input type="text" name="limited_period_monthly_sip_total[0]" id="limited_period_monthly_sip_total_0" class="form-control" value="" readonly="readonly">
                                                    <div class="cal-icon">
                                                        %
                                                    </div>
                                                    <em id="limited_period_monthly_sip_total_error_0" class="error"></em>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            <div class="row">
                                                <label class="col-sm-12 col-form-label checkcontainer2">
                                                    <input type="hidden" name="lumpsum_monthly_sip_investment[0]" id="lumpsum_monthly_sip_investment_0" value="0">
                                                    <input id="lumpsum_monthly_sip_investment_mode_0" type="checkbox" name="lumpsum_monthly_sip_investment_mode[]" value="4" onchange="changeLumpsumMonthlySIPInvestmentMode(0);"> Lumpsum+Monthly SIP
                                                    <span class="checkmark"></span>
                                                </label>
                                            </div>
                                            <div style="padding-left: 20px;display: none;" id="lumpsum_monthly_sip_investment_mode_view_0">
                                                <div class="form-group row">
                                                    <label class="col-sm-12 checkLinecontainer mb-0 mt-2"> Lumpsum Amount
                                                        <input class="form-check-input fixed_deposit_chk" id="lumpsum_monthly_sip_1_0" type="radio" name="lumpsum_monthly_sip[0]" value="1" checked="checked" onchange="changeLumpsumAmount(0)">
                                                        <span class="checkmark"></span>
                                                    </label>
                                                </div>

                                                <div style="padding-left: 20px;" id="lumpsum_monthly_sip_lumpsum_view_0">

                                                    <div class="form-group row">
                                                        <label class="col-sm-1 col-form-label">Debt</label>
                                                        <div class="col-sm-2">
                                                            <input type="text" name="lumpsum_monthly_sip_amount_debt[0]" id="lumpsum_monthly_sip_amount_debt_0" class="form-control" value="" onkeyup="changeLumpsumMonthlySIPAmount(0); maxFunction(0,1);" readonly="readonly">
                                                            <div class="cal-icon">
                                                                %
                                                            </div>
                                                        ...
                                                        <label class="col-sm-1 col-form-label">Hybrid</label>
                                                        <div class="col-sm-2">
                                                            <input type="text" name="lumpsum_monthly_sip_amount_hybrid[0]" id="lumpsum_monthly_sip_amount_hybrid_0" class="form-control" value="" onkeyup="changeLumpsumMonthlySIPAmount(0); maxFunction(0,1);" readonly="readonly">
                                                            <div class="cal-icon">
                                                                %
                                                            </div>
                                                            <em id="lumpsum_monthly_sip_amount_hybrid_error_0" class="error"></em>
                                                        </div>
                                                        <label class="col-sm-1 col-form-label">Equity</label>
                                                        <div class="col-sm-2">
                                                            <input type="text" name="lumpsum_monthly_sip_amount_equity[0]" id="lumpsum_monthly_sip_amount_equity_0" class="form-control" value="" onkeyup="changeLumpsumMonthlySIPAmount(0); maxFunction(0,1);" readonly="readonly">
                                                            <div class="cal-icon">
                                                                %
                                                            </div>
                                                            <em id="lumpsum_monthly_sip_amount_equity_error_0" class="error"></em>
                                                        </div>
                                                        <label class="col-sm-1 col-form-label">Total</label>
                                                        <div class="col-sm-2">
                                                            <input type="text" name="lumpsum_monthly_sip_amount_total[0]" id="lumpsum_monthly_sip_amount_total_0" class="form-control" value="" readonly="readonly" >
                                                            <div class="cal-icon">
                                                                %
                                                            </div>
                                                            <em id="lumpsum_monthly_sip_amount_total_error_0" class="error"></em>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-sm-2 col-form-label">Amount</label>
                                                        <div class="col-sm-4" id="lumpsum_monthly_sip_lumpsum_amount_view_0">
                                                            <input type="text" name="lumpsum_monthly_sip_lumpsum_amount[0]" class="form-control" id="lumpsum_monthly_sip_lumpsum_amount_0" value="" onkeyup="maxFunction(0,1); changeAmount(0,1);">
                                                            <div class="cal-icon">
                                                                ₹
                                                            </div>
                                                            <em id="lumpsum_monthly_sip_lumpsum_amount_error_0" class="error"></em>
                                                        </div>
                                                        <div class="col-sm-4" style="padding-top: 9px;" id="lumpsum_monthly_sip_lumpsum_amount_exceed_0">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-sm-12 checkLinecontainer mb-0 mt-2"> Monthly SIP Amount
                                                        <input class="form-check-input fixed_deposit_chk" id="lumpsum_monthly_sip_2_0" type="radio" name="lumpsum_monthly_sip[0]" value="2" onchange="changeMonthlySIPAmount(0);" >
                                                        <span class="checkmark"></span>
                                                    </label>
                                                </div>
                                                <div style="padding-left: 20px;" id="lumpsum_monthly_sip_view_0">
                                                    <div class="form-group row">
                                                        <label class="col-sm-1 col-form-label">Debt</label>
                                                        <div class="col-sm-2">
                                                            <input type="text" name="lumpsum_monthly_sip_debt[0]" id="lumpsum_monthly_sip_debt_0" class="form-control" value="" onkeyup="changeLumpsumMonthlySIP(0); maxFunction(0,2);" readonly="readonly">
                                                            <div class="cal-icon">
                                                                %
                                                            </div>
                                                            <em id="lumpsum_monthly_sip_debt_error_0" class="error"></em>
                                                        </div>
                                                        <label class="col-sm-1 col-form-label">Hybrid</label>
                                                        <div class="col-sm-2">
                                                            <input type="text" name="lumpsum_monthly_sip_hybrid[0]" id="lumpsum_monthly_sip_hybrid_0" class="form-control" value="" onkeyup="changeLumpsumMonthlySIP(0); maxFunction(0,2);" readonly="readonly">
                                                            <div class="cal-icon">
                                                                %
                                                            </div>
                                                            <em id="lumpsum_monthly_sip_hybrid_error_0" class="error"></em>
                                                        </div>
                                                        <label class="col-sm-1 col-form-label">Equity</label>
                                                        <div class="col-sm-2">
                                                            <input type="text" name="lumpsum_monthly_sip_equity[0]" id="lumpsum_monthly_sip_equity_0" class="form-control" value="" onkeyup="changeLumpsumMonthlySIP(0); maxFunction(0,2);" readonly="readonly">
                                                            <div class="cal-icon">
                                                                %
                                                            </div>
                                                            <em id="lumpsum_monthly_sip_equity_error_0" class="error"></em>
                                                        </div>
                                                        <label class="col-sm-1 col-form-label">Total</label>
                                                        <div class="col-sm-2">
                                                            <input type="text" name="lumpsum_monthly_sip_total[0]" id="lumpsum_monthly_sip_total_0" class="form-control" value="" readonly="readonly">
                                                            <div class="cal-icon">
                                                                %
                                                            </div>
                                                            <em id="lumpsum_monthly_sip_total_error_0" class="error"></em>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-sm-2 col-form-label">Amount</label>
                                                        <div class="col-sm-4" id="lumpsum_monthly_sip_amount_view_0">
                                                            <input type="text" name="lumpsum_monthly_sip_amount[0]" class="form-control" id="lumpsum_monthly_sip_amount_0" value="" onkeyup="maxFunction(0,2); changeAmount(0,2);" readonly="readonly">
                                                            <div class="cal-icon">
                                                                ₹
                                                            </div>
                                                            <em id="lumpsum_monthly_sip_amount_error_0" class="error"></em>
                                                        </div>
                                                        <div class="col-sm-4" style="padding-top: 9px;" id="lumpsum_monthly_sip_amount_exceed_0">
