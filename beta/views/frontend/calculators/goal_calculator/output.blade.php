...
@section('content')
    ...
    <div class="banner styleApril">
        ...
        @include('frontend.calculators.left_sidebar')
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="page-title">Goal Calculator</h2>
                </div>
            </div>
        </div>
    </div>
        ...
        <div id="content" class="container">
            <div class="row">
                <div class="col-md-12 offset-md-0 text-center">
                    <a href="{{route('frontend.goal_calculator')}}?action=back" class="btn btn-primary btn-round"><i class="fa fa-angle-left"></i> Back</a>
                    ...
                    <div class="outputTableHolder">
                        <h1 class="midheading">Goal Planning Calculation @if(isset($clientname) && !empty($clientname)) For {{$clientname?$clientname:''}}  @else  @endif</h1>
                        
                        @foreach($list as $key => $value)
    
                            <h1 class="midheading">{{$value['purpose_of_investment']}} </h1>
                            ...
                            @if($value['cost_type'] == 1)
                                ...
                                <h1 class="midheading">Assumed Rate of Return</h1>
                                <div class="roundBorderHolder">
                                    <table class="table table-bordered">
                                    <tbody>
                                        <tr>
                                ...
                                <h1 class="midheading">Investment Options</h1>
                                <div class="roundBorderHolder">
                                    <table class="table table-bordered">
                                    <tbody>
                                        <tr>
