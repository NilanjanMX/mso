                    ...
                    <form enctype="multipart/form-data" method="post" class="js-validate-form" action="{{route('frontend.goal_calculator_output')}}" name="goal_calculator_form" id="goal_calculator_form" onsubmit="return formSubmit();">
                                ...
                                <div id="goal_calculator_view">
                                    @foreach($list as $key => $value)
                                        <div id="goal_calculator_view_{{$key}}">
                                            @if($key)
                                                <div class="form-group row mt2 mb2" id="goal_calculator_remove_view_{{$key}}">
                                                    <div class="col-sm-12 text-center">
                                                        <button type="button" class="btn banner-btn my-3 removeGoalCalculatorBtn" onclick="removeGoalCalculator(`{{$key}}`);" style="background-color: #dc3545;border-color: #dc3545;color: #fff !important;"> Remove Goal Calculator</button>
                                                    </div>
                                                </div>
                                            @endif
                                            <div class="row">
                        ...
                        <div class="card sip-calculator singleLineHolder calculatorFormShape">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <textarea class="form-control {{ $errors->has('note') ? ' is-invalid' : '' }}" name="note" rows="2" id="note" style="height: 100px;" maxlength="500" onkeyup="changeNote();">@if(isset($note)) {{$note}} @endif</textarea>
                                    ...
                                    <div class="offset-1 col-sm-10">
                                        <div class="calcBelowBtn">
                                            ...
                                            @if(session()->get('calculator_form_id'))
                                                <button type="button" onclick="location.reload();" class="btn banner-btn whitebg mx-3"> Reset</button>
                                            @else
                                                <a href="{{route('frontend.goal_calculator')}}" class="btn banner-btn whitebg mx-3"> Reset</a>
                                            @endif
                                                <button class="btn banner-btn mx-3">Calculate</button>
                                        </div>
                                    </div>
