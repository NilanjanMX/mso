	  ...
	  <div class="modal-dialog modal-dialog-centered" role="document">
	    <div class="modal-content">
	        ...
	        <div class="modal-footer text-center" style="justify-content: center;">
	            ...
	            <a href="" class="btn btn-secondary btnblue" id="without_cover_page" onclick="closeErrorAfterLoginModal();" >Without Cover Page</a>
	        </div>
	    </div>
	  </div>
	</div> -->
...
@else
	<div class="modal fade" id="errorAfterLoginModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
	  <div class="modal-dialog modal-dialog-centered" role="document">
	    <div class="modal-content">
	        <div class="successHead text-center">
	            <h3>Download Without Cover Page</h3>
	            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
	              <span aria-hidden="true">&times;</span>
	            </button>
	        </div>
	        <div class="modal-footer text-center" style="justify-content: center;">
	            <a href="javascript:void(0);" class="btn btn-secondary btnblue" id="with_cover_page" onclick="withCoverPage();" >With Cover Page</a>
	            <a href="" class="btn btn-secondary btnblue" id="without_cover_page" onclick="closeErrorAfterLoginModal();" >Download Now </a>
	        </div>
	    </div>
	  </div>
	</div>
...
<script type="text/javascript">
	...
	const withCoverBtn = document.querySelector('#save-list-button');

	withCoverBtn.addEventListener("click",function(e){
		e.preventDefault();
		
		var form = document.getElementById("downloadModalForm");
		var cover_img = "{{ get_cover_img() }}";
		var pdf_title_line1 = document.getElementById("pdf_title_line1").value;
		console.log(cover_img);
		if(pdf_title_line1 && !cover_img){
			alert("Please choose any cover image from display settings!")
			return;
		}else{
			form.submit();
		}
    ...
    function closeErrorAfterLoginModal(){
        $('#errorAfterLoginModal').modal('hide');
    }
