<style>
    .styleApril table.suggested-sceme tr.performanceTime th {
        width: 8%;
    }
</style>
    ...
    @if(isset($suggest) && session()->has('suggested_scheme_list'))
        ...
        <main class="mainPdf">
            @php
                ...
                $hybrid_cnt = 0;
                $other_cnt = 0;
                foreach($suggested_scheme_list as $suggested_scheme_key=>$suggested_scheme){
                ...
                $calculator_duration_count = $past_performance;


                if(in_array("AUM", $calculator_duration)){
                    $calculator_duration_count = $calculator_duration_count+1;
                }
                if(in_array("TYPE", $calculator_duration)){
                    $calculator_duration_count = $calculator_duration_count+2;
                }

            @endphp
            

            <div class="roundBorderHolder withBluebar withBluebarMrgn" style="border-radius: 12px;">
            <table class="suggested-sceme">
                <tbody>
                <tr>
                    @if($suggested_performance=='with_performance')
                        <td class="nobordernopadding" colspan="{{$calculator_duration_count+2}}">
                    @else
                        @if(in_array("TYPE", $calculator_duration))
                            <td class="nobordernopadding" colspan="5">
                        @else
                ...
                @if($debt_cnt>0)
                    ...
                    @if($suggested_performance=='with_performance')
                        <tr>
                            <th colspan="{{$calculator_duration_count+2}}" style="text-align: center;background: {{$address_color_background}} !important; color: #fff !important;text-transform:uppercase">DEBT</th>
                        </tr>
                        <tr>
                            <th rowspan="2" style="vertical-align: middle;width:5%;">S.&nbsp;No.</th>
                            <th rowspan="2" style="vertical-align: middle;">Scheme Name</th>
                            @if(in_array("AUM", $calculator_duration))
                                <th rowspan="2" style="vertical-align: middle;width: 10%;">AUM <br>(<span class="pdfRupeeIcon">&#8377;</span> Cr)</th>
                            @endif
                            <th colspan="{{$past_performance}}" style="vertical-align: middle; text-align: center;white-space: nowrap;">Past Performance (%)</th>
                            @if(in_array("TYPE", $calculator_duration))
                                <th rowspan="2" style="vertical-align: middle;width: 10%;">Type<br>&nbsp;</th>
                                <th rowspan="2" style="vertical-align: middle;width: 10%;">Amount <br>(<span class="pdfRupeeIcon">&#8377;</span>)</th>
                            @endif
                        </tr>
                        <tr class="performanceTime">
                            @if(in_array("PERCHANGE", $calculator_duration))
                                <th>1&nbsp;Day</th>
                            @endif
                            @if(in_array("1WEEKRET", $calculator_duration))
                    ...
                    @else
                        <tr>
                            <th colspan="5" style="text-align: center;background: {{$address_color_background}} !important; color: #fff !important;text-transform:uppercase">DEBT</th>
                        </tr>
                        <tr>
                            <th>S.&nbsp;No.</th>
                            <th>Scheme Name</th>
                            ...
                            @endif
                            @if(in_array("TYPE", $calculator_duration))
                                <th>Amount <br>(<span class="pdfRupeeIcon">&#8377;</span>)</th>
                            @endif
                        </tr>
                    @endif
                    @foreach($suggested_scheme_list as $suggested_scheme_key=>$suggested_scheme)
                        ...
                        @if($suggested_scheme['ASSET_TYPE']=='Debt')
                            <tr>
                                <td>{{$scheme_cnt}}</td>
                                <td style="text-align: left; padding-left: 10px"><strong>{{(strlen($suggested_scheme['S_NAME']) > 70)?substr($suggested_scheme['S_NAME'], 0, 70).'..':$suggested_scheme['S_NAME']}}</strong> <br><span style="font-size: 12px;"><i>{{(strlen($suggested_scheme['CATEGORY']) > 103)?substr($suggested_scheme['CATEGORY'], 0, 103).'..':$suggested_scheme['CATEGORY']}}</i></spen></td>
                                @if($suggested_performance=='with_performance')
                                    @if(in_array("AUM", $calculator_duration))
                                    ...
                                    @endif
                                    @if(in_array("TYPE", $calculator_duration))
                                    <td>{{isset($scheme_type[$suggested_scheme_key])?$scheme_type[$suggested_scheme_key]:""}}</td>
                                    @endif
                                    @if(in_array("TYPE", $calculator_duration))
                                    <td>{{isset($scheme_amount[$suggested_scheme_key])?custome_money_format($scheme_amount[$suggested_scheme_key]):""}}</td>
                                    @endif
                                @else
                                    @if(in_array("TYPE", $calculator_duration))
                                    <td>{{isset($scheme_type[$suggested_scheme_key])?$scheme_type[$suggested_scheme_key]:""}}</td>
                ...
                @if($hybrid_cnt>0)
                    ...
                    @if($suggested_performance=='with_performance')
                        <tr>
                            <th colspan="{{$calculator_duration_count+2}}" style="text-align: center;background: {{$address_color_background}} !important; color: #fff !important;text-transform:uppercase">HYBRID</th>
                        </tr>
                        <tr>
                            <th rowspan="2" style="vertical-align: middle;width:5%;">S.&nbsp;No.</th>
                            <th rowspan="2" style="vertical-align: middle;">Scheme Name</th>
                    ...
                    @else
                        <tr>
                            <th colspan="5" style="text-align: center;background: {{$address_color_background}} !important; color: #fff !important;text-transform:uppercase">HYBRID</th>
                        </tr>
                        <tr>
                            <th>S.&nbsp;No.</th>
                            <th>Scheme Name</th>
                ...
                @if($equity_cnt>0)
                    ...
                    @if($suggested_performance=='with_performance')
                        <tr>
                            <th colspan="{{$calculator_duration_count+2}}" style="text-align: center;background: {{$address_color_background}} !important; color: #fff !important;text-transform:uppercase">EQUITY</th>
                        </tr>
                        <tr>
                            <th rowspan="2" style="vertical-align: middle;width:5%;">S.&nbsp;No.</th>
                            <th rowspan="2" style="vertical-align: middle;">Scheme Name</th>
                    ...
                    @else
                        <tr>
                            <th colspan="5" style="text-align: center;background: {{$address_color_background}} !important; color: #fff !important;text-transform:uppercase">EQUITY</th>
                        </tr>
                        <tr>
                            <th>S.&nbsp;No.</th>
                            <th>Scheme Name</th>
                ...
                @if($commodity_cnt>0)
                    ...
                    @if($suggested_performance=='with_performance')
                        <tr>
                            <th colspan="{{$calculator_duration_count+2}}" style="text-align: center;background: {{$address_color_background}} !important; color: #fff !important;text-transform:uppercase">COMMODITY</th>
                        </tr>
                        <tr>
                            <th rowspan="2" style="vertical-align: middle;width:5%;">S.&nbsp;No.</th>
                            <th rowspan="2" style="vertical-align: middle;">Scheme Name</th>
                    ...
                    @else
                        <tr>
                            <th colspan="5" style="text-align: center;background: {{$address_color_background}} !important; color: #fff !important;text-transform:uppercase">COMMODITY</th>
                        </tr>
                        <tr>
                            <th>S.&nbsp;No.</th>
                            <th>Scheme Name</th>
                ...
                @if($other_cnt>0)
                    ...
                    @if($suggested_performance=='with_performance')
                        <tr>
                            <th colspan="{{$calculator_duration_count+2}}" style="text-align: center;background: {{$address_color_background}} !important; color: #fff !important;text-transform:uppercase">OTHERS</th>
                        </tr>
                        <tr>
                            <th rowspan="2" style="vertical-align: middle;width:5%;">S.&nbsp;No.</th>
                            <th rowspan="2" style="vertical-align: middle;">Scheme Name</th>
                    ...
                    @else
                        <tr>
                            <th colspan="5" style="text-align: center;background: {{$address_color_background}} !important; color: #fff !important;text-transform:uppercase">OTHERS</th>
                        </tr>
                        <tr>
                            <th>S.&nbsp;No.</th>
                            <th>Scheme Name</th>
