            ...
            <table class="suggested-sceme">
                ...
                <tr>
                    @if($suggested_performance=='with_performance')
                        <td class="nobordernopadding" colspan="{{$calculator_duration_count+3}}">
                    @else
                        @if(in_array("TYPE", $calculator_duration))
                ...
                @if($debt_cnt>0)
                    ...
                    @if($suggested_performance=='with_performance')
                        <tr>
                            <th colspan="{{$calculator_duration_count+3}}" style="text-align: center;background: {{$address_color_background}} !important; color: #fff !important;text-transform:uppercase">DEBT</th>
                        </tr>
                        <tr>
                            ...
                            @endif
                            <th colspan="{{$past_performance}}" style="vertical-align: middle; text-align: center">Past Performance</th>
                            @if(in_array("TYPE", $calculator_duration))
                ...
                @if($hybrid_cnt>0)
                    ...
                    @if($suggested_performance=='with_performance')
                        <tr>
                            <th colspan="{{$calculator_duration_count+3}}" style="text-align: center;background: {{$address_color_background}} !important; color: #fff !important;text-transform:uppercase">HYBRID</th>
                        </tr>
                        <tr>
                            <th rowspan="2" style="vertical-align: middle;width:5%;">S.&nbsp;No.</th>
                            <th rowspan="2" style="vertical-align: middle;">Scheme Name</th>
                ...
                @if($equity_cnt>0)
                    ...
                    @if($suggested_performance=='with_performance')
                        <tr>
                            <th colspan="{{$calculator_duration_count+3}}" style="text-align: center;background: {{$address_color_background}} !important; color: #fff !important;text-transform:uppercase">EQUITY</th>
                        </tr>
                        <tr>
                            <th rowspan="2" style="vertical-align: middle;width:5%;">S.&nbsp;No.</th>
                            <th rowspan="2" style="vertical-align: middle;">Scheme Name</th>
                ...
                @if($commodity_cnt>0)
                    ...
                    @if($suggested_performance=='with_performance')
                        <tr>
                            <th colspan="{{$calculator_duration_count+3}}" style="text-align: center;background: {{$address_color_background}} !important; color: #fff !important;text-transform:uppercase">COMMODITY</th>
                        </tr>
                        <tr>
                            <th rowspan="2" style="vertical-align: middle;width:5%;">S.&nbsp;No.</th>
                            <th rowspan="2" style="vertical-align: middle;">Scheme Name</th>
                ...
                @if($other_cnt>0)
                    ...
                    @if($suggested_performance=='with_performance')
                        <tr>
                            <th colspan="{{$calculator_duration_count+3}}" style="text-align: center;background: {{$address_color_background}} !important; color: #fff !important;text-transform:uppercase">OTHERS</th>
                        </tr>
                        <tr>
                            <th rowspan="2" style="vertical-align: middle;width:5%;">S.&nbsp;No.</th>
                            <th rowspan="2" style="vertical-align: middle;">Scheme Name</th>
