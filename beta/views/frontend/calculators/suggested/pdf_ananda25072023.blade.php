                    ...
                    @if($suggested_performance=='with_performance')
                        ...
                        <tr>
                            ...
                            @if(in_array("TYPE", $calculator_duration))
                                ...
                                <th rowspan="2" style="vertical-align: middle;">Amount <br>(<span class="pdfRupeeIcon">&#8377;</span>)</th>
                            @endif
                        </tr>
                    ...
                    @foreach($suggested_scheme_list as $suggested_scheme)
                        ...
                        @if($suggested_scheme['ASSET_TYPE']=='Debt')
                            <tr>
                                ...
                                <td style="text-align: left; padding-left: 5px">{{(strlen($suggested_scheme['CATEGORY']) > 103)?substr($suggested_scheme['CATEGORY'], 0, 103).'..':$suggested_scheme['CATEGORY']}}</td>
                                @if($suggested_performance=='with_performance')
                                    @if(in_array("AUM", $calculator_duration))
