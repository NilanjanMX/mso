    ...
    function drawChart() {
        @if(isset($rate2_percent))
            var data = google.visualization.arrayToDataTable([
                ...
                @for($i=1;$i<=$payment_period+$deferment_period;$i++)
                    @php
                        ...
                        if($i<=$payment_period){
                            $cumulative_investment = $cumulative_investment + $amount;
                        }
...
<!-- <div class="banner bannerForAll container" style="padding-bottom: 0; margin-bottom: 15px;">
    ...
    <div class="banner styleApril">
        ...
        @include('frontend.calculators.left_sidebar')
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="page-title">Future Value of Annual Lump sum Investment</h2>
                </div>
            </div>
        </div>
    </div>
        ...
        <div id="content" class="container">
            <div class="row">
                <div class="col-md-12 offset-md-0 text-center">
                    ...
                    @else
                        <a href="{{route('frontend.futureValueOfAnnualLumpsumInvestment_back')}}?action=back" class="btn btn-primary btn-round"><i class="fa fa-angle-left"></i> Back</a>
                    @endif
                    ...
                    <div class="outputTableHolder">
                        <h1 class="midheading">Annual Lumpsum @if(isset($clientname) && !empty($clientname)) Calculation <br> For {{$clientname?$clientname:''}} @else Planning @endif</h1>
    ...
    <script type="text/javascript">
        var base_url = "{{route('frontend.futureValueOfAnnualLumpsumInvestment_pdf')}}";
    </script>
