...
@section('js_after')
    <script>
        ...
        function changeInvestmentPeriod(){
            var investment_period = $("input[name=investment_period]").val();
            
            $("input[name=payment_period]").val(investment_period);
        }
                        ...
                        <form class="js-validate-form" action="{{route('frontend.futureValueOfAnnualLumpsumInvestment_output')}}" method="post">
                            <div class="card sip-calculator singleLineHolder calculatorFormShape">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control maxtwodigit {{ $errors->has('investment_period') ? ' is-invalid' : '' }}" name="investment_period" value="{{old('investment_period')}}"  id="investment_period">
                                        <div class="cal-icon">
                                            Yrs
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control maxtwodigit {{ $errors->has('payment_period') ? ' is-invalid' : '' }}" name="payment_period"
                                        id="payment_period" 
                                        value="{{old('payment_period')}}"  >
                                        <div class="cal-icon">
                                            Yrs
                                        </div>
