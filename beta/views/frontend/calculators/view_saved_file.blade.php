                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($save_file['data'])
                                                            ...
                                                            <a href="{{url('/')}}/{{$save_file['url']}}-view?id={{$save_file['id']}}" class="btn btn-primary btn-sm" title="View">
                                                                <i class="fas fa-eye"></i>
                                                            </a>

                                                            <a href="{{url('/')}}/{{$save_file['url']}}-edit?id={{$save_file['id']}}" class="btn btn-primary btn-sm" title="Edit" style="background: #666667;border-color: #666667;">
                                                                <i class="fas fa-pencil-alt"></i>
                                                            </a>
                                                        @else
                                                            <a href="{{route('frontend.view_saved_file_details',['id'=>$save_file['id']])}}" class="btn btn-primary btn-sm" title="View">
                                                                <i class="fas fa-eye"></i>
                                                            </a>
                                                        @endif
