...
<main class="mainPdf">
    ...
    @endif
            ...
            @else
                ...
                <h2 style="color: #131f55;font-size:22px;marginn-bottom:5px;"><span class="pdfRupeeIcon">&#8377;</span>  {{custome_money_format($monthly_annuity_amount1)}}</h2>
    ...
    @endif
            ...
            <?php if($deferment=='yes' && $include_inflation == 'yes' && $include_taxation == 'yes'){ ?>
                ...
                @else
                    ...
                    <h2 style="color: #131f55;font-size:22px;marginn-bottom:5px;"><span class="pdfRupeeIcon">&#8377;</span>  
                        @php
                            $av41_inf=(1+($expected_inflation_rate/100))**(1/12)-1;
                            $av50_new=($monthly_annuity_amount1*((1+$av41_inf)**$annuity_period_months-1)/((1+$av41_inf)-1));
                        @endphp
                ...
                @if(isset($accumulation_phase_interest_rate_2) && $accumulation_phase_interest_rate_2>0)
                    ...
                    @for($i=1;$i<=$s_count;$i++)
                        ...
                        <tr>
                            ...
                            @endphp
                            <td><span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($ci)}} -- {{$i}}</td>
                            @endif
            ...
            <table class="table table-bordered text-center">
                ...
                @if(isset($distribution_phase_interest_rate_2) && $distribution_phase_interest_rate_2>0)
                    ...
                    @for($i=1;$i<=$annuity_period;$i++)
                        ...
                        @if ($j%22 == 1 && $j != $annuity_period && $j != 1)
                            </tbody>
                            </table>
                            </div>
                            </main>
