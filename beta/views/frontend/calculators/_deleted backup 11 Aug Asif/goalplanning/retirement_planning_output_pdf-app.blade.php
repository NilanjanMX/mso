...
<main style="width: 760px; margin-left: 20px;">
    ...
    <div style="padding: 0 15%;">
        <h1 style="color: #000;font-size:16px;margin-bottom:20px !important;text-align:center;">Retirement @if(isset($clientname)) Proposal For {{$clientname?$clientname:''}} @else Planning @endif</h1>
    ...
    @elseif(($future_value_of_current_investment+$other_amount_receivable_on_retirement)>=$total_retirement_corpus1)
        ...
        <table>
            ...
            <tr>
                ...
                @if($accumulation_phase_interest_rate_2>0)
                    <td style="text-align: left"><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{custome_money_format($sip_till_retirement2)}}</td>
                @endif
            </tr>
            <tr>
                ...
                @if($accumulation_phase_interest_rate_2>0)
                    <td style="text-align: left"><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{custome_money_format($sip_for_5_years2)}}</td>
                @endif
            </tr>
            <tr>
                ...
                @if($accumulation_phase_interest_rate_2>0)
                    <td style="text-align: left"><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{custome_money_format($sip_for_10_years2)}}</td>
                @endif
            </tr>
            <tr>
                ...
                @if($accumulation_phase_interest_rate_2>0)
                    <td style="text-align: left"><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{custome_money_format($limpsum_investment2)}}</td>
                @endif
            </tr>
            </tbody>
        </table>
    @elseif(($future_value_of_current_investment+$other_amount_receivable_on_retirement)>=$total_retirement_corpus2 && $accumulation_phase_interest_rate_2>0)
        ...
        <table>
            ...
            <tr>
                <td style="text-align: left">Monthly SIP Till Age {{$retirement_age}}</td>
                <td style="text-align: left"><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{custome_money_format($sip_till_retirement1)}} </td>
            ...
            <tr>
                <td style="text-align: left">Monthly SIP For 5 Years</td>
                <td style="text-align: left"><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{custome_money_format($sip_for_5_years1)}} </td>

            </tr>
            <tr>
                <td style="text-align: left">Monthly SIP For 10 Years</td>
                <td style="text-align: left"><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{custome_money_format($sip_for_10_years1)}} </td>

            </tr>
            <tr>
                <td style="text-align: left">Lumpsum Investment</td>
                <td style="text-align: left"><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{custome_money_format($limpsum_investment1)}} </td>
 ...
 @include('frontend.calculators.common.footer')
  ...
  @if(isset($report) && $report=='detailed')
    ...
    <table style="background: #fff;">
        ...
        @for($m=1;$m<=$total_months;$m++)
            ...
            @if($m%12==0)
                ...
                <tr>
                    <td>{{$age}}</td>
                    <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{custome_money_format($year_monthly_annuity1/12)}}</td>
                    <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{custome_money_format($eom_value1)}}</td>
                    @if($accumulation_phase_interest_rate_2>0)
                    <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{custome_money_format($year_monthly_annuity1/12)}}</td>
                    <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{custome_money_format($eom_value2)}}</td>
                    @endif
                </tr>
                @php
                    $year_monthly_annuity1 = 0;
                ...
                @if($cnt%25==0 && ($age_at_which_annuity_ends-$retirement_age)>25  && ($age_at_which_annuity_ends-$retirement_age)>$cnt)
                    </tbody>
                </table>
                    @include('frontend.calculators.common.footer')
                    <div class="page-break"></div>
    ...
    @endif
        ...
        @php
        $note_data2 = \App\Models\Calculator_note::where('category','cashflow')->where('calculator','Retirement_Planning')->first();
        if(!empty($note_data2)){
        @endphp
