            ...
            <div class="row">
                <div class="col-md-10 offset-md-1 text-center">
                    ...
                    <div class="outputTableHolder">
                        <h5 class="midheading">Lumpsum Investment @if(isset($clientname)) Proposal <br> For {{$clientname?$clientname:''}} @else Planning @endif</h5>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form target="_blank" action="{{route('frontend.futureValueOfLumpsumInvestment_merge_download')}}" method="get">
