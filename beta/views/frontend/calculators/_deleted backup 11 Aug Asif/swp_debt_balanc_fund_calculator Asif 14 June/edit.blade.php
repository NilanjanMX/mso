                ...
                <div class="col-md-12">
                    ...
                    <form class="js-validate-form" action="{{route('frontend.swp_debt_balanc_fund_calculator_output')}}" method="post">
                        <div class="card sip-calculator singleLineHolder calculatorFormShape">
                            ...
                            <div id="deferred_annuity_box" style="display:none;">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12">
                                        ...
                                        <h6 class="text-muted"><strong>Select Asset Allocation</strong></h6>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="calme1 form-control pr-2 mr-1 number {{ $errors->has('debt') ? ' is-invalid' : '' }}" name="debt" id="debt" value="{{isset($form_data['debt'])?$form_data['debt']:0}}" >
                            ...
                            <div class="form-group row">
                                    <div class="col-sm-12">
                                        <h6 class="text-muted"><strong>Expected Rate of Return</strong></h6>
                                    </div>
                            </div>
                            ...
                            <div class="form-group row">
                                    <div class="col-sm-12">
                                        <h6 class="text-muted"><strong>Select SWP (in ₹):</strong></h6>
                                    </div>
                            </div>
