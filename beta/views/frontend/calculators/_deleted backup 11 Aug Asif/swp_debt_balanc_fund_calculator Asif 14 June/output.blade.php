            ...
            <div class="row">
                <div class="col-md-10 offset-md-1 text-center">
                    ...
                    <div class="outputTableHolder">
                        <h5 class="midheading">SWP Planning @if(isset($clientname) && !empty($clientname)) <br> For {{$clientname?$clientname:''}}  @else  @endif</h5>
                        <div class="roundBorderHolder">
                            ...
                            <h5 style="color: #131f55;font-size:22px;margin-bottom:20px;">Expected Portfolio Return</h5>
                            <h5 style="
                                    margin: 0 auto 15px auto;
                                    padding: 12px 10px;
                                    max-width: 237px;
                                    border: 1px solid #ccc;
                                ">{{$exp_portfolio_return?$exp_portfolio_return:0}}%</h5>
        
                            <h5 style="color: #131f55;font-size:22px;margin-bottom:20px;">{{$withdrawal?$withdrawal:0}} SWP Amount</h5>
                            <h5 style="
                                    margin: 0 auto 15px auto;
                                    padding: 12px 10px;
                                    max-width: 237px;
                                    border: 1px solid #ccc;
                                ">₹ {{$withdrawal_amount?custome_money_format($withdrawal_amount):0}}</h5>
                            @php
                            ...
                            @endphp
                            <h5 style="color: #131f55;font-size:22px;margin-bottom:20px;">Total Annuity Received</h5>
                            <h5 style="
                                    margin: 0 auto 15px auto;
                                    padding: 12px 10px;
                                    max-width: 237px;
                                    border: 1px solid #ccc;
                                ">₹ {{$withdrawal_amount?custome_money_format($withdrawal_amount*$swp_period*$mo):0}}</h5>
        
                            <h5 style="color: #131f55;font-size:22px;margin-bottom:20px;">Closing Fund Value</h5>
                            <h5 style="
                                    margin: 0 auto 15px auto;
                                    padding: 12px 10px;
                                    max-width: 237px;
                                    border: 1px solid #ccc;
                                ">₹ <span id="cl_view"></span></h5>
                            
        
                            <h6 class="mb-3 text-center">* It is assumed that SWP amount is received on the last day of the month.<br>
                            * Mutual fund investments are subject to marker risks, read all scheme related documents carefully.<br>
                            * Returns are not guaranteed. The above is for illustration purpose only.<br><br></h6>
                        </div>
                        ...
                        <h5 style="color: #131f55;font-size:22px;margin-bottom:20px;">Projected Annual Cash Flow & Fund Value</h5>
                        <div class="roundBorderHolder">
                            @php
