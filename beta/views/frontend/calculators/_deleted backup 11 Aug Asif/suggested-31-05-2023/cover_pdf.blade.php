...
@if(isset($suggest) && session()->has('suggested_scheme_list'))
    ...
    @endphp
    <header>
        <table style="border:0 !important; width: 100%;" cellpadding="0" cellspacing="0" width="100%">
            <tr>
                <td style="text-align:left; border:0;" align="left">&nbsp;</td>
                
                <td style="text-align:right; border:0; width: 50%;padding-right:80px;" align="right" valign="middle">
                    @if($company_logo)
                        <img src="{{$company_logo}}" alt="Red dot" style="width: 120px" />
                    @endif
                </td>
            </tr>
        </table>
    ...
    <div style="padding: 0px;margin-left: 11%;margin-top: 160px;">
