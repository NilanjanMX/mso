    ...
    <table class="table table-bordered text-center less-padding suggestfont" style="background: #fff;">
        ...
        @if($debt_cnt>0)
            ...
            <tr>
                ...
                <th colspan="7" style="vertical-align: middle; text-align: center">Past Performance</th>
            </tr>
            <tr>
            ...
            @else
                <tr>
                    <th colspan="3" class="bluetableheader">DEBT</th>
                </tr>
                <tr>
                    <th width="10%">S.&nbsp;No.</th>
                    <th width="45%">Scheme Name</th>
        ...
        @if($hybrid_cnt>0)
            ...
            @else
                <tr>
                    <th colspan="3" class="bluetableheader">HYBRID</th>
                </tr>
                <tr>
                    <th width="10%">S.&nbsp;No.</th>
                    <th width="45%">Scheme Name</th>
        ...
        @if($equity_cnt>0)
            ...
            @else
                <tr>
                    <th colspan="3" class="bluetableheader">EQUITY</th>
                </tr>
                <tr>
                    <th width="10%">S.&nbsp;No.</th>
                    <th width="45%">Scheme Name</th>
        ...
        @if($commodity_cnt>0)
            ...
            @else
                <tr>
                    <th colspan="3" class="bluetableheader">COMMODITY</th>
                </tr>
                <tr>
                    <th width="10%">S.&nbsp;No.</th>
                    <th width="45%">Scheme Name</th>
        ...
        @if($other_cnt>0)
            ...
            @else
                <tr>
                    <th colspan="3" class="bluetableheader">OTHERS</th>
                </tr>
                <tr>
                    <th width="10%">S.&nbsp;No.</th>
                    <th width="45%">Scheme Name</th>
