        ...
        <div id="content" class="container">
            <div class="row">
                <div class="col-md-10 offset-md-1 text-center">
                    <a href="javascript:history.back()" class="btn btn-primary btn-round"><i class="fa fa-angle-left"></i>
                        Back</a>
                    ...
                    <div class="outputTableHolder">
                        <h5 class="midheading">Portfolio Projection Report @if (isset($clientname) && !empty($clientname))
                        ...
                        @if ($enter_loan_details == 1)
                            ...
                            <h5 class="mb-3 text-center">Expected Portfolio Value</h5>
                            <div class="roundBorderHolder">
                                <table class="table table-bordered">
                                    <tbody>
                                        <tr>
                            ...
                            @if (isset($report) && $report == 'detailed')
                                <h5 class="mb-3 text-center">Annual Investment & Expected Fund Value</h5>
                                <div class="roundBorderHolder">
