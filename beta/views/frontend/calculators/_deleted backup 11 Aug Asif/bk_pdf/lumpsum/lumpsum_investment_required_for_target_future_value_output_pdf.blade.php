...
<table>
    ...
    <h1 style="color: #000;font-size:16px;margin-bottom:20px;text-align:center;">Initial Investment Required</h1>
    ...
    <footer>
        <p>
            ...
            * Returns are not guaranteed. The above is for illustration purpose only.</p>
    </footer>
