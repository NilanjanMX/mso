...
<h1 style="color: #000;font-size:16px;margin-bottom:20px;text-align:center;">Lumpsum Investment Goal Planning Ready Recokner @if(isset($clientname)) For {{$clientname?$clientname:''}} @endif</h1>
<table>
    <tbody><tr>
    ...
    <h1 style="background-color: #131f55;color:#fff;font-size:20px;padding:10px;text-align:center;">Lumpsum Investment Required</h1>
    <table >
        <tbody>
        <tr>
