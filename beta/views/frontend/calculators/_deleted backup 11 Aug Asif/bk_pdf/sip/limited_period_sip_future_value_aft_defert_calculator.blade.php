        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 offset-md-2">
                    <h3 class="mb-3">Limited Period SIP - Future Value After Deferment Period</h3>
                    <div class="card sip-calculator">
                        <div class="card-header text-center">
                            This calculator finds out future value of SIP made for a limited period and then waiting till deferment period. (For e.g., suppose a client needs funds after 20 years but want to do SIP only for 10 years.)
                        </div>
                        <div class="card-body">
                        <form action="{{route('frontend.limitedPeriodSIPfutureValueAfterDefermentPeriodOutput')}}" method="post">
                            @csrf
