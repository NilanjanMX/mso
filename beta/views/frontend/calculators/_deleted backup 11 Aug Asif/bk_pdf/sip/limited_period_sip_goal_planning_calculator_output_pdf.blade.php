...
<main style="width: 760px; margin-left: 20px;">
    ...
    <div style="padding: 0 15%;">
        <h1 style="color: #000;font-size:16px;margin-bottom:20px;text-align:center;">Limited Period
    ...
    <h1 style="color: #000;font-size:16px;margin-bottom:20px;margin-top: 30px !important;text-align:center;">Monthly SIP
        Required</h1>
    ...
    <h1 style="color: #000;font-size:16px;margin-bottom:20px;margin-top: 30px !important;text-align:center;">Total
        Investment</h1>
    <table class="table table-bordered text-center">
        <tbody>
        @if(isset($interest2))
        ...
        <table>
            ...
            @if(isset($interest2))
                            ...
                            @for($i=1;$i<=$sip_period+$deferment_period;$i++)
                                ...
                                @if($i%25==0 && $sip_period+$deferment_period>25)
                                        </tbody>
                                    </table>
                                    <footer>
                                        <p style="margin-left:-10%;text-align: center;">
