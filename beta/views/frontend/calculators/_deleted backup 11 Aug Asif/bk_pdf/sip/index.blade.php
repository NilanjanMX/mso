                ...
                <div class="col-md-9">
                    <div class="rt-pnl">
                        ...
                        <div class="rt-btn-prt">
                            ...
                            <a href="{{route('frontend.how-to-use-calculator')}}" target="_blank">How to Use</a>view-saved-files
                        </div>
                            ...
                            <div class="col-md-6">
                                <a href="#">
                                    <div class="calculator-bx">
                                        ...
                                        <h3>SIP Future Value Ready Recokner</h3>
                                    </div>
                                </a>
                            </div>
                            <div class="col-md-6">
                                <a href="#">
                                    <div class="calculator-bx">
                                        ...
                                        <h3>SIP Goal Planning Ready Recokner</h3>
                                    </div>
                                </a>
                            </div>
