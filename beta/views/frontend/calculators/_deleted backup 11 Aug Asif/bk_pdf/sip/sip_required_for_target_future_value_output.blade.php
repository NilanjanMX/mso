            ...
            <div class="row">
                <div class="col-md-8 offset-md-2">
                    ...
                    <h5>
                        ...
                        @endif
                        @if(isset($report) && $report=='detailed' && isset($include_step_up) && $include_step_up=='yes' && isset($include_cost_delay_report) && $include_cost_delay_report=='yes')
                            <h5>Cost of Delay in Starting Normal SIP</h5>
                            <table class="table table-bordered text-center" style="background: #fff;">
                                <tbody>
                                @if(isset($interest2))
                                    <tr>
