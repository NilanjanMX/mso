...
@section('js_after')
    <script>
        ...
        @if($form_data['include_step_up']=='yes')  SetstepUp(1); @else SetstepUp(0); @endif
                    ...
                    <form class="js-validate-form" action="{{route('frontend.futureValueOfSipOutput')}}" method="post">      
                        ...
                        <div class="card sip-calculator singleLineHolder">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <label class="radio-inline"><input type="radio" name="include_step_up" value="yes" onchange="SetstepUp(1)" @if($form_data['include_step_up']=='yes')  checked  @endif >Yes </label>
                        
                                    <label class="radio-inline"><input type="radio" name="include_step_up" value="no" onchange="SetstepUp(0)" @if($form_data['include_step_up']=='no')   checked  @endif >No </label>
                            ...
                            <div id="step_up_fields" style='display:none;'>
                                <div class="form-group row">
                                    <label class="col-sm-5 col-form-label"><span>Step - Up % Every Year</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="from-control" type="radio" id="stepupFirst" @if(isset($form_data['step_up_rate']) && $form_data['step_up_rate']!='')  checked  @endif value=1 name="steuup" onchange="activateMe(1)"></label>
                                    <div class="col-sm-7">
                                        
                                        <input type="text" class="form-control" name="step_up_rate" id="step_up_rate" value="{{$form_data['step_up_rate'] ?? ''}}" >
                                        <div class="cal-icon">
                                            %
                                        </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-5 col-form-label"><span>Step - Up Amount Every Year</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="from-control" type="radio" id="stepupSecond" value=2 @if(isset($form_data['step_up_amount']) && $form_data['step_up_amount']!='')  checked  @endif name="steuup" onchange="activateMe(2)" ></label>
                                    <div class="col-sm-7">
                                        
                                        <input type="text" class="form-control" name="step_up_amount" id="step_up_amount" value="{{$form_data['step_up_amount'] ?? ''}}" >
                                        <div class="cal-icon">
                                            ₹
                                        </div>
