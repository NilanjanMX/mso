...
<main style="width: 760px; margin-left: 20px;">
    ...
    <div style="padding: 0 15%;">
        <h1 style="color: #000;font-size:16px;margin-bottom:20px !important;text-align:center;">Lumpsum Investment Ready Recokner @if(isset($clientname)) <br> For {{$clientname?$clientname:''}} @endif</h1>
<table>
    <tbody><tr>
        <td style="width: 50%;">
    ...
    <h1 style="background-color: #131f55;color:#fff !important;font-size:20px;padding:10px;text-align:center;">Future Value of Lumpsum Investment</h1>
    <table >
        <tbody>
        <tr>
