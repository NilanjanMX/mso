    ...
    <section class="main-sec">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    <h3 class="mb-3 text-center">Lumsum Investment Required for Target Future Value</h3>
                    <div class="card sip-calculator">
                        @include('frontend.calculators.common_bio')
                        <form class="js-validate-form" action="{{route('frontend.lumpsumInvestmentRequiredForTargetFutureValueOutput')}}" method="post">
                            @csrf
