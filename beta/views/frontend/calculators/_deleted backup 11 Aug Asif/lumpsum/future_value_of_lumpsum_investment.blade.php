        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="page-title">CALCULATORS CUM CLIENT PROPOSALS 1</h2>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <form class="js-validate-form" action="{{route('frontend.futureValueOfLumpsumInvestmentOutput')}}" method="post">
