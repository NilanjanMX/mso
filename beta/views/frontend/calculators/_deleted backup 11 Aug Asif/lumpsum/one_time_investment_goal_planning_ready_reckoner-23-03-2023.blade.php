    ...
    <section class="main-sec">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    <h3 class="mb-3 text-center">Lumpsum Investment Goal Planning Ready Reckoner</h3>
                    <div class="card sip-calculator sip-calculator__modify">
                        @include('frontend.calculators.common_bio')
                        <div class="card-body">
                            <form class="js-validate-form" action="{{route('frontend.oneTimeInvestmentGoalPlanningReadyReckonerOutput')}}" method="post">
                                @csrf
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label">Target Amount</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control {{ $errors->has('investment') ? ' is-invalid' : '' }}" name="investment" value="{{old('investment')}}"  required>
                                        <div class="cal-icon">
                                            ₹
                                        </div>
