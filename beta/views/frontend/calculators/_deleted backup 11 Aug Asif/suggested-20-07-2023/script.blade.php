            ...
            success: function (result) {
                if(result.length>0) {
                    ...
                    var trdata = "<tr><td><strong>" + result[0]['S_NAME'] + "</strong></td>" +
                        ...
                        "<td>" + YEARRET10 + "%</td>" +
                        "<td>" + INCRET + "%</td>" +
                        "<td><select name='scheme_type["+schemecode+"]' style='width: 50px; border: 1px solid #F1F3F4'><option value=''></option><option>SIP</option><option>Lumpsum</option></select></td>" +
                        "<td><span class='number-wrapper'><input type=\"number\" name=\"scheme_amount["+schemecode+"]\"  style='width: 50px;'> ₹</span></td>" +
