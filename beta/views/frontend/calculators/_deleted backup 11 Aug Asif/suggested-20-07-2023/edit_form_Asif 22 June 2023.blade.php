    ...
    <div class="col-sm-7 include-performance-container">
        <div class="form-check form-check-inline">
            <label class="checkLinecontainer">Create New
                <input class="form-check-input" type="radio" name="suggestedlist_type" id="inlineRadio3" value="createlist" @if(isset($data) && $data['suggestedlist_type']=='createlist') checked @endif>
                <span class="checkmark"></span>
            </label>   
        </div>
        <div class="form-check form-check-inline">
                ...
                <div class="roundTable">
                    <table class="table table-bordered suggested-scheme-details">
                        ...
                        <tr>
                            ...
                            <th style="width: 5%; text-align: center;" rowspan="2">Type</th>
                        ...
                        @if(isset($suggested_scheme_list) && count($suggested_scheme_list)>0)
                            @foreach($suggested_scheme_list as $key=>$value)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name='scheme_type[{{$suggested_scheme["Schemecode"]}}]' style='width: 50px; border: 1px solid #F1F3F4'>
                                        ...
                                        <!-- <input type="text" name="scheme_type[{{$suggested_scheme['Schemecode']}}]" value="{{$scheme_type[$suggested_scheme['Schemecode']]}}" style='width: 50px;'></td> -->
                                    <td>
                                    <span class='number-wrapper'>
                                        <input type="number" name="scheme_amount[{{$suggested_scheme['Schemecode']}}]" value="{{isset($scheme_amount[$suggested_scheme['Schemecode']])?$scheme_amount[$suggested_scheme['Schemecode']]:""}}"  style='width: 50px;'> ₹</span>
                                    </td>
