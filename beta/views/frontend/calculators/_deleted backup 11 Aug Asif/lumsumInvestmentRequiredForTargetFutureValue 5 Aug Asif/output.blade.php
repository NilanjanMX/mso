        ...
        @if(isset($report) && $report=='detailed' && $is_graph)
            ...
            function drawChart() {
                var data = google.visualization.arrayToDataTable([
                    ['Year',"CInv@ {{$interest1?number_format((float)$interest1, 2, '.', ''):0}}%", "EV@ {{$interest1?number_format((float)$interest1, 2, '.', ''):0}}%","CInv@ {{$interest2?number_format((float)$interest2, 2, '.', ''):0}}%", "EV@ {{$interest2?number_format((float)$interest2, 2, '.', ''):0}}%"],
                    ...
                    @for($i=1;$i<=$period;$i++)
                        @php
                            ...
                            if($i==1){
                                $vaiue3 = (($amount/pow((1+($interest1/100)), $period)));
                                $vaiue4 = (($amount/pow((1+($interest2/100)), $period)));
                            }

                            $vaiue1 = ($previous_amount_int1);
                            $vaiue2 = ($previous_amount_int2);
                        @endphp
                        ['<?php echo $i;?>',<?php echo $vaiue3;?>,<?php echo $vaiue1;?>,<?php echo $vaiue4;?>,<?php echo $vaiue2;?>],
                    @endfor
                ]);
        ...
        <div id="content" class="container">
            <div class="row">
                <div class="col-md-12 offset-md-0 text-center">
                    <a href="{{route('frontend.lumsumInvestmentRequiredForTargetFutureValueBack')}}?action=back" class="btn btn-primary btn-round"><i class="fa fa-angle-left"></i> Back</a>
