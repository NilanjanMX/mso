    ...
    <section class="main-sec">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    <h3 class="mb-3 text-center">SIP Future Value Ready Reckoner</h3>
                    <div class="card sip-calculator sip-calculator__modify">
                        @include('frontend.calculators.common_bio')
                        <div class="card-body">
                            <form class="js-validate-form" action="{{route('frontend.sipFutureValueReadyRecoknerOutput')}}" method="post">
                                @csrf
