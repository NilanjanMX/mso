        ...
        @endif
            ...
            <table style="background: #fff;">
                ...
                @else
                    ...
                    <tr>
                        <th style="vertical-align: middle">Delay in No. of Year</th>
                        <th>SIP Amount</th>
                        <th>Total Investment</th>
                    </tr>
                    @for($i=1;$i<$period;$i++)
            ...
            @endif
                ...
                @if(isset($interest2) && isset($include_cost_delay_report) && $include_cost_delay_report=='yes')
                    <p style="text-align: left;background: #a9f3ff;padding:5px;margin: 0">
                        For example, If you delay your SIP by 1 year, your SIP amount will increase to <span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>{{custome_money_format($cost_delay_sip_amount1)}} instead of <span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>{{custome_money_format($senario1_monthly_amount)}} in case of Scenario(1) and will increase to <span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>{{custome_money_format($cost_delay_sip_amount2)}} instead of <span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>{{custome_money_format($senario2_monthly_amount)}} in case of Scenario(2).
                    </p>
                            @elseif(isset($include_cost_delay_report) && $include_cost_delay_report=='yes')
                    <p style="text-align: left;background: #a9f3ff;padding:5px; margin: 0 ">
                        For example, If you delay your SIP by 1 year, your SIP amount will increase to <span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>{{custome_money_format($cost_delay_sip_amount1)}} instead of <span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>{{custome_money_format($senario1_monthly_amount)}}.
                    </p>
                @endif
                <p style="margin:0;margin-top: 2px;padding: 0">@php
        $note_data2 = \App\Models\Calculator_note::where('category','cashflow')->where('calculator','SIP_Required_For_Target_Future_Value')->first();
        if(!empty($note_data2)){
        @endphp
        {!!$note_data2->description!!}
