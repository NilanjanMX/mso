...
<main style="width: 760px; margin-left: 20px;">
    ...
    <div style="padding: 0 15%;">
        <h1 style="color: #000;font-size:16px;margin-bottom:20px !important;text-align:center;">Step-Up SIP @if(isset($clientname)) Proposal For {{$clientname?$clientname:''}} @else Planning @endif</h1>
        <table>
            <tbody><tr>
        ...
        <div style="padding: 0 20%;">
            ...
            <table class="table table-bordered text-center">
                ...
                <tr>
                    <td>
                        <strong><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{custome_money_format($total_investment)}}</strong>
                    </td>
                </tr>
                </tbody>
            </table>
