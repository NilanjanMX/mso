...
<main style="width: 760px; margin-left: 20px;">
    ...
    <table >
        ...
        <tr>
            ...
            <td>
                <strong><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{price_in_lakh(((1+(pow((1+$interest2/100),(1/12))-1))*$amount*((pow((1+(pow((1+$interest2/100),(1/12))-1)),($period1*12))-1)/(pow((1+$interest2/100),(1/12))-1))))}} </strong>
            </td>
            <td>
                <strong><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{price_in_lakh(((1+(pow((1+$interest2/100),(1/12))-1))*$amount*((pow((1+(pow((1+$interest2/100),(1/12))-1)),($period2*12))-1)/(pow((1+$interest2/100),(1/12))-1))))}} </strong>
            </td>
            <td>
                <strong><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{price_in_lakh(((1+(pow((1+$interest2/100),(1/12))-1))*$amount*((pow((1+(pow((1+$interest2/100),(1/12))-1)),($period3*12))-1)/(pow((1+$interest2/100),(1/12))-1))))}} </strong>
            </td>
            <td>
                <strong><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{price_in_lakh(((1+(pow((1+$interest2/100),(1/12))-1))*$amount*((pow((1+(pow((1+$interest2/100),(1/12))-1)),($period4*12))-1)/(pow((1+$interest2/100),(1/12))-1))))}} </strong>
            </td>
            <td>
                <strong><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{price_in_lakh(((1+(pow((1+$interest2/100),(1/12))-1))*$amount*((pow((1+(pow((1+$interest2/100),(1/12))-1)),($period5*12))-1)/(pow((1+$interest2/100),(1/12))-1))))}} </strong>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <strong><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{price_in_lakh(((1+(pow((1+$interest3/100),(1/12))-1))*$amount*((pow((1+(pow((1+$interest3/100),(1/12))-1)),($period1*12))-1)/(pow((1+$interest3/100),(1/12))-1))))}} </strong>
            </td>
            <td>
                <strong><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{price_in_lakh(((1+(pow((1+$interest3/100),(1/12))-1))*$amount*((pow((1+(pow((1+$interest3/100),(1/12))-1)),($period2*12))-1)/(pow((1+$interest3/100),(1/12))-1))))}} </strong>
            </td>
            <td>
                <strong><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{price_in_lakh(((1+(pow((1+$interest3/100),(1/12))-1))*$amount*((pow((1+(pow((1+$interest3/100),(1/12))-1)),($period3*12))-1)/(pow((1+$interest3/100),(1/12))-1))))}} </strong>
            </td>
            <td>
                <strong><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{price_in_lakh(((1+(pow((1+$interest3/100),(1/12))-1))*$amount*((pow((1+(pow((1+$interest3/100),(1/12))-1)),($period4*12))-1)/(pow((1+$interest3/100),(1/12))-1))))}} </strong>
            </td>
            <td>
                <strong><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{price_in_lakh(((1+(pow((1+$interest3/100),(1/12))-1))*$amount*((pow((1+(pow((1+$interest3/100),(1/12))-1)),($period5*12))-1)/(pow((1+$interest3/100),(1/12))-1))))}} </strong>
            </td>
        </tr>
        <tr>
