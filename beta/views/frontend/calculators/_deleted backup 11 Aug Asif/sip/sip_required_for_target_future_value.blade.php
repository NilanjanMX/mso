        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <form class="js-validate-form" action="{{route('frontend.sipRequiredForFutureValueOutput')}}" method="post">
                        <div class="card sip-calculator singleLineHolder calculatorFormShape">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-check form-check-inline">
                                        <label class="checkLinecontainer mb-0 mt-1">Yes
                                            <input class="form-check-input" type="radio" name="include_step_up" value="yes" @if(old('include_step_up')=='yes') checked  @endif >
                                            <span class="checkmark"></span>
                                        </label> 
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <label class="checkLinecontainer mb-0 mt-1">No
                                            <input class="form-check-input" type="radio" name="include_step_up" value="no" @if(old('include_step_up')=='yes')  @else checked  @endif >
                                            <span class="checkmark"></span>
                                        </label> 
                                    </div>
                                    ...
                                    <!--    <input type="radio" name="include_step_up" value="no" @if(old('include_step_up')=='yes')  @else checked  @endif >No -->
                                    <!--</label>-->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-check form-check-inline">
                                        <label class="checkLinecontainer mb-0 mt-1">Yes
                                            <input class="form-check-input" type="radio" name="include_cost_delay_report" value="yes" @if(old('include_cost_delay_report')=='yes') checked  @endif >
                                            <span class="checkmark"></span>
                                        </label> 
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <label class="checkLinecontainer mb-0 mt-1">No
                                            <input class="form-check-input" type="radio" name="include_cost_delay_report" value="no" @if(old('include_cost_delay_report')=='yes')  @else checked  @endif >
                                            <span class="checkmark"></span>
                                        </label> 
                                    </div>
