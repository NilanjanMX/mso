    ...
    <section class="main-sec">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    <h3 class="mb-3 text-center">SIP Required For Target Future Value</h3>
                    <div class="card sip-calculator">
                        ...
                        <form class="js-validate-form" action="{{route('frontend.sipRequiredForFutureValueOutput')}}" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <label class="radio-inline"><input type="radio" name="include_cost_delay_report" value="yes" @if(old('include_cost_delay_report')=='yes') checked  @endif >Yes </label>

                                    <label class="radio-inline"><input type="radio" name="include_cost_delay_report" value="no" @if(old('include_cost_delay_report')=='yes')  @else checked  @endif >No </label>
