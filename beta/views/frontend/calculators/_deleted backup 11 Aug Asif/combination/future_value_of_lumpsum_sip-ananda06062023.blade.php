    ...
    <section class="main-sec">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    <h3 class="mb-3 text-center">Future Value Of Lumpsum + SIP</h3>
                    <div class="card sip-calculator">
                        ...
                        <form class="js-validate-form" action="{{route('frontend.futureValueOfLumpsumSipOutput')}}" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control number {{ $errors->has('expected_rate_of_return1') ? ' is-invalid' : '' }}" name="expected_rate_of_return1" value="{{old('expected_rate_of_return1')}}"   required>
                                    <div class="cal-icon">
                                        %
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control {{ $errors->has('lumpsum_investment') ? ' is-invalid' : '' }}" name="lumpsum_investment" value="{{old('lumpsum_investment')}}" maxlength="10"  required>
                                    <div class="cal-icon">
                                        ₹
                                    </div>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-5 col-form-label">Assumed Rate Of Return</label>
                                <div class="col-sm-7">
                                    <input type="text" class="form-control number {{ $errors->has('expected_rate_of_return2') ? ' is-invalid' : '' }}" name="expected_rate_of_return2" value="{{old('expected_rate_of_return2')}}"   >
                                    <div class="cal-icon">
                                        %
                                    </div>
