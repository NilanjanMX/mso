    ...
    <section class="main-sec">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    <h3 class="mb-3 text-center">SIP / Lumpsum Required For Target Future Value</h3>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="investment_type" id="inlineRadio1" value="lumpsum" @if(old('report')=='SIP') @else checked  @endif>
                                        <label class="form-check-label" for="inlineRadio1">Lumpsum Required</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="investment_type" id="inlineRadio2" value="SIP" @if(old('report')=='SIP') checked  @endif >
                                        <label class="form-check-label" for="inlineRadio2">SIP Required</label>
                                    </div>
                                </div>
                            </div>
