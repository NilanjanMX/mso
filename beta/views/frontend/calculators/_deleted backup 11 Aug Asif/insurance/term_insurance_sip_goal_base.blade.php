    ...
    <section class="main-sec">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    <h3 class="mb-3 text-center">Term Insurance + SIP (Goal Based)</h3>
                    <div class="card sip-calculator">
                        @include('frontend.calculators.common_bio')
                        <div class="card-body">
                        <form class="js-validate-form" action="{{route('frontend.termInsuranceSIPgoalBaseOutput')}}" method="post">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control {{ $errors->has('goal_amount') ? ' is-invalid' : '' }}" name="goal_amount" value="{{old('goal_amount')}}" maxlength="10"  required>
                                    <div class="cal-icon">
                                        ₹
                                    </div>
