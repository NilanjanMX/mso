        ...
        jQuery(document).ready(function(){
            jQuery('#save_cal_btn').click(function(e){
                ...
                if(title.trim()==''){
                    ...
                    jQuery.ajax({
                        url: "{{ route('frontend.stpRequiredForTargetFutureValueOutputSave') }}",
                        method: 'get',
                        data: {
                            title: title
                        },
            ...
            <div class="row">
                <div class="col-md-8 offset-md-2 text-center">
                    ...
                    @if($calculator_permissions['is_download'])
                        <a href="{{route('frontend.stpRequiredForTargetFutureValueOutputDownloadPDF')}}" target="_blank" id="cmd" class="btn btn-primary btn-round">Download / Print</a>
                    @else
                    ...
                    <h5 class="mb-3 text-center">STP Investment @if(isset($clientname)) Proposal <br> For {{$clientname?$clientname:''}} @else Planning @endif</h5>
