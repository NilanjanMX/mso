            ...
            <div class="row">
                <div class="col-md-8 offset-md-2 text-center">
                    ...
                    @if($calculator_permissions['is_download'])
                        <a href="{{route('frontend.stpGoalPlanningValueReadyRecoknerOutputDownloadPDF')}}" target="_blank" id="cmd" class="btn btn-primary btn-round">Download / Print</a>
                    @else
                    ...
                    <h5 class="mb-3 text-center">STP Goal Planning Ready Reckoner @if(isset($clientname)) <br> For {{$clientname?$clientname:''}} @endif</h5>
