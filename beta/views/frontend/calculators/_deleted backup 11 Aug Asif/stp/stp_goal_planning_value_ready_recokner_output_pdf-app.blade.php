...
<main style="width: 760px; margin-left: 20px;">
    ...
    <div style="padding: 0 15%;">
        <h1 style="color: #000;font-size:16px;margin-bottom:20px !important;text-align:center;">STP Goal Planning Ready Reckoner @if(isset($clientname)) For {{$clientname?$clientname:''}} @endif</h1>
        <table>
            <tbody>
            <tr>
