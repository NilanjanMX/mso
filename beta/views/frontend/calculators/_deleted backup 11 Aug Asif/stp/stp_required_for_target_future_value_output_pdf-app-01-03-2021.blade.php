...
<main style="width: 780px; margin-left: 20px;">
   ...
   for ($j=1;$j<=$number_of_months;$j++){
    ...
    <div style="padding: 0 15%;">
        <h1 style="color: #000;font-size:16px;margin-bottom:20px !important;text-align:center;">STP Investment @if(isset($clientname)) Proposal For {{$clientname?$clientname:''}} @else Planning @endif</h1>
        <table>
            <tbody>
            <tr>
    ...
    @if(isset($report) && $report=='detailed')
        ...
        <h1 style="background-color: #131f55;color:#fff !important;font-size:20px;padding:10px;text-align:center;">
            Projected Annual Investment Value</h1>
        <table>
            <tbody>
            <tr>
                <th>Year</th>
        ...
        @php
        $note_data2 = \App\Models\Calculator_note::where('category','cashflow')->where('calculator','STP_Required_For_Target_Future_Value')->first();
        if(!empty($note_data2)){
        @endphp
