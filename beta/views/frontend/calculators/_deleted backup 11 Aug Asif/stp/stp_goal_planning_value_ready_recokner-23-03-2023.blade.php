    ...
    <section class="main-sec">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    <h3 class="mb-3 text-center">STP Goal Planning Ready Reckoner</h3>
                        ...
                        <div class="card-body">
                            <form class="js-validate-form" action="{{route('frontend.stpGoalPlanningValueReadyRecoknerOutput')}}" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control {{ $errors->has('target_amount') ? ' is-invalid' : '' }}" name="target_amount" value="{{old('target_amount')}}"  required>
                                        <div class="cal-icon">
                                            ₹
                                        </div>
