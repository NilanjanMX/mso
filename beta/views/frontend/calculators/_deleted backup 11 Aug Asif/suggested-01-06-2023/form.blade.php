            ...
            <div class="table-responsive mt-3">
                ...
                <table class="table table-bordered suggested-scheme-details">
                    ...
                    <tr>
                        ...
                        <th>
                            <label class="checkcontainer">
                                <input class="rcheck_a rcheck_c_n" type="checkbox" name="duration[]" value="1MONTHRET" checked> 
                                <span class="checkmark"></span>
                            </label>
                            </th>
                        <th>
                        ...
                        <th>
                        <label class="checkcontainer">
                        <input class="rcheck_a rcheck_c_n" type="checkbox" name="duration[]" value="10YEARRET" checked>
                                <span class="checkmark"></span>
                        </label>
                         </th>
                        <th style="width: 9.2%;">
