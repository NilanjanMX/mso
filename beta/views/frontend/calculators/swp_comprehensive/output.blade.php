...
@section('content')
    ...
    <div class="banner styleApril">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="page-title">SWP Comprehensive Calculator</h2>
                </div>
            </div>
        </div>
    </div>
        ...
        <div id="content" class="container">
            <div class="row">
                <div class="col-md-12 offset-md-0 text-center">
                    <a href="{{route('frontend.swp_comprehension_back')}}?action=back" class="btn btn-primary btn-round"><i class="fa fa-angle-left"></i> Back</a>
                    ...
                    <div class="outputTableHolder">
                        <h1 class="midheading">@if(isset($details)) {{$details}} @else SWP Calculation @endif @if(isset($clientname) && !empty($clientname)) <br> For {{$clientname?$clientname:''}}  @else  @endif</h1>
                           ...
                           // dd("fourth calc");
                            ...
                            <h1 class="midheading">Suggested Asset Allocation</h1>
                            @if($calctype==2 || $calctype==5|| $calctype==6 || $calctype==7|| $calctype==8 || $calctype==9 || $calctype==10|| $calctype==11 || $calctype==12|| $calctype==13|| $calctype==14|| $calctype==15|| $calctype==16 || $calctype==17 || $calctype==18 || $calctype>18) <h1 class="midheading">Accumulation Phase</h1> 
                            ...
                            @endif
                            @if($calctype==2 || $calctype==5 || $calctype==6 || $calctype==7 || $calctype==8 || $calctype==9 || $calctype==10|| $calctype==11 || $calctype==12|| $calctype==13|| $calctype==14|| $calctype==15|| $calctype==16 || $calctype==17 || $calctype==18 || $calctype>18) <h1 class="midheading">Distribution Phase</h1>
                             @endif
                            <div class="roundBorderHolder">
                                <table class="table table-bordered">
                                <tr><td>Asset Class</td><td>Allocation</td><td>Assumed Return</td></tr>
                        ...
                        <h1 class="midheading">Total Withdrawal</h1>
                            ...
                            <h1 class="midheading">Projected Monthly Withdrawal & Fund Value</h1>
                            ...
                            <div class="roundBorderHolder">
                                ...
                                <h1 class="midheading">Distribution Phase<br/>Projected {{$addonText}} Withdrawal & Fund Value</h1>
                            ...
                            @if($calctype==3)
                                ...
                                <h1 class="midheading">Projected {{$addonText}} Withdrawal & Fund Value</h1>
                            ...
                            @if($calctype==6)
                                ...
                                <h1 class="midheading">Distribution Phase<br/>Projected Monthly Withdrawal & Fund Value</h1>
