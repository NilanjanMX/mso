                        ...
                        <div class="card sip-calculator singleLineHolder">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-check">
                                        <input class="form-check-input fixed_deposit_chk" type="radio" name="investmentmode" onchange="TurnOnSip(1)" @if($investmentmode==1) checked  @endif value=1>
                                        <label class="form-check-label" for="inlineRadio1">Lumpsum</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input fixed_deposit_chk" type="radio" name="investmentmode" value=2 @if($investmentmode==2) checked  @endif onchange="TurnOnSip(2)" >
                                        <label class="form-check-label" for="inlineRadio2">Annual Lumpsum</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input fixed_deposit_chk" type="radio" name="investmentmode" value=3 @if($investmentmode==3) checked  @endif onchange="TurnOnSip(3)" >
                                        <label class="form-check-label" for="inlineRadio2">SIP</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input fixed_deposit_chk" type="radio" name="investmentmode" value=4 @if($investmentmode==4) checked  @endif onchange="TurnOnSip(4)" >
                            ...
                            <div id="sipamt" style="display:none;">
                              <div class="form-group row">
                                  ...
                                  <div class="col-sm-7">
                                      <input type="text" class="form-control pr-2 mr-1 maxtwodigit " id="sipamti" name="sipamt" value="{{$sipamt}}" required="">
                                      <div class="cal-icon">
                                          ₹
                                      </div>
                                  </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input fixed_deposit_chk" type="radio" name="deferment" onchange="showAc(1)" @if($deferment==1) checked  @endif value="1">
                                                <label class="form-check-label" for="inlineRadio1">No</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input fixed_deposit_chk" type="radio" name="deferment" value="2" @if($deferment==2) checked  @endif onchange="showAc(2)" >
                                                <label class="form-check-label" for="inlineRadio2">Yes</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-8">
                                            <div class="d-flex align-items-center">
                                                <input type="text" name="defermentperiod" id="defval" onChange="accumulatedcalc()" class="form-control" value="{{$defermentperiod}}" readonly>
                                            </div>
                                            <div class="cal-icon">
                                                Yrs
                                            </div>
                            ...
                            <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="form-check form-check-inline">
                                        <input class="form-check-input fixed_deposit_chk" type="radio" name="annualincr" onchange="changeIncr(false)"  @if($annualincr==1) checked  @endif value="1">
                                        <label class="form-check-label" for="inlineRadio1">No</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input fixed_deposit_chk" type="radio" name="annualincr" value="2" @if($annualincr==2) checked  @endif onchange="changeIncr(true)" >
                                        <label class="form-check-label" for="inlineRadio2">Yes</label>
                                    </div>
                                            </div>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-4 col-form-label"><span>In %</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input id="percentRadio" class="form-check-input fixed_deposit_chk"  onchange="activateMe(1)" type="radio" name="incrtype" class="form-control" value=0 @if($annualincr==1) checked  @endif disabled style="margin-top: 6px;"></label>
                                <div class="col-sm-8">
                                    <div class="d-flex align-items-center">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-4 col-form-label">
                                    <span>In Amount</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                                    <input id="percentAmount" class="form-check-input fixed_deposit_chk"  onchange="activateMe(2)" @if($annualincr==1) checked  @endif type="radio" name="incrtype" class="form-control" value=1 disabled style="margin-top: 6px;">
                            ...
                            <div class="form-group row" style = "display:none;">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="form-check form-check-inline">
                                        <input class="form-check-input fixed_deposit_chk" type="radio" name="taxation" onchange="TurnOnSip('sipInv')"  @if($annualincr==1) checked  @endif value="1">
                                        <label class="form-check-label" for="inlineRadio1">No</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input fixed_deposit_chk" type="radio" name="taxation" value="1" @if($annualincr==1) checked  @endif onchange="TurnOnSip('emiInv')" >
                                        <label class="form-check-label" for="inlineRadio2">Yes</label>
                                    </div>
                                            </div>
