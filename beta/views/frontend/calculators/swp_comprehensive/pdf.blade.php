    ...
    <body class="styleApril">
        ...
        <main class="mainPdf">
            ...
            <div style="padding: 0 0%;">
                <h1 class="pdfTitie">@if(isset($details)) {{$details}} @else SWP Calculation @endif @if(isset($clientname) && !empty($clientname)) <br> For {{$clientname?$clientname:''}}  @else  @endif</h1>
                        ...
                        <table>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                         <span class='pdfRupeeIcon'>&#8377;</span> {{custome_money_format($initial)}}
                                    </td>
                                </tr>
                                @if($investmentmode==4)
                                    <tr>
                                        ...
                                        <td>
                                            <span class='pdfRupeeIcon'>&#8377;</span> {{custome_money_format($sipamt)}}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                          <span class='pdfRupeeIcon'>&#8377;</span> {{custome_money_format($accumulated)}}
                                    </td>
                                </tr>
                                @endif
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($incrtype == 0)
                                          {{$inpercent}} %
                                         @else
                                         <span class='pdfRupeeIcon'>&#8377;</span> {{custome_money_format($inamount)}}
                                         @endif
                                    </td>
                                </tr>
                                @endif
                                <tr>
                                    ...
                                    <td>
                                        <span class='pdfRupeeIcon'>&#8377;</span> {{custome_money_format($swpAmt)}}
                    ...
                    <h1 class="pdfTitie">Suggested Asset Allocation</h1>

                    @if($calctype==2 || $calctype==5|| $calctype==6 ||$calctype==7 || $calctype==8 || $calctype==9 || $calctype==10 || $calctype==11 || $calctype==12 || $calctype==13|| $calctype==14|| $calctype==15|| $calctype==16 || $calctype==17 || $calctype==18 || $calctype>18) 
                        <h1 class="pdfTitie">Accumulation Phase</h1> 
                            
                        <div class="roundBorderHolder">
                            <table>
                                <tr style="background:{{$city_color}}"><td><strong>Asset Class</strong></td><td><strong>Allocation</strong></td><td><strong>Assumed Return</strong></td></tr>
                                @if($acequity > 0)
                                    <tr>
                                            <td>
                    ...
                    @if($calctype==2 || $calctype==5|| $calctype==6 ||$calctype==7 || $calctype==8 || $calctype==9 || $calctype==10 || $calctype==11 || $calctype==12 || $calctype==13|| $calctype==14|| $calctype==15|| $calctype==16 || $calctype==17 || $calctype==18 || $calctype>18) 
                        <h1 class="pdfTitie">Distribution Phase</h1>
                    @endif
                    <div class="roundBorderHolder">
                        <table>
                            <tr style="background:{{$city_color}}"><td><strong>Asset Class</strong></td><td><strong>Allocation</strong></td><td><strong>Assumed Return</strong></td></tr>
                    ...
                    <h1 class="pdfTitie">Total Withdrawal</h1>
                        ...
                        <h3 class="pdfBlueCell" style="background:{{$address_color_background}}">
                                <span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($totalWithdrawal)}}
                    </h3>
                    
                    <h1 class="pdfTitie">End Value</h1>
                        
                        
                    <h3 class="pdfBlueCell" style="background:{{$address_color_background}}">
                            <span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($balanceAvailable)}}
                    </h3>
            ...
            <main class="mainPdf">
                            ...
                            @if($calctype==1)
                                ...
                                <h1 class="pdfTitie">Projected Monthly Withdrawal & Fund Value</h1>
                        <div class="roundBorderHolder">
                        <table>
                            <tr  style="background:{{$city_color}}"><td>@if($currentage>0) Age @else Year @endif</td><td>{{$addonText}} SWP Amount</td><td>Fund Value at End of Year</td></tr>
                            @php
                            $month = 1;
                            $rowCount = 0;
                            $openingBal = $initial;
                    ...
                    <div class="roundBorderHolder">
                        <table>
                            <tr style="background:{{$city_color}}"><td >@if($currentage>0) Age @else Year @endif</td><td>{{$addonText}} SWP Amount</td><td>Fund Value at End of Year</td></tr>
                                ...
                                echo("<tr><td>".$age."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($monthlySwp))."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($yearEnd))."</td></tr>");
                                $age++;
                            ...
                            <h1 class="pdfTitie">Accumulation Phase<br/>Projected Annual Investment Value</h1>
                            <div class="roundBorderHolder">
                            <table>
                            <tr  style="background:{{$city_color}}"><td>@if($currentage>0) Age @else Year @endif</td><td>Annual Investment</td><td>Year End Value</td></tr>
                            @php
                            $year = 1;
                            ...
                            while($defPeriod >= $year)
                            {
                                ...
                                if(!$onetime){
                                echo("<tr><td>".($year + $currentage)."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($lumpsumInv))."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($yearEndVal))."</td></tr>");
                                $onetime = true;
                                }
                                else
                                {
                ...
                <h1 class="pdfTitie">Accumulation Phase<br/>Projected Annual Investment Value</h1>
                            ...
                            <tr  style="background:{{$city_color}}"><td>@if($currentage>0) Age @else Year @endif</td><td>Annual Investment</td><td>Year End Value</td></tr>
                                    ...
                                    echo("<tr><td>".($year + $currentage)."</td><td>".'-'."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($yearEndVal))."</td></tr>");
                                }
                ...
                <main class="mainPdf">
                             ...
                             <h1 class="pdfTitie">Distribution Phase<br/>Projected {{$addonText}} Withdrawal & Fund Value</h1>
                    <div class="roundBorderHolder">   
                        <table>
                            <tr  style="background:{{$city_color}}"><td>Year</td><td>{{$addonText}} Withdrawal Amount</td><td>Fund Value at End of Year</td></tr>
                            @php
                            $month = 1;
                            $addYear = $year-1;
                    ...
                    <div class="roundBorderHolder">          
                        <table>
                            <tr  style="background:{{$city_color}}"><td>Year</td><td>{{$addonText}} Withdrawal Amount</td><td>Fund Value at End of Year</td></tr>
                                ...
                                echo("<tr><td>".($year+$currentage)."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($monthlySwp))."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($yearEnd))."</td></tr>");
                                $age++;
                                $year++;
                                }
                        ...
                        @if($calctype==3)
                            ...
                            <h1 class="pdfTitie">Projected {{$addonText}} Withdrawal & Fund Value</h5>
                            
                        <div class="roundBorderHolder">    
                            <table>
                                <tr  style="background:{{$city_color}}"><td>@if($currentage>0) Age @else Year @endif</td><td>Average {{$addonText}} Withdrawal Amount</td><td>Fund Value at End of Year</td></tr>
                ...
                <main class="mainPdf">
                            ...
                            <h1 class="pdfTitie">Projected {{$addonText}} Withdrawal & Fund Value</h1>
                            <div class="roundBorderHolder">
                            <table>
                                <tr  style="background:{{$city_color}}"><td>@if($currentage>0) Age @else Year @endif</td><td>Average {{$addonText}} Withdrawal Amount</td><td>Fund Value at End of Year</td></tr>
                                        ...
                                        echo("<tr><td>".++$age."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($avgMonth))."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($val))."</td></tr>");
                                        $isYear = true;
                                        $store = 0;
                                    }
                        ...
                        <div class="roundBorderHolder">     
                             <table>
                                <tr  style="background:{{$city_color}}"><td>@if($currentage>0) Age @else Year @endif</td><td>{{$addonText}} SWP Amount</td><td>Fund Value at End of Year</td></tr>
                                    ...
                                    echo("<tr><td>".$mainAge."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($annualSwp/12))."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($val))."</td></tr>");
                                    $year++;
                ...
                <main class="mainPdf">
                            ...
                            <table>
                                <tr  style="background:{{$city_color}}"><td>@if($currentage>0) Age @else Year @endif</td><td>{{$addonText}} SWP Amount</td><td>Fund Value at End of Year</td></tr>
                                        ...
                                        $avgMonth = $store/(12 / $inter);
                                        if($currentage>0)
                                        echo("<tr><td>". (++$age + $currentage)."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($avgMonth))."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($val))."</td></tr>");
                                        else
                                        echo("<tr><td>".(++$year + $currentage)."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($avgMonth))."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($val))."</td></tr>");
                                        $isYear = true;
                                        $store = 0;
                                    }
                        ...
                        <div class="roundBorderHolder"> 
                        <table>
                            <tr  style="background:{{$city_color}}"><td>Year</td><td>Annual Investment</td><td>Year End Value</td></tr>
                            @php
                            $year = 1;
                            $defPeriod = $defermentperiod;
                            $lumpsumInv = $initial;
                        ...
                        <table>
                            ...
                            <main class="mainPdf">
                             ...
                             <h1 class="pdfTitie">Distribution Phase<br/>Projected Monthly Withdrawal & Fund Value</h1>
                            ...
                            <div class="roundBorderHolder">  
                             <table>
                                <tr  style="background:{{$city_color}}"><td>@if($currentage>0) Age @else Year @endif</td><td>{{$addonText}} SWP Amount</td><td>Fund Value at End of Year</td></tr>
                                    ...
                                    $val = $openingBal + $openingBal * $annualRate-$annualSwp;
                                    echo("<tr><td>".($currentage + $year)."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($annualSwp/12))."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($val))."</td></tr>");
                                    $year++;
                                    $annualSwp = $store+$annualIncrement*12;
                                    $store = $annualSwp;
                                    $openingBal = $val;
                        ...
                        <table>
                            <tr  style="background:{{$city_color}}"><td>@if($currentage>0) Age @else Year @endif</td><td>Annual Investment</td><td>Year End Value</td></tr>
                                ...
                                echo("<tr><td>".($year + $currentage)."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($amountInvested))."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($yearendVal))."</td></tr>");
                                $year++;
                                $age++;
                            }
                            @endphp
                    ...
                    <div class="roundBorderHolder">                  
                        ...
                        <table>
                            <tr  style="background:{{$city_color}}"><td>@if($currentage>0) Age @else Year @endif</td><td>{{$addonText}} SWP Amount</td><td>Fund Value at End of Year</td></tr>
                                ...
                                echo("<tr><td>".($age + $currentage)."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($monthlySwp))."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($yearEnd))."</td></tr>");
                                $age++;
                                $year++;
                                }
                            ...
                            <tr  style="background:{{$city_color}}"><td>@if($currentage>0) Age @else Year @endif</td><td>Annual Investment</td><td>Year End Value</td></tr>
                                ...
                                if($year <= $payPer)
                                echo("<tr><td>".($year+$currentage)."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($amountInvested))."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($yearEndValue))."</td></tr>");
                                else
                                echo("<tr><td>".($year+$currentage)."</td><td>-</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($yearEndValue))."</td></tr>");
                                $year++;
                                //$lumpsumInv = $yearEndVal;
                    ...
                    <div class="roundBorderHolder">    
                        ...
                        <div class="roundBorderHolder">     
                             <table>
                                <tr  style="background:{{$city_color}}"><td>@if($currentage>0) Age @else Year @endif</td><td>Average Monthly Withdrawal Amount</td><td>Fund Value at End of Year</td></tr>
                                @php
                                $addYear = $year-1;
                                $swpPer = $swp;
                                $year = 1;
                    ...
                    <div class="roundBorderHolder">     
                        ...
                        <div class="roundBorderHolder">      
                        <table>
                                <tr  style="background:{{$city_color}}"><td>@if($currentage>0) Year @else Year @endif</td><td>{{$addonText}} SWP Amount</td><td>Fund Value at End of Year</td></tr>
                                @php
                                $addYear = $year-1;
                                $swpPer = $swp;
                                $year = 1;
                        ...
                        <table>
                                <tr  style="background:{{$city_color}}"><td>@if($currentage>0) Year @else Year @endif</td><td>{{$addonText}} SWP Amount</td><td>Fund Value at End of Year</td></tr>
                                    ...
                                    $val = $openingBal + $openingBal * $annualRate-$annualSwp;
                                    echo("<tr><td>".($year+$currentage)."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($annualSwp/12))."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($val))."</td></tr>");
                                    $year++;
                                    $annualSwp = $store+$annualIncrement*12;
                                    $store = $annualSwp;
                                    $openingBal = $val;
                        ...
                        <table>
                            <tr style="background:{{$city_color}}" ><td>@if($currentage>0) Age @else Year @endif</td><td>Annual Investment</td><td>Year End Value</td></tr>
                                ...
                                echo("<tr><td>".($year + $currentage)."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($amountInvested * 12))."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($yearendVal))."</td></tr>");
                                $year++;
                                $age++;
                            }
                            @endphp
                      ...
                      <table>
                         ...
                         <table>
                            <tr style="background:{{$city_color}}" ><td>@if($currentage>0) Age @else Year @endif</td><td>Annual Investment</td><td>Year End Value</td></tr>
                                ...
                                if($year <= $payPer)
                                echo("<tr><td>".($year + $currentage)."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($amountInvested * 12))."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($yearEndValue))."</td></tr>");
                                else
                                echo("<tr><td>".($year + $currentage)."</td><td>-</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($yearEndValue))."</td></tr>");
                                $year++;
                                $mainAge = $currentage + $year;
                    ...
                    <div class="roundBorderHolder">                
                        <table>
                            <tr  style="background:{{$city_color}}"><td>@if($currentage>0) Age @else Year @endif</td><td>{{$addonText}} Withdrawal Amount</td><td>Fund Value at End of Year</td></tr>
                            @php
                            $addYear = $year-1;
                                $swpperiod = $swp * 12;
                                $month = 1;
                        ...
                        <table>
                           ...
                           <div class="roundBorderHolder">
                            ...
                            <tr  style="background:{{$city_color}}"><td>@if($currentage>0) Age @else Year @endif</td><td>Annual Investment</td><td>Year End Value</td></tr>
                                ...
                                if($year <= $payPer)
                                echo("<tr><td>".($currentage+$year)."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($amountInvested*12))."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($yearEndValue))."</td></tr>");
                                else
                                echo("<tr><td>".($currentage+$year)."</td><td>-</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($yearEndValue))."</td></tr>");
                                $year++;
                                //$lumpsumInv = $yearEndVal;
                        ...
                        <div class="roundBorderHolder">
                        <table>
                                <tr  style="background:{{$city_color}}"><td>@if($currentage>0) Year @else Year @endif</td><td>Average Monthly Withdrawal Amount</td><td>Fund Value at End of Year</td></tr>
                                @php
                                $addYear = $year-1;
                                $swpPer = $swp;
                                $year = 1;
                        ...
                        <table>
                            <tr  style="background:{{$city_color}}"><td>@if($currentage>0) Age @else Year @endif</td><td>Annual Investment</td><td>Year End Value</td></tr>
                                ...
                                echo("<tr><td>".($year + $currentage)."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($amountInvested*12))."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($totalYearEndValue))."</td></tr>");
                        ...
                        <div class="roundBorderHolder">     
                             <table>
                            <tr  style="background:{{$city_color}}"><td>Age</td><td>{{$addonText}} SWP Amount</td><td>Fund Value at End of Year</td></tr>
                            @php
                            $addYear = $year-1;
                            $month = 1;
                            $openingBal = $accumulated;
                            ...
                            <tr  style="background:{{$city_color}}"><td>@if($currentage>0) Age @else Year @endif</td><td>Annual Investment</td><td>Year End Value</td></tr>
                                ...
                                if($year <= $payPer)
                                echo("<tr><td>".($year + $currentage)."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($amountInvested*12))."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($totalYearEndVal))."</td></tr>");
                                else
                                echo("<tr><td>".($year + $currentage)."</td><td>-</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($totalYearEndVal))."</td></tr>");
                                $year++;
                                $mainAge = $currentage + $year;
                                //$lumpsumInv = $yearEndVal;
                        ...
                        <table>
                            ...
                            <tr ><td>@if($currentage>0) Age @else Year @endif</td><td>Annual Investment</td><td>Year End Value</td></tr>
                                ...
                                if($year <= $payPer)
                                echo("<tr><td>".($currentage+$year)."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($amountInvested*12))."</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($totalYearEndVal))."</td></tr>");
                                else
                                echo("<tr><td>".($currentage+$year)."</td><td>-</td><td><span class='pdfRupeeIcon'>&#8377;</span>".custome_money_format(round($totalYearEndVal))."</td></tr>");
                                $year++;
                                //$lumpsumInv = $yearEndVal;
                        ...
                        <table>
                            ...
                            <p style="text-align:left;">
                                ...
                                @endif
                                <br>
                        *The above is for illustration purpose only. Report Date : {{date('d/m/Y')}}
                            </p>
                    </main>
