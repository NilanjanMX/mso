                        ...
                        <div class="card sip-calculator singleLineHolder calculatorFormShape">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-check pl-0">
                                        <label class="checkLinecontainer" for="TurnOnSip_1">Lumpsum
                                            <input class="form-check-input fixed_deposit_chk" id="TurnOnSip_1" type="radio" name="investmentmode" onchange="TurnOnSip(1)"  checked value=1>
                                            <span class="checkmark"></span>
                                        </label> 
                                    </div>
                                    <div class="form-check pl-0">
                                        <label class="checkLinecontainer" for="TurnOnSip_2">Annual Lumpsum
                                            <input class="form-check-input fixed_deposit_chk" id="TurnOnSip_2" type="radio" name="investmentmode" value=2  onchange="TurnOnSip(2)" >
                                            <span class="checkmark"></span>
                                        </label> 
                                    </div>
                                    <div class="form-check pl-0">
                                        <label class="checkLinecontainer" for="TurnOnSip_3">SIP
                                            <input class="form-check-input fixed_deposit_chk" id="TurnOnSip_3" type="radio" name="investmentmode" value=3  onchange="TurnOnSip(3)" >
                                            <span class="checkmark"></span>
                                        </label> 
                                    </div>
                                    <div class="form-check pl-0">
                                        <label class="checkLinecontainer" for="TurnOnSip_4">Lumpsum+SIP
                                            <input class="form-check-input fixed_deposit_chk" id="TurnOnSip_4" type="radio" name="investmentmode" value=4  onchange="TurnOnSip(4)" >
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div id="sipamt" style="display:none;">
                              <div class="form-group row">
                                  ...
                                  <div class="col-sm-7">
                                      <input type="text" class="form-control pr-2 mr-1 " id="sipamti" name="sipamt" value="" required="">
                                      <div class="cal-icon">
                                          ₹
                                      </div>
                                  </div>
                                        ...
                                        <div class="col-sm-5">
                                            <div class="form-check form-check-inline">
                                                <label class="checkLinecontainer mb-0 mt-2" for="showAc_1">No
                                                    <input class="form-check-input fixed_deposit_chk" id="showAc_1" type="radio" name="deferment" onchange="showAc(1)"  checked value="1">
                                                    <span class="checkmark"></span>
                                                </label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <label class="checkLinecontainer mb-0 mt-2" for="showAc_2">Yes
                                                    <input class="form-check-input fixed_deposit_chk" id="showAc_2" type="radio" name="deferment" value="2"  onchange="showAc(2)" >
                                                    <span class="checkmark"></span>
                                                </label>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-5">
                                                <div class="form-check form-check-inline">
                                                    <label class="checkLinecontainer mb-0 mt-1" for="changeIncr_false">No
                                                        <input class="form-check-input fixed_deposit_chk" id="changeIncr_false" type="radio" name="annualincr" onchange="changeIncr(false)"  checked value="1">
                                                        <span class="checkmark"></span>
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <label class="checkLinecontainer mb-0 mt-1" for="changeIncr_true">Yes
                                                        <input class="form-check-input fixed_deposit_chk" id="changeIncr_true" type="radio" name="annualincr" value="2"  onchange="changeIncr(true)" >
                                                        <span class="checkmark"></span>
                                                    </label>
                                                </div>
                                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-5">
                                    <label class="checkLinecontainer mb-0 mt-2"><span>In %</span>
                                        <input id="percentRadio" class="form-check-input fixed_deposit_chk"  onchange="activateMe(1)" type="radio" name="incrtype" class="form-control" value=0 disabled>
                                        <span class="checkmark"></span>
                                    </label>
                                </div>
                                <div class="col-sm-7">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-5 openEye">
                                    <label class="checkLinecontainer mb-0 mt-2">In Amount  &nbsp; 
                                        <input id="percentAmount" class="form-check-input fixed_deposit_chk"  onchange="activateMe(2)" type="radio" name="incrtype" class="form-control" value=1 disabled>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12">
                                    <label class="checkLinecontainer mb-0 mt-2">In Amount:
                                        <input class="form-check-input" type="radio" name="sets" value="1" onchange="SetSwp(1)">
                                        <span class="checkmark"></span>
                                    </label>
                                </div>
                                  ...
                                  <div class="col-sm-3">
                                      <div class="d-flex align-items-center">
                                          <label class="checkLinecontainer mb-0 mr-2">Monthly
                                            <input class="form-check-input" type="radio" name="cats" onchange="SetSwpValue(1)" value="1">
                                            <span class="checkmark"></span>
                                          </label>
                                  ...
                                  <div class="col-sm-3">
                                      <div class="d-flex align-items-center">
                                          <label class="checkLinecontainer mb-0 mr-2">Quaterly
                                            <input class="form-check-input" type="radio" name="cats" onchange="SetSwpValue(2)" value="2">
                                            <span class="checkmark"></span>
                                          </label>
                                  ...
                                  <div class="col-sm-3">
                                      <div class="d-flex align-items-center">
                                          <label class="checkLinecontainer mb-0 mr-2" style="white-space: nowrap;">Half-Yearly
                                            <input class="form-check-input" type="radio" name="cats" onchange="SetSwpValue(3)" value="3">
                                            <span class="checkmark"></span>
                                          </label>
                                  ...
                                  <div class="col-sm-3">
                                      <div class="d-flex align-items-center">
                                          <label class="checkLinecontainer mb-0 mr-2">Yearly
                                            <input class="form-check-input" type="radio" name="cats" onchange="SetSwpValue(4)" value="4">
                                            <span class="checkmark"></span>
                                          </label>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12">
                                    <label class="checkLinecontainer mb-0 mt-2">In %: (Select the withdrawal mode and total annual withdrawal %)
                                        <input class="form-check-input" type="radio" name="sets" value="2"  onchange="SetSwp(2)">
                                        <span class="checkmark"></span>
                                    </label>
                                </div>
                            </div>
                            <div id="percentsec" style="display:none;">
                              <div class="form-group row">
                                  <div class="col-sm-3">
                                      <div class="d-flex align-items-center">
                                          <label class="checkLinecontainer mb-0 mr-2">Monthly
                                            <input class="form-check-input" type="radio" name="pats" onchange="SetSwpValue(1)" value="1">
                                            <span class="checkmark"></span>
                                          </label>
                                  ...
                                  <div class="col-sm-3">
                                      <div class="d-flex align-items-center">
                                          <label class="checkLinecontainer mb-0 mr-2">Quaterly
                                            <input class="form-check-input" type="radio" name="pats" onchange="SetSwpValue(2)" value="2">
                                            <span class="checkmark"></span>
                                          </label>
                                  ...
                                  <div class="col-sm-3">
                                      <div class="d-flex align-items-center">
                                          <label class="checkLinecontainer mb-0 mr-2" style="white-space: nowrap;">Half-Yearly
                                            <input class="form-check-input" type="radio" name="pats" onchange="SetSwpValue(3)" value="3">
                                            <span class="checkmark"></span>
                                          </label>
                                  ...
                                  <div class="col-sm-3">
                                      <div class="d-flex align-items-center">
                                          <label class="checkLinecontainer mb-0 mr-2">Yearly
                                            <input class="form-check-input" type="radio" name="pats" onchange="SetSwpValue(4)" value="4">
                                            <span class="checkmark"></span>
                                          </label>
                              ...
                              <div class="form-group row">
                                  <div class="col-sm-3">
                                      <div class="d-flex align-middle fourbox">
                                          ...
                                          <input type="text" name="monthlyamt1" id="monthlyamt1" class="form-control" value="" readonly>
                                      </div>
                                  ...
                                  <div class="col-sm-3">
                                      <div class="d-flex align-middle fourbox">
                                          ...
                                          <input type="text" name="quaterlyamt1" id="quaterlyamt1" class="form-control" value="" readonly>
                                      </div>
                                  ...
                                  <div class="col-sm-3">
                                      <div class="d-flex align-middle fourbox">
                                          ...
                                          <input type="text" name="halfyearamt1" id="half-yearamt1" class="form-control" value=""  readonly>
                                      </div>
                                  ...
                                  <div class="col-sm-3">
                                      <div class="d-flex align-middle fourbox">
                                          ...
                                          <input type="text" name="annualyamt1" id="annualyamt1" class="form-control" value="" readonly>
                                      </div>
