                        ...
                        <form class="js-validate-form" action="{{route('frontend.stpFutureValueReadyRecoknerOutput')}}" method="post">
                            <div class="card sip-calculator singleLineHolder calculatorFormShape">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control {{ $errors->has('initial_investment') ? ' is-invalid' : '' }}" name="initial_investment" value="{{$form_data['initial_investment'] ?? ''}}" >
                                        <div class="cal-icon">
                                            ₹
                                        </div>
                                    ...
                                    <div class="col-sm-8">
                                        <div class="form-check form-check-inline">
                                            <label class="checkLinecontainer mb-0 mt-2" for="monthly_transfer_mode1">Capital Appreciation
                                                <input class="form-check-input" type="radio" id="monthly_transfer_mode1" name="monthly_transfer_mode" value="CA" @if($form_data['monthly_transfer_mode']=='CA') checked  @endif>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="offset-1 col-sm-10">
                                        <div class="calcBelowBtn">
                                                ...
                                                @if(session()->get('stp_future_value_ready_recokner_form_id'))
                                                    <button type="button" onclick="location.reload();" class="btn banner-btn whitebg mx-3"> Reset</button>
                                                @else
                                                    <a href="{{route('frontend.stpFutureValueReadyRecokner')}}" class="btn banner-btn whitebg mx-3"> Reset</a>
                                                @endif
                                                <button class="btn banner-btn mx-3">Calculate</button>
                                        </div>
                                    </div>
