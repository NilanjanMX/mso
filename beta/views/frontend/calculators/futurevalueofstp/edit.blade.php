                                ...
                                <div class="col-sm-7">
                                    <div class="form-check form-check-inline">
                                        <label class="checkLinecontainer mb-0 mt-1" for="monthly_transfer_mode1">Capital Appreciation
                                            <input class="form-check-input" type="radio" id="monthly_transfer_mode1" name="monthly_transfer_mode" value="CA"  @if($form_data['monthly_transfer_mode']=='CA')  checked @else checked  @endif>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-check form-check-inline">
                                                <label class="checkLinecontainer mb-0 mt-2" for="fixed_transfer_mode3">Fixed %
                                                    <input class="form-check-input" type="radio" id="fixed_transfer_mode3" name="fixed_transfer_mode" value="FP" @if(isset($form_data['fixed_transfer_mode']) && $form_data['fixed_transfer_mode']=='FP' || !isset($form_data['fixed_transfer_mode'])) checked  @endif>
                                                    <span class="checkmark"></span>
                                                </label> 
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control {{ $errors->has('fixed_percent') ? ' is-invalid' : '' }}" name="fixed_percent"   value="{{ $form_data['fixed_percent'] ?? ''}}" @if(old('fixed_transfer_mode')=='FP') required  @endif @if(isset($form_data['fixed_transfer_mode']) && $form_data['fixed_transfer_mode']=='FP') required  @endif>
                                            <div class="cal-icon">
                                                %
                                            </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-check form-check-inline">
                                                <label class="checkLinecontainer mb-0 mt-2" for="fixed_transfer_mode5">Fixed Amount
                                                    <input class="form-check-input" type="radio" id="fixed_transfer_mode5" name="fixed_transfer_mode" value="FA" @if(isset($form_data['fixed_transfer_mode']) && $form_data['fixed_transfer_mode']=='FA') checked  @endif >
                                                    <span class="checkmark"></span>
                                                </label> 
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control {{ $errors->has('fixed_amount') ? ' is-invalid' : '' }}" name="fixed_amount"  value="{{ $form_data['fixed_amount'] ?? ''}}" min="100" @if(old('fixed_transfer_mode')=='FA') required  @endif  @if(isset($form_data['fixed_transfer_mode']) && $form_data['fixed_transfer_mode']=='FA') required  @endif>
                                            <div class="cal-icon">
                                                ₹
                                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="offset-1 col-sm-10">
                                    <div class="calcBelowBtn">
                                            ...
                                            @if(session()->get('future_value_of_stp_form_id'))
                                                <button type="button" onclick="location.reload();" class="btn banner-btn whitebg mx-3"> Reset</button>
                                            @else
                                                <a href="{{route('frontend.futureValueOfSTP')}}" class="btn banner-btn whitebg mx-3"> Reset</a>
                                            @endif
                                            <button class="btn banner-btn mx-3">Calculate</button>
                                    </div>
                                </div>
