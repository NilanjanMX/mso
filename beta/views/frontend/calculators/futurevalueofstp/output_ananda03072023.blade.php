...
<!-- <div class="banner bannerForAll container" style="padding-bottom: 0; margin-bottom: 15px;">
    ...
    <div class="banner styleApril">
        ...
        @include('frontend.calculators.left_sidebar')
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="page-title">Future Value of STP</h2>
                </div>
            </div>
        </div>
    </div>
        ...
        <div id="content" class="container">
            <div class="row">
                <div class="col-md-10 offset-md-1 text-center">
                    ...
                    @else
                        <a href="{{route('frontend.futureValueOfSTPBack')}}?action=back" class="btn btn-primary btn-round"><i class="fa fa-angle-left"></i> Back</a>
                    @endif
                    ...
                    <div class="outputTableHolder">
                        <h5 class="midheading">STP Investment @if(isset($clientname)) Proposal <br> For {{$clientname?$clientname:''}} @else Planning @endif</h5>
                        ...
                        @endif
                            <h1 style="color: #131f55;font-size:22px;margin-bottom:20px;text-align: center;">Projected Future Value</h1>
                            <div class="roundBorderHolder">
                            <table class="table table-bordered text-center">
                                <tbody>
                                <tr>
                            ...
                            <h5 class="text-center">Projected Annual Investment Value</h5>
                            <div class="roundBorderHolder">
