            ...
            <div class="row">
                <div class="col-md-12 offset-md-0 text-center">
                    ...
                    <div class="outputTableHolder">
                        <h1 class="midheading">STP Investment @if(isset($clientname)) Proposal <br> For {{$clientname?$clientname:''}} @else Planning @endif</h1>
                        <div class="roundBorderHolder">
                            ...
                            <h1 class="midheading">Projected Annual Investment Value</h5>
                            <div class="roundBorderHolder">
                            <table class="table table-bordered text-center">
                                <tbody>
                                <tr>
