                        ...
                        <table>
                            ...
                            @while($yr <= ($period))
                                ...
                                $ev2 = (1+$rate2_percent)*$spAmt*((pow((1+$rate2_percent),($yr * 12))-1)/$rate2_percent);
                                    ...
                                    echo("<tr><td>".$yr."</td><td><span class=\"pdfRupeeIcon\">&#8377;</span> ".custom_money_format($spAmt)."</td><td><span class=\"pdfRupeeIcon\">&#8377;</span> ".custom_money_format(round($spAmt * 12))."</td><td><span class=\"pdfRupeeIcon\">&#8377;</span> ".custom_money_format(round($ev1))."</td><td><span class=\"pdfRupeeIcon\">&#8377;</span> ".custom_money_format(round($ev2))."</td></tr>");
                               }
                               else
                               {
