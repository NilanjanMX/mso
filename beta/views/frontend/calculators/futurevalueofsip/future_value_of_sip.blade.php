                                ...
                                <div class="col-sm-7">
                                    <div class="form-check form-check-inline">
                                        <label class="checkLinecontainer mb-0 mt-1">Yes
                                            <input type="radio" name="include_step_up" value="yes" onchange="SetstepUp(1)" @if (old('include_step_up') == 'yes') checked @endif>
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <label class="checkLinecontainer mb-0 mt-1">No
                                            <input type="radio" name="include_step_up" value="no" onchange="SetstepUp(0)" @if (old('include_step_up') == 'no') @else checked @endif> 
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-5">
                                        <label class="checkLinecontainer mb-0 mt-2 pl-0"><span>Step - Up % Every Year</span>
                                            <input class="from-control" type="radio" id="stepupFirst" value=1 name="steuup" onchange="activateMe(1)">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-5">
                                        <label class="checkLinecontainer mb-0 mt-2 pl-0"><span>Step - Up Amount Every Year</span>
                                            <input class="from-control" type="radio" id="stepupSecond" value=2 name="steuup" onchange="activateMe(2)">
                                            <span class="checkmark" style="left: auto;right: 0px;margin-right: 110px;"></span>
                                        </label>
                                    </div>
