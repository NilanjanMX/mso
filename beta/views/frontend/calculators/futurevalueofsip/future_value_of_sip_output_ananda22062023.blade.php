        ...
        @if (isset($report) && isset($is_graph) && $report == 'detailed')
            ...
            function drawChart() {
                var data = google.visualization.arrayToDataTable([
                    ['Year',
                        'Year End Value Scenario 1  @ {{ $interest1 ? number_format((float) $interest1, 2, '.', '') : 0 }} %',
            ...
            <div class="row">
                <div class="col-md-10 offset-md-1 text-center">
                    ...
                    <div class="outputTableHolder">
                        <h5 class="mb-3 text-center">SIP @if (isset($clientname))
                        ...
                        <h1 style="color: #131f55;font-size:22px;margin-bottom:20px;text-align: center;">Expected Future
                            Value</h1>
                        <div class="roundBorderHolder">
                            <table class="table table-bordered text-center">
                                <tbody>
                                ...
                                <table class="table table-bordered text-center" style="background: #fff;">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Year End Value Scenario 1 @ {{ number_format($interest1, 2, '.', '') }} %
                                            </td>
                                            @if (isset($rate2_percent))
                                                <td>Year End Value Scenario 2 @ {{ number_format($interest2, 2, '.', '') }}
                                                    %</td>
                                            @endif
                                        </tr>
                                        @php
