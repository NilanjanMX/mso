...
@section('js_after')
    <script>
        ...
        }, "The value of Expected Rate of Return cannot be equal to Annual Increment % in SIP Amount.");
        ...
        var validator = $(".js-validate-form").validate({
            ...
            messages: {
                ...
                interest1: "Please enter a value between 0.10 - 15.00% and not equal as step up rate",
                    ...
                    <form class="js-validate-form" action="{{ route('frontend.futureValueOfSipOutput') }}" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text"
                                        ...
                                        name="amount" value="{{ old('amount') }}" maxlength="10">
                                    <div class="cal-icon">
                                        ₹
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text"
                                        ...
                                        name="interest1" value="{{ old('interest1') }}">
                                    <div class="cal-icon">
                                        %
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text"
                                        ...
                                        name="interest2" value="{{ old('interest2') }}">
                                    <div class="cal-icon">
                                        %
                                    </div>
                        ...
                        <div class="card sip-calculator singleLineHolder">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <label class="radio-inline"><input type="radio" name="include_step_up" value="yes"
                                            onchange="SetstepUp(1)" @if (old('include_step_up') == 'yes') checked @endif>Yes
                                    </label>

                                    <label class="radio-inline"><input type="radio" name="include_step_up" value="no"
                                            onchange="SetstepUp(0)"
                                            @if (old('include_step_up') == 'no') @else checked @endif>No </label>
                            ...
                            <div id="step_up_fields" style='display:none;'>
                                <div class="form-group row">
                                    <label class="col-sm-5 col-form-label"><span>Step - Up % Every
                                            Year</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="from-control"
                                            type="radio" id="stepupFirst" value=1 name="steuup"
                                            onchange="activateMe(1)"></label>
                                    <div class="col-sm-7">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-5 col-form-label"><span>Step - Up Amount Every
                                            Year</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="from-control"
                                            type="radio" id="stepupSecond" value=2 name="steuup"
                                            onchange="activateMe(2)"></label>
                                    <div class="col-sm-7">

                                        <input type="text" class="form-control" name="step_up_amount"
                                            id="step_up_amount" value="{{ old('step_up_amount') }}">
                                        <div class="cal-icon">
                                            ₹
                                        </div>
                            ...
                            <div class="form-group row" style="align-items: flex-start;">
                                ...
                                <div class="col-sm-7">
                                    <textarea class="form-control {{ $errors->has('note') ? ' is-invalid' : '' }}" name="note" rows="2"
                                        id="note" style="height: 100px;" maxlength="500" onkeyup="changeNote();">{{ old('note') }}</textarea>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <label class="checkLinecontainer">Summary Report
                                            <input class="form-check-input" type="radio" name="report"
                                                ...
                                                @if (old('report') == 'summary') checked @endif>
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <label class="checkLinecontainer">Detailed Report
                                            <input class="form-check-input" type="radio" name="report"
                                                ...
                                                @if (old('report') == 'summary') @else checked @endif>
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="offset-1 col-sm-10">
                                    <div class=" calcBelowBtn">
                                        ...
                                        <button type="button" onclick="location.reload();"
                                            class="btn banner-btn whitebg mx-3"> Reset</button>
