            ...
            <div class="item">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p>Lörem ipsum rutavdrag bespepp. Danyre gereras, sar rugbyförälder, ären. Multitirade pabel men
                            spökgarn medan nåfus kreddig. Decill eus. Osm kromera, diadunade intrarade.
                        </p>
                    ...
                    <div class="col-md-5"><img class="img-fluid" src="{{ asset('') }}img/pcalculatorbanner.png"
                            alt="" /></div>
                </div>
            </div>
        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <label class="radio-inline"><input type="radio" name="include_step_up" value="yes"
                                            onchange="SetstepUp(1)" @if ($form_data['include_step_up'] == 'yes') checked @endif>Yes
                                    </label>

                                    <label class="radio-inline"><input type="radio" name="include_step_up" value="no"
                                            onchange="SetstepUp(0)" @if ($form_data['include_step_up'] == 'no') checked @endif>No
                                    </label>
                            ...
                            <div id="step_up_fields" style='display:none;'>
                                <div class="form-group row">
                                    <label class="col-sm-5 col-form-label"><span>Step - Up % Every
                                            ...
                                            type="radio" id="stepupFirst"
                                            @if (isset($form_data['step_up_rate']) && $form_data['step_up_rate'] != '') checked @endif value=1 name="steuup"
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-5 col-form-label"><span>Step - Up Amount Every
                                            Year</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="from-control"
                                            type="radio" id="stepupSecond" value=2
                                            @if (isset($form_data['step_up_amount']) && $form_data['step_up_amount'] != '') checked @endif name="steuup"
                                ...
                                <div class="offset-1 col-sm-10">
                                    <div class="calcBelowBtn">
                                        <button type="button" onclick="window.history.go(-1); return false;"
                                            class="btn banner-btn whitebg mx-3"><i class="fa fa-angle-left"></i>
                                            Back</button>
