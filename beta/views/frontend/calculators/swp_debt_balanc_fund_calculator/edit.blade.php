...
@section('js_after')
    ...
    <script>
        $(function() {
            ...
            // $('.calme2').keyup();
            $('#swp_period').keyup();
            $('#annual_withdrawal_precent_investment').keyup();
            // $('#debt_fund').keyup();
            // $('.fixed_deposit_chk').click();
            // $('#is_client').click();
        });

        

        @if( $form_data['annuity']=='Deferred_Annuity')
            $('#deferred_annuity_box').css("display", "block");
                    ...
                    <form class="js-validate-form" action="{{route('frontend.swp_debt_balanc_fund_calculator_output')}}" method="post">
                        <div class="card sip-calculator singleLineHolder calculatorFormShape">
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <div class="form-check form-check-inline">
                                        ...
                                        <label class="checkLinecontainer" for="Immediate_Annuity">Immediate Annuity
                                            <input class="form-check-input fixed_deposit_chk" id="Immediate_Annuity" type="radio" name="annuity"  value="Immediate_Annuity" @if($form_data['annuity']=='Immediate_Annuity' || $form_data['annuity']!='Deferred_Annuity') checked  @endif>
                                    ...
                                    <div class="form-check form-check-inline">
                                        ...
                                        <label class="checkLinecontainer" for="Deferred_Annuity">Deferred Annuity
                                            <input class="form-check-input fixed_deposit_chk" id="Deferred_Annuity" type="radio" name="annuity" value="Deferred_Annuity" @if($form_data['annuity']=='Deferred_Annuity') checked  @endif >
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control maxtwodigit {{ $errors->has('current_age') ? ' is-invalid' : '' }}" name="current_age" value="{{isset($form_data['current_age'])?$form_data['current_age']:''}}" maxlength="10" >
                                    <div class="cal-icon">
                                        Yr
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" id="initial_investment" class="form-control number {{ $errors->has('initial_investment') ? ' is-invalid' : '' }}" name="initial_investment" value="{{$form_data['initial_investment']}}" >
                                    <div class="cal-icon">
                                        ₹
                                    </div>
                            ...
                            <div id="deferred_annuity_box" style="display:none;">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" id="deferment_period" class="form-control {{ $errors->has('deferment_period') ? ' is-invalid' : '' }}" name="deferment_period" value="{{isset($form_data['deferment_period'])?$form_data['deferment_period']:''}}" maxlength="10" >
                                        <div class="cal-icon">
                                            Yrs
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="calme1 form-control pr-2 mr-1 number {{ $errors->has('debt') ? ' is-invalid' : '' }}" name="debt" id="debt" value="{{isset($form_data['debt'])?$form_data['debt']:''}}" >
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="calme1 form-control pr-2 mr-1 number {{ $errors->has('balance') ? ' is-invalid' : '' }}" name="balance" id="balance" value="{{$form_data['balance']}}" >
                                                <div class="cal-icon" style="width:33px;">
                                                    %
                                                </div>
                                            </div>
                                     ...
                                     <div class="col-md-3">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="calme1 form-control pr-2 mr-1 number {{ $errors->has('equity') ? ' is-invalid' : '' }}" name="equity" id="equity" value="{{$form_data['equity']}}" >
                                                <div class="cal-icon" style="width:33px;">
                                                    %
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-7">
                                                <input readonly type="text" class="form-control pr-2 mr-1 number {{ $errors->has('total1') ? ' is-invalid' : '' }}" name="total1" id="total1" value="{{isset($form_data['total1'])?$form_data['total1']:''}}" >
                                                <div class="cal-icon" style="width:33px;">
                                                    %
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group row">
                                            <label class="col-sm-7 col-form-label">Debt</label>
                                            <div class="col-sm-5">
                                                <input type="text" class="calme2 form-control pr-2 mr-1 number {{ $errors->has('debt2') ? ' is-invalid' : '' }}" name="debt2" id="debt2" value="{{isset($form_data['debt2'])?$form_data['debt2']:''}}" >
                                                <div class="cal-icon" style="width:33px;">
                                                    %
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group row">
                                            <label class="col-sm-7 col-form-label">Balance</label>
                                            <div class="col-sm-5">
                                                <input type="text" class="calme2 form-control pr-2 mr-1 number {{ $errors->has('balance2') ? ' is-invalid' : '' }}" name="balance2" id="balance2" value="{{$form_data['balance2']}}" >
                                                <div class="cal-icon" style="width:33px;">
                                                    %
                                                </div>
                                            </div>
                                     ...
                                     <div class="col-md-3">
                                        <div class="form-group row">
                                            <label class="col-sm-7 col-form-label">Equity</label>
                                            <div class="col-sm-5">
                                                <input type="text" class="calme2 form-control pr-2 mr-1 number {{ $errors->has('equity2') ? ' is-invalid' : '' }}" name="equity2" id="equity2" value="{{$form_data['equity2']}}" >
                                                <div class="cal-icon" style="width:33px;">
                                                    %
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group row">
                                            <label class="col-sm-5 col-form-label">Total</label>
                                            <div class="col-sm-7">
                                                <input readonly type="text" class="form-control pr-2 mr-1 number {{ $errors->has('total2') ? ' is-invalid' : '' }}" name="total2" id="total2" value="{{isset($form_data['total2'])?$form_data['total2']:''}}" >
                                                <div class="cal-icon" style="width:33px;">
                                                    %
                                                </div>
                                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input readonly type="text" id="fund_value_dis" class="form-control number {{ $errors->has('fund_value_dis') ? ' is-invalid' : '' }}" name="fund_value_dis" value="{{isset($form_data['fund_value_dis'])?$form_data['fund_value_dis']:''}}" >

                                    <input readonly type="hidden" id="fund_value" class="form-control number {{ $errors->has('fund_value') ? ' is-invalid' : '' }}" name="fund_value" value="{{isset($form_data['fund_value'])?$form_data['fund_value']:''}}" >
                                    <div class="cal-icon">
                                        ₹
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" id="expected_return_debt_fund" class="form-control {{ $errors->has('expected_return_debt_fund') ? ' is-invalid' : '' }}" name="expected_return_debt_fund" value="{{$form_data['expected_return_debt_fund']}}"  >
                                            <div class="cal-icon">
                                                %
                                            </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" id="expected_return_balance_fund" class="form-control number {{ $errors->has('expected_return_balance_fund') ? ' is-invalid' : '' }}" name="expected_return_balance_fund" value="{{$form_data['expected_return_balance_fund']}}" >
                                            <div class="cal-icon">
                                                %
                                            </div>
                            ...
                            <div class="equity_fund_box">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control pr-2 mr-1 number {{ $errors->has('debt_fund') ? ' is-invalid' : '' }}" name="debt_fund" id="debt_fund" value="{{$form_data['debt_fund']}}" >
                                                <div class="cal-icon">
                                                    %
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                <input readonly type="text" class="form-control pr-2 mr-1 number {{ $errors->has('balance_fund') ? ' is-invalid' : '' }}" name="balance_fund" id="balance_fund" value="{{$form_data['balance_fund']}}" >
                                                <div class="cal-icon">
                                                    %
                                                </div>
                                            </div>
                                     ...
                                     <div class="col-md-4">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                <input readonly type="text" class="form-control pr-2 mr-1 number {{ $errors->has('exp_portfolio_return') ? ' is-invalid' : '' }}" name="exp_portfolio_return" id="exp_portfolio_return" value="{{$form_data['exp_portfolio_return']}}" >
                                                <div class="cal-icon">
                                                    %
                                                </div>
                                            </div>
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" id="annual_withdrawal_precent_investment" class="form-control number {{ $errors->has('annual_withdrawal_precent_investment') ? ' is-invalid' : '' }}" name="annual_withdrawal_precent_investment" value="{{$form_data['annual_withdrawal_precent_investment']}}" >
                                    <div class="cal-icon">
                                        %
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-check form-check-inline">
                                        ...
                                        <label class="checkLinecontainer mb-0" for="Monthly">Monthly
                                            <input class="form-check-input" type="radio" name="withdrawal" id="Monthly" value="Monthly" @if($form_data['withdrawal']=='Monthly' || $form_data['withdrawal']!='Monthly') checked  @endif>
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                            <div class="col-sm-8">
                                                <input readonly type="text" class="form-control pr-2 mr-1 number {{ $errors->has('monthly_withdrawal_amount') ? ' is-invalid' : '' }}" name="monthly_withdrawal_amount_dis" id="monthly_withdrawal_amount" value="{{isset($form_data['withdrawal_amount_display'])?$form_data['withdrawal_amount_display']:''}}" >
                                    ...
                                    <div class="form-check form-check-inline">
                                        ...
                                        <label class="checkLinecontainer mb-0" for="Quarterly">Quarterly
                                            <input class="form-check-input" type="radio" name="withdrawal" id="Quarterly" value="Quarterly" @if($form_data['withdrawal']=='Quarterly') checked  @endif>
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                            <div class="col-sm-8">
                                                <input readonly type="text" class="form-control pr-2 mr-1 number {{ $errors->has('monthly_withdrawal_amount2') ? ' is-invalid' : '' }}" name="monthly_withdrawal_amount2_dis" id="monthly_withdrawal_amount2" value="{{isset($form_data['monthly_withdrawal_amount2'])?$form_data['monthly_withdrawal_amount2']:''}}" >
                                    ...
                                    <div class="form-check form-check-inline">
                                        ...
                                        <label class="checkLinecontainer mb-0" for="Half-Yearly">Half-Yearly
                                            <input class="form-check-input" type="radio" name="withdrawal" id="Half-Yearly" value="Half-Yearly" @if($form_data['withdrawal']=='Half-Yearly') checked  @endif>
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                            <div class="col-sm-8">
                                                <input readonly type="text" class="form-control pr-2 mr-1 number {{ $errors->has('monthly_withdrawal_amount3') ? ' is-invalid' : '' }}" name="monthly_withdrawal_amount3_dis" id="monthly_withdrawal_amount3" value="{{isset($form_data['monthly_withdrawal_amount3'])?$form_data['monthly_withdrawal_amount3']:''}}" >
                                    ...
                                    <div class="form-check form-check-inline">
                                        ...
                                        <label class="checkLinecontainer mb-0" for="Yearly">Yearly
                                            <input class="form-check-input" type="radio" name="withdrawal" id="Yearly"  value="Yearly" @if($form_data['withdrawal']=='Yearly') checked  @endif>
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                            <div class="col-sm-9">
                                                <input readonly type="text" class="form-control pr-2 mr-1 number {{ $errors->has('monthly_withdrawal_amount4') ? ' is-invalid' : '' }}" name="monthly_withdrawal_amount4_dis" id="monthly_withdrawal_amount4" value="{{isset($form_data['monthly_withdrawal_amount4'])?$form_data['monthly_withdrawal_amount4']:''}}" >
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" id="swp_period" class="form-control number {{ $errors->has('swp_period') ? ' is-invalid' : '' }}" name="swp_period" value="{{$form_data['swp_period']}}" >
                                     <div class="cal-icon">
                                        Yrs
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control number {{ $errors->has('periodic_rebalance_period') ? ' is-invalid' : '' }}" name="periodic_rebalance_period" value="{{$form_data['periodic_rebalance_period']}}" >
                                    <input type="hidden" name="periodic_rebalance_period_val" id="periodic_rebalance_period_val" value="{{$form_data['periodic_rebalance_period_val']}}">
                                     <div class="cal-icon">
                                        Yrs
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="offset-1 col-sm-10">
                                    <div class="calcBelowBtn">
                                            ...
                                            @if(session()->get('swp_debt_balanc_fund_calculator_form_id'))
                                                <button type="button" onclick="location.reload();" class="btn banner-btn whitebg mx-3"> Reset</button>
                                            @else
                                                <a href="{{route('frontend.swp_debt_balanc_fund_calculator')}}" class="btn banner-btn whitebg mx-3"> Reset</a>
                                            @endif
                                            <button class="btn banner-btn mx-3">Calculate</button>
                                    </div>
                                </div>
