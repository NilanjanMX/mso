        ...
        <div id="content" class="container">
            <div class="row">
                ...
                <div class="outputTableHolder">
                    ...
                    <h1 class="midheading">Portfolio Projection Report @if(isset($clientname) && !empty($clientname)) <br> For {{$clientname?$clientname:''}}  @else  @endif</h1>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form target="_blank" action="{{route('frontend.portfolio_projection_MergeDownload')}}" method="get">
