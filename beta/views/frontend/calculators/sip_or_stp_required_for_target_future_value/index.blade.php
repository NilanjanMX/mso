                                    ...
                                    <div class="col-sm-7">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <label class="checkLinecontainer mb-0 mt-1" for="inlineRadio2">SIP
                                                <input class="form-check-input" type="radio" name="sip_or_stp" id="inlineRadio2" value="sip" @if(old('report')=='stp') @else checked  @endif >
                                                <span class="checkmark"></span>
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <label class="checkLinecontainer mb-0 mt-1" for="inlineRadio1">STP
                                                <input class="form-check-input" type="radio" name="sip_or_stp" id="inlineRadio1" value="stp" @if(old('report')=='stp') checked  @endif>
                                                <span class="checkmark"></span>
                                            </label>
                                        </div>
