...
var calculation_type = $("input[name='sip_or_stp']").val();
        if(calculation_type == "sip") {
            ...
            $(".calculate-stp").hide();
            $(".calculate-stp input").prop("disabled", true);
        }
        if(calculation_type == "stp") {
            $(".calculate-sip").hide();
            $(".calculate-sip input").prop("disabled", true);
            $(".calculate-stp").show();
            $(".calculate-stp input").prop("disabled", false);
        }

        $("input[name='sip_or_stp']").on('change', function () {
...
<section class="main-sec styleNew">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                <h3 class="smalllineHeading">SIP / STP Required For Target Future Value</h3>
                
                    @include('frontend.calculators.common_bio')
                    <br>
                    <form class="js-validate-form" action="{{route('frontend.sipStpRequiredForTargetFutureValue_output')}}" method="post">
                        <div class="card sip-calculator singleLineHolder calculatorFormShape">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control {{ $errors->has('target_amount') ? ' is-invalid' : '' }}" name="target_amount" value="{{old('target_amount', isset($data['target_amount'])?$data['target_amount']:'')}}" maxlength="10"  required>
                                    <div class="cal-icon">
                                        ₹
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control maxtwodigit {{ $errors->has('investment_period') ? ' is-invalid' : '' }}" name="investment_period" value="{{old('investment_period', isset($data['investment_period'])?$data['investment_period']:'')}}"  required>
                                    <div class="cal-icon">
                                        Yrs
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <label class="checkLinecontainer mb-0 mt-1" for="inlineRadio2">SIP
                                            <input class="form-check-input" type="radio" name="sip_or_stp" id="inlineRadio2" value="sip" @if(old('report', isset($data['report'])?$data['report']:'')=='stp') @else checked  @endif >
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <label class="checkLinecontainer mb-0 mt-1" for="inlineRadio1">STP
                                            <input class="form-check-input" type="radio" name="sip_or_stp" id="inlineRadio1" value="stp" @if(old('report', isset($data['report'])?$data['report']:'')=='stp') checked  @endif>
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                            ...
                            <div class="form-group row calculate-sip">
                                <label class="col-sm-5 col-form-label">STP Investment</label>
                                <div class="col-sm-7">
                                    <input type="text" class="form-control {{ $errors->has('amount') ? ' is-invalid' : '' }}" name="amount" value="{{old('amount', isset($data['amount'])?$data['amount']:'')}}"  required>
                                    <div class="cal-icon">
                                        ₹
                                    </div>
                            ...
                            <div class="form-group row calculate-sip">
                                <div class="col-sm-12">
                                    <h6 class="text-muted titleBlueUnderline">Assumed Rate Of Return (STP):</h6>
                                </div>
                            </div>
                            <div class="form-group row calculate-sip">
                                <label class="col-sm-5 col-form-label">Debt Fund</label>
                                <div class="col-sm-7">
                                    <input type="text" class="form-control number {{ $errors->has('debt_interest') ? ' is-invalid' : '' }}" name="debt_interest" value="{{old('debt_interest', isset($data['debt_interest'])?$data['debt_interest']:'')}}"   >
                                    <div class="cal-icon">
                                        %
                                    </div>
                            ...
                            <div class="form-group row calculate-sip">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control number {{ $errors->has('equity_interest') ? ' is-invalid' : '' }}" name="equity_interest" value="{{old('equity_interest', isset($data['equity_interest'])?$data['equity_interest']:'')}}"   >
                                    <div class="cal-icon">
                                        %
                                    </div>
                            ...
                            <div class="form-group row calculate-sip">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control number {{ $errors->has('sip_interest_rate') ? ' is-invalid' : '' }}" name="sip_interest_rate" value="{{old('sip_interest_rate', isset($data['sip_interest_rate'])?$data['sip_interest_rate']:'')}}"   >
                                    <div class="cal-icon">
                                        %
                                    </div>
                            ...
                            <div class="form-group row calculate-stp">
                            ...
                            <input type="hidden" name="monthly_transfer_mode" value="CA" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="offset-1 col-sm-10">
                                    <div class=" calcBelowBtn">
                                            ...
                                            @if(session()->get('sipStpRequiredForTargetFutureValue_form_id'))
                                                <button type="button" onclick="location.reload();" class="btn banner-btn whitebg mx-3"> Reset</button>
                                            @else
                                                <a href="{{route('frontend.sipStpRequiredForTargetFutureValue')}}" class="btn banner-btn whitebg mx-3"> Reset</a>
                                            @endif
