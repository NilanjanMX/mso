                    ...
                    <form class="js-validate-form" action="{{route('frontend.recover_emis_through_sip_output')}}" method="post">
                        <div class="card sip-calculator singleLineHolder calculatorFormShape">
                            ...
                            <div class="form-group row openEye">
                                <label class="col-sm-5 col-form-label">Tenure  &nbsp; 
                                    <span><i class="fa fa-eye"></i><span>Enter the remaining tenure</span></span>
                                </label>
                                <div class="col-sm-7">
                                    <div class="d-flex align-items-center">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="offset-1 col-sm-10">
                                        <div class="calcBelowBtn">
                                                ...
                                                @if(session()->get('recover_emis_through_sip_form_id'))
                                                    <button type="button" onclick="location.reload();" class="btn banner-btn whitebg mx-3"> Reset</button>
                                                @else
                                                    <a href="{{route('frontend.recover_emis_through_sip')}}" class="btn banner-btn whitebg mx-3"> Reset</a>
                                                @endif
                                                <button class="btn banner-btn mx-3">Calculate</button>
                                        </div>
                                    </div>
