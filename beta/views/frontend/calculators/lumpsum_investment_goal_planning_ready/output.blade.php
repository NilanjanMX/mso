...
@section('content')
    ...
    <div class="banner styleApril">
        ...
        @include('frontend.calculators.left_sidebar')
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="page-title">Lumpsum Investment Need Based Ready Reckoner</h2>
                </div>
            </div>
        </div>
    </div>
        ...
        <div id="content" class="container">
            <div class="row">
                <div class="col-md-12 offset-md-0 text-center">
                    ...
                    @else
                        <a href="{{route('frontend.oneTimeInvestmentGoalPlanningReadyReckoner_back')}}?action=back" class="btn btn-primary btn-round"><i class="fa fa-angle-left"></i> Back</a>
                    @endif
                    ...
                    @if($permission['is_download'])
                        ...
                        @else
                            <a href="{{route('frontend.oneTimeInvestmentGoalPlanningReadyReckoner_pdf')}}" target="_blank" id="cmd" class="btn btn-primary btn-round btn-solid">Download / Print</a>
                        @endif
                    @else
                    ...
                    <div class="outputTableHolder">
                        <h1 class="midheading">Lumpsum Investment Need Based Ready Reckoner @if(isset($clientname) && !empty($clientname)) <br> For {{$clientname?$clientname:''}} @endif</h1>
                        ...
                        <div class="roundBorderHolder">
                            ...
                            <h1 class="midheading">Lumpsum Investment Required</h1>
                        <div class="roundBorderHolder">
                            <table class="table table-bordered text-center">
                                <tbody>
                        ...
                        @php
                            $note_data1 = \App\Models\Calculator_note::where('category','summery')->where('calculator','Lumpsum_Investment_Goal_Planning_Ready_Reckoner')->first();
                        @endphp
                        @if(!empty($note_data1))
