    ...
    @include('frontend.calculators.common.header')
        ...
        <main class="mainPdf">
            <div style="padding: 0 0%;">
                <h1 class="pdfTitie">Lumpsum Investment Need Based Ready Reckoner @if(isset($clientname) && !empty($clientname)) <br>For {{$clientname?$clientname:''}} @endif</h1>
                ...
                <h1 class="pdfTitie">Lumpsum Investment Required</h1>
