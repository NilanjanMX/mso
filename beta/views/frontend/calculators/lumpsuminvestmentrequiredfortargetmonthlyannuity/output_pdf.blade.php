...
<main class="mainPdf">
    ...
    <div style="padding: 0 0%;">
        ...
        @php
                    ...
                    @if($deferment=='yes')
                    <h1 class="pdfTitie">Accumulated Corpus Required @if($deferment=='yes') @if(!isset($distribution_phase_interest_rate_2)) @ {{$distribution_phase_interest_rate_1?number_format($distribution_phase_interest_rate_1, 2, '.', ''):0}} % @endif @else @if(!isset($interest2)) @ {{$interest1?number_format($interest1, 2, '.', ''):0}} % @endif @endif</h1>
                    ...
                    <div class="roundBorderHolder">
                        ...
                        @else
                        <h5 class="pdfBlueCell"><span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($av39)}}</h5>
                        @endif

                    @endif

                    <h1 class="pdfTitie">Lumpsum Investment Required @if($deferment=='yes') @if(!isset($accumulation_phase_interest_rate_2)) @ {{$accumulation_phase_interest_rate_1?number_format($accumulation_phase_interest_rate_1, 2, '.', ''):0}} % @endif @else @if(!isset($interest2)) @ {{$interest1?number_format($interest1, 2, '.', ''):0}} % @endif @endif </h1>
                    ...
                    <div class="roundBorderHolder">
                        <table>
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <strong><span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($lumpsum_investment_required1)}} </strong>
                                    </td>
                                    <td>
                                        <strong><span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($lumpsum_investment_required2)}} </strong>
                                    </td>
                                </tr>
                    ...
                    <h5 class="pdfBlueCell"><span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($lumpsum_investment_required1)}}</h5>
                    ...
                    $av43_new=$av39/(1+$av35)**$av33;
                    @endphp
                        <h5 class="pdfBlueCell"><span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($av43_new)}}</h5>
                    @else
                    @php
                    $av43_new=$av39/(1+$av35)**$av33;
                    @endphp
                    ...
                    <?php if($deferment=='yes' && $include_inflation == 'yes' && $include_taxation == 'yes'){ ?>
                        ...
                        @endphp 
                        <h5 class="pdfBlueCell"><span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($av50_new)}}</h5>
                    ...
                    <?php } elseif ($deferment == 'yes' && $include_inflation == 'no' && $include_taxation == 'yes'){ ?>
                        <h5 class="pdfBlueCell"><span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($initial_investment * $annuity_period_months)}}</h5>
                    ...
                    <p  style="text-align:left;">* It is assumed that SWP amount is received on the last day of each month starting from the 1st month. Mutual fund investments are subject to marker risks, read all scheme related documents carefully. Returns are not guaranteed. The above is for illustration purpose only.</p>
                    ...
                    <div class="roundBorderHolder withBluebar doubleLineTableTitle">
                         <table>
                            <tbody>
                                ...
                                <tr>
                                        <td>{{$count_sec+$i}} </td>
                                        <td> @if($i==1) <span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($av43_new)}} @else -- @endif</td>
                                        <td><span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($yev1)}}</td>
                                        @if(isset($accumulation_phase_interest_rate_2))
                                        <td> @if($i==1) <span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($av43_new2)}} @else -- @endif</td>
                                ...
                                @php
                                    ...
                                    @endphp
                                        ...
                                        @if($include_taxation=='yes' && $include_inflation=='no')
                                            <td><span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($initial_investment)}}</td>
                                        @else
                    ...
                    <!--</header>-->
                        ...
                        <div class="roundBorderHolder withBluebar">
                            <table>
                                ...
                                @else
                                    <tr>
                                        <th style="vertical-align: middle;background:{{$address_color_background}}" rowspan="2">@if(isset($current_age) && $current_age!=0) Age @else Year @endif</th>
                                        <th style="background:{{$address_color_background}}" colspan="2">Scenario 1 @ {{$distribution_phase_interest_rate_1?number_format((float)$distribution_phase_interest_rate_1, 2, '.', ''):0}} %</th>
                                ...
                                @if(isset($interest2))
                                    ...
                                    @for($i=1;$i<=$period;$i++)
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($initial_investment)}}</td>
                                            @else
                                            <td><span class="pdfRupeeIcon">&#8377;</span> <!-- {{custome_money_format($lumpsum_investment_required1)}} -->{{custome_money_format($initial_investment)}}</td>
                                            @endif
                                            ...
                                            <td><span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($initial_investment)}}</td>
                                            @else
                                            <td><span class="pdfRupeeIcon">&#8377;</span> <!-- {{custome_money_format($lumpsum_investment_required2)}} -->
                                            {{custome_money_format($initial_investment)}}</td>
                                            @endif
                                            <td>
                                            <span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($year_end_value_senario_2)}}</td>
                                        </tr>
                                        @if($i%25==0 && $period>25 && $period>$i)
                                        </tbody>
                                        </table>
                            ...
                            <table>
                                ...
                                <tr>
                                 ...
                                 @if($yr%25==0 && $period>25 && $period>$yr)
                                    ...
                                    <tr>
                                        <td>{{$count_sec+$dif_sec+$yr}}</td>
                                        <td><span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($initial_investment*12)}}</td>
                                        <td><span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($l147)}}</td>
                                        <td><span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($q147)}}</td>
                                        @if(isset($interest2))
                                        <td><span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($initial_investment*12)}}</td>
