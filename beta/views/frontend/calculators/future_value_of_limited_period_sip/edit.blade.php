        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <h3 class="smalllineHeading">Future Value of Limited Period SIP</h3>
                    ...
                    <br>
                    <form class="js-validate-form" action="{{route('frontend.limitedPeriodSIPfutureValueAfterDefermentPeriod_output')}}" method="post">
                        <div class="card sip-calculator singleLineHolder calculatorFormShape">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control maxtwodigit {{ $errors->has('deferment_period') ? ' is-invalid' : '' }}" name="deferment_period" value="{{$data['deferment_period']}}"  >
                                    <div class="cal-icon">
                                        Yrs
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="offset-1 col-sm-10">
                                        <div class="calcBelowBtn">
                                            ...
                                            @if(session()->get('limited_period_sip_form_id'))
                                                <button type="button" onclick="location.reload();" class="btn banner-btn whitebg mx-3"> Reset</button>
                                            @else
                                                <a href="{{route('frontend.limitedPeriodSIPfutureValueAfterDefermentPeriod')}}" class="btn banner-btn whitebg mx-3"> Reset</a>
                                            @endif
                                                <button class="btn banner-btn mx-3">Calculate</button>
                                        </div>
                                    </div>
