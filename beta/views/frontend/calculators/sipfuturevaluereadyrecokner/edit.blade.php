    ...
    <section class="main-sec styleNew">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    <h3 class="smalllineHeading">SIP Future Value Ready Reckoner</h3>
                    
                        @include('frontend.calculators.common_bio')
                        <br>
                        <form class="js-validate-form" action="{{route('frontend.sipFutureValueReadyReckonerOutput')}}" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="offset-1 col-sm-10">
                                        <div class="calcBelowBtn">
                                                ...
                                                @if(session()->get('sip_future_value_ready_reckoner_form_id'))
                                                    <button type="button" onclick="location.reload();" class="btn banner-btn whitebg mx-3"> Reset</button>
                                                @else
                                                    <a href="{{route('frontend.sipFutureValueReadyReckoner')}}" class="btn banner-btn whitebg mx-3"> Reset</a>
                                                @endif
                                                <button class="btn banner-btn mx-3">Calculate</button>
                                        </div>
                                    </div>
