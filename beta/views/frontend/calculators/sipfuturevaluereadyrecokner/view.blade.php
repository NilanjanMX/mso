        ...
        <div id="content" class="container">
            <div class="row">
                ...
                <div class="outputTableHolder">
                    ...
                    <h1 class="midheading">SIP Ready Reckoner @if(isset($clientname)) <br> For {{$clientname?$clientname:''}} @endif</h5>
                        <div class="roundBorderHolder">
                            ...
                            <h1 class="midheading">Future Value of SIP Amount</h1>
                            <div class="roundBorderHolder">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form target="_blank" action="{{route('frontend.sipFutureValueReadyReckonerMergeDownload')}}" method="get">
