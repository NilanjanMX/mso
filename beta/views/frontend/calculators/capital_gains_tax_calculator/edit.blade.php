...
$('#sale_date').datepicker({
        ...
        function processSaleDate() {
            var query = $('.sale_date').val();
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="form-check form-check-inline">
                                            <label class="checkLinecontainer" for="TurnPurchase_before">Capital Asset purchased before FY2001-02
                                                <input class="form-check-input fixed_deposit_chk" type="radio" id="TurnPurchase_before" name="purchased_before" onchange="TurnPurchase('before')"  
                                                @if ($data['purchased_before'] == 1)
                                                    checked
                                                @endif value="1"/>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <label class="checkLinecontainer" for="TurnPurchase_after">Capital Asset purchased in or after FY2001-02
                                                <input class="form-check-input fixed_deposit_chk" type="radio" id="TurnPurchase_after" name="purchased_before" value="2"  onchange="TurnPurchase('after')"
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="financial_delete col-sm-1">
                                                        <button type="button"  style="color:red; margin-top: 10px;background: none;" onclick='removeMe(0)'>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="offset-1 col-sm-10">
                                        <div class="calcBelowBtn">
                                            ...
                                            @if(session()->get('capital_gains_tax_calculator_form_id'))
                                                <button type="button" onclick="location.reload();" class="btn banner-btn whitebg mx-3"> Reset</button>
                                            @else
                                                <a href="{{route('frontend.capital_gains_tax_calculator')}}" class="btn banner-btn whitebg mx-3"> Reset</a>
                                            @endif
                                                <button class="btn banner-btn mx-3">Calculate</button>
                                        </div>
                                    </div>
