    ...
    @include('frontend.calculators.common.header')
        ...
        <main style="width: 806px;">
            <div style="padding: 0 0%;">
                <h1 style="color: #000;font-size:16px;margin-bottom:20px !important;text-align:center;">Capital Gains Tax Calculation @if(isset($clientname) && !empty($clientname)) For {{$clientname?$clientname:''}}  @else  @endif</h1>
                <div class="roundBorderHolder">
                    <table class="table table-bordered leftright" style="background: #fff; width: 100%;">
                        <tbody>
                            @if(!empty($asset_name))
                            <tr>
                                <td align="left">
