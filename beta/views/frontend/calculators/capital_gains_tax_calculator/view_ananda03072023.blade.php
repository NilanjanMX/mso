            ...
            <div class="row">
                <div class="col-md-10 offset-md-1 text-center">
                    ...
                    <div class="outputTableHolder">
                        <h5 class="midheading">Capital Gains Tax Calculation @if(isset($clientname) && !empty($clientname)) For {{$clientname?$clientname:''}}  @else  @endif</h5>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form target="_blank" action="{{route('frontend.capital_gains_tax_calculator_merge_download')}}" method="get">
