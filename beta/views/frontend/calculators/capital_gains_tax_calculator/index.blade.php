                                    ...
                                    <div class="col-sm-8">
                                        <div class="form-check form-check-inline">
                                            <label class="checkLinecontainer" for="TurnPurchase_before">Capital Asset purchased before FY2001-02
                                                <input class="form-check-input fixed_deposit_chk" type="radio" id="TurnPurchase_before" name="purchased_before" onchange="TurnPurchase('before')"  checked value="1"/>
