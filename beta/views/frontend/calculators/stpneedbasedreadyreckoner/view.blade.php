        ...
        <div id="content" class="container">
            <div class="row">
                ...
                <div class="outputTableHolder">
                    ...
                    <h1 class="midheading">STP Need Based Ready Reckoner @if(isset($clientname)) <br> For {{$clientname?$clientname:''}} @endif</h1>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form target="_blank" action="{{route('frontend.stpGoalPlanningValueReadyRecoknerMergeDownload')}}" method="get">
