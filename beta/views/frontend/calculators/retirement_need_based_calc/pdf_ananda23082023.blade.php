    ...
    @include('frontend.calculators.common.header')
        ...
        <main class="mainPdf">
            <div style="padding: 0 0%;">
                <h1 class="pdfTitie">Retirement @if(isset($clientname)) Proposal <br> For {{$clientname?$clientname:''}} @else Need Based Calculator @endif</h1>
                        ...
                        <div class="roundBorderHolder">
                            <table>
                                ...
                                <tr>
                                    ...
                                    @if($accumulation_phase_interest_rate_2>0)
                                        <td style="text-align: center"><span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($sip_for_5_years2)}}</td>
                                    @endif
                                </tr>
                                <tr>
                                    ...
                                    @if($accumulation_phase_interest_rate_2>0)
                                        <td style="text-align: center"><span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($sip_for_10_years2)}}</td>
                                    @endif
                                </tr>
                                <tr>
                                    ...
                                    @if($accumulation_phase_interest_rate_2>0)
                                        <td style="text-align: center"><span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($limpsum_investment2)}}</td>
                                    @endif
                                </tr>
                                </tbody>
                            </table>
                    ...
                    @elseif(($future_value_of_current_investment+$other_amount_receivable_on_retirement)>=$total_retirement_corpus2 && $accumulation_phase_interest_rate_2>0)
                        ...
                        <div class="roundBorderHolder">
                            <table>
                                ...
                                <tr>
                                    <td style="">Monthly SIP For 5 Years</td>
                                    <td style="text-align: center"><span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($sip_for_5_years1)}} </td>
    
                                </tr>
                                <tr>
                                    <td style="">Monthly SIP For 10 Years</td>
                                    <td style="text-align: center"><span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($sip_for_10_years1)}} </td>
    
                                </tr>
                                <tr>
                                    <td style="">Lumpsum Investment</td>
                                    <td style="text-align: center"><span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($limpsum_investment1)}} </td>
