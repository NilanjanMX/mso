...
@section('content')
    ...
    <div class="banner styleApril">
        ...
        @include('frontend.calculators.left_sidebar')
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="page-title">Retirement Need Based Calculator</h2>
                </div>
            </div>
        </div>
    </div>
        ...
        <div id="content" class="container">
            <div class="row">
                <div class="col-md-12 offset-md-0 text-center">
                    ...
                    @else
                        <a href="{{route('frontend.retirementPlanning_back')}}?action=back" class="btn btn-primary btn-round"><i class="fa fa-angle-left"></i> Back</a>
                    @endif
                    ...
                    @if($permission['is_download'])
                        ...
                        @else
                            <a href="{{route('frontend.retirementPlanning_pdf')}}" target="_blank" id="cmd" class="btn btn-primary btn-round btn-solid">Download / Print</a>
                        @endif
                    @else
                    ...
                    <div class="outputTableHolder">
                            ...
                            <div class="roundBorderHolder">
                                <table class="table table-bordered text-center">
                                    ...
                                    <tr>
                                        ...
                                        @if($accumulation_phase_interest_rate_2>0)
                                            <td>₹  {{($sip_for_5_years2 != "")?custome_money_format($sip_for_5_years2):"NA"}} </td>
                                        @endif
                                    </tr>
                                    <tr>
                                        <td>Monthly SIP For 10 Years</td>
                                        @if($accumulation_phase_interest_rate_2>0)
                                            <td>₹  {{($sip_for_10_years2 != "")?custome_money_format($sip_for_10_years2):"NA"}} </td>
                                        @endif
                                    </tr>
                                    <tr>
                                        <td>Lumpsum Investment</td>
                                        @if($accumulation_phase_interest_rate_2>0)
                                            <td>₹  {{($limpsum_investment2 != "")?custome_money_format($limpsum_investment2):"NA"}} </td>
                                        @endif
                                    </tr>
                                    </tbody>
                                </table>
                        ...
                        @elseif(($future_value_of_current_investment+$other_amount_receivable_on_retirement)>=$total_retirement_corpus2 && $accumulation_phase_interest_rate_2>0)
                            ...
                            <div class="roundBorderHolder">
                                <table class="table table-bordered text-center">
                                    ...
                                    <tr>
                                        <td>Monthly SIP For 5 Years</td>
                                        <td>₹  {{($sip_for_5_years1 != "")?custome_money_format($sip_for_5_years1):"NA"}} </td>
                                    </tr>
                                    <tr>
                                        <td>Monthly SIP For 10 Years</td>
                                        <td>₹  {{($sip_for_10_years1 != "")?custome_money_format($sip_for_10_years1):"NA"}} </td>
                                    </tr>
                                    <tr>
                                        <td>Lumpsum Investment</td>
                                        <td>₹  {{($limpsum_investment1 != "")?custome_money_format($limpsum_investment1):"NA"}} </td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                        @else
                            ...
                            <div class="roundBorderHolder">
                                <table class="table table-bordered text-center">
                                    ...
                                    <tr>
                                        <td>Monthly SIP Till Age {{$retirement_age}}</td>
                                        <td>₹  {{($sip_till_retirement1 != "")?custome_money_format($sip_till_retirement1):"NA"}} </td>
                                        @if($accumulation_phase_interest_rate_2>0)
                                            <td>₹  {{($sip_till_retirement2 != "")?custome_money_format($sip_till_retirement2):"NA"}} </td>
                                        @endif
                                    </tr>
                                    <tr>
                                        <td>Monthly SIP For 5 Years</td>
                        ...
                        <p style="text-align: left;">
                            * Monthly annuity will increase every month due to effect of inflation. For simplicity, the amount shown above under monthly annuity is the monthly average of total annuity payments received during the year. <br>
                            * The Annuity is received on the 1st day of each month starting the 1st month.<br>
                            Report Date : {{date('d/m/Y')}}
                        </p>
