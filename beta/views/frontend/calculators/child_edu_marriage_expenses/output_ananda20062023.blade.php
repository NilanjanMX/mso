...
<!-- <div class="banner bannerForAll container" style="padding-bottom: 0; margin-bottom: 15px;">
    ...
    <div class="banner styleApril">
        ...
        @include('frontend.calculators.left_sidebar')
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="page-title">Child Education/Marriage Expenses Calculator</h2>
                </div>
            </div>
        </div>
    </div>
        ...
        <div id="content" class="container">
            <div class="row">
                <div class="col-md-10 offset-md-1 text-center">
                    ...
                    @else
                        <a href="{{route('frontend.childEducation_back')}}?action=back" class="btn btn-primary btn-round"><i class="fa fa-angle-left"></i> Back</a>
                    @endif
                    ...
                    @if($permission['is_download'])
                        ...
                        @else
                            <a href="{{route('frontend.childEducation_pdf')}}" target="_blank" id="cmd" class="btn btn-primary btn-round btn-solid">Download / Print</a>
                        @endif
                    @else
                    ...
                    <div class="outputTableHolder">
                        <h5 class="midheading">Child {{$fund_requirement_purpose}} @if(isset($clientname)) Proposal <br> For {{$clientname?$clientname:''}} @else Expenses Calculation @endif</h5>
