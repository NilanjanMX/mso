    ...
    @include('frontend.calculators.common.header')
        ...
        <main style="width: 806px;">
            <div style="padding: 0 0%;">
                <h1 style="color: #000;font-size:16px;margin-bottom:20px !important;text-align:center;">Child {{$fund_requirement_purpose}} @if(isset($clientname)) Proposal <br> For {{$clientname?$clientname:''}} @else Expenses Calculation @endif</h1>
