...
<!-- <div class="banner bannerForAll container" style="padding-bottom: 0; margin-bottom: 15px;">
        ...
        <div id="content" class="container">
            <div class="row">
                ...
                <div class="outputTableHolder">
                    ...
                    <h1 class="midheading">Lumpsum Investment Ready Reckoner @if(isset($clientname)) <br/> For {{$clientname?$clientname:''}} @endif</h5>
                        ...
                        @include('frontend.calculators.common.comment_output')
                            <h1 class="midheading">Future Value of Lumpsum Investment</h1>
                            <div class="roundBorderHolder">
                            <table class="table table-bordered text-center">
                            <tbody>

                                <tr>
                                    <td rowspan="2" style="vertical-align: middle;"><strong>Rate of Return</strong></td>
    ...
    <script type="text/javascript">
        var base_url = "{{route('frontend.oneTimeInvestmentReadyReckonerOutputPdf')}}";
    </script>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form target="_blank" action="{{route('frontend.oneTimeInvestmentReadyReckonerMergeDownload')}}" method="get">
