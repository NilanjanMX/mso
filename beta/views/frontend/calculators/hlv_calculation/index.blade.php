                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-check form-check-inline">
                                            <label class="checkLinecontainer" for="sipInv">Income Replacement Method
                                                <input class="form-check-input fixed_deposit_chk" type="radio" id="sipInv" name="enter_loan_details" onchange="TurnOnSip('sipInv')"   value="1" checked>
                                                <span class="checkmark"></span>
                                            </label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <label class="checkLinecontainer" for="emiInv">Need Analysis Method
                                                <input class="form-check-input fixed_deposit_chk" type="radio" id="emiInv" name="enter_loan_details" value="2"  onchange="TurnOnSip('emiInv')" >
                                                <span class="checkmark"></span>
                                            </label>
                                        </div>
                                    </div>
