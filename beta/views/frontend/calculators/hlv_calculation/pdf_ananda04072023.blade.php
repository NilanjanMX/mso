    ...
    @include('frontend.calculators.common.header')
        ...
        <main style="width: 806px;">
            ...
            <div style="padding: 0 0%;">
                <h1 style="margin:0 auto; color: #000;font-size:16px;margin-bottom:20px !important;text-align:center; background-color: #a9f3ff; padding: 10px 0; width:90%;">Human Life Value Calculation @if(isset($clientname) && !empty($clientname)) <br> For {{$clientname?$clientname:''}}  @else  @endif</h1>
                ...
                @if($formType == 1)
                        ...
                        <table class="table table-bordered leftright" style="margin: 0 auto; width:70%">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{$anual}}
                                    </td>
                                </tr>
                                @if($expected != '')
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    @if($personal != '') <span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{custome_money_format($personal)}} @endif
                                    </td>
                                </tr>
                                @endif
                            </tbody>
                        </table>
                        <h5 style="color: #131f55;font-size:22px;margin-bottom:10px; text-align:center;">Human Life Value</h5>
                        ...
                        <h5 style="
                            ...
                            ">
                                <span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{custome_money_format($humanLifeValue)}}
                        </h5>
                        ...
                        <table class="table table-bordered leftright" style="margin: 0 auto; width:70%">
                            ...
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                       <span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{custome_money_format($anual)}}
                                    </td>
                                </tr>
                                @if($expected != '')
                                <tr>
                        ...
                        <table class="table table-bordered leftright" style="margin: 0 auto; width:70%">
                            ...
                            <tr>
                                    ...
                                    <td>
                                       <span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{custome_money_format($household)}}
                                    </td>
                                </tr>
                                @endif
                            ...
                            <tr>
                                    ...
                                    <td>
                                       <span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{custome_money_format($anualretire)}}
                                    </td>
                                </tr>
                                @endif
                                 @if(isset($inflation))
                        ...
                        <header>
                            ...
                            <tr>
                                ...
                                <td style="text-align:right; border:0;" valign="middle"><img style="display:inline-block;" src="{{$company_logo}}" alt=""></td>
                            </tr>
                            </tbody>
                            </table>
                        </header>
                        ...
                        <table class="table table-bordered leftright" style="margin: 0 auto; width:70%">
                            @if(isset($market))
                                <tr>
                                    ...
                                    <td>
                                       <span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{custome_money_format($market)}}
                                    </td>
                                </tr>
                            @endif
                            @if(isset($lifeinsure))
                                <tr>
                                    ...
                                    <td>
                                       <span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{custome_money_format($lifeinsure)}}
                                    </td>
                                </tr>
                            @endif
                            @if(isset($anualsavings))
                                <tr>
                                    ...
                                    <td>
                                       <span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{custome_money_format($anualsavings)}}
                                    </td>
                                </tr>
                            @endif
