    ...
    <script>
        ...
        $(document).on("click",".deferment_radio",function(){
            ...
            if(rval=='yes')
            {
                ...
                $('input[name="deferment_period"]').val("");
    ...
    <section class="main-sec">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    <h3 class="smalllineHeading">SIP Required For Target Monthly SWP</h3>
                    @include('frontend.calculators.common_bio')
                    
                    <form class="js-validate-form" action="{{route('frontend.monthlyTargetAnnuityForSIPOUTPUT')}}" method="post">
                        <div class="card sip-calculator singleLineHolder calculatorFormShape">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control {{ $errors->has('sip_amount') ? ' is-invalid' : '' }}" name="sip_amount" value="{{$form_data['sip_amount'] ?? ''}}" maxlength="10" >
                                    <div class="cal-icon">
                                        ₹
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="alert_validation form-control maxtwodigit {{ $errors->has('sip_period') ? ' is-invalid' : '' }}" name="sip_period" value="{{$form_data['sip_period'] ?? ''}}"  >
                                    <div class="cal-icon">
                                        Yrs
                                    </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-check form-check-inline">
                                                ...
                                                <label class="checkLinecontainer mb-0 mt-2" for="inlineRadiod1">Yes
                                                    <input class="form-check-input deferment_radio" type="radio" name="deferment" id="inlineRadiod1" value="yes" @if(isset($form_data) && $form_data['deferment']=='yes') checked  @endif>
                                            ...
                                            <div class="form-check form-check-inline">
                                                ...
                                                <label class="checkLinecontainer mb-0 mt-2" for="inlineRadiod2">No
                                                    <input class="form-check-input deferment_radio" type="radio" name="deferment" id="inlineRadiod2" value="no" @if(isset($form_data) && $form_data['deferment']=='no') checked  @endif>
                                                    <span class="checkmark"></span>
                                                </label>
                                            </div>
                                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="alert_validation form-control maxtwodigit {{ $errors->has('annuity_period') ? ' is-invalid' : '' }}" name="annuity_period" value="{{$form_data['annuity_period'] ?? ''}}"  >
                                    <div class="cal-icon">
                                        Yrs
                                    </div>
                                ...
                                <div class="col-sm-7">
                                    <div class="row">
                                        <div class="col-sm-12 form-group">
                                            <div class="form-group">
                                                <input type="text" class="form-control {{ $errors->has('balance_required') ? ' is-invalid' : '' }}" name="balance_required" value="{{$form_data['balance_required'] ?? 0}}" required>
                                                <div class="cal-icon" style="right: 1px;">
                                                    ₹
                                                </div>
                                ...
                                <div class="col-sm-7">
                                    <div class="form-check form-check-inline">
                                        <label class="checkLinecontainer" for="inlineRadioii1">Yes
                                            <input class="form-check-input include_inflation" type="radio" name="include_inflation" id="inlineRadioii1" value="yes" @if(isset($form_data) && $form_data['include_inflation']=='yes') checked  @endif>
                                            <span class="checkmark"></span>
                                        </label> 
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <label class="checkLinecontainer" for="inlineRadioii2">No
                                            <input class="form-check-input include_inflation" type="radio" name="include_inflation" id="inlineRadioii2" value="no" @if(isset($form_data) && $form_data['include_inflation']=='no') checked  @endif>
                                            <span class="checkmark"></span>
                                        </label> 
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                <input readonly type="text" id="for_period_upto" class="form-control pr-2 mr-1 number maxtwodigit {{ $errors->has('for_period_upto') ? ' is-invalid' : '' }}" name="for_period_upto" value="{{$form_data['for_period_upto'] ?? ''}}"  onkeyup="changeForPeriodUpto();">
                                                <div class="cal-icon">
                                                    Yrs
                                                </div>
                                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="offset-1 col-sm-10">
                                    <div class="calcBelowBtn">
                                            ...
                                            @if(session()->get('monthly_annuity_for_sip_form_id'))
                                                <button type="button" onclick="location.reload();" class="btn banner-btn whitebg mx-3"> Reset</button>
                                            @else
                                                <a href="{{route('frontend.monthlyTargetAnnuityForSIP')}}" class="btn banner-btn whitebg mx-3"> Reset</a>
                                            @endif
                                            <button class="btn banner-btn mx-3">Calculate</button>
                                    </div>
                                </div>
