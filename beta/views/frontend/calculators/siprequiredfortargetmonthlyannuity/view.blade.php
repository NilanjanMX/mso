        ...
        <div id="content" class="container">
            <div class="row">
                <div class="col-md-12 offset-md-0 text-center">
                    ...
                    <h1 class="midheading">Monthly SWP Planning @if(isset($clientname)) <br> For {{$clientname?$clientname:''}} @endif</h1>
                    @php
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form target="_blank" action="{{route('frontend.monthlyTargetAnnuityForMergeDownload')}}" method="get">
