...
<html lang="en">
    ...
    @include('frontend.calculators.common.header')
        ...
        <div style="padding: 0 15%;">
            <h1
                style="background:#8edeff; color:#000;margin-bottom:30px !important;text-align:center;font-size:24px !important; padding: 10px;">
                Monthly SWP Calculation @if(isset($clientname)) <br> For {{$clientname?$clientname:''}} @endif</h1>
            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        <td>
                            {{$applicable_short_term_tax_rate?number_format($applicable_short_term_tax_rate, 2, '.',
                            ''):0}} %
                        </td>
                        <td>
                            {{$applicable_long_term_tax_rate?number_format($applicable_long_term_tax_rate, 2, '.',
                            ''):0}} %
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="2">
                            {{$assumed_inflation_rate_for_indexation?number_format($assumed_inflation_rate_for_indexation,
                            2, '.', ''):0}} %
                        </td>
                    </tr>
                    @endif
        ...
        <div style="padding: 0 15%;">
            @if($deferment=='yes')
            <h1
                style="color: #000;font-size:16px;margin-bottom:5px !important;margin-top: 30px !important;text-align:center;">
                Accumulated Corpus @if($deferment=='yes') @if(!isset($accumulation_phase_interest_rate_2)) @
                {{$accumulation_phase_interest_rate_1?number_format($accumulation_phase_interest_rate_1, 2, '.', ''):0}}
                % @endif @else @if(!isset($interest2)) @ {{$interest1?number_format($interest1, 2, '.', ''):0}} % @endif
                @endif</h1>
            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        <th>
                            <strong>Scenario 1 @
                                {{$accumulation_phase_interest_rate_1?number_format($accumulation_phase_interest_rate_1,
                                2, '.', ''):0}} %</strong>
                        </th>
                        @if(isset($accumulation_phase_interest_rate_2))
                        <th>
                            <strong>Scenario 2 @
                                {{$accumulation_phase_interest_rate_2?number_format($accumulation_phase_interest_rate_2,
                                2, '.', ''):0}} %</strong>
                        </th>
                        @endif
                    </tr>
                    <tr>
                        <td>
                            <strong><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                                {{custome_money_format($av39)}} </strong>
                        </td>
                        @if(isset($accumulation_phase_interest_rate_2))
                        <td>
                            <strong><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                                {{custome_money_format($av40)}} </strong>
                        </td>
                        @endif
                    </tr>
            ...
            @else
            <h1
                style="color: #000;border:1px black solid;font-size:24px;margin:0 auto;margin-bottom:15px !important;text-align:center;background: #a9f3ff;width: 200px; text-align: center;padding-top: 10px;padding-bottom:10px;">
                <span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{custome_money_format($av39)}}</h1>
            @endif
        ...
        <div style="padding: 0 15%;">
            ...
            <h1
                style="color: #000;font-size:16px;margin-bottom:5px !important;margin-top: 30px !important;text-align:center;">
                First Year Average Monthly SWP @if($deferment=='yes') @if(!isset($distribution_phase_interest_rate_2)) @
            ...
            <h1
                style="color: #000;font-size:16px;margin-bottom:5px !important;margin-top: 30px !important;text-align:center;">
                Monthly SWP Amount @if($deferment=='yes') @if(!isset($distribution_phase_interest_rate_2)) @
                {{$distribution_phase_interest_rate_1?number_format($distribution_phase_interest_rate_1, 2, '.', ''):0}}
                % @endif @else @if(!isset($interest2)) @ {{$interest1?number_format($interest1, 2, '.', ''):0}} % @endif
                @endif</h1>
            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <strong><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                                {{custome_money_format($av43_new)}} </strong>
                        </td>
                        @else
                        <td>
                            <strong><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                                {{custome_money_format($monthly_annuity_amount1)}} </strong>
                        </td>
                        @endif
                        @if($include_inflation=='yes')
                        @php
                        ...
                        <td>
                            <strong><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                                {{custome_money_format($av43_new2)}} </strong>
                        </td>
                        @else
                        <td>
                            <strong><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                                {{custome_money_format($monthly_annuity_amount2)}} </strong>
                        </td>
                        @endif
            ...
            <h1
                style="color: #000;border:1px black solid;font-size:24px;margin:0 auto;margin-bottom:15px !important;text-align:center;background: #a9f3ff;width: 200px; text-align: center;padding-top: 10px;padding-bottom:10px;">
                <span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{custome_money_format($av43_new)}}
            </h1>
            @else
            <h1
                style="color: #000;border:1px black solid;font-size:24px;margin:0 auto;margin-bottom:15px !important;text-align:center;background: #a9f3ff;width: 200px; text-align: center;padding-top: 10px;padding-bottom:10px;">
                <span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                {{custome_money_format($monthly_annuity_amount1)}}</h1>
            @endif
            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        <th>
                            <strong>Scenario 1 @
                                {{$distribution_phase_interest_rate_1?number_format($distribution_phase_interest_rate_1,
                                2, '.', ''):0}} %</strong>
                        </th>
                        @if(isset($distribution_phase_interest_rate_2))
                        <th>
                            <strong>Scenario 2 @
                                {{$distribution_phase_interest_rate_2?number_format($distribution_phase_interest_rate_2,
                                2, '.', ''):0}} %</strong>
                        </th>
                        @endif
                    </tr>
            ...
            <table>
                <tbody>
                    <tr>
                        <th>
                            Scenario 1 @
                            {{$distribution_phase_interest_rate_1?number_format($distribution_phase_interest_rate_1, 2,
                            '.', ''):0}} %
                        </th>
                        @if(isset($accumulation_phase_interest_rate_2))
                        <th>
                            Scenario 2 @
                            {{$distribution_phase_interest_rate_2?number_format($distribution_phase_interest_rate_2, 2,
                            '.', ''):0}} %
                        </th>
                        @endif
                    </tr>
                    <tr>
                        <td>
                            ...
                            <strong><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                                {{custome_money_format($av50_new)}}</strong>
                        </td>
                        @if(isset($monthly_annuity_amount2))
                        @php
                        $av41_inf=(1+($expected_inflation_rate/100))**(1/12)-1;
            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        <td>
                            <strong><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                                {{custome_money_format($monthly_annuity_amount1 * $annuity_period_months)}}</strong>
                        </td>
                        @if(isset($monthly_annuity_amount2))
                        <td>
                            <strong><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                                {{custome_money_format($monthly_annuity_amount2 * $annuity_period_months)}} </strong>
                        </td>
                        @endif
                    </tr>
                </tbody>
        ...
        @php
        $note_data1 =
        \App\Models\Calculator_note::where('category','summery')->where('calculator','Monthly_Annuity_For_Lumpsum_Investment')->first();
        if(!empty($note_data1)){
        @endphp
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="text-align:right; border:0;" align="left" valign="middle"><img
                                style="display:inline-block;" src="{{$company_logo}}" alt=""></td>
                    </tr>
                </tbody>
            </table>
        </header>
        ...
        <h1
            style="color: #000;font-size:16px;margin-bottom:5px !important;margin-top: 30px !important;text-align:center;">
            Accumulation Phase <br> Projected Annual Investment Value</h1>
        <table style="background: #fff;">
            <tbody>
                <tr>
                    ...
                    <th>Year End Value @
                        {{$accumulation_phase_interest_rate_1?number_format((float)$accumulation_phase_interest_rate_1,
                        2, '.', ''):0}} %</th>

                    @if(isset($accumulation_phase_interest_rate_2))
                    <th>Year End Value @
                        {{$accumulation_phase_interest_rate_2?number_format((float)$accumulation_phase_interest_rate_2,
                        2, '.', ''):0}} %</th>
                    @endif
                </tr>
                @for($i=1;$i<=$deferment_period;$i++) @php
                    $yev1=$initial_investment*(1+$accumulation_phase_interest_rate_1/100)**$i;
                    if(isset($accumulation_phase_interest_rate_2)) {
                    $yev2=$initial_investment*(1+$accumulation_phase_interest_rate_2/100)**$i; } @endphp <tr>
                    <td>{{$count_sec+$i}}</td>
                    <td> @if($i==1) <span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                        {{custome_money_format($initial_investment)}} @else -- @endif</td>
                    <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                        {{custome_money_format($yev1)}}</td>
                    @if(isset($accumulation_phase_interest_rate_2))
                    <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                        {{custome_money_format($yev2)}}</td>
                    @endif
                    </tr>
        ...
        <h1
            style="color: #000;font-size:16px;margin-bottom:5px !important;margin-top: 30px !important;text-align:center;">
            Distribution Phase <br> Monthly Withdrawal & Projected Investment Value</h1>
        @if(isset($expected_inflation_rate))
        <table>
            <tbody>
                <tr>
                    <th rowspan="2" style="vertical-align: middle;">@if(isset($current_age) && $current_age!=0) Age
                        @else Year @endif</th>
                    <th colspan="2">Scenario 1 @
                        {{$distribution_phase_interest_rate_1?number_format((float)$distribution_phase_interest_rate_1,
                        2, '.', ''):0}} %</th>
                    @if(isset($distribution_phase_interest_rate_2))
                    <th colspan="2">Scenario 2 @
                        {{$distribution_phase_interest_rate_2?number_format((float)$distribution_phase_interest_rate_2,
                        2, '.', ''):0}} %</th>
                    @endif
                </tr>
                <tr>
                ...
                $ff2=0;
                $z=1;
                for($i=1;$i<=$period*12;$i++) { if($i==1) { $as63=$av39; }else{ $as63=$ax63; }
                    $at63=$monthly_rate_of_return1; $au63=$as63+$as63*$at63; $av63=$av36_inf; if($i==1) {
                    $aw63=$monthly_annuity_amount1; }else{ $aw63=$aw63+$aw63*$av63; } $ax63=$au63-$aw63; $ff1+=$aw63;
                    if(isset($distribution_phase_interest_rate_2)) { if($i==1) { $az63=$av40; }else{ $az63=$be63; }
                    $ba63=$monthly_rate_of_return2; $bb63=$az63+$az63*$ba63; $bc63=$av36_inf; if($i==1) {
                    $bd63=$monthly_annuity_amount2; }else{ $bd63=$bd63+$bd63*$bc63; } $be63=$bb63-$bd63; $ff2+=$bd63; }
                    if($i%12==0) { $ff1r=$ff1/12; if(isset($distribution_phase_interest_rate_2)) { $ff2r=$ff2/12; }
                    @endphp <tr>
                    <td>{{$count_sec+$dif_sec+$z}}</td>
                    <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                        {{custome_money_format($ff1r)}}</td>
                    <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                        {{custome_money_format($ax63)}}</td>
                    @if(isset($distribution_phase_interest_rate_2))
                    <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                        {{custome_money_format($ff2r)}}</td>
                    <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                        {{custome_money_format($be63)}}</td>
                    @endif
                    </tr>
        ...
        <h1
            style="color: #000;font-size:16px;margin-bottom:5px !important;margin-top: 30px !important;text-align:center;">
            Annual Tax & Post-Tax Withdrawal </h1>
        <table>
            <tbody>
                <tr>
                    <th rowspan="2" style="vertical-align: middle;">@if(isset($current_age) && $current_age!=0) Age
                        @else Year @endif</th>
                    <th colspan="3">Scenario 1 @
                        {{$accumulation_phase_interest_rate_1?number_format((float)$accumulation_phase_interest_rate_1,
                        2, '.', ''):0}} %</th>
                    @if(isset($accumulation_phase_interest_rate_2))
                    <th colspan="3">Scenario 2 @
                        {{$accumulation_phase_interest_rate_2?number_format((float)$accumulation_phase_interest_rate_2,
                        2, '.', ''):0}} %</th>
                    @endif
                </tr>
                ...
                $ab107=0;
                $ag107=0;
                for($i=1;$i<=$period*12;$i++) { $av41_inf=(1+($expected_inflation_rate/100))**(1/12)-1; if($i==1) {
                    $ax=$monthly_annuity_amount1; }else{ $ax=$ax+$ax*$av41_inf; }
                    $av37=(1+($distribution_phase_interest_rate_1/100))**(1/12)-1; $az=$ax/(1+$av37)**$i;
                    $bc63=$az*(1+($assumed_inflation_rate_for_indexation/100))**($yr-1); if($yr<=$for_period_upto) {
                    $bd63=$ax-$az; }else{ $bd63=$ax-$bc63; } if($yr<=$for_period_upto) {
                    $bg63=$bd63*($applicable_short_term_tax_rate/100); }else{
                    $bg63=$bd63*($applicable_long_term_tax_rate/100); } $bh63=$ax-$bg63; $g103+=$ax; $l147+=$bg63;
                    $q147+=$bh63; //-------- if(isset($distribution_phase_interest_rate_2)) {
                    $av41_inf=(1+($expected_inflation_rate/100))**(1/12)-1; if($i==1) { $bo=$monthly_annuity_amount2;
                    }else{ $bo=$bo+$bo*$av41_inf; } $w103+=$bo;
                    $bl63=(1+($distribution_phase_interest_rate_2/100))**(1/12)-1; $bq63=$bo/(1+$bl63)**$i;
                    $bt63=$bq63*(1+($assumed_inflation_rate_for_indexation/100))**($yr-1); if($yr<=$for_period_upto) {
                    $bu63=$bo-$bq63; }else{ $bu63=$bo-$bt63; } if($yr<=$for_period_upto) {
                    $bx63=$bu63*($applicable_short_term_tax_rate/100); }else{
                    $bx63=$bu63*($applicable_long_term_tax_rate/100); } $ab107+=$bx63; $by63=$bo-$bx63; $ag107+=$by63; }
                    @endphp 
                    @if($i%12==0) { 
                    <tr>
                        <td>{{$count_sec+$dif_sec+$yr}}</td>
                        <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                            {{custome_money_format($g103)}}</td>
                        <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                            {{custome_money_format($l147)}}</td>
                        <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                            {{custome_money_format($q147)}}</td>
                        @if(isset($distribution_phase_interest_rate_2))
                        <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                            {{custome_money_format($w103)}}</td>
                        <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                            {{custome_money_format($ab107)}}</td>
                        <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                            {{custome_money_format($ag107)}}</td>
                        @endif
                    </tr>
                    @endif
        ...
        <table>
            <tbody>
                ...
                @for($i=1;$i<=$period;$i++) @php //Year End Value
                    // (AS67*(1+AU67)^(AR67*12)-(AW67*((1+AU67)^(AR67*12)-1)/AU67))
                    ...
                    <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                        {{custome_money_format($monthly_annuity_amount1)}}</td>
                    <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                        {{custome_money_format($year_end_value_senario_1)}}</td>
                    <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                        {{custome_money_format($monthly_annuity_amount2)}}</td>
                    <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                        {{custome_money_format($year_end_value_senario_2)}}</td>
                    </tr>
                    @if($i%25==0 && $period>25 && $period>$i)
            </tbody>
        </table>
        ...
        <table>
            <tbody>
                ...
                $ab107=0;
                $ag107=0;
                for($i=1;$i<=$period*12;$i++) { $av37=(1+($distribution_phase_interest_rate_1/100))**(1/12)-1;
                    $ay107=$monthly_annuity_amount1/(1+$av37)**$i;
                    $bb107=$ay107*(1+($assumed_inflation_rate_for_indexation/100))**($yr-1); if($yr<=$for_period_upto) {
                    $bc=$monthly_annuity_amount1-$ay107; }else{ $bc=$monthly_annuity_amount1-$bb107; }
                    if($yr<=$for_period_upto) { $bf=$bc*($applicable_short_term_tax_rate/100); }else{
                    $bf=$bc*($applicable_long_term_tax_rate/100); } $l147+=$bf; $bg107=$monthly_annuity_amount1-$bf;
                    $q147+=$bg107; if(isset($distribution_phase_interest_rate_2)) { $bm107=$monthly_annuity_amount2;
                    $bk107=(1+($distribution_phase_interest_rate_2/100))**(1/12)-1;
                    $bo107=$monthly_annuity_amount2/(1+$bk107)**$i;
                    $br107=$bo107*(1+($assumed_inflation_rate_for_indexation/100))**($yr-1); if($yr<=$for_period_upto) {
                    $bs107=$bm107-$bo107; }else{ $bs107=$bm107-$br107; } if($yr<=$for_period_upto) {
                    $bv107=$bs107*$applicable_short_term_tax_rate/100; }else{
                    $bv107=$bs107*$applicable_long_term_tax_rate/100; } $ab107+=$bv107; $bw107=$bm107-$bv107;
                    $ag107+=$bw107; } if($i%12==0) { @endphp <tr>
                    <td>{{$count_sec+$dif_sec+$yr}}</td>
                    <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                        {{custome_money_format($monthly_annuity_amount1*12)}}</td>
                    <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                        {{custome_money_format($l147)}}</td>
                    <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                        {{custome_money_format($q147)}}</td>
                    @if(isset($distribution_phase_interest_rate_2))
                    <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                        {{custome_money_format($monthly_annuity_amount2*12)}}</td>
                    <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                        {{custome_money_format($ab107)}}</td>
                    <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                        {{custome_money_format($ag107)}}</td>
        ...
        <h1
            style="color: #000;font-size:16px;margin-bottom:5px !important;margin-top: 30px !important;text-align:center;">
            Monthly Withdrawal & Projected Investment Value</h1>
        ...
        <table>
            <tbody>
                ...
                $ff2=0;
                $z=1;
                for($i=1;$i<=$period*12;$i++) { if($i==1) { $as63=$initial_investment; }else{ $as63=$ax63; }
                    $at63=$monthly_rate_of_return1; $au63=$as63+$as63*$at63; $av63=$av36_inf; if($i==1) {
                    $aw63=$monthly_annuity_amount1; }else{ $aw63=$aw63+$aw63*$av63; } $ax63=$au63-$aw63; $ff1+=$aw63;
                    if(isset($interest2)) { if($i==1) { $az63=$initial_investment; }else{ $az63=$be63; }
                    $ba63=$monthly_rate_of_return2; $bb63=$az63+$az63*$ba63; $bc63=$av36_inf; if($i==1) {
                    $bd63=$monthly_annuity_amount2; }else{ $bd63=$bd63+$bd63*$bc63; } $be63=$bb63-$bd63; $ff2+=$bd63; }
                    if($i%12==0) { $ff1r=$ff1/12; if(isset($interest2)) { $ff2r=$ff2/12; } @endphp <tr>
                    <td>{{$count_sec+$dif_sec+$z}}</td>
                    <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                        {{custome_money_format($ff1r)}}</td>
                    <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
        ...
        <table class="small-font">
            <tbody>
                ...
                $ag107=0;
                for($i=1;$i<=$period*12;$i++) { $av41_inf=(1+($expected_inflation_rate/100))**(1/12)-1; if($i==1) {
                    $ax=$monthly_annuity_amount1; }else{ $ax=$ax+$ax*$av41_inf; } $av37=(1+($interest1/100))**(1/12)-1;
                    $az=$ax/(1+$av37)**$i; $bc63=$az*(1+($assumed_inflation_rate_for_indexation/100))**($yr-1);
                    if($yr<=$for_period_upto) { $bd63=$ax-$az; }else{ $bd63=$ax-$bc63; } if($yr<=$for_period_upto) {
                    $bg63=$bd63*($applicable_short_term_tax_rate/100); }else{
                    $bg63=$bd63*($applicable_long_term_tax_rate/100); } $bh63=$ax-$bg63; $g103+=$ax; $l147+=$bg63;
                    $q147+=$bh63; //--------ggggggggg if(isset($interest2)) {
                    $av41_inf=(1+($expected_inflation_rate/100))**(1/12)-1; if($i==1) { $bo=$monthly_annuity_amount2;
                    }else{ $bo=$bo+$bo*$av41_inf; } $w103+=$bo; $bl63=(1+($interest2/100))**(1/12)-1;
                    $bq63=$bo/(1+$bl63)**$i; $bt63=$bq63*(1+($assumed_inflation_rate_for_indexation/100))**($yr-1);
                    if($yr<=$for_period_upto) { $bu63=$bo-$bq63; }else{ $bu63=$bo-$bt63; } if($yr<=$for_period_upto) {
                    $bx63=$bu63*($applicable_short_term_tax_rate/100); }else{
                    $bx63=$bu63*($applicable_long_term_tax_rate/100); } $ab107+=$bx63; $by63=$bo-$bx63; $ag107+=$by63; }
                    if($i%12==0) { @endphp <!-- nnnnnnnnnnnnnn -->
                    <tr>
                        <td>{{$count_sec+$dif_sec+$yr}}</td>
                        <td><span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>
                            {{custome_money_format($g103)}}</td>
        ...
        <table class="small-font">
            <tbody>
                ...
                $ab107=0;
                $ag107=0;
                for($i=1;$i<=$period*12;$i++) { //zzzzzzzzzzzz $ax=$monthly_annuity_amount1;
                    $av37=(1+($interest1/100))**(1/12)-1; $az=$ax/(1+$av37)**$i;
                    $bc63=$az*(1+($assumed_inflation_rate_for_indexation/100))**($yr-1); if($yr<=$for_period_upto) {
                    $bd63=$ax-$az; }else{ $bd63=$ax-$bc63; } if($yr<=$for_period_upto) {
                    $bg63=$bd63*($applicable_short_term_tax_rate/100); }else{
                    $bg63=$bd63*($applicable_long_term_tax_rate/100); } $bh63=$ax-$bg63; $g103+=$ax; $l147+=$bg63;
                    $q147+=$bh63; //-------- if(isset($interest2)) { $bo=$monthly_annuity_amount2; $w103+=$bo;
                    $bl63=(1+($interest2/100))**(1/12)-1; $bq63=$bo/(1+$bl63)**$i;
                    $bt63=$bq63*(1+($assumed_inflation_rate_for_indexation/100))**($yr-1); if($yr<=$for_period_upto) {
                    $bu63=$bo-$bq63; }else{ $bu63=$bo-$bt63; } if($yr<=$for_period_upto) {
                    $bx63=$bu63*($applicable_short_term_tax_rate/100); }else{
                    $bx63=$bu63*($applicable_long_term_tax_rate/100); } $ab107+=$bx63; $by63=$bo-$bx63; $ag107+=$by63; }
