...
@php
    ...
    if(!$data['client_name']){
        $data['client_name'] = isset($form_data['clientname'])?$form_data['clientname']:'';
    }
    ...
    $data['accumulation_phase_interest_rate_1'] = old('accumulation_phase_interest_rate_1');
    if(!$data['accumulation_phase_interest_rate_1']){
        $data['accumulation_phase_interest_rate_1'] = isset($form_data['accumulation_phase_interest_rate_1'])?$form_data['accumulation_phase_interest_rate_1']:'';
    }
    
    $data['distribution_phase_interest_rate_1'] = old('distribution_phase_interest_rate_1');
    if(!$data['distribution_phase_interest_rate_1']){
        $data['distribution_phase_interest_rate_1'] = isset($form_data['distribution_phase_interest_rate_1'])?$form_data['distribution_phase_interest_rate_1']:'';
    }
    
    $data['accumulation_phase_interest_rate_2'] = old('accumulation_phase_interest_rate_2');
    if(!$data['accumulation_phase_interest_rate_2']){
        $data['accumulation_phase_interest_rate_2'] = isset($form_data['accumulation_phase_interest_rate_2'])?$form_data['accumulation_phase_interest_rate_2']:'';
    }
    
    $data['distribution_phase_interest_rate_2'] = old('distribution_phase_interest_rate_2');
    if(!$data['distribution_phase_interest_rate_2']){
        $data['distribution_phase_interest_rate_2'] = isset($form_data['distribution_phase_interest_rate_2'])?$form_data['distribution_phase_interest_rate_2']:'';
    }
    
    
    $data['include_inflation'] = old('include_inflation');
    if(!$data['include_inflation']){
        $data['include_inflation'] = isset($form_data['include_inflation'])?$form_data['include_inflation']:'';
    }
    
    $data['deferment'] = old('deferment');
    if(!$data['deferment']){
        $data['deferment'] = isset($form_data['deferment'])?$form_data['deferment']:'';
    }
...
@section('js_after')
    ...
    $(document).on("click",".include_inflation",function(){
        ...
        if(ival=='yes')
        {
            ...
            $('input[name="expected_inflation_rate"]').val('');
        }
    });
    
    @if($data['include_inflation']=='yes')
        $('input[name="expected_inflation_rate"]').prop("readonly", false);
    @else
        $('input[name="expected_inflation_rate"]').prop("readonly", true);
    @endif
...
<section class="main-sec styleNew">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                <h3 class="smalllineHeading">Monthly SWP For Lumpsum Investment</h3>
                
                    @include('frontend.calculators.common_bio')
                    <br>
                    <form class="js-validate-form" action="{{route('frontend.monthlyAnnuityForLumpsumInvestment_output')}}" method="post">
                        <div class="card sip-calculator singleLineHolder calculatorFormShape">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control alert_validation maxtwodigit {{ $errors->has('current_age') ? ' is-invalid' : '' }}" name="current_age" value="{{old('current_age',isset($data['current_age'])?$data['current_age']:'')}}" maxlength="10" >
                                    <div class="cal-icon">
                                        Yrs
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control {{ $errors->has('initial_investment') ? ' is-invalid' : '' }}" name="initial_investment" value="{{old('initial_investment',isset($data['initial_investment'])?$data['initial_investment']:'')}}" maxlength="10" >
                                    <div class="cal-icon">
                                        ₹
                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-check form-check-inline">
                                                    <label class="checkLinecontainer mb-0 mt-2" for="inlineRadiod1">Yes
                                                        <input class="form-check-input deferment_radio" type="radio" name="deferment" id="inlineRadiod1" value="yes" @if(old('deferment')=='yes' || $data['deferment']=='yes') checked  @endif>
                                                        <span class="checkmark"></span>
                                                    </label> 
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <label class="checkLinecontainer mb-0 mt-2" for="inlineRadiod2">No
                                                        <input class="form-check-input deferment_radio" type="radio" name="deferment" id="inlineRadiod2" value="no" @if(old('deferment')=='no' || $data['deferment']=='no') checked @endif >
                                                        <span class="checkmark"></span>
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" readonly id="deferment_period" class="form-control alert_validation pr-2 mr-1 number maxtwodigit {{ $errors->has('deferment_period') ? ' is-invalid' : '' }}" name="deferment_period" value="{{old('deferment_period',isset($data['deferment_period'])?$data['deferment_period']:'')}}" >
                                                <div class="cal-icon">
                                                    Yrs
                                                </div>
                                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="alert_validation form-control maxtwodigit {{ $errors->has('period') ? ' is-invalid' : '' }}" name="period" value="{{old('period',isset($data['period'])?$data['period']:'')}}"  >
                                    <div class="cal-icon">
                                        Yrs
                                    </div>
                            ...
                            <div class="deferment_div1">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control number {{ $errors->has('interest1') ? ' is-invalid' : '' }}" name="interest1" value="{{old('interest1',isset($data['interest1'])?$data['interest1']:'')}}" >
                                        <div class="cal-icon">
                                            %
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control number {{ $errors->has('interest2') ? ' is-invalid' : '' }}" name="interest2" value="{{old('interest2',isset($data['interest2'])?$data['interest2']:'')}}" >
                                        <div class="cal-icon">
                                            %
                                        </div>
                            ...
                            <div class="deferment_div2">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <h6 class="mb-0 pb-0">Accumulation Phase
                                                </h6>
                                            </div>
                                            <div class="col-sm-6">
                                                <h6 class="mb-0 pb-0">Distribution Phase</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group mb-0">
                                                    <input type="text" class="form-control number {{ $errors->has('accumulation_phase_interest_rate_1') ? ' is-invalid' : '' }}" name="accumulation_phase_interest_rate_1" value="{{$data['accumulation_phase_interest_rate_1']}}" required>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group mb-0">
                                                    <input type="text" class="form-control number {{ $errors->has('distribution_phase_interest_rate_1') ? ' is-invalid' : '' }}" name="distribution_phase_interest_rate_1" value="{{$data['distribution_phase_interest_rate_1']}}" required>
                                                    <div class="cal-icon" style="right: 1px;">
                                                        %
                                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group mb-0">
                                                    <input type="text" class="form-control number {{ $errors->has('accumulation_phase_interest_rate_2') ? ' is-invalid' : '' }}" name="accumulation_phase_interest_rate_2" value="{{$data['accumulation_phase_interest_rate_2']}}" >
                                                    <div class="cal-icon" style="right: 1px;">
                                                        %
                                                    </div>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group mb-0">
                                                    <input type="text" class="form-control number {{ $errors->has('distribution_phase_interest_rate_2') ? ' is-invalid' : '' }}" name="distribution_phase_interest_rate_2" value="{{$data['distribution_phase_interest_rate_2']}}">
                                                    <div class="cal-icon" style="right: 1px;">
                                                        %
                                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control {{ $errors->has('balance_required') ? ' is-invalid' : '' }}" name="balance_required" value="{{old('balance_required',isset($data['balance_required'])?$data['balance_required']:'')}}" maxlength="10" >
                                    <div class="cal-icon">
                                        ₹
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-check form-check-inline">
                                        <label class="checkLinecontainer mb-0 mt-1" for="inlineRadioii1">Yes
                                            <input class="form-check-input include_inflation" type="radio" name="include_inflation" id="inlineRadioii1" value="yes" @if($data['include_inflation']=='yes') checked  @endif>
                                            <span class="checkmark"></span>
                                        </label> 
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <label class="checkLinecontainer mb-0 mt-1" for="inlineRadioii2">No
                                            <input class="form-check-input include_inflation" type="radio" name="include_inflation" id="inlineRadioii2" value="no" @if($data['include_inflation']=='no' || $data['include_inflation'] == '') checked  @endif >
                                            <span class="checkmark"></span>
                                        </label> 
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input readonly type="text" class="eir_val form-control {{ $errors->has('expected_inflation_rate') ? ' is-invalid' : '' }}" name="expected_inflation_rate" value="{{old('expected_inflation_rate',isset($data['expected_inflation_rate'])?$data['expected_inflation_rate']:'')}}" maxlength="10" >
                                    <div class="cal-icon">
                                        %
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-check form-check-inline">
                                        <label class="checkLinecontainer mb-0 mt-1" for="inlineRadioit1">Yes
                                    ...
                                    <div class="form-check form-check-inline">
                                        <label class="checkLinecontainer mb-0 mt-1" for="inlineRadioit2">No
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input readonly type="text" class="form-control {{ $errors->has('assumed_inflation_rate_for_indexation') ? ' is-invalid' : '' }}" name="assumed_inflation_rate_for_indexation" value="{{old('assumed_inflation_rate_for_indexation',isset($data['assumed_inflation_rate_for_indexation'])?$data['assumed_inflation_rate_for_indexation']:'')}}" maxlength="10" >
                                    <div class="cal-icon">
                                        %
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                <input readonly type="text" class="form-control pr-2 mr-1 number {{ $errors->has('applicable_short_term_tax_rate') ? ' is-invalid' : '' }}" name="applicable_short_term_tax_rate" value="{{old('applicable_short_term_tax_rate',isset($data['applicable_short_term_tax_rate'])?$data['applicable_short_term_tax_rate']:'')}}" >
                                                <div class="cal-icon">
                                                    %
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                <input readonly type="text" id="for_period_upto" class="form-control pr-2 mr-1 number maxtwodigit {{ $errors->has('for_period_upto') ? ' is-invalid' : '' }}" name="for_period_upto" value="{{old('for_period_upto',isset($data['for_period_upto'])?$data['for_period_upto']:'')}}" >
                                                <div class="cal-icon">
                                                    Yrs
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                <input readonly type="text" class="form-control pr-2 mr-1 number {{ $errors->has('applicable_long_term_tax_rate') ? ' is-invalid' : '' }}" name="applicable_long_term_tax_rate" value="{{old('applicable_long_term_tax_rate',isset($data['applicable_long_term_tax_rate'])?$data['applicable_long_term_tax_rate']:'')}}" >
                                                <div class="cal-icon">
                                                    %
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" readonly id="from_the_year" class="form-control pr-2 mr-1 number maxtwodigit {{ $errors->has('from_the_year') ? ' is-invalid' : '' }}" name="from_the_year" value="{{old('from_the_year',isset($data['from_the_year'])?$data['from_the_year']:'')}}" >
                                                <div class="cal-icon">
                                                    Yrs
                                                </div>
                                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="offset-1 col-sm-10">
                                    <div class="calcBelowBtn">
                                            ...
                                            {{-- <button type="button" onclick="location.reload();" class="btn banner-btn whitebg mx-3"> Reset</button> --}}
                                            @if(session()->get('monthlyAnnuityForLumpsumInvestment_form_id'))
                                                <button type="button" onclick="location.reload();" class="btn banner-btn whitebg mx-3"> Reset</button>
                                            @else
                                                <a href="{{route('frontend.monthlyAnnuityForLumpsumInvestment')}}" class="btn banner-btn whitebg mx-3"> Reset</a>
                                            @endif
                                            <button class="btn banner-btn mx-3">Calculate</button>
                                    </div>
                                </div>
