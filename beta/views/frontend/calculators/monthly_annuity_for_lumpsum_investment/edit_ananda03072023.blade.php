                        ...
                        <div class="card sip-calculator singleLineHolder calculatorFormShape">
                            ...
                            <div class="fixed_deposit_box">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-7 col-form-label">Deferment Period  <a href="#" data-toggle="tooltip" class="red-tooltip" data-placement="top" title="Current Age + Deferment Period + SWP Period cannot exceed 100."><i class="fa fa-info-circle" style="font-size:14px; color:#203864;"></i></a></label>
