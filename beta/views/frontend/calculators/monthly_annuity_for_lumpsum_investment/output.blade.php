...
@section('content')
    ...
    <div class="banner styleApril">
        ...
        @include('frontend.calculators.left_sidebar')
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="page-title">Monthly SWP For Lumpsum Investment</h2>
                </div>
            </div>
        </div>
    </div>
        ...
        <div id="content" class="container">
            <div class="row">
                <div class="col-md-12 offset-md-0 text-center">
                    ...
                    @else
                        <a href="{{route('frontend.monthlyAnnuityForLumpsumInvestment_back')}}?action=back" class="btn btn-primary btn-round"><i class="fa fa-angle-left"></i> Back</a>
                    @endif
                    ...
                    <div class="outputTableHolder">
                        <h1 class="midheading">Monthly SWP Calculation @if(isset($clientname) && !empty($clientname)) <br> For {{$clientname?$clientname:''}} @endif</h1>
                            ...
                            @if($deferment=='yes')
                            <h1 class="midheading">Accumulated Corpus @if($deferment=='yes') @if(!isset($accumulation_phase_interest_rate_2)) @ {{$accumulation_phase_interest_rate_1?number_format($accumulation_phase_interest_rate_1, 2, '.', ''):0}} % @endif @else @if(!isset($interest2)) @ {{$interest1?number_format($interest1, 2, '.', ''):0}} % @endif @endif</h1>
                            ...
                            <div class="roundBorderHolder">
                                ...
                                @else
                                <h5 class="outputSingleBox">₹ {{custome_money_format($av39)}}</h5>
                                @endif
                            ...
                            @if($include_inflation=='yes')
                                ...
                                <h1 class="midheading">First Year Average Monthly SWP @if($deferment=='yes') @if(!isset($distribution_phase_interest_rate_2)) @ {{$distribution_phase_interest_rate_1?number_format($distribution_phase_interest_rate_1, 2, '.', ''):0}} % @endif @else @if(!isset($interest2)) @ {{$interest1?number_format($interest1, 2, '.', ''):0}} % @endif @endif</h1>

                            @else

                            <h1 class="midheading">Monthly SWP Amount @if($deferment=='yes') @if(!isset($distribution_phase_interest_rate_2)) @ {{$distribution_phase_interest_rate_1?number_format($distribution_phase_interest_rate_1, 2, '.', ''):0}} % @endif @else @if(!isset($interest2)) @ {{$interest1?number_format($interest1, 2, '.', ''):0}} % @endif @endif
                            </h1>
                            ...
                            @if($deferment=='no')
                                ...
                                @else
                                    ...
                                    @if($include_inflation=='yes')
                                        ...
                                        $av43_new=($monthly_annuity_amount1*(1-(1+$av36_inf)**12)/(1-(1+$av36_inf)))/12;
                                        @endphp
                                        <h5  class="outputSingleBox">₹ {{custome_money_format($av43_new)}}</h5>
                                    @else
                                        <h5 class="outputSingleBox">₹ {{custome_money_format($monthly_annuity_amount1)}}</h5>
                                    @endif
                        ...
                        <?php } elseif ($deferment == 'yes' && $include_inflation == 'no' && $include_taxation == 'yes'){ ?>
                            ...
                            <h1 class="midheading">Distribution Phase <br> Monthly Withdrawal & Projected Investment Value</h1>
                            @if(isset($expected_inflation_rate))
                            <div class="roundBorderHolder">
                                <table class="table table-bordered text-center">
                                <tbody>
                            ...
                            @else
                                ...
                                <h1 class="midheading">Monthly Withdrawal & Projected Investment Value</h1>
