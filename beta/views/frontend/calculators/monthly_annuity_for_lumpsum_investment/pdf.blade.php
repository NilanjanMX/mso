    ...
    @include('frontend.calculators.common.header')
        ...
        <main class="mainPdf">
            <div style="padding: 0 0%;">
                <h1 class="pdfTitie">Monthly SWP Calculation @if(isset($clientname) && !empty($clientname)) <br> For {{$clientname?$clientname:''}} @endif</h1>
            ...
            <main class="mainPdf">
                            ...
                            <div class="roundBorderHolder withBluebar doubleLineTableTitle">
                                <table class="small-font">
                                    <tbody>
                                        <tr>
                                            <th style="vertical-align: middle;background:{{$address_color_background}}" rowspan="2" >Year</th>
