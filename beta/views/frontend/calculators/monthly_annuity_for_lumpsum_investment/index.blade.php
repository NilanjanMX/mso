                        ...
                        <form class="js-validate-form" action="{{route('frontend.monthlyAnnuityForLumpsumInvestment_output')}}" method="post">
                            <div class="card sip-calculator singleLineHolder calculatorFormShape">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control alert_validation maxtwodigit {{ $errors->has('current_age') ? ' is-invalid' : '' }}" name="current_age" value="{{old('current_age')}}" maxlength="10" >
                                        <div class="cal-icon">
                                            Yrs
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" readonly id="deferment_period" class="form-control alert_validation pr-2 mr-1 number maxtwodigit {{ $errors->has('deferment_period') ? ' is-invalid' : '' }}" name="deferment_period" value="{{old('deferment_period',isset($deferment_period)?$deferment_period:'')}}" >
                                                <div class="cal-icon">
                                                    Yrs
                                                </div>
                                            </div>
