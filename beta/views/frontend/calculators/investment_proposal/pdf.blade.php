...
<head>
    ...
    <style>
        .investmentProposalTable th {
            background: {{$city_color}} !important;
        }
        .investmentProposalTable {
            border: 1px solid #b8b8b8 !important;
        }
        .investmentProposalTable th,
        .investmentProposalTable td {
...
<body class="styleApril">
        ...
        <main class="mainPdf">
            ...
            <h1 class="pdfTitie">
                Investment Proposal @if(isset($clientname) && !empty($clientname)) For {{$clientname?$clientname:''}}  @else  @endif
            </h1>
        </div>
            @php 
                $index = 0; 
            ...
            @if($lumpsum_checkbox)
                <main class="mainPdf">
                    @php  $index = $index+5; $break_count = 0;  @endphp
                    @if(count($lumpsum_form_list))
                        <h1 class="pdfTitie" style="text-align:left;">Lumpsum Investment</h1>
                        <div class="roundBorderHolder">
                            <table class="investmentProposalTable">
                                <thead style="position: relative;bottom: 0px;">
                                    <tr style="">
                ...
                <main class="mainPdf">
                    ...
                    @if(count($sip_form_list))
                        ...
                        <div class="roundBorderHolder">
                            <table class="investmentProposalTable">
                                <thead>
                                    <tr style="background:{{$city_color}}">
            ...
            @if($stp_checkbox)
                @if($lumpsum_checkbox || $sip_checkbox)
                    @include('frontend.calculators.common.watermark')
                    @include('frontend.calculators.common.footer')
                    <div class="page-break"></div>
            ...
            @if($swp_checkbox)
                @if($lumpsum_checkbox || $sip_checkbox || $stp_checkbox)
                    @include('frontend.calculators.common.watermark')
                    @include('frontend.calculators.common.footer')
                    <div class="page-break"></div> 
            ...
            @if($insurance_product_checkbox)
                @if($lumpsum_checkbox || $sip_checkbox || $stp_checkbox || $swp_checkbox || $non_mf_product_checkbox)
                    @include('frontend.calculators.common.watermark')
                    @include('frontend.calculators.common.footer')
                    <div class="page-break"></div>
