                        ...
                        <form action="{{route('frontend.investment_proposal_output')}}" method="post" onsubmit="return onsubmitFunction();">
                            <div class="card sip-calculator singleLineHolder calculatorFormShape">
                                ...
                                <div class="" id="global_lumpsum">
                                    ...
                                    <div class="row">
                                        <label class="col-sm-12 col-form-label checkcontainer2">
                                            <input type="checkbox" name="lumpsum_checkbox" id="lumpsum_checkbox" onchange="changeLumpsumCheckbox();"> Lumpsum
                                            <span class="checkmark"></span>
                                        </label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                        ...
                                                                        <em id="lumpsum_investment_period_error" class="error"></em>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-6">
                                ...
                                <div class="row pt-5 mt-3" id="global_sip">
                                    <label class="col-sm-12 col-form-label checkcontainer2">
                                        <input type="checkbox" name="sip_checkbox" id="sip_checkbox" onchange="changeSIPCheckbox();"> SIP
                                        <span class="checkmark"></span>
                                    </label>
                                ...
                                <div class="row pt-5 mt-3" id="global_stp">
                                    <label class="col-sm-12 col-form-label checkcontainer2">
                                        <input type="checkbox" name="stp_checkbox" id="stp_checkbox" onchange="changeSTPCheckbox();"> STP
                                        <span class="checkmark"></span>
                                    </label>
                                ...
                                <div class="row pt-5 mt-3" id="global_swp">
                                    <label class="col-sm-12 col-form-label checkcontainer2">
                                        <input type="checkbox" name="swp_checkbox" id="swp_checkbox" onchange="changeSWPCheckbox();"> SWP
                                        <span class="checkmark"></span>
                                    </label>
                                ...
                                <div class="row">
                                    <label class="col-sm-12 col-form-label checkcontainer2">
                                        <input type="checkbox" name="non_mf_product_checkbox" id="non_mf_product_checkbox" onchange="changeNonMfProductCheckbox();"> Other Investment Schemes
                                        <span class="checkmark"></span>
                                    </label>
                                                ...
                                                <table id="nonMfTable" class="table table-bordered">
                                                    <thead>
                                                      <tr>
                                                        <th>
                                                            <label class="checkcontainer mb-0" style="padding-left: 45px;">
                                                                <input type="checkbox" checked="checked" name="non_mf_product_investor_checkbox" value="1"> Investor
                                                                <span class="checkmark" style="left: 0px;margin-left: 12px;"></span>
                                                            </label>
                                                        </th>
                                                        <th >Product</th>
                                                        ...
                                                        <th>
                                                            <label class="checkcontainer mb-0" style="padding-left: 45px;">
                                                                <input type="checkbox" checked="checked" name="non_mf_product_amount_checkbox" value="1"> Amount
                                                                <span class="checkmark" style="left: 0px;margin-left: 12px;"></span>
                                                            </label>
                                                        </th>
                                                        <th>
                                                            <label class="checkcontainer mb-0" style="padding-left: 45px;">
                                                                <input type="checkbox" checked="checked" name="non_mf_product_remark_checkbox" value="1"> Remarks
                                                                <span class="checkmark" style="left: 0px;margin-left: 12px;"></span>
                                                            </label>
                                                        </th>
                                                    ...
                                                    <tbody id="non_mf_product_div" class="spaceless">
                                                      <tr id="non_mf_product_tr_0">
                                                        <td><input type="text" value="" style="width: 100%;" maxlength="500" name="non_mf_product_inverstor[]"></td>
                                                        <td>
                                                            <div class="">
                                                                ...
                                                                <div class="form-group mb-0" id="non_mf_product_id_d_0" style="display: none;">
                                                                    <input type="text" value="" style="width: 100%;" id="product_name_0" maxlength="500" name="product_name[]">
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td><input type="text" value="" style="width: 100%;" maxlength="40" name="non_mf_product_company[]" id="non_mf_product_company_0" ></td>
                                                        <td><input type="text" value="" style="width: 100%;" maxlength="500" name="non_mf_product_amount[]" id="non_mf_product_amount_0" onkeypress="return isNumeric(event)"></td>
                                                        <td><input type="text" value="" style="width: 100%;" maxlength="100" name="non_mf_product_remark[]" id="non_mf_product_remark_0"></td>      
                                                        <td>
                                                            <label class="checkcontainer mb-0" style="padding-left: 45px;">
                                                        ...
                                                        <td id="" style="color:red;text-align: center; width: 5%;" onclick="removeNonMfProducts('0');">
                                                             <i class="fa fa-trash" aria-hidden="true" style="font-size: 18px;"></i> 
                                                        </td>
                                                      </tr>
                                                    </tbody>
                                ...
                                <div class="row">
                                    <label class="col-sm-12 col-form-label checkcontainer2">
                                        <input type="checkbox" name="insurance_product_checkbox" id="insurance_product_checkbox" onchange="changeInsuranceProductCheckbox();"> Insurance Schemes
                                        <span class="checkmark"></span>
                                    </label>
                                                ...
                                                <table id="insuranceTable" class="table table-bordered">
                                                    <thead>
                                                      <tr>
                                                        <th>
                                                            <label class="checkcontainer mb-0" style="padding-left: 45px;">
                                                                <input type="checkbox" checked="checked" name="insurance_product_insured_name_checkbox" value="1"> Insured Name
                                                                <span class="checkmark" style="left: 0px;margin-left: 12px;"></span>
                                                            </label>
                                                        </th>
                                                        <th >Product</th>
                                                        ...
                                                        <th>
                                                            <label class="checkcontainer mb-0" style="padding-left: 45px;">
                                                                <input type="checkbox" checked="checked" name="insurance_product_remark_checkbox" value="1"> Remarks
                                                                <span class="checkmark" style="left: 0px;margin-left: 12px;"></span>
                                                            </label>
                                                        </th>
                                                        <th >Action</th>
                                                    ...
                                                    <tbody id="insurance_product_div" class="spaceless">
                                                      <tr id="insurance_product_tr_0">
                                                        <td><input type="text" value="" style="width: 100%;" maxlength="500" name="insurance_product_investor[]" id="insurance_product_investor"></td>
                                                        <td>
                                                            <div class="">
                                                                ...
                                                                <div class="form-group mb-0" id="insurance_product_type_d_0" style="display: none;">
                                                                    <input type="text" value="" style="width: 100%;" id="product_type_name_0" maxlength="500" name="product_type_name[]">
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td><input type="text" value="" style="width: 100%;" maxlength="40" name="insurance_product_company[]" id="insurance_product_company_0"></td>
                                                        <td><input type="text" value="" style="width: 100%;" maxlength="500" name="insurance_product_sum_assured[]" id="insurance_product_sum_assured_0"></td>
                                                        <td><input type="text" value="" style="width: 100%;" maxlength="500" name="insurance_product_annual_premium[]" id="insurance_product_annual_premium_0"></td>
                                                        <td><input type="text" value="" style="width: 100%;" maxlength="100" name="insurance_product_remark[]" id="insurance_product_remark_0"></td>
                                                        <td id="" style="color:red;text-align: center; width: 5%;" onclick="removeInsuranceProduct('0');">
                                                             <i class="fa fa-trash" aria-hidden="true" style="font-size: 18px;"></i> 
                                                        </td>
                                                      </tr>
                                                    </tbody>
                                ...
                                <!--            <textarea style="width: 100%;border: 1px solid #cacaca;" maxlength="500" rows="3" name="comment" id="comment"></textarea>-->
                                <!--        </div>-->
                                <!--    </div>-->
                                <!--</div>-->
                                ...
                                <!--            <div class="">-->
                                <!--                <label class="allocationCheck black" style="padding-left: 12px;margin-left: 5px;">-->
                                <!--                    <input type="checkbox" name="performance_of_selected_mutual_fund" id="performance_of_selected_mutual_fund" value="1">-->
                                <!--                    <span class="checkmark"></span>-->
                                <!--                </label>-->
                                <!--                <label class="form-check-label" for="performance_of_selected_mutual_fund" style="vertical-align: text-bottom; font-weight:500;">Add Performance of Selected Mutual Fund Scheme</label>-->
                                <!--            </div>-->
                                <!--        </div>-->
                                <!--    </div>-->
                                    
                                <!--    <div class="col-md-12" id="performance_of_selected_mutual_fund_view" style="display: none;">-->
                                <!--        <div class="table-responsive">-->
                                <!--            <table class="table portfolioTopTable mfCalcTable nonMfCalcTable insuranceCalcTable width01" id="performance_of_selected_mutual_fund_table">-->
                                <!--                <thead>-->
                                <!--                    <tr>-->
                                ...
                                <!--                    </tr>-->
                                <!--                </thead>-->
                                <!--                <tbody id="performance_of_selected_mutual_fund_tbody">-->
