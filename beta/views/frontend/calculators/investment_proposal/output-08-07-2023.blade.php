...
<style>
    /*.invproptable {*/
    /*    border-collapse: separate;border-spacing: 0px 0px; width: 100%;margin-top: -6px;*/
    /*    border: 1px solid rgba(19,31,85,0.4);*/
    /*    border-bottom:0;*/
    /*    border-left:0;*/
    /*}*/
    /*.invproptable th {*/
    /*    font-size: 13px;font-weight: 500;background: #25a8e0;*/
    /*    text-align: center;color: #fff;*/
    /*    padding:4px 9px;line-height: 16px;vertical-align: middle;*/
    /*    border-bottom: 1px solid rgba(19,31,85,0.4);*/
    /*    border-left: 1px solid rgba(19,31,85,0.4);*/
    /*}*/
    /*.invproptable td {*/
    /*    background-color: #f0f1f6;font-size: 12px;color: #000;*/
