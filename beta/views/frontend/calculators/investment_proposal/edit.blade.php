...
@section('js_after')
    ...
    <script>
        ...
        @if($performance_of_selected_mutual_fund)
            if( $('#performance_of_selected_mutual_fund').is(':checked') ){
                document.getElementById('performance_of_selected_mutual_fund_view').style.display = "block";
                renderSchemeList();
            }else {
                document.getElementById('performance_of_selected_mutual_fund_view').style.display = "none";
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <label class="sqarecontainer">
                                            <input id="performance_of_selected_mutual_fund" type="checkbox" name="performance_of_selected_mutual_fund" value="1" <?php echo ($performance_of_selected_mutual_fund == 1)?'checked':'';?>> 
                                            <span class="checkmark"></span>
