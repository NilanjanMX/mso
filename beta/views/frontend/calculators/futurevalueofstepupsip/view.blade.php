        ...
        <div id="content" class="container">
            <div class="row">
                ...
                <div class="outputTableHolder">
                    ...
                    <h1 class="midheading">Step-Up SIP @if(isset($clientname)) Proposal <br> For {{$clientname?$clientname:''}} @else Planning @endif</h5>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form target="_blank" action="{{route('frontend.futureValueOfStepUpSIPMergeDownload')}}" method="get">
