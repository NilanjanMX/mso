...
<main class="mainPdf">
    <div style="padding: 0 0%;">
        <h1 class="pdfTitie">STP Investment @if(isset($clientname) && !empty($clientname)) Proposal <br> For {{$clientname?$clientname:''}} @else Planning @endif</h1>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td rowspan="2" style="width: 50%;padding: 0">
                        <table width="100%">
                            <tr>
                                <td style="width: 50%;">Debt Fund</td>
                                <td style="width: 50%;">
                                    {{$debt_fund?number_format($debt_fund, 2, '.', ''):0}} %
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 50%;">Equity Fund</td>
                                <td style="width: 50%;">
        ...
        <div class="roundBorderHolder">
            <table>
                <tbody>
                <tr>
                    <td style="width: 50%;">Debt Fund Value</td>
                    <td style="width: 50%;">
                        <span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($debt_fund_value)}}
                    </td>
                </tr>
                <tr>
                    <td style="width: 50%;">Equity Fund Value</td>
                    <td style="width: 50%;">
                        <span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($equity_fund_value)}}
                    </td>
                </tr>
                <tr>
                    <td style="width: 50%;">Total Fund Value</td>
                    <td style="width: 50%;">
                        <span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($total_fund_value)}}
                    </td>
                </tr>
                <tr>
                    <td style="width: 50%;">Annualised Returns</td>
                    <td style="width: 50%;">
...
<main class="mainPdf">
        ...
        <h1 class="bluebar" style="background:{{$city_color}}">STP Investment @if(isset($clientname) && !empty($clientname)) Proposal <br> For {{$clientname?$clientname:''}} @else Planning @endif</h1>
                ...
                @if($monthly_transfer_mode=='CA')
                    @for($j=1;$j<=$investment_period;$j++)
                        ...
                        <tr>
                            <td> {{$j}}</td>
                            <td>
                                <span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($assumed_initial_investment_required)}}
                            </td>
                            <td>
                                <span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($monthly_appreciation2*12)}}
                            </td>
                            <td>
                                <span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($equity_fund_value_begining_of_year)}}
                            </td>
                            <td>
                                <span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($equity_fund_eoy)}}
                            </td>
                            <td>
                                <span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($total_value_eoy)}}
                            </td>
