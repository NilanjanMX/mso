                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7" id="monthly_transfer_active_field">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control {{ $errors->has('fixed_percent') ? ' is-invalid' : '' }}" name="fixed_percent" autocomplete="off" min="0.1" max="2.0" value="{{ old('fixed_percent', isset($data['fixed_percent'])?$data['fixed_percent']:'') }}" @if(old('fixed_transfer_mode', isset($data['fixed_transfer_mode'])?$data['fixed_transfer_mode']:'')=='FP') required @else readonly @endif>
                                        <div class="cal-icon">
                                            %
                                        </div>
                                ...
                                <div class="row mt-1">
                                    <div class="col-sm-6">
                                        <div class="form-check">
                                            <input class="form-check-input" disabled type="radio" id="fixed_transfer_mode5" name="fixed_transfer_mode" value="FA" @if(old('fixed_transfer_mode', isset($data['fixed_transfer_mode'])?$data['fixed_transfer_mode']:'')=='FA') checked  @endif >
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control {{ $errors->has('fixed_amount') ? ' is-invalid' : '' }}" name="fixed_amount" autocomplete="off" value="" min="100" @if(old('fixed_transfer_mode', isset($data['fixed_transfer_mode'])?$data['fixed_transfer_mode']:'')=='FA') required @else readonly @endif >
                                        <div class="cal-icon">
                                            ₹
                                        </div>
