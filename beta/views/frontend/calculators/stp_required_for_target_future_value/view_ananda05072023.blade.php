            ...
            <div class="row">
                <div class="col-md-10 offset-md-1 text-center">
                    ...
                    <div class="outputTableHolder">
                        <h5 class="midheading">STP Required For Target Future Value Comparison @if(isset($clientname)) <br> For {{$clientname?$clientname:''}} @else  @endif</h5>
                        ...
                        <div class="roundBorderHolder">
                            ...
                            <h5 class="midheading">Projected Annual Investment Value</h5>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form target="_blank" action="{{route('frontend.stpRequiredForTargetFutureValue_merge_download')}}" method="get">
