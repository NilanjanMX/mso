...
@php
    ...
    $data['include_step_up'] = old('include_step_up');
    if(!$data['include_step_up']){
        $data['include_step_up'] = isset($form_data['include_step_up'])?$form_data['include_step_up']:'';
    }
                        ...
                        <div class="card sip-calculator singleLineHolder calculatorFormShape">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-check form-check-inline">
                                        <label class="checkLinecontainer mb-0 mt-1">Yes
                                            <input type="radio" name="include_step_up" value="yes" @if($data['include_step_up']=='yes') checked  @endif >
                                            <span class="checkmark"></span>
                                        </label> 
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <label class="checkLinecontainer mb-0 mt-1">No
                                            <input type="radio" name="include_step_up" value="no" @if($data['include_step_up']=='yes')  @else checked  @endif >
                                            <span class="checkmark"></span>
                                        </label> 
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-check form-check-inline">
                                        <label class="checkLinecontainer mb-0 mt-1">Yes
                                            <input type="radio" name="include_cost_delay_report" value="yes" @if($data['include_cost_delay_report']=='yes') checked  @endif >
                                            <span class="checkmark"></span>
                                        </label> 
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <label class="checkLinecontainer mb-0 mt-1">No
                                            <input type="radio" name="include_cost_delay_report" value="no" @if($data['include_cost_delay_report']=='yes')  @else checked  @endif >
                                            <span class="checkmark"></span>
                                        </label> 
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-5">
                                        <label class="sqarecontainer">Add Comments (If any)
                                            <input id="is_note" type="checkbox" name="is_note" value="1" @if(isset($form_data['is_note'])?$form_data['is_note']:''=='1') checked  @endif> 
                                            <span class="checkmark"></span>
                                        </label>
                                    </div>
                                    <div class="col-sm-7">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="offset-1 col-sm-10">
                                        <div class="calcBelowBtn">
                                                ...
                                                @if(session()->get('sip_required_for_target_future_value_form_id'))
                                                    <button type="button" onclick="location.reload();" class="btn banner-btn whitebg mx-3"> Reset</button>
                                                @else
                                                    <a href="{{route('frontend.sipRequiredForTargetFutureValue')}}" class="btn banner-btn whitebg mx-3"> Reset</a>
                                                @endif
                                                <button class="btn banner-btn mx-3">Calculate</button>
                                        </div>
                                    </div>
