...
@section('js_after')
    ...
    <script type="text/javascript">
        ...
        @if(isset($is_graph) && $is_graph)
            @php
                $previous_amount_int1 = 0;
                $previous_amount_int2 = 0;
            ...
            function drawChart() {
                ...
                @if(isset($include_step_up) && $include_step_up=='yes')
                    ...
                    @if(isset($interest2) && $interest2)
                        var data = google.visualization.arrayToDataTable([
                            ['Year',
                                    "Investment@ {{ $interest1 ? number_format((float) $interest1, 2, '.', '') : 0 }} % (Normal SIP)",
                                    'Exp Future Value@ {{ $interest1 ? number_format((float) $interest1, 2, '.', '') : 0 }} %',
                                    "Investment@ {{ $interest2 ? number_format((float) $interest2, 2, '.', '') : 0 }} % (Normal SIP)",
                            ...
                            @for($i=1;$i<=$period;$i++)
                                @php
                                    ...
                                    $cumulative_investment1 = $cumulative_investment1 + $senario1_monthly_amount * 12;
                                    $cumulative_investment2 = $cumulative_investment2 + $senario2_monthly_amount * 12;
                                    
                                    $vaiue1 = round($previous_amount_int1);
                                    $vaiue2 = round($previous_amount_int2);
                                @endphp
                                    ['<?php echo $i; ?>', <?php echo round($cumulative_investment1);?>,<?php echo $vaiue1; ?>,<?php echo round($cumulative_investment2);?>,<?php echo $vaiue2;?>],
                            @endfor
                        ]);
                    @else
                        var data = google.visualization.arrayToDataTable([
                    ...
                    @if(isset($interest2) && $interest2)
                        ...
                        var data = google.visualization.arrayToDataTable([
                            [
                                'Year',
                                "Investment@ {{ $interest1 ? number_format((float) $interest1, 2, '.', '') : 0 }} % (Step-Up SIP)",
                                'Exp Future Value@ {{ $interest1 ? number_format((float) $interest1, 2, '.', '') : 0 }} %',
                                "Investment@ {{ $interest2 ? number_format((float) $interest2, 2, '.', '') : 0 }} % (Step-Up SIP)",
                                'Exp Future Value@ {{ $interest2 ? number_format((float) $interest2, 2, '.', '') : 0 }} %'
                            ],
                            ...
                            @for($i=1;$i<=$period;$i++)
                                @php
                                    ...
                                    $cumulative_investment1 = $cumulative_investment1 + $stepup_senario1_change_amount * 12;
                                    $cumulative_investment2 = $cumulative_investment2 + $stepup_senario2_change_amount * 12;
                ...
                @else
                    @if(isset($interest2) && $interest2)
                        var data = google.visualization.arrayToDataTable([
                            ['Year',
                                    "Investment@ {{ $interest1 ? number_format((float) $interest1, 2, '.', '') : 0 }} %",
                                    'Exp Future Value@ {{ $interest1 ? number_format((float) $interest1, 2, '.', '') : 0 }} %',
                                    "Investment@ {{ $interest2 ? number_format((float) $interest2, 2, '.', '') : 0 }} %",
                                    'Exp Future Value@ {{ $interest2 ? number_format((float) $interest2, 2, '.', '') : 0 }} %'
                                ],
...
<!-- <div class="banner bannerForAll container" style="padding-bottom: 0; margin-bottom: 15px;">
    ...
    <div class="banner styleApril">
        ...
        @include('frontend.calculators.left_sidebar')
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="page-title">SIP Required For Target Future Value</h2>
                </div>
            </div>
        </div>
    </div>
