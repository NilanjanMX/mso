    ...
    <section class="main-sec">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    <h3 class="smalllineHeading">Future Value Of Lumpsum + SIP</h3>
                    @include('frontend.calculators.common_bio')
                    <br>
                    <form class="js-validate-form" action="{{route('frontend.futureValueOfLumpsumSipOutput')}}" method="post">
                        <div class="card sip-calculator singleLineHolder calculatorFormShape">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control {{ $errors->has('sip_amount') ? ' is-invalid' : '' }}" name="sip_amount" value="{{$form_data['sip_amount']}}" maxlength="10"  required>
                                    <div class="cal-icon">
                                        ₹
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control number {{ $errors->has('expected_rate_of_return1') ? ' is-invalid' : '' }}" name="expected_rate_of_return1" value="{{$form_data['expected_rate_of_return1']}}"   required>
                                    <div class="cal-icon">
                                        %
                                    </div>
                                    @if ($errors->has('expected_rate_of_return1'))
                                        <div class="invalid-feedback" role="alert">
                                            <strong>{{ $errors->first('expected_rate_of_return1') }}</strong>
                                        </div>
                                    @endif
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control {{ $errors->has('lumpsum_investment') ? ' is-invalid' : '' }}" name="lumpsum_investment" value="{{$form_data['lumpsum_investment']}}" maxlength="10"  required>
                                    <div class="cal-icon">
                                        ₹
                                    </div>
                                    @if ($errors->has('lumpsum_investment'))
                                        <div class="invalid-feedback" role="alert">
                                            <strong>{{ $errors->first('lumpsum_investment') }}</strong>
                                        </div>
                                    @endif
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-5 col-form-label">Assumed Rate Of Return</label>
                                <div class="col-sm-7">
                                    <input type="text" class="form-control number {{ $errors->has('expected_rate_of_return2') ? ' is-invalid' : '' }}" name="expected_rate_of_return2" value="{{$form_data['expected_rate_of_return2']}}"   >
                                    <div class="cal-icon">
                                        %
                                    </div>
                                    @if ($errors->has('expected_rate_of_return2'))
                                        <div class="invalid-feedback" role="alert">
                                            <strong>{{ $errors->first('expected_rate_of_return2') }}</strong>
                                        </div>
                                    @endif
                                </div>
                            </div>
                        ...
                        <div class="card sip-calculator singleLineHolder calculatorFormShape">
                            <div class="form-group row">
                                ...
                                <label class="sqarecontainer" style="margin: 8px 0 0 0;">
                                    ...
                                    <input placeholder="Add Client Name" type="text" class="form-control {{ $errors->has('clientname') ? ' is-invalid' : '' }}" name="clientname"   value="{{isset($form_data['clientname'])?$form_data['clientname']:''}}" maxlength="30">
                                    <div class="cal-icon">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="offset-1 col-sm-10">
                                    <div class="calcBelowBtn">
                                            ...
                                            @if(session()->get('future_value_of_lumpsum_sip_form_id'))
                                                <button type="button" onclick="location.reload();" class="btn banner-btn whitebg mx-3"> Reset</button>
                                            @else
                                                <a href="{{route('frontend.futureValueOfLumpsumSip')}}" class="btn banner-btn whitebg mx-3"> Reset</a>
                                            @endif
                                            <button class="btn banner-btn mx-3">Calculate</button>
                                    </div>
                                </div>
