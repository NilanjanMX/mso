            ...
            <div class="row">
                <div class="col-md-8 offset-md-2 text-center">
                    ...
                    @if($calculator_permissions['is_download'])
                        <a href="{{route('frontend.swp_debt_balanc_fund_calculator_pdf')}}" target="_blank" id="cmd" class="btn btn-primary btn-round">Download / Print</a>
                    @else
                    ...
                    <h5 class="mb-2 mt-3">SWP Planning @if(isset($clientname) && !empty($clientname)) <br> For {{$clientname?$clientname:''}}  @else  @endif</h5>
                    ...
                    <?php }else{ ?>
                        <h2 style="color: #131f55;font-size:22px;margin-bottom:10px;margin-top:30px;">SWP Period</h2>
                    <?php } ?>
                    ...
                    <h2 style="color: #131f55;font-size:22px;margin-top:20px;margin-bottom: 0;">Expected Portfolio Return</h2>
                    <h2 style="color: #131f55;font-size:22px;margin-bottom:20px;">{{$exp_portfolio_return?$exp_portfolio_return:0}}%</h2>

                    <h2 style="color: #131f55;font-size:22px;margin-top:20px;margin-bottom: 0;">{{$withdrawal?$withdrawal:0}} SWP Amount</h2>
                    <h2 style="color: #131f55;font-size:22px;margin-bottom:20px;">₹ {{$withdrawal_amount?custome_money_format($withdrawal_amount):0}}</h2>
                    @php
                    ...
                    @endphp
                    <h2 style="color: #131f55;font-size:22px;margin-top:20px;margin-bottom: 0;">Total Annuity Received</h2>
                    <h2 style="color: #131f55;font-size:22px;margin-bottom:20px;">₹ {{$withdrawal_amount?custome_money_format($withdrawal_amount*$swp_period*$mo):0}}</h2>

                    <h2 style="color: #131f55;font-size:22px;margin-top:20px;margin-bottom: 0;">Closing Fund Value</h2>
                    <h2 style="color: #131f55;font-size:22px;margin-bottom:20px;">₹ <span id="cl_view"></span></h2>
                    ...
                    * Returns are not guaranteed. The above is for illustration purpose only.<br><br>
                    ...
                    <h2 style="color: #131f55;font-size:22px;margin-bottom:5px;">Projected Annual Cash Flow & Fund Value</h2>
                    @php
