...
@php
    ...
    $data['investment_period'] = old('investment_period');
    if(!$data['investment_period']){
        $data['investment_period'] = $form_data['investment_period'];
    }

    $data['payment_period'] = old('payment_period');
    if(!$data['payment_period']){
        $data['payment_period'] = $form_data['payment_period'];
    }
    ...
    $data['clientname'] = old('clientname');
    if(!$data['clientname']){
        $data['clientname'] = $form_data['clientname'];
    }
    ...
    <section class="main-sec styleNew">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    <h3 class="smalllineHeading">Lumsum Investment Required for Target Future Value</h3>
                    ...
                    <form class="js-validate-form" action="{{route('frontend.annualLumpsumRequiredForTargetFutureValue_output')}}" method="post">      
                        <div class="card sip-calculator singleLineHolder calculatorFormShape">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control maxtwodigit {{ $errors->has('investment_period') ? ' is-invalid' : '' }}" name="investment_period" id="investment_period" value="{{$data['investment_period']}}"  >
                                    <div class="cal-icon">
                                        Yr
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control maxtwodigit {{ $errors->has('payment_period') ? ' is-invalid' : '' }}" name="payment_period" value="{{$data['payment_period']}}"  id="payment_period">
                                    <div class="cal-icon">
                                        Yr
                                    </div>
                        ...
                        <div class="card sip-calculator singleLineHolder calculatorFormShape">
                            <div class="form-group row">
                                ...
                                <label class="sqarecontainer" style="margin: 8px 0 0 0;">
                                    ...
                                    <input placeholder="Add Client Name" type="text" class="form-control {{ $errors->has('clientname') ? ' is-invalid' : '' }}" name="clientname"   value="{{$data['clientname']}}" maxlength="30">
                                    <div class="cal-icon">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="offset-1 col-sm-10">
                                    <div class="calcBelowBtn">
                                            ...
                                            @if(session()->get('annual_lumpsum_investment_target_future_value_form_id'))
                                                <button type="button" onclick="location.reload();" class="btn banner-btn whitebg mx-3"> Reset</button>
                                            @else
                                                <a href="{{route('frontend.lumsumInvestmentRequiredForTargetFutureValue')}}" class="btn banner-btn whitebg mx-3"> Reset</a>
                                            @endif
                                            <button class="btn banner-btn mx-3">Calculate</button>
                                    </div>
                                </div>
