                ...
                <div class="roundBorderHolder">
                    <table>
                        ...
                        <tr>
                            ...
                            <td style="Width:50%;">
                                <span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($stp_amount)}}
                            </td>
                        </tr>
                        <tr>
                            <td style="Width:50%;">
                            ...
                            <td style="Width:50%;padding: 0">
                                <table style="width: 100%;">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="Width:50%;">Debt</td>
                                            <td style="Width:50%;">{{$debt_interest?number_format($debt_interest, 2, '.', ''):0}} %</td>
                                        </tr>
                                        <tr>
                                            <td style="Width:50%;">Equity</td>
                                            <td style="Width:50%;">{{$equity_interest?number_format($equity_interest, 2, '.', ''):0}} %</td>
                                        </tr>
                    ...
                    <div class="roundBorderHolder">
                        <table>
                            ...
                            <tr>
                                ...
                                <td style="Width:50%;">
                                    <span class="pdfRupeeIcon">&#8377;</span> {{custome_money_format($sip_fund_value)}}
                                </td>
                            </tr>
                            <tr>
                                <td style="Width:50%;">
                ...
                <div class="roundBorderHolder withBluebar">
                    <table>
                        ...
                        <tr>
                            ...
                            <th style="background:{{$address_color_background}};">STP Fund Value</th>
