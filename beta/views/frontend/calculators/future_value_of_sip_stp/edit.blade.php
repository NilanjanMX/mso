...
@php
    ...
    if(!$data['report']){
        $data['report'] = isset($form_data['report'])?$form_data['report']:'';
    }
    
    $data['suggest'] = old('suggest');
    if(!$data['suggest']){
        $data['suggest'] = isset($form_data['suggest'])?$form_data['suggest']:'';
    }
                    ...
                    <form class="js-validate-form" action="{{route('frontend.futureValueOfSipStp_output')}}" method="post">
                        <div class="card sip-calculator singleLineHolder calculatorFormShape">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control {{ $errors->has('sip_amount') ? ' is-invalid' : '' }}" name="sip_amount" value="{{old('sip_amount', isset($data['sip_amount'])?$data['sip_amount']:'')}}" maxlength="10"  required>
                                    <div class="cal-icon">
                                        ₹
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control {{ $errors->has('stp_amount') ? ' is-invalid' : '' }}" name="stp_amount" value="{{old('stp_amount', isset($data['stp_amount'])?$data['stp_amount']:'')}}" maxlength="10"  required>
                                    <div class="cal-icon">
                                        ₹
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-check form-check-inline">
                                        <label class="checkLinecontainer mb-0 mt-1" for="inlineRadio1">Capital Appreciation
                            ...
                            <div class="form-group row">
                                ...
                                <div class="offset-1 col-sm-10">
                                    <div class=" calcBelowBtn">
                                            ...
                                            @if(session()->get('futureValueOfSipStp_form_id'))
                                                <button type="button" onclick="location.reload();" class="btn banner-btn whitebg mx-3"> Reset</button>
                                            @else
                                                <a href="{{route('frontend.futureValueOfSipStp')}}" class="btn banner-btn whitebg mx-3"> Reset</a>
                                            @endif
