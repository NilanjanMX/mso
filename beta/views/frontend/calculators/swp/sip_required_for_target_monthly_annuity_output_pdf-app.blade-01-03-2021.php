...
<main style="width: 760px; margin-left: 20px;">
            ...
            <table class="table table-bordered text-center">
                ...
                @else
                    <tr>
                        <td>
                            <strong>
                                <span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span>{{custome_money_format($sip_required1)}}
                            </strong>
                        </td>
                    </tr>
                @endif
    ...
    @php
        $note_data1 = \App\Models\Calculator_note::where('category','summery')->where('calculator','SIP_Required_For_Target_Monthly_Annuity')->first();
        if(!empty($note_data1)){
        @endphp
    ...
    @if(isset($report) && $report=='detailed')
        ...
        @php
        $note_data2 = \App\Models\Calculator_note::where('category','cashflow')->where('calculator','SIP_Required_For_Target_Monthly_Annuity')->first();
        if(!empty($note_data2)){
        @endphp
