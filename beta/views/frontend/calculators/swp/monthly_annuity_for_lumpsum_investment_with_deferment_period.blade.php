...
@section('js_after')
    <script>
        ...
        jQuery.validator.addMethod('lesserThanEqual', function(value, element, param) {
            ...
            rules: {
                ...
                accumulation_phase_interest_rate_2: {
                    required: function(element) {
                        return ($("input[name='distribution_phase_interest_rate_2']").val().length) ? true : false;
                    },
                    number: true,
                    twodecimalplaces: true,
                    range: [0.10, 15.00]
                ...
                distribution_phase_interest_rate_2: {
                    required: function(element) {
                        return ($("input[name='accumulation_phase_interest_rate_2']").val().length) ? true : false;
                    },
                    number: true,
                    twodecimalplaces: true,
                    range: [0.10, 15.00]
                ...
                balance_required: {
                    //required: true,
                    digits: true,
                    lesserThanEqual:  "#initial_investment",
                    maxlength: 10,
                    range: [0, 9999999999],
                }
            },
            messages: {
                balance_required: { lesserThanEqual: "Must be 'less than' or 'equal to' Initial Investment!" },
            }
        });
    </script>
    ...
    <section class="main-sec">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    <h3 class="mb-3 text-center">Monthly Annuity For Lumpsum Investment With Deferment Period</h3>
                    <div class="card sip-calculator">
                        <div class="card-header text-center">
                            This calculator gives you how much amount you can withdraw every month (SWP) for a given one time lumpsum investment after a deferment period. (You can decide how much balance you need at the end of the annuity period. It could also be nil. If your balance requirement is high, figures could become negative.)
                        </div>
                        <div class="card-body">
                        <form class="js-validate-form" action="{{route('frontend.monthlyAnnuityForlumpsumInvestmentWithDefermentPeriodOutput')}}" method="post">
                            @csrf
                            <div class="form-group row">
                                <label class="col-sm-5 col-form-label">Initial Investment</label>
                                <div class="col-sm-7">
                                    <input type="text" id="initial_investment" class="form-control {{ $errors->has('initial_investment') ? ' is-invalid' : '' }}" name="initial_investment" value="{{old('initial_investment')}}" maxlength="10"  required>
                                    <div class="cal-icon">
                                        ₹
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control maxtwodigit {{ $errors->has('deferment_period') ? ' is-invalid' : '' }}" name="deferment_period" value="{{old('deferment_period')}}"   required>
                                    <div class="cal-icon">
                                        Yr
                                    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control maxtwodigit {{ $errors->has('annuity_period') ? ' is-invalid' : '' }}" name="annuity_period" value="{{old('annuity_period')}}"   required>
                                    <div class="cal-icon">
                                        Yr
                                    </div>
