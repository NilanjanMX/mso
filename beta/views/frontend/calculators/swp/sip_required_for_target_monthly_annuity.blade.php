    ...
    <section class="main-sec">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    <h3 class="mb-3 text-center">SIP Required For Target Monthly Annuity</h3>
                    <div class="card sip-calculator">
                        <div class="card-header text-center">
                            This calculator gives you SIP amount required to get target monthly withdrawal (SWP) after SIP ends. (You can decide how much balance you need at the end of the annuity period. It could also be nil. If your balance requirement is high, figures could become negative.)
                        </div>
                        <div class="card-body">
