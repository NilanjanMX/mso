                   ...
                   @php
                      ...
                      <table class="table table-bordered text-center" style="margin-top: 40px;">
                        ...
                        <tr>
                            ...
                            <td style="border: 1px solid #b8b8b8;">
                                <span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{custome_money_format($rat2+$debt_tax_payable_n)}}
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <span style="font-family: DejaVu Sans; sans-serif;">&#8377;</span> {{custome_money_format(($initial_investment+$rwd2*$period) - ($rat2+$debt_tax_payable_n))}}
                            </td>
                        </tr>
                        </tbody>
                    </table>
