    ...
    <section class="main-sec">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    <h3 class="mb-3 text-center">SIP Required For Target Monthly SWP</h3>
                    <div class="card sip-calculator">
                        @include('frontend.calculators.common_bio')
                        <div class="card-body">
                        <form class="js-validate-form" action="{{route('frontend.sipRequiredForTargetMonthlyAnnuityOutput')}}" method="post">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control {{ $errors->has('monthly_annuity_required') ? ' is-invalid' : '' }}" name="monthly_annuity_required" value="{{old('monthly_annuity_required')}}" maxlength="10" >
                                    <div class="cal-icon">
                                        ₹
                                    </div>
                                    @if ($errors->has('monthly_annuity_required'))
                                        <div class="invalid-feedback" role="alert">
                                            <strong>{{ $errors->first('monthly_annuity_required') }}</strong>
                                        </div>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="fixed_deposit_box" style="display:none;">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-7 col-form-label">For period upto 1</label>
                                            <div class="col-sm-5">
