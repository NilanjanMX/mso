        ...
        @php
                   ...
                   <?php } elseif ($deferment == 'yes' && $include_inflation == 'no' && $include_taxation == 'yes'){ ?>
                    ...
                    @if(isset($report) && $report=='detailed')
                        <h1 style="color: #000;font-size:16px;margin-bottom:5px !important;margin-top: 30px !important;text-align:center;">Accumulation Phase Asif <br>Projected Annual Investment Value</h1>
