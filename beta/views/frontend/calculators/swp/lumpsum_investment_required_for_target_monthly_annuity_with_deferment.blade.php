    ...
    <section class="main-sec">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    <h3 class="mb-3 text-center">Lumpsum Investment Required For Target Monthly Annuity With Deferment Period</h3>
                    <div class="card sip-calculator">
                        <div class="card-header text-center">
                            This calculator gives you how much lumpsum investment is required for receiving a target monthly annuity (SWP) after a given deferment period. (You can decide how much balance you need at the end of the annuity period. It could also be nil. If your balance requirement is high, figures could become negative.)
                        </div>
                        <div class="card-body">
                        <form class="js-validate-form" action="{{route('frontend.lumpsumInvestmentRequiredForTargetMonthlyAnnuityWithDefermentOutput')}}" method="post">
                            @csrf
                            <div class="form-group row">
                                <label class="col-sm-5 col-form-label">Monthly Annuity Required</label>
                                <div class="col-sm-7">
                                    <input type="text" class="form-control {{ $errors->has('required_monthly_annuity') ? ' is-invalid' : '' }}" name="required_monthly_annuity" value="{{old('required_monthly_annuity')}}" maxlength="10"  required>
                                    <div class="cal-icon">
                                        ₹
                                    </div>
