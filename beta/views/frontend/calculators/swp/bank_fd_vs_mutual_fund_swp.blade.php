...
@section('js_after')
        ...
        $(function() {
            ...
            var validator = $(".js-validate-form").validate({
                ...
                messages:{
                    ...
                    fixed_deposit: "Please enter a value between 0.00 - 12.00%.",
                    debt_fund: "Please enter a value between 0.00 - 10.00%.",
                    ...
                    applicable_long_term_tax_rate: "Please enter a value between 0.00 - 99.00%.",
    ...
    <script type="text/javascript">
        ...
        var is_client = $('#is_client').attr('checked');
    ...
    <script type="text/javascript">
        function saveDataInLocalStorage(){
            var values = $("input[name='schemecode[]']")
    ...
    <section class="main-sec">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    <h3 class="mb-3 text-center">Bank FD vs. Mutual Fund SWP</h3>
                    <div class="card sip-calculator">
                        @include('frontend.calculators.common_bio')
                    <div class="card-body">
                        <form class="js-validate-form" action="{{route('frontend.bank_fd_vs_mutual_fund_swp_output')}}" method="post">
                            @csrf
                            ...
                            <div class="form-group row">
                                <label class="col-sm-5 col-form-label">Withdrawal Mode</label>
                                <div class="col-sm-7">
                                   
                                    <select class="form-control {{ $errors->has('withdrawal_mode') ? ' is-invalid' : '' }}" name="withdrawal_mode">
                                    <option value="Monthly">Monthly</option>
                                    <option value="Quarterly">Quarterly</option>
                                    <option value="Half-Yearly">Half-Yearly</option>
                                    <option value="Yearly">Yearly</option>
                                    </select>
                                    @if ($errors->has('withdrawal_mode'))
                                        <div class="invalid-feedback" role="alert">
                                            <strong>{{ $errors->first('withdrawal_mode') }}</strong>
                                        </div>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label class="col-sm-5 col-form-label">
                                    <input id="tax_calculation" type="checkbox" name="tax_calculation" value="1" @if(old('tax_calculation')=='1') checked  @endif> Display tax calculation
                                </label>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="offset-5 col-sm-7">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <button class="btn btn-primary btn-round btn-block" onclick="saveDataInLocalStorage();">Calculate</button>
                                        </div>
                                    </div>
