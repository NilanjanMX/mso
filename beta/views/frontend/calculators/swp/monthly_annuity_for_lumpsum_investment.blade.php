    ...
    <section class="main-sec">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    <h3 class="mb-3 text-center">Monthly SWP For Lumpsum Investment</h3>
                    <div class="card sip-calculator">
                        @include('frontend.calculators.common_bio')
                        <div class="card-body">
                        <form class="js-validate-form" action="{{route('frontend.monthlyAnnuityForLumpsumInvestmentOutput')}}" method="post">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="offset-5 col-sm-7">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <button class="btn btn-primary btn-round btn-block dis_btn">Calculate</button>
                                        </div>
                                    </div>
