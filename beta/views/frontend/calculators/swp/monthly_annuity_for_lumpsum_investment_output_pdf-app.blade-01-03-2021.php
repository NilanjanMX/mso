...
@php
    ...
    //Monthly Annuity Amount (1) (AV27*AV31)/(1-(1+AV27)^(-AV26))
    ...
    //Monthly Annuity Amount (2) (AV28*AV32)/(1-(1+AV28)^(-AV26))
...
<main style="width: 760px; margin-left: 20px;">
   ...
   @php
    ...
    @if(isset($report) && $report=='detailed')
        ...
        @php
        $note_data2 = \App\Models\Calculator_note::where('category','cashflow')->where('calculator','Monthly_Annuity_For_Lumpsum_Investment')->first();
        if(!empty($note_data2)){
        @endphp
