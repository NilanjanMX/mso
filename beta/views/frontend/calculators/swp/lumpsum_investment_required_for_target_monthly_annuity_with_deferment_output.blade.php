        ...
        jQuery(document).ready(function(){
            jQuery('#save_cal_btn').click(function(e){
                ...
                if(title.trim()==''){
                    ...
                    jQuery.ajax({
                        url: "{{ route('frontend.lumpsumInvestmentRequiredForTargetMonthlyAnnuityWithDefermentOutputSave') }}",
                        method: 'get',
                        data: {
                            title: title
                        },
        ...
        <div id="content" class="container">
            <div class="row">
                <div class="col-md-8 offset-md-2 text-center">
                    ...
                    <a href="{{route('frontend.lumpsumInvestmentRequiredForTargetMonthlyAnnuityWithDefermentOutputDownloadPdf')}}" target="_blank" id="cmd" class="btn btn-primary btn-round">Download / Print</a>
                    ...
                    <h1 style="color: #131f55;font-size:22px;margin-bottom:20px;text-align: center;">Lumpsum Investment Required</h1>
                    <table class="table table-bordered text-center">
                        <tbody>
                        @if(isset($accumulation_phase_interest_rate_2) && $accumulation_phase_interest_rate_2>0)
                            <tr>
                        ...
                        @else
                            <tr>
                                ...
                                <td>
                                    ₹ {{custome_money_format($lumpsum_investment_required1)}}
                                </td>
                            </tr>
                        @endif
                        </tbody>
                            ...
                            @if(isset($accumulation_phase_interest_rate_2) && $accumulation_phase_interest_rate_2>0)
                                ...
                                @for($i=1;$i<=$deferment_period;$i++)
                                    ...
                                    <tr>
                                        <td>{{$i}}</td>
                                        @if($i==1)
                                            <td>₹ {{custome_money_format($lumpsum_investment_required1)}}</td>
                                        @else
                                            <td> -- </td>
                                        @endif
                                        ...
                                        @if($i==1)
                                            <td>₹ {{custome_money_format($lumpsum_investment_required2)}}</td>
                                        @else
                                            <td> -- </td>
                                        @endif
