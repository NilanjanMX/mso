...
<body>
    <main>
            ...
            <header>
                <table style="border:0 !important;" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td style="text-align:right; border:0;" valign="middle"><img style="display:inline-block; width:110px; height:auto; margin-top: 50px;" src="{{$company_logo}}" alt=""></td>
                    </tr>
                    </tbody>
                </table>
            </header>
            ...
            <div>
                 <h1 style="margin:0 auto; color: #000;font-size:14px;margin-bottom:10px !important;margin-top:10px !important;text-align:center; background-color: #a9f3ff; padding: 10px 0; width:90%;">STP Comprehensive @if(isset($clientname) && !empty($clientname)) For {{$clientname?$clientname:''}}  @else  @endif</h1>
                 <div style="padding: 0 5%;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <table style="width:102%; margin-left:-5px; margin-top:-5px;margin-bottom:-5px; border:0;">
                                            <tr>
                                    <td style="border-top:0px; border-left:0px !important;">
                                        <strong>Debt Fund</strong>
                                    </td>
                                    <td style="border-top:0px; border-right:0px !important;">
                                          {{sprintf('%0.2f',$debt)}} %
                                    </td>
                                </tr>
                                <tr>
                                    <td style="border-bottom:0px; border-left:0px !important;">
                                        <strong>Equity Fund</strong>
                                    </td>
                                    <td style="border-bottom:0px; border-right:0px !important;">
                                          {{sprintf('%0.2f',$equity)}} %
                                    </td>
                                </tr>
                                        </table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($transfermode == 2)
                                        <span style='font-family: DejaVu Sans; sans-serif;'>&#8377;</span> {{custome_money_format($fixedamount)}}
                                        @else
                                         <span style='font-family: DejaVu Sans; sans-serif;'>&#8377;</span> {{custome_money_format($eachTransferAmt)}}
                                         @endif
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <br/><br/><br/>
                    <h1 style=" color: #000;font-size:16px;margin-bottom:10px !important;text-align:center; background-color: #a9f3ff; padding: 10px 0; width:100%;">Projected Future Value</h1>
                    ...
                    <table class="table table-bordered">
                        <tbody>
                            <tr>
                                    ...
                                    <td>
                                        @if($transfermode == 2)
                                        <span style='font-family: DejaVu Sans; sans-serif;'>&#8377;</span> {{custome_money_format($finalFutreValueLeft)}}
                                        @else
                                         <span style='font-family: DejaVu Sans; sans-serif;'>&#8377;</span> {{custome_money_format($finalFutureValueDebt)}}
                                         @endif
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                         <span style='font-family: DejaVu Sans; sans-serif;'>&#8377;</span> {{custome_money_format($finalFutureValueEquity)}}
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                         <span style='font-family: DejaVu Sans; sans-serif;'>&#8377;</span> {{custome_money_format($totalFundValue)}}
                                    </td>
                                </tr>
                                <tr>
                                    <td>
            ...
            @include('frontend.calculators.common.footer')
                    ...
                    <h1 style="color: #000;font-size:16px;margin-bottom:20px !important;text-align:center; background-color: #fff; width:100%;">Projected Annual Investment Value</h1>
                    ...
                    <table class="table table-bordered">
                        <tbody>
                           ...
                           <tr style="background-color: #a9f3ff">
                               <td style="font-size:12px;"><strong>{{$addon}}</strong></td><td style="font-size:12px;"><strong>Debt Fund Value at the Beginning of Every {{$addon}}</strong></td><td style="font-size:12px;"><strong>Transfer to Equity Every {{$addon}}</strong></td><td style="font-size:12px;"><strong>Equity Fund Value at the Beginning of Every {{$addon}}</strong></td><td style="font-size:12px;"><strong>Equity Fund Value at the End of Every {{$addon}}</strong></td>
                           <td style="font-size:12px;"><strong>Total Value at the End of Every {{$addon}} (Debt+Equity)</strong></td><td style="font-size:12px;"><strong>Annualised Returns</strong></td>
                           </tr>
                    ...
                    @php
                        ...
                        // dd($transferAmount);
                         $annualReturn =pow(( $totalValAtEnd/$initial),(1/(1/12)))-1;
                            $annualReturn *= 100;
                            echo("<tr><td style='font-size:6px;'>1</td><td><span style='font-family: DejaVu Sans; sans-serif;'>&#8377;</span> ".custome_money_format($showDebtVal)."</td><td style='font-size:6px;'><span style='font-family: DejaVu Sans; sans-serif;'>&#8377;</span> ".custome_money_format($transferAmount)."</td><td style='font-size:6px;'><span style='font-family: DejaVu Sans; sans-serif;'>&#8377;</span> ".custome_money_format($equityValAtBegin)."</td><td style='font-size:6px;'><span style='font-family: DejaVu Sans; sans-serif;'>&#8377;</span> ".custome_money_format($equityBalEow)."</td><td style='font-size:6px;'><span style='font-family: DejaVu Sans; sans-serif;'>&#8377;</span> ".custome_money_format($totalValAtEnd)."</td><td style='font-size:6px;'>".sprintf('%0.2f',$annualReturn)." %</td></tr>");
                        ...
                        while($monthNo <= $tot)
                        {
                          ...
                          //dd($equityBalEow);
                            ...
                            if($showMonth % 26 == 0)
                            {
                                ...
                                echo('<header><table style="border:0 !important;" cellpadding="0" cellspacing="0"><tbody><tr><td style="text-align:left; border:0;">&nbsp;</td><td style="text-align:right; border:0;" valign="middle"><img style="display:inline-block; width:110px; height:auto; margin-top: 50px;" src="'.$company_logo.'" alt=""></td></tr></tbody></table></header>');
                                echo('<h1 style="margin:0 auto; color: #000;font-size:16px;margin-bottom:20px !important;text-align:center; background-color: #fff; padding: 10px 0; width:100%;">Projected Annual Investment Value</h1>');
                                @endphp
                                @include('frontend.calculators.common.footer')
                                @php
                                echo('<table class="table table-bordered"><tbody><tr style="background-color: #a9f3ff"><td style="font-size:12px;"><strong>'.$addon.'</strong></td><td style="font-size:12px;"><strong>Debt Fund Value at the Beginning of Every '.$addon.'</strong></td><td style="font-size:12px;"><strong>Transfer to Equity Every '.$addon.'</strong></td><td style="font-size:12px;"><strong>Equity Fund Value at the Beginning of Every '.$addon.'</strong></td><td style="font-size:12px;"><strong>Equity Fund Value at the End of Every '.$addon.'</strong></td><td style="font-size:12px;"><strong>Total Value at the End of Every '.$addon.' (Debt+Equity)</strong></td><td style="font-size:12px;"><strong>Annualised Returns</strong></td></tr>');
                            }
                            
                            echo("<tr><td style='font-size:12px;'>".$showMonth."</td><td style='font-size:12px;'><span style='font-family: DejaVu Sans; sans-serif;'>&#8377;</span> ".custome_money_format($showDebtVal)."</td><td style='font-size:12px;'><span style='font-family: DejaVu Sans; sans-serif;'>&#8377;</span> ".custome_money_format($transferEveryYear)."</td><td style='font-size:12px;'><span style='font-family: DejaVu Sans; sans-serif;'>&#8377;</span> ".custome_money_format($equityValAtBegin)."</td><td style='font-size:12px;'><span style='font-family: DejaVu Sans; sans-serif;'>&#8377;</span> ".custome_money_format($equityBalEow)."</td><td style='font-size:12px;'><span style='font-family: DejaVu Sans; sans-serif;'>&#8377;</span> ".custome_money_format($totalValAtEnd)."</td><td style='font-size:12px;'>".sprintf('%0.2f',$annualReturn)." %</td></tr>");
        ...
        * The above is for illustration purpose only. Report Date : {{date('d/m/Y')}}<br>
        ...
        @php
            $note_data2 = \App\Models\Calculator_note::where('category','cashflow')->where('calculator','stp_custom_transfer')->first();
            if(!empty($note_data2)){
            @endphp
