...
<body class="styleApril">
    ...
    <main class="mainPdf">
            <div style="padding: 0 0%;">
                 <h1 class="pdfTitie">STP Comprehensive @if(isset($clientname) && !empty($clientname)) <br> For {{$clientname?$clientname:''}}  @else  @endif</h1>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($transfermode == 2)
                                        <span class='pdfRupeeIcon'>&#8377;</span> {{custome_money_format($fixedamount)}}
                                        @else
                                         <span class='pdfRupeeIcon'>&#8377;</span> {{custome_money_format($eachTransferAmt)}}
                                         @endif
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <h1 class="pdfTitie">Projected Future Value</h1>
                    ...
                    <div class="roundBorderHolder">
                        ...
                        <tbody>
                            <tr>
                                    ...
                                    <td>
                                        @if($transfermode == 2)
                                        <span class='pdfRupeeIcon'>&#8377;</span> {{custome_money_format($finalFutreValueLeft)}}
                                        @else
                                         <span class='pdfRupeeIcon'>&#8377;</span> {{custome_money_format($finalFutureValueDebt)}}
                                         @endif
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                         <span class='pdfRupeeIcon'>&#8377;</span> {{custome_money_format($finalFutureValueEquity)}}
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                         <span class='pdfRupeeIcon'>&#8377;</span> {{custome_money_format($totalFundValue)}}
                                    </td>
                                </tr>
                                <tr>
                                    <td>
        ...
        <main class="mainPdf">
                    ...
                    <h1 class="pdfTitie">Projected Annual Investment Value</h1>
                    ...
                    @php
                        ...
                        // dd($transferAmount);
                         $annualReturn =pow(( $totalValAtEnd/$initial),(1/(1/12)))-1;
                            $annualReturn *= 100;
                            echo("<tr><td style='font-size:6px;'>1</td><td><span class='pdfRupeeIcon'>&#8377;</span> ".custome_money_format($showDebtVal)."</td><td style='font-size:6px;'><span class='pdfRupeeIcon'>&#8377;</span> ".custome_money_format($transferAmount)."</td><td style='font-size:6px;'><span class='pdfRupeeIcon'>&#8377;</span> ".custome_money_format($equityValAtBegin)."</td><td style='font-size:6px;'><span class='pdfRupeeIcon'>&#8377;</span> ".custome_money_format($equityBalEow)."</td><td style='font-size:6px;'><span class='pdfRupeeIcon'>&#8377;</span> ".custome_money_format($totalValAtEnd)."</td><td style='font-size:6px;'>".sprintf('%0.2f',$annualReturn)." %</td></tr>");
        ...
        <p>*The above is for illustration purpose only. Report Date : {{date('d/m/Y')}}</p>
