                ...
                <div class="col-md-12">
                    ...
                    <form id="sip" enctype="multipart/form-data" method="post" class="js-validate-form" action="{{route('frontend.stp_custom_transfer_output')}}" name="recover_emis_through_sip_form">
                      <div class="card sip-calculator singleLineHolder">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-sm-8">
                                  <div class="form-check form-check-inline">
                                      <input class="form-check-input fixed_deposit_chk" type="radio" id="transfermode" name="transfermode" onchange="ShowEach(1)"  checked value=1>
                                      <label class="form-check-label" for="inlineRadio1">Capital Appreciation</label>
                                  </div>
                                  <div class="form-check form-check-inline">
                                      <input class="form-check-input fixed_deposit_chk" type="radio" id="transfermode" name="transfermode" value=2  onchange="ShowEach(2)" >
                          ...
                          <div class="form-group row">
                              <label class="col-sm-4 col-form-label"><span>Fixed Amount</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input class="form-check-input fixed_deposit_chk"  onchange="activateEach(1)" type="radio" name="eachtransfer" class="form-control" value=1 checked></label>
                              <div class="col-sm-8">
                          ...
                          <div class="form-group row">
                              <label class="col-sm-4 col-form-label"><span>Fixed %</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input class="form-check-input fixed_deposit_chk"  onchange="activateEach(2)" type="radio" name="eachtransfer" class="form-control" value=2></label>
                              <div class="col-sm-8">
                                  <div class="d-flex align-items-center">
                          ...
                          <div class="form-group row">
                              <label class="col-sm-4 col-form-label"><span>Years</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input class="form-check-input fixed_deposit_chk"  onchange="activateMe(1)" type="radio" name="investmentperiod" class="form-control" value=1 checked></label>
                              <div class="col-sm-8">
                                  <div class="d-flex align-items-center">
                          ...
                          <div class="form-group row">
                              <label class="col-sm-4 col-form-label"><span>Months</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input class="form-check-input fixed_deposit_chk"  onchange="activateMe(2)" type="radio" name="investmentperiod" class="form-control" value=2></label>
                              <div class="col-sm-8">
                                  <div class="d-flex align-items-center">
