...
@section('content')
    ...
    <div class="banner styleApril">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="page-title">STP Comprehensive Calculator</h2>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 offset-md-0 text-center">
                    ...
                    <div class="outputTableHolder">
                        <h1 class="midheading">STP Comprehensive @if(isset($clientname) && !empty($clientname)) <br> For {{$clientname?$clientname:''}}  @else  @endif</h1>
                        ...
                        @endif
                        <p class="text-left">
                        *The above is for illustration purpose only. Report Date : {{date('d/m/Y')}}</p>
