                              ...
                              <div class="col-sm-7">
                                  <div class="form-check form-check-inline">
                                      <label class="checkLinecontainer mb-0 mt-1" for="ShowEach_1">Capital Appreciation
                                            <input class="form-check-input fixed_deposit_chk" type="radio" id="ShowEach_1" name="transfermode" onchange="ShowEach(1)" <?php echo ($transfermode == 1)?'checked':''; ?> value=1>
                                            <span class="checkmark"></span>
                                      </label>
                                  </div>
                                  <div class="form-check form-check-inline">
                                      <label class="checkLinecontainer mb-0 mt-1" for="ShowEach_2">Fixed Amount
                                            <input class="form-check-input fixed_deposit_chk" type="radio" id="ShowEach_2" name="transfermode" <?php echo ($transfermode == 2)?'checked':''; ?> value=2  onchange="ShowEach(2)" >
                                            <span class="checkmark"></span>
                                      </label>
                                  </div>
                              </div>
                          ...
                          <div class="form-group row">
                              <div class="col-sm-5">
                                  <label class="checkLinecontainer mb-0 mt-2"><span>Fixed Amount</span>
                                    <input class="form-check-input fixed_deposit_chk"  onchange="activateEach(1)" type="radio" name="eachtransfer" class="form-control" value=1 <?php echo ($eachtransfer == 1)?'checked':'';?>>
                                    <span class="checkmark"></span>
                                  </label>
                              </div>
                          ...
                          <div class="form-group row">
                              <div class="col-sm-5">
                                    <label class="checkLinecontainer mb-0 mt-2"><span>Fixed %</span>
                                        <input class="form-check-input fixed_deposit_chk"  onchange="activateEach(2)" type="radio" name="eachtransfer" class="form-control" value=2 <?php echo ($eachtransfer == 2)?'checked':'';?>>
                                        <span class="checkmark"></span>
                                    </label>
                                </div>
                              <div class="col-sm-7">
                          ...
                          <div class="form-group row">
                              <div class="col-sm-5">
                                    <label class="checkLinecontainer mb-0 mt-2"><span>Years</span>
                                        <input class="form-check-input fixed_deposit_chk"  onchange="activateMe(1)" type="radio" name="investmentperiod" class="form-control" value=1 <?php echo ($investmentperiod == 1)?'checked':'';?>>
                                        <span class="checkmark"></span>
                                    </label>
                                </div>
                          ...
                          <div class="form-group row">
                              <div class="col-sm-5">
                                    <label class="checkLinecontainer mb-0 mt-2"><span>Months</span>
                                        <input class="form-check-input fixed_deposit_chk"  onchange="activateMe(2)" type="radio" name="investmentperiod" class="form-control" value=2 <?php echo ($investmentperiod == 2)?'checked':'';?>>
                                        <span class="checkmark"></span>
                                    </label>
                                </div>
