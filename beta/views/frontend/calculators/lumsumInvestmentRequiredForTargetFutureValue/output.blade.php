                    ...
                    var data = google.visualization.arrayToDataTable([
                        ...
                        @for($i=1;$i<=$period;$i++)
                            @php
                                ...
                                $vaiue6 = round($vaiue4);
                            @endphp
                            ['<?php echo $i;?>',<?php echo $vaiue5;?>,<?php echo $vaiue1;?>,<?php echo $vaiue6;?>,<?php echo $vaiue2;?>],
                        @endfor
                    ]);
                    ...
                    var data = google.visualization.arrayToDataTable([
                        ...
                        @for($i=1;$i<=$period;$i++)
                            @php
                                ...
                                $vaiue2 = round($vaiue3);
                            @endphp
                            ['<?php echo $i;?>',<?php echo $vaiue2;?>,<?php echo $vaiue1;?>],
                        @endfor
                    ]);
...
<!-- <div class="banner bannerForAll container" style="padding-bottom: 0; margin-bottom: 15px;">
    ...
    <div class="banner styleApril">
        ...
        @include('frontend.calculators.left_sidebar')
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="page-title">Lumsum Investment Required for Target Future Value</h2>
                </div>
            </div>
        </div>
    </div>
