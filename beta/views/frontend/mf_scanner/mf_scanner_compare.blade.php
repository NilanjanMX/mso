...
@section('js_after')
    ...
    <script>
        ...
        function checkDownload(){
            ...
            console.log($("#rating_checkbox").attr('checked'));
            
            document.getElementById("holding_checkbox_id").value = ($("#top_holding_all").attr('checked'))?1:0;
            document.getElementById("rating_checkbox_id").value = ($("#rating_checkbox").attr('checked'))?1:0;
            // return false;
        ...
        function saveModalData(){
            ...
            document.getElementById("holding_checkbox_id").value = ($("#top_holding_all").attr('checked'))?1:0;
            document.getElementById("rating_checkbox_id").value = $("#rating_checkbox").attr('checked');
            document.getElementById("compare_title").value = document.getElementById('modal_title').value;
...
<style>
    ...
    #comparison_fund .list-group-item{min-height:102px;line-height:2}
...
@php
    ...
    $glob_checked_img = asset('')."/img/star_icon-checked.png";
    $glob_unchecked_img = asset('')."/img/star_icon-unchecked.png";
    
    foreach($result as $key=>$value){
        $rating = "";
        if($value->rating == 5){
            $rating = "<img  src='".$glob_checked_img."' style='width: 13px;'><img  src='".$glob_checked_img."' style='width: 13px;'><img  src='".$glob_checked_img."' style='width: 13px;'><img  src='".$glob_checked_img."' style='width: 13px;'><img  src='".$glob_checked_img."' style='width: 13px;'>";
        }else if($value->rating == 4){
            $rating = "<img  src='".$glob_checked_img."' style='width: 13px;'><img  src='".$glob_checked_img."' style='width: 13px;'><img  src='".$glob_checked_img."' style='width: 13px;'><img  src='".$glob_checked_img."' style='width: 13px;'><img  src='".$glob_unchecked_img."' style='width: 13px;'>";
        }else if($value->rating == 3){
            $rating = "<img  src='".$glob_checked_img."' style='width: 13px;'><img  src='".$glob_checked_img."' style='width: 13px;'><img  src='".$glob_checked_img."' style='width: 13px;'><img  src='".$glob_unchecked_img."' style='width: 13px;'><img  src='".$glob_unchecked_img."' style='width: 13px;'>";
        }else if($value->rating == 2){
            $rating = "<img  src='".$glob_checked_img."' style='width: 13px;'><img  src='".$glob_checked_img."' style='width: 13px;'><img  src='".$glob_unchecked_img."' style='width: 13px;'><img  src='".$glob_unchecked_img."' style='width: 13px;'><img  src='".$glob_unchecked_img."' style='width: 13px;'>";
        }else if($value->rating == 1){
            $rating = "<img  src='".$glob_checked_img."' style='width: 13px;'><img  src='".$glob_unchecked_img."' style='width: 13px;'><img  src='".$glob_unchecked_img."' style='width: 13px;'><img  src='".$glob_unchecked_img."' style='width: 13px;'><img  src='".$glob_unchecked_img."' style='width: 13px;'>";
        }else {
            $rating = "Unrated";
        }
        ...
        $iHtml1 .= '<div class="mob_mf_com col-3 col-md-3 col_0" style="display: block;" id="row_view1_'.$key.'">
                      <div class="comparison_fund_outer">
                        ...
                        <div class="comparison_fund_inner_bottom">
                          <span id="classification_0">'.$value->classname.'</span> <br>
                          <span id="classification_0">'.$rating.'</span>
                        </div>
                      </div>                  
                    </div>';
                ...
                <form method="get" action="" id="download_save_form">
                  <div class="input-group row">
                    ...
                    <div class="col-sm-3" style="padding-left: 0px;">
                        ...
                        <input type="hidden" id="rating_checkbox_id" name="rating_checkbox_id" value="">
                        <span id="download_saved_div">
                            <?php if(count($result) > 1) { ?>
                                ...
                                @else
                                    <button type="button" class="btn btn-success downloadButton" onclick="openDownloadPermissionModal();">
                                        Download
                                    </button>
                                @endif
                                ...
                                @else
                                    <button  type="button" class="btn btn-success  savedButton" onclick="openSavePermissionModal();">
                                        Save
                                    </button>
                                @endif
          ...
          <div class="area_wrap_mob">
                    ...
                    <div class="mob_mf_com col-2 col-md-2">                 
                        <div class="list-group">
                            <div class="list-group-item scmedatahead text-center">
                                <h2 style="line-height:18px;width: 100%;margin: 0;padding: 0;">
                                    <!--Comparison of selected funds based on various parameters-->
                                    <b><br>Scheme <br>Comparison<br><br>

                                    <span><input type="checkbox" name="rating_checkbox" id="rating_checkbox" value="1" checked></span>
                                    MSO Rating</b>
                                </h2>
                            </div>
                        </div>                
            ...
            <div class="row" id="comparison_basic" style="padding-top: 1.5rem;">
              <div class="" style="
                ...
                <div class="comparison_head">
                    <span><input type="checkbox" name="basic_detail_all" id="basic_detail_all" value="" onchange="changeAllCheckbox('basic_detail')" checked></span>
              ...
              <div class="col-2 col-md-2 comparison_bodyP1" id="basic_detail_id">
                <ul class="list-group">
                    <li class="list-group-item">
                        <span><input type="checkbox" name="basic_detail_checkbox[]" id="basic_detail_checkbox" value="inception_date" checked></span>
                        <span>Inception Date</span>
                    </li>
                    <li class="list-group-item">
                        <span><input type="checkbox" name="basic_detail_checkbox[]" id="basic_detail_checkbox" value="fund_type" checked></span>
                        Fund Type
                    </li>
                    <li class="list-group-item">
                        <span><input type="checkbox" name="basic_detail_checkbox[]" id="basic_detail_checkbox" value="fund_manager" checked></span>
                        Fund Manager
                    </li>
                    <li class="list-group-item">
                        <span><input type="checkbox" name="basic_detail_checkbox[]" id="basic_detail_checkbox" value="aum" checked></span>
                        AUM (in Rs. Cr)
                    </li>
                    <li class="list-group-item">
                        <span><input type="checkbox" name="basic_detail_checkbox[]" id="basic_detail_checkbox" value="benchmark_index" checked></span>
                        Benchmark Index
                    </li>
                    <li class="list-group-item">
                        <span><input type="checkbox" name="basic_detail_checkbox[]" id="basic_detail_checkbox" value="expense_ratio" checked></span>
                        Expense Ratio (%)
                    </li>
                    <li class="list-group-item">
                        <span><input type="checkbox" name="basic_detail_checkbox[]" id="basic_detail_checkbox" value="exit_load" checked></span>
                        Exit Load (%)
                    </li>
                    <li class="list-group-item">
                        <span><input type="checkbox" name="basic_detail_checkbox" id="basic_detail_checkbox" value="latest_nav" checked></span>
                        Latest NAV
                    </li>
                </ul>                       
              </div>
            ...
            <div class="row" id="comparison_return">
              <div class="col-12 col-md-12 pr-2">
                <div class="comparison_head">
                    <span><input type="checkbox" name="return_all" id="return_all" value="" onchange="changeAllCheckbox('return')" checked></span>
                    <span>RETURN (%)</span>
                </div>
              </div>
              <div class="col-2 col-md-2 comparison_bodyP1" id="return_id">
                  <ul class="list-group">
                    <li class="list-group-item">
                        <span><input type="checkbox" name="return_checkbox[]" id="return_checkbox" value="1_month" checked></span>
                        1 Month
                    </li>
                    <li class="list-group-item">
                        <span><input type="checkbox" name="return_checkbox[]" id="return_checkbox" value="3_month" checked></span>
                        3 Month
                    </li>
                    <li class="list-group-item">
                        <span><input type="checkbox" name="return_checkbox[]" id="return_checkbox" value="6_month" checked></span>
                        6 Month
                    </li>
                    <li class="list-group-item">
                        <span><input type="checkbox" name="return_checkbox[]" id="return_checkbox" value="1_year" checked></span>
                        1 Year
                    </li>
                    <li class="list-group-item">
                        <span><input type="checkbox" name="return_checkbox[]" id="return_checkbox" value="2_year" checked></span>
                        2 Year
                    </li>
                    <li class="list-group-item">
                        <span><input type="checkbox" name="return_checkbox[]" id="return_checkbox" value="3_year" checked></span>
                        3 Year
                    </li>
                    <li class="list-group-item">
                        <span><input type="checkbox" name="return_checkbox[]" id="return_checkbox" value="5_year" checked></span>
                        5 Year
                    </li>
                    <li class="list-group-item">
                        <span><input type="checkbox" name="return_checkbox[]" id="return_checkbox" value="10_year" checked></span>
                        10 Year
                    </li>
                    <li class="list-group-item">
                        <span><input type="checkbox" name="return_checkbox[]" id="return_checkbox" value="since_inception" checked></span>
                        Since Inception
                    </li>
                  </ul>                       
              </div>
            ...
            <div class="row" id="comparison_performance_measures">
              <div class="col-12 col-md-12 pr-2">
                <div class="comparison_head">
                    <span><input type="checkbox" name="mf_ratios_all" id="mf_ratios_all" value="" onchange="changeAllCheckbox('mf_ratios')" checked></span>
                    <span>MF RATIOS</span>
                </div>
              </div>
              <div class="col-2 col-md-2 comparison_bodyP1" id="mf_ratios_id">
                <ul class="list-group">
                    <li class="list-group-item">
                        <span><input type="checkbox" name="mf_ratios_checkbox[]" id="mf_ratios_checkbox" value="alpha_ratio" checked></span>
                        Alpha Ratio
                    </li>
                    <li class="list-group-item">
                        <span><input type="checkbox" name="mf_ratios_checkbox[]" id="mf_ratios_checkbox" value="sharpe_ratio" checked></span>
                        Sharpe Ratio
                    </li>
                    <li class="list-group-item">
                        <span><input type="checkbox" name="mf_ratios_checkbox[]" id="mf_ratios_checkbox" value="sortino" checked></span>
                        Sortino
                    </li>
                    <li class="list-group-item">
                        <span><input type="checkbox" name="mf_ratios_checkbox[]" id="mf_ratios_checkbox" value="beta" checked></span>
                        Beta
                    </li>
                    <li class="list-group-item">
                        <span><input type="checkbox" name="mf_ratios_checkbox[]" id="mf_ratios_checkbox" value="standard_deviation" checked></span>
                        Standard Deviation
                    </li>
                </ul>                       
              </div>
            ...
            <div class="row" id="comparison_portfolio_attributes">
              <div class="col-12 col-md-12 pr-2">
                <div class="comparison_head">
                    <span><input type="checkbox" name="portfolio_attributes_all" id="portfolio_attributes_all" value="" onchange="changeAllCheckbox('portfolio_attributes')" checked></span>
              ...
              <div class="col-2 col-md-2 comparison_bodyP1" id="portfolio_attributes_id">
                <ul class="list-group">
                    <li class="list-group-item">
                        <span><input type="checkbox" name="portfolio_checkbox[]" id="portfolio_checkbox" value="portfolio_pb_ratio" checked></span>
                        Portfolio P/B Ratio
                    </li>
                    <li class="list-group-item">
                        <span><input type="checkbox" name="portfolio_checkbox[]" id="portfolio_checkbox" value="portfolio_pe_ratio" checked></span>
                        Portfolio P/E Ratio
                    </li>
                    <li class="list-group-item">
                        <span><input type="checkbox" name="portfolio_checkbox[]" id="portfolio_checkbox" value="dividend_yield" checked></span>
                        Dividend Yield
                    </li>
                    <li class="list-group-item">
                        <span><input type="checkbox" name="portfolio_checkbox[]" id="portfolio_checkbox" value="turnover_ratio" checked></span>
                        Turnover Ratio (%)
                    </li>
                    <li class="list-group-item">
                        <span><input type="checkbox" name="portfolio_checkbox[]" id="portfolio_checkbox" value="no_of_stocks" checked></span>
                        No. of Stocks
                    </li>
                    <li class="list-group-item">
                        <span><input type="checkbox" name="portfolio_checkbox[]" id="portfolio_checkbox" value="avg_market_cap" checked></span>
                        Avg Mkt Cap (Rs Cr)
                    </li>
                    <li class="list-group-item">
                        <span><input type="checkbox" name="portfolio_checkbox[]" id="portfolio_checkbox" value="large_cap" checked></span>
                        Large Cap (%)
                    </li>
                    <li class="list-group-item">
                        <span><input type="checkbox" name="portfolio_checkbox[]" id="portfolio_checkbox" value="mid_cap" checked></span>
                        Mid Cap (%)
                    </li>
                    <li class="list-group-item">
                        <span><input type="checkbox" name="portfolio_checkbox[]" id="portfolio_checkbox" value="small_cap" checked></span>
                        Small Cap (%)
                    </li> 
                    <li class="list-group-item">
                        <span><input type="checkbox" name="portfolio_checkbox[]" id="portfolio_checkbox" value="average_maturity" checked></span>
                        Average Maturity
                    </li> 
                    <li class="list-group-item">
                        <span><input type="checkbox" name="portfolio_checkbox[]" id="portfolio_checkbox" value="modified_duration" checked></span>
                        Modified Duration
                    </li> 
                    <li class="list-group-item">
                        <span><input type="checkbox" name="portfolio_checkbox[]" id="portfolio_checkbox" value="yield_to_maturity" checked></span>
                        YTM (%)
                    </li> 
                    <li class="list-group-item">
                        <span><input type="checkbox" name="portfolio_checkbox[]" id="portfolio_checkbox" value="sovereign_rating" checked></span>
                        Sovereign Rating
                    </li> 
                    <li class="list-group-item">
                        <span><input type="checkbox" name="portfolio_checkbox[]" id="portfolio_checkbox" value="aaa_rated" checked></span>
                        AAA Rated
                    </li> 
                    <li class="list-group-item">
                        <span><input type="checkbox" name="portfolio_checkbox[]" id="portfolio_checkbox" value="aa_rated" checked></span>
                        AA Rated
                    </li> 
                    <li class="list-group-item">
                        <span><input type="checkbox" name="portfolio_checkbox[]" id="portfolio_checkbox" value="a_rated" checked></span>
                        A Rated
                    </li> 
                    <li class="list-group-item">
                        <span><input type="checkbox" name="portfolio_checkbox[]" id="portfolio_checkbox" value="unrated" checked></span>
                        Unrated
                    </li>             
                </ul>                       
              </div>
            ...
            <div class="row" id="comparison_top_10_holdings">
                <div class="col-12 col-md-12 pr-2"> 
                    <div class="comparison_head">
                        <span><input type="checkbox" name="top_holding_all" id="top_holding_all" value="1" checked></span>
